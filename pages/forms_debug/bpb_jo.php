...
{ $akses = flookup("bpb_jo","userpassword","username='$user'");  }
if ($akses=="0") 
...
echo "<div class='box'>";
  echo "<div class='box-body'>";
    echo "<div class='row'>";
      echo "<form method='post' name='form' action='s_bpb_jo.php?mod=$mod&mode=$mode&noid=$bppbno&id=$id_line' onsubmit='return validasi()'>";
        echo "
        <div class='col-md-3'>
        ...
        echo "<div class='col-md-3'>";
          ...
          echo "<div class='form-group'>";
            ...
            echo "<input type='text' class='form-control' name='txtkkbc' 
        ...
        echo "<div class='col-md-3'>";
          ...
          <div class='col-md-6'>
            <div class='form-group'>
              ...
              <input type='text' class='form-control' name='txtbcaju' $st_txt_h  
          ...
          <div class='col-md-6'>
            <div class='form-group'>
              ...
              <input type='text' class='form-control' name='txttglaju' $st_txt_tgl_h1 readonly  
...
<div class="box">
  <?php 
  $fldnyacri=" left(bpbno,1) in ('A','F','B') "; $mod2=33;
  ?>
    ...
    <table id="examplefix3" class="display responsive" style="width:100%">
      ...
      <tbody>
        ...
        $sql="SELECT a.*,s.goods_code,$fld_desc itemdesc,supplier 
          ...
          and a.id_jo!='' and ifnull(a.id_book,'0')='0' 
          and right(bpbno,1)!='R'    
