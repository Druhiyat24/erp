...
insert_log($sql,$user);
$sql="update bppb_req set qty_old=qty where bppbno='$cri'";
insert_log($sql,$user);
$sql="update bppb_req set qty=0,cancel='Y',cancel_by='$user',cancel_date='$date2' where bppbno='$cri'";
insert_log($sql,$user);

$_SESSION['msg'] = "Data Berhasil Dicancel";
echo "<script>window.location.href='../forms/?mod=car';</script>";
?>