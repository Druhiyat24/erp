...
SELECT IAC.v_noinvoicecommercial
		...
		FROM invoice_commercial IAC
			LEFT JOIN(
				SELECT SUM(carton) j_carton,id_inv,max(id_so_det)id_so_det,sum(qty) qty_inv,sum(price)price_inv FROM invoice_detail GROUP BY id_inv 
