...
SELECT ID.id,ID.id_inv,ID.id_so_det,SOD.id_so,ID.lot,ID.carton carton
		,SOD.qty,SOD.size,SOD.price,SOD.color
			,if(SOD.size = 'XS', ID.qty ,0)  XS
			,if(SOD.size = 'S',  ID.qty ,0)   S
			,if(SOD.size = 'M',  ID.qty ,0)   M
			,if(SOD.size = 'L',  ID.qty ,0)   L
			,if(SOD.size = 'XL', ID.qty ,0)  XL
			,if(SOD.size = 'XXL',ID.qty ,0) XXL
			,if(SOD.size = '3XL',ID.qty ,0) 3XL
		,SO.id_cost
