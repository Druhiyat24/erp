...
{	if ($fld!="" AND $tbl!="" AND $criteria!="")
	...
	notes,n_kurs,ppn,tax,discount,pph,jenis,jml_pterms,fg_pkp,id_dayterms,d_start_installment,n_installment,fg_installment)
			...
			'{$header['txtnotes']}','{$header['n_kurs']}','{$header['ppn_nya']}','{$header['ppn_nya']}','{$header['txtdisc']}','{$header['txtdisc']}','{$header['jenis_item']}','{$header['txtdays']}','{$header['pkp']}','{$header['txtid_dayterms']}','{$header['start_installment']}','{$header['jumlah_installment']}','{$header['fg_installment']}')";
/*  			echo $insert;
			die();   */
