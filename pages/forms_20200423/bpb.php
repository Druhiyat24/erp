              ...
              <div class='col-md-3'>
                ...
                { echo "<div class='form-group'>";
                    ...
                    { $sql="select id_item isi,concat(kpno,'|',styleno,'|',buyerno) 
                        ...
                        where id_so_det is null group by kpno order by kpno";
                    ...
                    { $sql="select a.id_item isi,concat(a.kpno,'|',a.styleno,'|',a.buyerno) 
                        ...
                        where a.id_so_det is null group by kpno order by kpno";
    ...
    <table id="examplefix3" class="display responsive" style="width:100%">
      ...
      <tbody>
        ...
        $sql="SELECT a.*,s.goods_code,$fld_desc itemdesc,supplier, br.bppbno
          ...
          where $fldnyacri and a.id_po_item is null and a.id_jo is null   
