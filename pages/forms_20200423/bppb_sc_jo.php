      ...
      echo "<form method='post' name='form' action='save_sc_jo.php?mod=$mod&mode=$mode&noid=$bppbno&id=$id_line' onsubmit='return validasi()'>";
        ...
        echo "<div class='col-md-3'>";
          ...
          echo "<div class='form-group'>";
            ...
            echo "<input type='text' class='form-control' name='txtbppbdate' onchange='getSat(this.value)' placeholder='$cmas $c53' value='$bppbdate'>";
          echo "</div>";
          echo "<div class='form-group'>";
  ...
  <div class="box-body">
    <table id="examplefix3" class="display responsive" style="width:100%;font-size:10px;">
      ...
      <tbody>
        ...
        $sql="SELECT a.*,s.goods_code,$fld_desc itemdesc,ms.supplier,mb.supplier buyer,
