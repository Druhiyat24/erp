...
<script type="text/javascript">
  ...
  var rakdet = document.getElementsByClassName('rakclass');
...
echo "<div class='box'>";
  ...
  echo "<div class='row'>";
    ...
    <div class='col-md-3'>
      ...
      if($noreq!="") {$fldcri=" where bppbno='$noreq'";} else {$fldcri=" where a.qty>ifnull(tmp_out.qty_out,0) ";}
      $sql="select a.bppbno isi,concat(a.bppbno,'|',ac.kpno,'|',ac.styleno,'|',mb.supplier) tampil 
        ...
        left join (select bppbno_req,id_item,id_jo,sum(qty) qty_out from bppb group by bppbno_req,id_item,id_jo) tmp_out 
        on a.bppbno=tmp_out.bppbno_req and a.id_item=tmp_out.id_item and a.id_jo=tmp_out.id_jo   
    ...
    echo "<div class='col-md-3'>";
      ...
      <div class='col-md-6'>
        ...
        <input type='text' maxlength='6' class='form-control' name='txtbcaju' $st_txt_h  
      ...
      <div class='col-md-6'>
        ...
        <input type='text' class='form-control' name='txttglaju' $st_txt_tgl_h1 
    ...
    echo "<div class='col-md-3'>";
      ...
      <div class='col-md-6'>
        <div class='form-group'>
        <label>$c53 *</label>
        <input type='text' class='form-control' name='txtbppbdate' id='datepicker3' 
    ...
    <div class='box-body'>
      ...
      { echo "<table id='examplefix2' style='width: 100%;'>";
        ...
        $sql="select breq.nomor_rak,breq.id line_item,breq.id_supplier,breq.qty qtyout,mi.goods_code,
          concat(mi.itemdesc,' ',mi.color,' ',mi.size,' ',mi.add_info) itemdesc,tbl_in.id_item,tbl_in.id_jo,tbl_in.qty_in,
...
<div class="box">
  ...
  { #YOUNGIL MATTYPE C JADI BAHAN BAKU
    if($nm_company=="PT. Youngil Leather Indonesia")
    { $fldnyacri=" mid(bppbno,4,1) in ('A','F','B','C') and mid(bppbno,4,2)!='FG' "; $mod2=35; }
    else
  ...
  <table id="examplefix3" class="display responsive" style="width:100%;font-size:10px;">
    ...
    $sql="SELECT a.bppbno_int,a.bppbno,a.bppbno_req,a.bppbdate,
