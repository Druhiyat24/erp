          ...
          echo "<div class='col-md-3'>";
            ...
            <div class='row'>
              ...
              <div class='col-md-6'>
                <div class='form-group'>
                  <label>$c43 *</label>
                  <input type='text' class='form-control' name='txtbcdate' readonly id='datepicker3'  
                    placeholder='Masukkan Tgl. Daftar' value='$datedef'>
                </div>
              </div>
            </div>";
          echo "</div>";
        ...
        <tbody>
          ...
          { $sjint=flookup("bppbno_int","bppb","bppbno='$data[bppbno]'");
            ...
            echo "
              ...
              { echo "
                <td>
                  <a href='cetaksjri.php?mode=In&noid=$data[bpbno]' 
