          ...
          echo "<table id='examplefix' width='100%' style='font-size:12px;'>";
            echo "
              ...
              $sql="select br.id,br.id_h,roll_no,lot_no,roll_qty,roll_foc,br.unit,
                ...
                brh.id='$id_h' and br.id_rak_loc is null ";
              #echo $sql;
              $i=1;
              ...
              { $x = $data['id']."|".$data['id_h'];
                echo "
                  <tr>
                    ...
                    <td>$data[lot_no]</td>
                    <td>
                      <input type='text' size='5' name='txtqtyact[$x]' id='txtqtyact' class='txtqtyactclass' 
                        value='$data[roll_qty]'>
                    </td>
                    <td>
                      <input type='text' size='5' name='txtqtyfoc[$x]' id='txtqtyfoc' class='txtqtyfpcclass' 
                        value='$data[roll_foc]'>
                    </td>
                    <td>$data[unit]</td>
                    <td>$data[barcode]</td>
