...
<div class="box">
  <?php 
  $fldnyacri=" left(bpbno,2)='FG' and a.id_so_det!='' "; $mod2=31;
  ?>
  ...
  <div class="box-body">
    <table id="examplefix3" class="display responsive" style="width:100%">
      ...
      <tbody>
        ...
        $query = mysql_query("SELECT a.*,ac.kpno,s.goods_code,$fld_desc itemdesc,ms.supplier,
          jod.id_jo idjonya,jo_no,ac.styleno stylenya,mb.supplier buyer   
