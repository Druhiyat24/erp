...
$akses = flookup("mnuBPBFG_po","userpassword","username='$user'");
if ($akses=="0") 
...
<form method='post' name='form' action='s_bpb_so_po.php?mod=<?php echo $mod; ?>' 
      ...
      <div class='row'>
        ...
        <div class='col-md-3'>
          ...
          <div class='form-group'>
            ...
            <select class='form-control select2' style='width: 100%;' onchange='getPoBySupplier(this.value)' name='txtid_supplier'>
          ...
          <div class='form-group'>
            ...
            <select class='form-control select2'  style='width: 100%;' 
              ...
              name='txtid_po' id='cboPO' onchange='getJO_po(this.value)'>
            </select>
...
<div class="box">
  ...
  $fldnyacri=" left(bpbno,2)='FG' AND (a.pono IS NOT NULL OR a.pono !='')"; $mod2="31_bj_po";
    ...
    <table id="examplefix3" class="display responsive" style="width:100%">
      ...
      <tbody>
        ...
        $query = mysql_query("SELECT a.*,ac.kpno,s.goods_code,$fld_desc itemdesc,supplier,
          ...
          jod.id_jo idjonya,jo_no,ac.Styleno, a.bcdate, a.dateinput 
...
<script src="js/BarangJadiPoForm.js"></script>