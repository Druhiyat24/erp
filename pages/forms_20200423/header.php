  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        ?>
        <li class="dropdown">
          <a href="" class="dropdown-toggle" data-toggle="dropdown"><?php echo $c3."(Sample)"; ?><span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <?PHP
            $akses = $rsUser["mnuBPB"];
            if ($st_company=="GB" OR $st_company=="PLB" OR $st_company=="MULTI_WHS")
            ...
            { $akses = $rsUser["mnuBPB"];
              ...
              $akses = $rsUser["bpb_po"];
              if ($akses=="1") {echo "<li><a href='?mod=26v_dev&mode=Bahan_Baku'>$c5 (PO Sample)</a></li>";}
/*               $akses = $rsUser["bpb_jo"];
              ...
              if ($akses=="1") {echo "<li><a href='?mod=38v&mode=WIP'>$wip_cap (JO)</a></li>";}
              $akses = $rsUser["mnuRI"];
           ...
           /*  $akses = $rsUser["bpb_bom"];
            ...
            $akses = $rsUser["bpb_roll"];
            if ($akses=="1") {echo "<li><a href='?mod=18L'>Detail Pemasukan (Location)</a></li>";}
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            { $akses = $rsUser["req_mat"];
              ...
              if ($akses=="1") {echo "<li><a href='?mod=37v&mode=WIP'>$wip_cap (JO)</a></li>";}
              $akses = $rsUser["mnuRO"];
              if ($akses=="1") {echo "<li><a href='?mod=21v&mode=Bahan_Baku'>Retur Bahan Baku</a></li>";}
            }
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <?php
            echo "<li><a href='?mod=39'>Laporan Material Status</a></li>";
            ?>
          </ul>
        </li>
        <?php } ?>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <?PHP
            echo "<li><a href='?mod=7&rptid=listhist'>$c23</a></li>";
