...
echo "<script type='text/javascript'>";
  echo "function validasi()
    ...
    { valid = false; 
      swal({ title: 'Qty RI Melebihi Qty BPB', $img_alert });
    }
    else if (jenisdok == '') 
    { valid = false; 
...
<script type="text/javascript">
  ...
  {   var html = $.ajax
      ({  type: "POST",
          url: 'ajax2.php?modeajax=view_list_sj_ro',
          data: "cri_item=" +cri_item,
          async: false
      }).responseText;
      if(html)
      ...
      echo "<form method='post' name='form' action='save_data_ro.php?mod=$mod&mode=$mode&id=$id_item' onsubmit='return validasi()'>";
        ...
        echo "<div class='col-md-3'>";
          ...
          echo "<div class='form-group'>";
            ...
            echo "<input type='text' class='form-control' name='txtbpbdate' id='datepicker2' placeholder='$cmas Tgl RO' value='$rodate'>";
          echo "</div>";
          echo "<div class='form-group'>";
        ...
        echo "<div class='col-md-3'>";
          ...
          echo "<div class='form-group'>";
            ...
            echo "<select class='form-control select2' style='width: 100%;' id='cbotujuan' disabled name='txttujuan'>";
            if ($bpbno!="")
          ...
          <div class='row'>
            <div class='col-md-6'>
              <div class='form-group'>
                <label>$c42 *</label>
                <input type='text' class='form-control' name='txtbcno' readonly placeholder='$cmas $c42' >
              </div>
            </div>
            <div class='col-md-6'>
              <div class='form-group'>
                <label>$c43 *</label>
                <input type='text' class='form-control' name='txtbcdate' readonly id='datepicker3' value='$datedef'  
