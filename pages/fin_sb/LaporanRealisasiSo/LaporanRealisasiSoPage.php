	...
	<table style="width:100%;font-size:11px; border-collapse: collapse; outline: none; border: none;">
		...
		<thead>
			...
			<tr>
				...
				<th style="font-size: 16px; border-collapse: collapse; border: none;" colspan="14"><strong>Laporan Realisasi Sales Order</strong></th>
	...
	<div id="formBs" class='box'>
		...
		<div class="box-body" style="font-size: 9pt;" >
			...
			<table id="laporan_jurnal" class="table table-condensed table-bordered" style="border:1px solid #000000 !important">
					...
					<thead>
						<tr>
							<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" rowspan="3">No.</th>
							<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" colspan="13">SALES ORDER</th>
							<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" colspan="4">SURAT JALAN 1</th>
							<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" colspan="4">SURAT JALAN 2</th>
							<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" colspan="4">SURAT JALAN DST</th>
