					...
					<table style="width:100%;font-size:11px; border-collapse: collapse; outline: none; border: none;">
						...
						<thead>
							...
							<tr>
								...
								<th style=" border-collapse: collapse; border: none;"><strong>LAPORAN BANK REKAP: </strong>
    ...
    <div id="formBs" class='box'>
            ...
            <div class="box-body" style="font-size: 9pt;" >
                <table id="laporan_jurnal" class="table table-condensed table-bordered" style="border:1px solid #000000 !important;width:100%;">
					<thead>
					<tr>
					<th rowspan="2" style="text-align: center;background-color:#ffffff;border:1px solid #000000">Nomor Akun</th>
					<th rowspan="2" style="text-align: center;background-color:#ffffff;border:1px solid #000000">Nama Akun</th>
					<th colspan="2" style="text-align: center;background-color:#ffffff;border:1px solid #000000">Debit</th>
					<th colspan="2" style="text-align: center;background-color:#ffffff;border:1px solid #000000">Kredit</th>
					</tr>
					<tr>
