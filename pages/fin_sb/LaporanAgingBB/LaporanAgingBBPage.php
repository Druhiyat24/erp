...
<div class="box list" style="display:none"> 
					...
					<table style="width:100%;font-size:11px; border-collapse: collapse; outline: none; border: none;">
						...
						<thead>
							...
							<tr>
								...
								<th style="font-size: 16px; border-collapse: collapse; border: none;" colspan="14"><strong>LAPORAN AGING BAHAN BAKU</strong></th>
    ...
    <div id="formBs" class='box'>
            ...
            <div class="box-body" style="font-size: 9pt;" >
                <table id="laporan_jurnal" class="stripe" style="border:1px solid #000000 !important;width:100%;">
						<thead>
         <tr>
            ...
            <th  rowspan="2"style="text-align: center;vertical-align: middle;background-color:#ffffff;border:1px solid #000000">NO WS</th>
            <th  rowspan="2"style="text-align: center;vertical-align: middle;background-color:#ffffff;border:1px solid #000000">ID ORDER</th>
            <th  rowspan="2"style="text-align: center;vertical-align: middle;background-color:#ffffff;border:1px solid #000000">ID KONSUMEN</th>
            <th  rowspan="2"style="text-align: center;vertical-align: middle;background-color:#ffffff;border:1px solid #000000">NAMA KONSUMEN</th>
            <th  rowspan="2"style="text-align: center;vertical-align: middle;background-color:#ffffff;border:1px solid #000000">DOKUMEN TERIMA</th>
            <th  colspan="4"style="text-align: center;background-color:#ffffff;border:1px solid #000000">QTY (PCS)</th>
            <th  colspan="4"style="text-align: center;background-color:#ffffff;border:1px solid #000000">PRICE</th>
            ...
            <th  colspan="9"style="text-align: center;background-color:#ffffff;border:1px solid #000000">PRICE</th>
