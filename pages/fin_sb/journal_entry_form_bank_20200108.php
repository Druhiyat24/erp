        ...
        <div class='box-body'>
            <div class='row'>
                ...
                <div class="col-md-12">
                    ...
                    <button type='submit' name='submit' class='btn btn-primary validasi_proses'>Simpan</button>
                    <button type='submit' name='posting' value='Posting' class='btn btn-primary validasi_proses'>Posting</button>
                    <?php endif;?>
                </div>
            </div>
        </div>
...
function select_rekap(id_rekap, nilai_inv){
    ...
    function validasi() {
			...
			//return false;
		var idcoa =document.form.idcoa.value;
		...
		var nilai = document.form.nilai.value;
        var date_journal = document.form.date_journal.value;
		var terimakeluar = document.form.terimakeluar.value;
		...
		else if (terimakeluar == '') {
            alert('Error: Load tidak sempurna, silahkan refresh (Ctrl+f5)');
