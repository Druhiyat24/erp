	...
	<table style="width:100%;font-size:11px; border-collapse: collapse; outline: none; border: none;">
		...
		<thead>
			...
			<tr>
				...
				<th style="font-size: 16px; border-collapse: collapse; border: none;" colspan="14"><strong>Laporan Rekap Penjualan Ekspor</strong></th>
			...
			<table id="laporan_jurnal" class="table table-condensed table-bordered" style="border:1px solid #000000 !important">
				...
				<thead>
					...
					<tr>
						...
						<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" colspan="4">TOTAL</th>
