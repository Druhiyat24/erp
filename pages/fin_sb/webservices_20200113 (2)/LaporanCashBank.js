...
saldoawalfooter = 0;
saldoawalfooter_convert = 0;
async function rekapbank(myRekap){
	saldoawalfooter = decodeURIComponent(myRekap.saldoawal);
	saldoawalfooter_convert = decodeURIComponent(myRekap.saldoawal_convert);
	...
	console.log(myRekap);
		...
		td  += "<tr>";
			...
			td  += "<td>";
				td  += decodeURIComponent(myRekap.records[i].debit);
			td  += "</td>";	

			td  += "<td>";
				td  += decodeURIComponent(myRekap.records[i].debit_convert);
			td  += "</td>";	

			td  += "<td>";
				td  += decodeURIComponent(myRekap.records[i].credit);
			td  += "</td>";		

			td  += "<td>";
				td  += decodeURIComponent(myRekap.records[i].credit_convert);
			td  += "</td>";				
			
				td  += "<td>";
					td  += decodeURIComponent(myRekap.records[i].saldoberjalan);
				td  += "</td>";		
			
				td  += "<td>";
					td  += decodeURIComponent(myRekap.records[i].saldoberjalan_convert);
				td  += "</td>";					
