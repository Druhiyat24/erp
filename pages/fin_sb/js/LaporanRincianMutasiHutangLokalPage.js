...
function GenerateTable(from_,to_){
	table = $('#laporan_jurnal').DataTable( {
	  ...
	  "lengthMenu": [[10, 25, 50, 999999999], [10, 25, 50, "All"]],
        ...
        "ajax":  "webservices/getDataLaporanRincianMutasiHutangLokal.php?from="+from_+"&to="+to_,
        "columns": [
		//0supplier_code
        {
			"data":           "supplier_code",
 		...
 		//lain_lain_kurs
        {
 		...
 		//id_journal_pembelian
        {
			"data":           "id_journal_pembelian",
         } ,	

 		//id_journal_pembayaran
        {
			"data":           "id_journal_pembayaran",
         } ,	

 		//nomor_payment_voucher
        {
			"data":           "nomor_payment_voucher",
         } ,	

 		//tgl_payment_voucher
        {
			"data":           "tgl_payment_voucher",
         } ,	
 		...
 		//lain2_idr
        {
 		...
 		//saldo_akhir_usd
        {
			"data":           "saldo_akhir_usd",
         } ,			

        //saldo_akhir_kurs
        {
            "data":           "saldo_akhir_kurs",
         } ,   
        //saldo_akhir_idr
        {
