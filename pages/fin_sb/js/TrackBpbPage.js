...
function GenerateTable(){
  ...
  table = $('#MasterInvoiceActualTable').DataTable( {
      ...
      'serverMethod': 'post',
      'ajax': {
          'url':'webservices/getListDataTrackBpb.php',
      },
			"aoColumns": [
			{data : 'bpb'              }, 
             {
                ...
                "render": function (data) {
                    return decodeURIComponent(data.pembelian);
                            }
            }, 
             {
                "data":           null,
                "render": function (data) {
                    return decodeURIComponent(data.journal_revers);
                            }
            },			
			
             {
                "data":           null,
                "render": function (data) {
                    return decodeURIComponent(data.no_kontrabon);
                            }
            }, 
             {
                "data":           null,
                "render": function (data) {
                    return decodeURIComponent(data.no_listpayment);
                            }
            }, 
             {
                "data":           null,
                "render": function (data) {
                    return decodeURIComponent(data.no_pembayaran);
                            }
            }, 
			]
    } );
