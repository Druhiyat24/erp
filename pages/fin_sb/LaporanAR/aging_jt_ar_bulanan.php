  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <table class="display responsive" style="width:100%;font-size:11px; border-collapse: collapse; outline: none; border: none;">
          ...
          <thead>
            ...
            <tr>
              ...
              <th style="font-size: 18px; border-collapse: collapse; border: none;" colspan="14"><strong>LAPORAN AGING PIUTANG DAGANG - BULANAN</strong></th>
        ...
        <table id="examplelaporan"  class="display responsive" style="width:auto;font-size:12px;" width="100%" >
          ...
          <thead>
            ...
            <tr>
              ...
              <th style="text-align: center; width: 1%;">COA</th>
...
";        
      //echo "<pre>$sql</pre>";
        ...
        // rumus perhitungan ap = 365/(total utang)/ (rata rata utang)
              ...
              echo "<td>$data[days] days</td>"; // days payment terms
              echo "<td>$data[Id_Supplier]</td>"; // days payment terms
              echo "<td style='text-align: right;'>".(number_format("$data[invoice_amount]"))."</td>"; //TOTAL
        echo "<td style='text-align: right;'>".(number_format("$data[nilai_180]"))."</td>"; //120
        echo "<td style='text-align: right;'>".(number_format("$data[nilai_151_180]"))."</td>"; //91-121
        echo "<td style='text-align: right;'>".(number_format("$data[nilai_121_150]"))."</td>"; //61-91
        echo "<td style='text-align: right;'>".(number_format("$data[nilai_91_120]"))."</td>"; //31-61
        echo "<td style='text-align: right;'>".(number_format("$data[nilai_61_90]"))."</td>"; //1-31
        echo "<td style='text-align: right;'>".(number_format("$data[nilai_31_60]"))."</td>"; //1-31
        echo "<td style='text-align: right;'>".(number_format("$data[nilai_1_30]"))."</td>"; //1-31        
        echo "<td style='text-align: right;'>".(number_format($ar_days  ,10,',','.'))."</td>"; //TOTAL

        echo "<td style='text-align: right;'>".(number_format("$data[jt1_30]"))."</td>"; //TOTAL
        echo "<td style='text-align: right;'>".(number_format("$data[jt31_60]"))."</td>"; //TOTAL
        echo "<td style='text-align: right;'>".(number_format("$data[jt61_90]"))."</td>"; //TOTAL
...
<?php echo "
  <tr>
    ...
    <th style='text-align: right;'>".number_format($total_180)."</th>
    <th style='text-align: right;'>".number_format($total_151_180)."</th>
    <th style='text-align: right;'>".number_format($total_121_150)."</th>
    <th style='text-align: right;'>".number_format($total_91_120)."</th>
    <th style='text-align: right;'>".number_format($total_61_90)."</th>
    <th style='text-align: right;'>".number_format($total_31_60)."</th>
