        ...
        <?php if(@count($list)):?>
            ...
            <?php foreach($list as $l):?>
                <tr>
                    ...
                    <td>
                        <?php if(isset($row) and !$row->fg_post):?>
                            <a class="btn btn-primary btn-s btn_edit" onclick="getDetailsInc('<?php echo $id ?>','<?php echo $l->row_id ?>')" href="#" data-toggle="tooltip" title="" data-item-id="<?=$id?>" data-item-row-id="<?=$l->row_id?>" data-original-title="Ubah"><i class="fa fa-pencil"></i></a>
                            <a class="btn btn-danger btn-s btn_delete" href="?mod=jefdcashbank&amp;id=<?=$id?>&amp;rid=<?=$l->row_id?>&amp;mode=del" data-toggle="tooltip" title="" data-item-id="<?=$id?>" data-item-row-id="<?=$l->row_id?>"  data-original-title="Hapus">
        ...
        <div class='box-body'>
            ...
            <div class="row">
                ...
                <div class='col-md-3'>
                    <div class='form-group'>
                        <label>Debit</label>
                        <input type='text' id='debit' class='form-control' name='debit' onclick="handlekeyUpRate(this)" onkeyup="handlekeyUpRate(this)"
                ...
                <div class="col-md-3">
                    <div class='form-group'>
                        <label>Kredit</label>
                        <input type='text' id='credit' class='form-control' onclick="handlekeyUpRate(this)"  onkeyup="handlekeyUpRate(this)" name='credit'
            ...
            <div class="row">
                ...
                <div class='col-md-3 konversi' >
                    <div class='form-group'>
                        ...
                        <input type='text' id='konversidebit' onclick="formatRupiahInc(this.value,this.id,'1')" class='form-control'  name='konversidebit'
                               placeholder='Masukkan Jumlah Debit' value=''>
                    </div>
                </div>
                <div class="col-md-3 konversi" >
                    <div class='form-group '>
                        ...
                        <input type='text' id='konversicredit' onclick="formatRupiahInc(this.value,this.id,'1')" class='form-control' name='konversicredit'
                               placeholder='Masukkan Jumlah Kredit' value=''>
                    </div>
                </div>
                <div class="col-md-2 konversi" >
                    <div class='form-group '>
                        <label>Rate</label>
                        <input type='text' id='rate' class='form-control' onclick="handlekeyUpRate(this)" name='rate'
