...
SELECT IAC.v_noinvoicecommercial
		...
		FROM invoice_commercial IAC
			...
			LEFT JOIN (
				SELECT id_journal,reff_doc,date_journal,fg_post FROM fin_journal_h
                ...
                <div class='col-md-3'>
                 ...
                 <div class='col-md-3'>
                     ...
                     <div class='form-group'>
                         ...
                         <input readonly type='text' id='fakturpajak' class='form-control' name='fakturpajak' autocomplete="off"
...
//            $('#fakturpajak').val(bpb.no_fp);
			...
			//datepicker2
$("#amount").val(bpb.n_amount);
$("#id_journal").val(bpb.id_journal);
$("#date_journal").val(bpb.date_journal);
$("#fakturpajak").val(bpb.v_fakturpajak); 
$("#datepicker2").val(bpb.date_invoice);
$("#periodpicker").val(bpb.periode);
$("#tgljatuhtempo").val(bpb.jatuh_tempo);
$("#curr").val(bpb.curr);
//$("#tgljatuhtempo").val(bpb.); datepicker2 //
//$("#fg_intercompany").val(bpb.);
