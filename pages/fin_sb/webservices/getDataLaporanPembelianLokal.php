...
$table = "(
			  SELECT mi.goods_code
                ...
                , b.curr
                , (b.price*b.qty)dpp
				, if(b.curr='USD',((b.price*b.qty)/mr.rate),((b.price*b.qty)/mr.rate))USD_dpp
                , poh.ppn
                , poh.podate
                , ((b.price*b.qty)+((poh.ppn/100)*(b.price*b.qty)))after_ppn
				, (((b.price*b.qty)/mr.rate)+((poh.ppn/100)*((b.price*b.qty)/mr.rate)))USD_after_ppn
                ...
                FROM bpb WHERE jenis_dok='BC 4.0' AND id_jo!='' AND confirm='Y')b ON b.bpbno_int=fjh.reff_doc
