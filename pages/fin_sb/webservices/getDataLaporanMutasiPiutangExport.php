...
"saldo_awal"=>htmlspecialchars(number_format((float)$row['saldo_awal'], 2, '.', ',')), //ok
"debit"=>htmlspecialchars(number_format((float)$row['debit'], 2, '.', ',')), //ok
"lain_lain"=>htmlspecialchars(number_format((float)$row['lain_lain'], 2, '.', ',')), //ok
"pengurangan"=>htmlspecialchars(number_format((float)$row['pengurangan'], 2, '.', ',')), //ok
"retur"=>htmlspecialchars(number_format((float)$row['retur'], 2, '.', ',')), //ok
"pengurangan_lain_lain"=>htmlspecialchars(number_format((float)$row['pengurangan_lain_lain'], 2, '.', ',')), //ok
"saldo_akhir"=>htmlspecialchars(number_format((float)$row['saldo_akhir'], 2, '.', ',')), //ok
