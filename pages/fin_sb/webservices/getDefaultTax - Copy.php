...
class getListData {
	...
	public function get($id){
		...
		";
		//echo $q;
		$q_det = "SELECT CONCAT('row_',row_id)id_select,row_id id_json,n_pph FROM fin_journal_d WHERE id_journal = '$id' AND credit > 0 AND (n_pph IS NOT NULL OR n_pph !='' OR n_pph > 0)";
