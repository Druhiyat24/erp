...
$table = "(
          ...
          , a.curr
              ...
              , IF(a.curr='USD',((a.price/mr.rate)*a.qty),'')dpp
              
              , IFNULL(db.bm,'0') AS bm
              , ifnull(db.pph,'0') AS pph
              , poh.ppn
            ...
            LEFT JOIN detail_bm db ON db.jenis_dok=a.jenis_dok
            WHERE 1=1 and ms.area = 'I' AND ms.tipe_sup='S' AND a.bpbno!='' and mi.matclass!='' AND mr.v_codecurr='PAJAK'
            #AND a.bpbdate <= '2020-01-01' AND a.bpbdate >= '2020-03-01'
            GROUP BY mi.matclass
)X";
