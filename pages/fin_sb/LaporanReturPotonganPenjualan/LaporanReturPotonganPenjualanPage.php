	...
	<table style="width:100%;font-size:11px; border-collapse: collapse; outline: none; border: none;">
		...
		<thead>
			...
			<tr>
				...
				<th style="font-size: 16px; border-collapse: collapse; border: none;" colspan="14"><strong>Laporan Retur & Potongan Penjualan</strong></th>
			...
			<table id="laporan_jurnal" class="table table-condensed table-bordered" style="border:1px solid #000000 !important">
				...
				<thead>
					...
					<tr>
						...
						<th colspan="2">EX FAKTUR PAJAK</th>
						<th colspan="2">NOTA RETUR MARKETING</th>
						<th colspan="9">DESCRIPTIONS BARANG</th>
