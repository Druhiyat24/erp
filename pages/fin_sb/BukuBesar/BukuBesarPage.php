                ...
                <div class="panel-body row">
                    <div class="col-md-3">
                        <div class='form-group'>
							...
							<button  class='btn btn-primary' onclick="Show('1')" >Laporan All</button>
            ...
            <div class="panel panel-default">
				...
				<div class="col-md-3 account">
                    ...
                    <div class="col-md-3">
	                    ...
	                    <div class='form-group'>
                        <label>Dari</label>
                        <input type='text' id='period_from' class='form-control' name='period_from' autocomplete="off"
                    ...
                    <div class="col-md-3">
                        <div class='form-group'>
                            <label>Sampai</label>
					                        ...
					                        <input type='text' id='period_to' class='form-control' name='period_to' autocomplete="off"
