<?php
  ...
  { $excel = "Y";
    ...
    { $nm_file="lap"; }
    header("Content-Disposition: attachment; filename=$nm_file.xls");//ganti nama sesuai keperluan 
...
<script>
  ...
  $(document).ready(function() {
    ...
    var table = $('#tbl_apply_emp').DataTable
    ({  scrollY:        "300px",
        scrollCollapse: true,
        fixedColumns: true,
        orderCellsTop: true,
    ...
    var table = $('#tbl_interview').DataTable
    ({  scrollY:        "300px",
        scrollCollapse: true,
        fixedColumns: true,
        orderCellsTop: true,
