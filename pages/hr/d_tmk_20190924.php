...
if (isset($_GET['nik'])) {$nik = $_GET['nik']; } else {$nik = "";}
...
echo "
  <script type='text/javascript'>
    ...
    { var kdtunjangan     = document.form.txtkdtunjangan.value;
      var name_employee   = document.form.txtnamaemp.value;
      ...
      var nilaitunjangan  = document.form.txtnilaitunjangan.value;
  ...
  echo "<div class='box-body'>";
      ...
      echo "<form method='post' name='form' action='s_tmk.php?mod=$mod&id=$id_tmk' onsubmit='return validasi()'>";
        ...
        echo "
              ...
              echo "<select class='form-control select2' style='width: 100%;' 
                name='txtnamaemp' onchange='changeValue(this.value)'>";
             ...
             echo "<option value='$row[nik]'>$row[nama]</option>";
              ...
              <div class='form-group'>
                    <label>Tahun Masuk *</label>
                      <input type='text' class='form-control' id='tahun' name='txttahun' value='$tahun'>
              </div>";
              echo "
                <div class='form-group'>
                  <label>Tanggal Hari ini</label>
                  <input type='text' class='form-control' value='$tgl_skrg' name='txttgl_skrg' readonly>
                </div></div>";   
    ...
    echo"
          <div class='form-group'>
                  ...
                  <input type='text' class='form-control' name='txtnilaitunjangan'
