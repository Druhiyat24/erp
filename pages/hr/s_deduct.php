...
$cek = flookup("count(*)","hr_deduction","nik='$txtnik' and paydate='$txtpaydate'");
if ($cek=="0")
{ $sql = "insert into hr_deduction (nik,paydate,amount,keterangan)
    values ('$txtnik','$txtpaydate','$txtamount','$txtketerangan')";
  insert_log($sql,$user);
  $_SESSION['msg'] = 'Data Berhasil Disimpan';
  echo "<script>
     window.location.href='../hr/?mod=23L';
  </script>";
}
else if ($id_item!="")
{	$sql="update hr_deduction set amount='$txtamount',keterangan='$txtketerangan'
