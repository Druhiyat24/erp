...
$id_so_det = $_GET['id_so_det'];
$cutnumber = $_GET['txtcutnumber'];
$cutno = sprintf("%02s", $cutnumber);
$dari = $_GET['txtdari'];
$dari_ = $dari - 1;
$sampai = $_GET['txtsampai'];
...
?>
    ...
    where sd.id = '$id_so_det' and sd.cancel = 'N' order by sd.id asc  limit 1 ";
    ...
    while ($rshder = mysql_fetch_array($qdet)) {
      ...
      $cut_kode = $size . "" . $cutno . "" . $from;
      $cut_kode_ = $size . "" . $cutno . "" . $from_;
...
<tr>
      <td><b>' . $cut_kode . '</b></td>
      <td rowspan="5">
      <img src ="' . $penyimpanan  . $simpan . '.png" alt = "" height="50" width = "50" ></td>
</tr>
<tr>
