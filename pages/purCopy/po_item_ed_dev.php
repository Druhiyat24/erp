...
{ $sql="select po.pono,l.id,reqno jo_no,concat(a.goods_code,' ',a.itemdesc) item,l.qty,l.unit,l.curr,l.price 
  ...
  from po_header_dev po inner join po_item_dev l on po.id=l.id_po 

  inner join reqnon_header_dev m on l.id_jo=m.id 
...
{ $sql="select po.pono,l.id,jo_no,concat(a.nama_group,' ',s.nama_sub_group,' ',
  ...
  inner join jo_dev m on l.id_jo=m.id 
...
echo "<div class='box'>";
  ...
  echo "<div class='box-body'>";
    ...
    echo "<div class='row'>";
      ...
      echo "<form method='post' name='form' action='s_po_it_ed_dev.php?mod=$mod&id=$id' onsubmit='return validasi()'>";
