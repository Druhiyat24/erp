...
{ $query = mysql_query("SELECT a.*,s.curr,group_concat(f.kode_mkt) lkd_mkt FROM po_header a inner join po_item s 
      ...
      <form method='post' name='form' action='s_po.php?mod=<?php echo $mod; ?>' onsubmit='return validasi()'>
        ...
        <div class='col-md-3'>              
          ...
          <div class='form-group'>
            ...
            <?php } else { ?>
              <input type="text" class='form-control' name='txtkode_dept' readonly value='<?=$kode_dept?>'>  
            <?php } ?>
