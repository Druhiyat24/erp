...
$app1_by = $user;
if ($trx=="CS")
{	$sql = "update act_costing set app1='A',app1_by='$app1_by',app1_date='$app1_date'
		where id='$id'";
	insert_log($sql,$user);
...
{	$sql = "update jo set app='A',app_by='$app1_by',app_date='$app1_date'
		where id='$id'";
	insert_log($sql,$user);
	$_SESSION['msg'] = 'Data Berhasil Disimpan';
	echo "<script>
...
{	$sql = "update po_header set app='A',app_by='$app1_by',app_date='$app1_date'
		where id='$id'";
	insert_log($sql,$user);
	$_SESSION['msg'] = 'Data Berhasil Disimpan';
	echo "<script>
...
{	$sql = "update reqnon_header set app='A',app_date='$app1_date'
		where id='$id' and app_by='$user'";
	insert_log($sql,$user);
	$sql = "update reqnon_header set app2='A',app_date2='$app1_date'
