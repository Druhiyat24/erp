...
{ ?>
  ...
  <div class="box">
    ...
    { $fldnyacri=" left(a.bpbno,1) in ('F') and left(a.bpbno,2)!='FG' "; $mod2="20e"; }
    ...
    <div class="box-header">
      ...
      <a href='../wh/?mod=<?php echo "retur_material_new"; ?>&mode=<?php echo $mode; ?>' class='btn btn-primary btn'>
    ...
    <div class="box-body">
      ...
      <table id="examplefix3" class="display responsive" style="width:100%">
        ...
        <tbody>
          ...
          $query = mysql_query("SELECT a.*,s.goods_code,$fld_desc itemdesc,supplier, a.last_date_bpb,brh.id id_brh,det.qty_rak
        ...
        <td><a href='pdfBarcode_in_material.php?mode=barcode&id=$data[id_brh]'
