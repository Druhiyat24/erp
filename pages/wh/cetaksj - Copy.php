...
$sql = "select * from in_material where no_dok = '$no_dok'";
...
<th align='center' colspan = "5">test</th>
  ...
  <tbody>
    ...
    tampil_data("select kode_barang,nama_barang,job_order,qty,unit from in_material where no_dok = '$no_dok'", 5);
    $sqlsum = "select sum(qty) jml_qty from in_material where no_dok = '$no_dok'";
          ...
          <table width="100%" style="border:none;">
            ...
            <tr>
              <td align="center" style="border:none;"><h2>' . $head_cap . '</h2></td>
                        ...
                        <tr>
              <td align="center" style="border:none;"><h2>' . $rsh['no_dok'] . '</h2></td>
            </tr>
          </table>
