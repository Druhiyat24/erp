...
<div class="box">
    <div class="box-header">
        <h3 class="box-title">LIST IN MATERIAL</h3>
    </div>
    <div>
    ...
    <div class="box-body">
        <table border="1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                // }
                $sql = "select no_dok,tgl_dok,supplier,no_po,tipe_pembelian,no_sj,keterangan,kode_barang,nama_barang,job_order,qty,unit,dibuat,tgl_input from in_material a where tgl_dok >= '$fromcri' and tgl_dok <= '$tocri'
";
