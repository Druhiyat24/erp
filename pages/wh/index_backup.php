...
<body class="hold-transition skin-purple layout-top-nav fixed">
  <div class="wrapper">
    ...
    if ($msg != "") {
      ...
      $icon = $_SESSION['icon'];
      echo "<script>swal('$msg', '$msgtext', '$icon');</script>";
    ...
    <script type="text/javascript">
      $("#form-simpan").on("click", "#simpan", function() {
        $("table tbody tr").each(function() {
          ...
          var tgl_dok = document.getElementById('datepicker1').value;
          ...
          var unit = $(this).closest('tr').find('td:eq(4) input').val();
    ...
    <script>
      ...
      $(document).ready(function() {
        var table = $('#examplefix_new').DataTable({
