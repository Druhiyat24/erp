...
function tampil_data_inmaterial($qry, $jml_kolom)
{
	if ($qry != "") {
		$query = mysql_query($qry);
		if (!$query) {
	...
	{	$x=$from;
		...
		{ if ($x<=$to and $x<=$bts) 
			{ $type="text"; 
				...
				echo "
				<td>
				<select class='form-control select2' name ='id_item[$x]'>";
				...
				echo "
				<td>
					<input type ='text'  name='qty_input[$x]' id='qty_input' class='form-control qty'>
				</td>";				
				echo "
				<td>
			 ...
			 echo "
				<td>
					<input type ='text' $stra name='no_roll[$x]' id='rollajax$x' class='form-control rollclass'>
						...
						<td>
							<input type ='text' name ='jml_roll[$x]' step='0.01' id='jmlajax$x' class='form-control jmlclass' onFocus='startCalc();' onBlur='stopCalc();' >
						</td>
						<td>
...
function show_roll_in_material($from,$to,$bts,$ket,$unit,$cri_rak_roll)
{	
		for ($x = $from; $x <= $to; $x++)
		{ if ($x<=$bts) 
			{ 
				$stra=" style='width: 70px; text-align: left;'  value='$x' ";
			 echo "
				<td>
					<input type ='text' $stra name='no[$x]' id='no$x' class='form-control noclass' readonly>
				</td>"; 
			 echo "
			 	<td>
					<input type ='text' style='width: 120px; text-align: left;' name='no_roll[$x]' id='rollajax$x' class='form-control rollclass' autocomplete='off' required>
				</td>			 
				<td>
					<input type ='text' name ='lot[$x]' id='lotajax$x' class='form-control lotclass' autocomplete='off' required>
				</td>
				<td>
					<input type ='text' name ='jml_roll[$x]' step='0.01' id='jmlajax$x' class='form-control jmlclass' onFocus='startCalc();' onBlur='stopCalc();'autocomplete='off' required >
				</td>
				<td>
					<input type ='text' name ='unit[$x]' id='unit$x' value = '$unit' class='form-control unitclass' readonly >
				</td>						
				<td>
					<input type ='text' name ='kode_rak[$x]' id='kode_rak$x' value = '$cri_rak_roll' class='form-control rakclass' readonly>
				</td>";
			}
