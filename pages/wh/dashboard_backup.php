          ...
          <div class="card-body table-responsive p-0 " style="height: 450px;">
            <table id="dashboard1" class="display responsive" style="width: 100%;font-size:13px;text-align:center;color:white;">
              ...
              <tbody>
                ...
                $query = mysql_query("select kode_rak,nama_rak,kapasitas, terisi, persen, sisa from dsb_whs");
                $no = 1;
                $supplier = null;
                $sizeStartRow = 0;
                $counter = 0;
          ...
          <div class='inner'>
            ...
            <div class="form-group">
              ...
              <div id="div_dashboard3" name="div_dashboard3" class='col-lg-6' style="padding-top: 30px;">
                ...
                $query4 = mysql_query("select kode_rak,nama_rak,kapasitas, terisi, persen, sisa from dsb_whs limit 1");
                $data4 = mysql_fetch_array($query4);
              ...
              <th>Persentase</th>
                  ...
                  <tbody>
                    ...
                    $query3 = mysql_query("select kode_rak,nama_rak,kapasitas, terisi, persen, sisa from dsb_whs limit 1");
                    $no = 1;
                    $supplier = null;
                    $sizeStartRow = 0;
                    $counter = 0;
          ...
          <div class='inner'>
            ...
            <div id="div_dashboard2" name="div_dashboard2" class="card-body table-responsive p-0" style="height: 200px;">
              <table id="dashboard2" class="display responsive " style="width: 100%;font-size:12px;text-align:center;color:white;">
                <thead>
                  <th width='20%' style="text-align:left;">Job Order</th>
                  <th width='20%' style="text-align:left;">Kode Barang</th>
                ...
                <tbody>
                  ...
                  $query2 = mysql_query("
                  select job_order, kode_barang, nama_barang, CONCAT(round(sum(roll_qty),2),' ',unit) tot_qty,SUM(roll) roll from (select jo.jo_no job_order, mi.goods_code kode_barang, mi.itemdesc nama_barang, roll_qty, b.unit, '1' roll, kode_rak, nama_rak from bpb_roll_h a
inner join bpb_roll b on a.id = b.id_h
inner join (select bpbno,bpbno_int,bpbdate from bpb group by bpbno) bpb on a.bpbno = bpb.bpbno
...
inner join master_rak mr on b.id_rak_loc = mr.id
where bpb.bpbdate >= '2022-10-01' and LEFT(a.bpbno,1) = 'F' and roll_qty_used = 0 and kode_rak = 'A.1.1.00'
order by bpbdate asc) a GROUP BY job_order");

                  while ($data2 = mysql_fetch_array($query2)) {
                    $job_order = $data2[job_order];
                    if ($job_order != '') {
                      echo "<tr>";
                      echo "
            <td style='text-align:left;'>$data2[job_order]</td>
            <td style='text-align:left;'>$data2[kode_barang]</td>
            <td style='text-align:left;'>$data2[nama_barang]</td>
            <td style='text-align:left;'>$data2[tot_qty]</td>
            <td style='text-align:center;'>$data2[roll]</td>";
                      echo "</tr>";
                    } else {
                      echo "<tr>";
                      echo "
            <td colspan = '7' width='100%' >Not Data Found</td>";
                      echo "</tr>";
                    }
                  }
                  ?>
