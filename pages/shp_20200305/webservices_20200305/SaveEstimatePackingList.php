...
class Save {
	...
	public function Insert($data){
		include __DIR__ .'/../../../include/conn.php';
		$q = "INSERT INTO shp_estimatepackinglist (
				n_so_id,
				n_id_invoice,
				v_from,
				v_to,
				v_pono,
				n_amount) VALUES('$data->so_no','$data->id_invoiceheader','$data->from','$data->to','$data->po','$data->amount')";
				
		$stmt = mysql_query($q);		
			$result = '{ "status":"ok", "message":"1", "records":""}';
		return $result;
	}	
	public function UpdateBPB($data){
		include __DIR__ .'/../../../include/conn.php';
	...
	public function Update($data){
		include __DIR__ .'/../../../include/conn.php';
		$q = "UPDATE shp_estimatepackinglist SET 
					n_so_id = '$data->so_no',
					n_id_invoice = '$data->id_invoiceheader',
					v_from = '$data->from',
					v_to = '$data->to',
					v_pono = '$data->po',
