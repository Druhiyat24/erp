...
$sql = "select a.*, ms.supplier supplier, mb.supplier buyer,IF(ditagihkan = 'Y','YA','TIDAK') ditagihkan_fix,b.inv_vendor,IF(jatuh_tempo is null,jatuh_tempo_new,jatuh_tempo) jatuh_tempo_new
from memo_h a
