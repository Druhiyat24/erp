      ...
      <div class='row'>
        <div class='col-md-3'>              
          <div class='form-group'>
            <label>Invoice # *</label>
            <input type='text' readonly placeholder="auto" class='form-control' onkeyup="handleKeyUp(this)"  name='txtinvno' id='txtinvno' >
          </div>        
          <div class='form-group'>
          ...
          <div class='form-group'>
            ...
            <input type='text' class='form-control' onkeyup="handleKeyUp(this)" name='txtshipper' id="txtshipper" placeholder='Seller/Sender Pengirim'  >
          </div>        
          <div class='form-group'>
            <label>WS # *</label><br/>
        ...
        <div class='col-md-3'>        
          ...
          <div class='form-group'>
            ...
            <input type='text' class='form-control' autocomplete="off" onkeyup="handleKeyUp(this)" onchange="handleKeyUp(this)" id='txtlc_issue_by' name='txtlc_issue_by' placeholder='Contract Date' >
          </div>  
          <div class='form-group'>
            <label>HS Code *</label>
          ...
          <div class='form-group'>
            ...
            <input type='text' id='datepicker2' autocomplete="off" onchange="handleKeyUp(this)" id='txtetd' class='form-control' name='txtetd' placeholder='Delivary Tim'  >
          </div>  
		  <div class='form-group'>
        ...
        <div class='col-md-3'>                  
          <div class='form-group'>
            ...
            <select class='form-control select2' onchange="handleKeyUp(this)" id='txtshipped_by' style='width: 100%;' name='txtshipped_by'>
          ...
          <div class='form-group'>
            ...
            <input type='text' class='form-control' readonly onkeyup="handleKeyUp(this)" name='txtnw' id='txtnw' placeholder='Masukkan Net Weight'  >
          </div>        
          <div class='form-group'>
            <label>Gross Weight</label>
            <input type='text' class='form-control' readonly onkeyup="handleKeyUp(this)" name='txtgw' id='txtgw' placeholder='Masukkan Gross Weight'  >
          </div>          
          <div class='form-group'>
...
<!--             <select class='form-control select2'  onchange="handleKeyUp(this)" style='width: 100%;' id='txtmeasurement' name='txtmeasurement'>
      ...
      -->     <select class='form-control select2' onchange="handleKeyUp(this)" id='txtmeasurement2' style='width: 100%;' name='txtmeasurement2'>
        ...
        <div class='col-md-3'>
         <a href="#" name='submit' onclick="Save()" class='btn btn-primary myPost'>Simpan</a>
        </div>  
      </div>
    </div>
  </div>
