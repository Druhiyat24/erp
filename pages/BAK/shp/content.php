...
else if ($mod=="upload_exim" OR $mod=="proses_upload_exim" OR $mod=="show_detail" OR $mod=="bc27_new")
{	include "upload_exim.php"; }
else if ($mod=="lap_dok_pabean")
{	include "lap_dok_pabean_sum.php"; }
else if ($mod=="lap_dok_pabean_exc")
{	include "lap_dok_pabean_exc.php";	}
else if ($mod=="lap_dok_pabean_det")
