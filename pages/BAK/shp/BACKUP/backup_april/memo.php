    ...
    <div class='box-body'>
      <div class='row'>
        <form method='post' name='form' action='save_memo.php?mod=simpan_header'>
          ...
          <div class='col-md-7'>
            <div class='form-group'>
              <label>Invoice Buyer * :</label>
              <input type='text' class='form-control' name='inv_buyer' required placeholder='Masukkan No Invoice Buyer'>
            </div>
            <div class='form-group'>
            ...
            <div class='form-group'>
              <label>Notes :</label>
              <textarea id='txtnotes' class='form-control' name='txtnotes' rows='4' cols='20'></textarea>
            </div>
          </div>
          <div class='col-md-7'>
            <div class='box-body'>
      ...
      <div class='row'>
        <form method='post' name='form' action='save_memo.php?mod=update_header&id_h=<?php echo $id_h; ?>'>
          ...
          <div class='col-md-7'>
            <div class='form-group'>
              <label>Invoice Buyer * :</label>
              <input type='text' class='form-control' name='inv_buyer' required value='<?php echo $inv_buyer; ?> ' placeholder='Masukkan No Invoice Buyer'>
            </div>
            <div class='form-group'>
              <label>Notes :</label>
