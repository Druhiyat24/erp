...
{ echo "<script>alert('Akses tidak diijinkan'); window.location.href='?mod=1';</script>"; }

# END CEK HAK AKSES KEMBALI

include 'PackingListPage.php';
...
<script src="js/PackingListPage.js?v=<?php echo date("Ymdhms") ?>"></script>