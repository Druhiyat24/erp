...
if(isset($_GET['dtrx2'])) { $tgl_tr2x=$_GET['dtrx2']; } else { $tgl_trx2=""; }
if($mod=="2L")
  { if($jen_trx=="") 
        ...
        &dtrx=<?php echo $tgl_trx; ?>&dtrx2=<?php echo $tgl_trx2; ?>' onsubmit='return validasi()'>
          ...
          #echo $sql;
            ...
            <div class='col-md-3'>
              ...
              <div class='form-group'>
                <label>Nomor Pengajuan</label>
                <select class='form-control select2' style='width: 100%;' name='txtnomor_aju' id='nomor_aju'>
                  <option value='<?php echo $nomor_aju;?>'><?php echo $nomor_aju;?></option>
                </select>
              </div>
              ...
              <div class='row'>
                <div class='col-md-6'>
                  <div class='form-group'>
                    <label>Nomor Daftar</label>
                    <input type='text' class='form-control' name='txtnomor_daftar' id="txtnomor_daftar" placeholder='Masukkan Nomor Daftar' value='<?php echo $nomor_daftar;?>' readonly>
                  </div>
                </div>
                <div class='col-md-6'>
                  <div class='form-group'>
