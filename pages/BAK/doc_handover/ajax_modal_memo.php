...
$totalbiaya = $total['total_biaya'];
	...
	<table width = '100%'>
	<tr>
			<th id='txtnobpb' width = '50%'>Tanggal Memo  : $tgl_memo</th>
			<th width = '50%'>Jenis Invoice : $jns_inv</th>
	</tr>
	<tr>
			<th width = '50%'>Kepada : $kepada</th>
			<th width = '50%'>Supplier : $supplier</th>
	</tr>
	<tr>
			<th width = '50%'>Jenis Trans : $jns_trans</th>
			<th width = '50%'>Buyer : $buyer</th>
	</tr>
	</table>
