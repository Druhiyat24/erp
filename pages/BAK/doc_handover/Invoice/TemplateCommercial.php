      ...
      <div class='row'>
        <div class='col-md-3'>              
          ...
          <div class='form-group'>
            ...
            <select disabled class='form-control select2' id="head_costumer" style='width: 100%;' name='txtid_buyer'
        ...
        <div class='col-md-3'>        
          ...
          <div class='form-group'>
            ...
            <select class='form-control select2' onkeyup="handleKeyUp(this)" id='txtport_of_loading' style='width: 100%;' name='txtport_of_loading'>

            </select>
          </div>          
          <div class='form-group'>
            <label>Port Of Discharges *</label>
            <select class='form-control select2' onkeyup="handleKeyUp(this)" id='txtport_of_discharges' style='width: 100%;' name='txtport_of_discharge'>
        ...
        <div class='col-md-3'>          
          <div class='form-group'>
            ...
            <select class='form-control select2' onkeyup="handleKeyUp(this)" style='width: 100%;' id='txtid_pterms' name='txtid_pterms'>
