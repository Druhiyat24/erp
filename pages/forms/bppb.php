  ...
  <div class="box-body">
    ...
    <table id="examplefix3" class="display responsive" style="width:100%">
      ...
      <tbody>
        ...
        if ($mode=="FG") { $tbl_mst="masterstyle"; $fld_desc="s.itemname"; } 

        else { $tbl_mst="masteritem"; $fld_desc="s.itemdesc"; }
...
/* 		if ($mod=="61v") {
        ...
        $query = mysql_query("SELECT max(a.bppbno_int) bppbno_int_n,a.*,s.goods_code,$fld_desc itemdesc,supplier , a.last_date_bppb,ms.area
          ...
          where 1=1 and $fldnyacri and a.bppbdate >='$tglf' and a.bppbdate <='$tglt' 
