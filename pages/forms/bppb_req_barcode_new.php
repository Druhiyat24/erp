...
{ $fromexc=date('d M Y',strtotime($_POST['frdate']));
  ...
  echo "<script>
  window.open ('index.php?mod=355_exc&from=$fromexc&to=$toexc&mode=exc&dest=xls', '_blank');
    </script>";
...
<div class="box">
  <div class="box-header">
    ...
    <?php } ?>
    <?php if($mod=="355") { ?>
  <a href='../forms/?mod=355v&mode=<?php echo $mode; ?>' class='btn btn-primary btn-s'>
    ...
    <div class="box-header">
      ...
      <div class='col-md-3'>
          ...
          <br>
              ...
              <button type='submit' name='submitexc' class='btn btn-success'>Export List Barcode BPPB</button>              
          </div>         
      </div>
