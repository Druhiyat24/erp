	...
	{	$ponya=$crinya;
		...
		echo "<table id='examplefix2' style='width: 100%;font-size:12px;'>";
			...
			echo "
				...
				{	$sql="select s.id line_item,d.id_item,r.reqno kpno,d.goods_code,concat(d.itemdesc, ' ', d.color)itemdesc,s.qty,s.unit, 
					...
					inner join reqnon_header r on s.id_jo = r.id
