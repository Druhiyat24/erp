...
# END COPAS ADD
                    ...
                    <table id="example1" class="table table-striped" style="width:100%">
                      <thead>
                        <tr>
                          ...
                          <td> <input type = 'text' class='form-control text-right' id='totalQty' size='2' value = '<?php echo $totalinput; ?>' disabled readonly> </td>
                          <td></td>
                          <td></td>
                        </tr>
                        <tr>
      ...
      # QUERY TABLE
                        ...
                        $sql="select bppb.id,so.so_no,ac.kpno,mp.product_group,mp.product_item,buyerno,dest,color,size,reff_no,sku,bppb.qty,bppb.curr,bppb.price from bppb 
      ...
      #echo $sql;
		...
		//echo "<script>var jsn ={bkb_qty :0}  <script>";
                          ...
                          <td>$data[reff_no]</td>
                          <td>$data[sku]</td>
                          <td class='text-right'><input type='hidden' name='idbppb[]' value='$data[id]'>
                          <input type='text' style='width: 120px;' class='form-control text-right qty-input' name='qty[]' value='$data[qty]'></td>
                          <td>$data[curr]</td>
                          <td>$data[price]</td>"; 
                          echo "</tr>";
