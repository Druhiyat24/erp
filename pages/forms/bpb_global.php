    ...
    <div class="box-body">
      <table id="examplefix3" class="display responsive" style="width:100%">
        ...
        <tbody>
          ...
          if ($cbotipe == 'F') {
            $sqljoin = "left join (select no_dok bpbno, sum(qty_sj) roll_qty from whs_lokasi_inmaterial where status = 'Y' group by no_dok) br on bpb.bpbno_int = br.bpbno";
        ...
        $sqljoin
        where bpb.bpbdate >= '$tglf' and bpb.bpbdate <= '$tglt' and bpb.bpbno like '$cbotipe%' 
        group by bpbno
        order by bpbdate desc ");
          //and bpb.pono is null and bpb.id_po_item is null
