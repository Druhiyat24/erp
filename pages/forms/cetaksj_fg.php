...
*/	
    ...
    $sql="select * from bppb a
left join so_det sd on a.id_so_det = sd.id
inner join so on so.id = sd.id_so where a.bppbno='$bppbno'";
  ...
  <tbody>
    ...
    <?php
      ...
      { 
        ...
        tampil_data("select $fldws $fld_add_fg3 ,$fld_mst $fld_add_fg2 ,a.qty,a.unit,so_no  
          ...
          where bppbno='$bppbno' order by a.id",$jml_fld);
