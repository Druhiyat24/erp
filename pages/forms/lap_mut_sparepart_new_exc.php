...
{ 
  ...
  header("Content-Disposition: attachment; filename=lap_mutasi_spareparts.xls");//ganti nama sesuai keperluan 
...
<div class="box">
  <div class="box-header">
    <h3 class="box-title">List Laporan Mutasi Spareparts</h3>
  </div>
  <div>
