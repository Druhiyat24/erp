...
{	$txtSupplier = nb($_POST['txtSupplier']);
	...
	{	$cek = flookup("count(*)","mastersupplier","Supplier='$txtSupplier' and tipe_sup='$txttipe_sup'");
		...
		{	$cek = flookup("count(*)","bpb","id_supplier='$id_item'");
			...
			if ($cek>=1)
			{	$sql = "update mastersupplier set id_terms='$txtterms_of_pay',Supplier='$txtSupplier',id_coa='$txtcoa',Attn='$txtAttn',Phone='$txtPhone',Fax='$txtFax',Email='$txtEmail',
					...
					country='$txtcountry',pkp='$txtpkp' where id_supplier='$id_item'";
				insert_log($sql,$user);
				$_SESSION['msg'] = 2;
				#echo "<script>window.location.href='index.php?mod=4&mode=$mode';</script>";
			}
			else
			{	$sql = "update mastersupplier set id_terms='$txtterms_of_pay',id_coa='$txtcoa',supplier_code='$txtsupplier_code',
					...
					status_kb='$txtstatus_kb',country='$txtcountry',tipe_sup='$txttipe_sup',pkp='$txtpkp' 
