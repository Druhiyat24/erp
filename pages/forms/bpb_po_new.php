...
<script type="text/javascript">
  ...
  { jQuery.ajax
    ...
    ({  type: "POST",
      ...
      url: 'ajax3_1_new.php?modeajax=view_list_po',
...
echo "<form method='post' name='form' action='save_data_bpb_po_gen_new.php?mod=$mod&mode=$mode&noid=$bpbno&id=$id_item&kp=$kp' onsubmit='return validasi()'>";
...
<div class='col-md-12'>
  ...
  <div class="tab-pane" id="tab_2">
    ...
    <div class='col-md-3'>
      ...
      echo '<select class="form-control select2" style="width: 100%;" id="profit_center" name="profit_center" required>
  ...
  { ?>
    ...
    <div class="box">
      ...
      <div class="box-header">
        ...
        <a href='../forms/?mod=<?php echo 261; ?>&mode=<?php echo $mode; ?>' class='btn btn-primary btn'>
        ...
        <table id="examplefix3" class="display responsive" style="width:100%;font-size:13px;">
          ...
          # QUERY TABLE
            ...
            $query = mysql_query("SELECT a.*,s.goods_code,$fld_desc itemdesc,supplier,a.qty_reject,a.nomor_kk_bc, a.last_date_bpb
              ...
              left join po_item poi on a.id_po_item=poi.id  
