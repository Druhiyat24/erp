...
$id_jo=$_GET['id'];
$id_item=$_GET['idd'];
$rs=mysql_fetch_array(mysql_query("select * from bom_dev_jo_item where id_jo='$id_jo' and id='$id_item'"));
$cons=$rs['cons'];
$unit=$rs['unit'];
$id_gen=$rs['id_item'];
# COPAS EDIT
$cek=flookup("count(*)","po_item_dev","id_jo='$id_jo' and id_gen='$id_gen'");
if ($cek!="0")
...
echo "<div class='box'>";
  echo "<div class='box-body'>";
    echo "<div class='row'>";
      echo "<form method='post' name='form' action='s_bom_jo_it_ed_dev.php?mod=$mod&id=$id_jo&idd=$id_item' onsubmit='return validasi()'>";
