          ...
          <div class='col-md-12'>
            <div class="nav-tabs-custom">
              <ul class="nav nav-tabs">
                ...
                <li><a href="#tab_4" data-toggle="tab">Dok Pabean</a></li>
                <li><a href="#tab_5" data-toggle="tab">Dok Pajak</a></li>
              </ul>
            </div>
                ...
                <div class='col-md-3'>
                  ...
                  <div class='col-md-6'>
                    <div class='form-group'>
                      <label>Dari Tgl PO *</label>
                      <input type='text' class='form-control' name='txttglcut' id='datepicker1' 
                        placeholder='Masukkan Filter Tgl PO' onchange='getListKPNo()'>
                    </div>
                  </div>
                  <div class='col-md-6'>
                    <div class='form-group'>
                      <label>Sampai Tgl PO *</label>
                      <input type='text' class='form-control' name='txttglcutto' id='datepicker2' 
                        placeholder='Masukkan Filter Tgl PO' onchange='getListKPNo()'>
                    </div>
                  </div>
                  <div class='form-group'>
              ...
              <div class="tab-pane" id="tab_2">
                ...
                <div class='col-md-3'>
                  ...
                  echo "<div class='form-group'>";
                    ...
                    echo "<input type='text' id='txtpono' class='form-control' name='txtpono' readonly>";
                  echo "</div>";
                  ?>
                </div>
                <div class='col-md-3'>
...
{ ?>
  <div class="box">
    ...
    <div class="box-header">
      ...
      <a href='../forms/?mod=<?php echo 26; ?>&mode=<?php echo $mode; ?>' class='btn btn-primary btn pull-right'>
