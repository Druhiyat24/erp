...
{ $fromexc=date('d M Y',strtotime($_POST['frdate']));
  $toexc=date('d M Y',strtotime($_POST['kedate']));
  echo "<script>
  window.open ('index.php?mod=18z_exc&from=$fromexc&to=$toexc&mode=exc&dest=xls', '_blank');
    </script>";
...
?>
  ...
  <div class="box">
   ...
   <br>
    <h3 class="box-title">Tampilkan Data BPB (Print Barcode /Excel)</h3>
    </div>
    ...
    <div class="box-header">
      ...
      <div class='col-md-3'>
          ...
          <br>
              ...
              <button type='submit' name='submitexc' class='btn btn-success'>Export List Barcode</button>            
          </div>         
      </div>
    ...
    <div class="box-body">
      <table id="examplefix3" class="display responsive" style="width:100%;font-size:12px;">
        ...
        <tbody>
          <?php
          # QUERY TABLE
          $sql="SELECT brh.dateinput,brh.location,bpb.invno,brh.id,brh.bpbno,ac.kpno,mi.goods_code,mi.itemdesc,bpb.dicekqc_date,bpb.dicekqc_by
            ...
            where bpbdate >= '$tglf' and bpbdate <= '$tglt' 
          ...
          { $bpbno_int=flookup("bpbno_int","bpb","bpbno='$data[bpbno]'");
            ...
            <tr>";
              ...
              <td>".fd_view($data["dicekqc_date"])."</td>
