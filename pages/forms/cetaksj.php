...
cancel from po_item where cancel != 'Y') POI ON POI.id = a.id_po_item 
  ...
  <table width="100%" style="border:none; font-size:10pt">
    <tr>
      ...
      <td> : '.$rsh['invno'].'</td>
      <td rowspan="3" style="text-align:right; padding-right:8px;"><img src="'.$qr_penyimpanan.$qr_simpan.'.png" alt="" height="70" width="70"></td>
    </tr>
    <tr>
      <td>No PO</td>
      <td> : '.$rsh['pono'].'</td>
  ...
  <tbody>
    ...
    tampil_data("select $fld_add_4 $fld_add_fg3 ,$fld_mst $fld_add_fg2 ,a.qty,a.unit,(a.qty-a.qty_reject)gqty,a.qty_reject,a.remark
      ...
      { 
        ...
        tampil_data("select $fldws $fld_add_fg3 ,$fld_mst $fld_add_fg2 ,a.qty,a.unit,$keterangan  
