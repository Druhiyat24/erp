...
echo "<div class='box'>";
  echo "<div class='box-body'>";
    echo "<div class='row'>";
    	...
    	if ($rpt=='brgjadistok') 
      { 
        echo "<form method='post' name='form' action='?mod=view_mut_brgjadistok&rptid=brgjadistok' onsubmit='return validasi()' >";
         
      }
      echo "<div class='col-md-3'>";
      echo "Laporan Mutasi Barang Jadi (Gudang Jadi)";
      echo "<br>";
        echo "<div class='form-group'>";
      		echo "<label>Dari Tanggal *</label>";
      		echo "<input type='text' class='form-control' id='datepickerfg_stok' name='txtfrom' placeholder='Masukkan Dari Tanggal' value='$from' autocomplete='off'>";
      	echo "</div>";
      	echo "<div class='form-group'>";
