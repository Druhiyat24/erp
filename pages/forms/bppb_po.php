...
/*    		alert(mode_nya);
  ...
  var nama_sup = document.form.txtid_supplier.value;
    ...
    ({  type: "POST",
        ...
        data: {nama_sup: nama_sup,mode_ : mode_nya},
...
/*         $sql="SELECT (POH.pono)pono,a.*,s.goods_code,s.itemdesc itemdesc,ms.supplier,mb.supplier buyer, a.last_date_bppb,
          ...
          LEFT JOIN (SELECT * FROM po_item WHERE 1=1 )POI ON POI.id_jo = a.id_jo AND POI.id_gen = a.id_item
          LEFT JOIN po_header POH ON POH.id = POI.id_po #AND POH.id_supplier = a.id_supplier
          where mid(bppbno,4,1)='C' and a.id_jo!='' and a.cancel='N' and a.confirm = 'Y'
