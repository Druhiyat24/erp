...
inner join mapping_category mc on mi.n_code_category = mc.n_id
where bpbdate >= '$tglf' and bpbdate <= '$tglt' and mi.mattype = 'N' and mc.description = '$MTCLASSGEN' and non_aktif = 'N' and bpb.bpbno like 'N%'
...
inner join mapping_category mc on mi.n_code_category = mc.n_id
where bppbdate >= '$tglf' and bppbdate <= '$tglt' and mi.mattype = 'N' and mc.description = '$MTCLASSGEN' and non_aktif = 'N' and bppb.bppbno like 'SJ-N%'
