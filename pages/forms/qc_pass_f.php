...
echo "<div class='box'>";
  echo "<div class='box-body'>";
    echo "<div class='row'>";
      echo "<form method='post' name='form' action='save_data_qc_f.php?mod=$mod&mode=$mode&id=$id_item' onsubmit='return validasi()'>";
        echo "<div class='box-body'>";
          ...
          //   where dicekqc='N' and mattype = 'F' and left(a.bpbno,2)!='FG' and a.bpbdate >= '2023-11-01'   
					// 	order by a.bpbdate desc";

          $sql="select s.mattype,
if(a.bpbno_int='',a.bpbno,a.bpbno_int) bpbno,
a.bpbno bpbno_ori,
a.id_item,
s.goods_code,
s.itemdesc,
...
select ac.id_buyer,ac.styleno,jd.id_jo, ac.kpno from jo_det jd
         ...
         where jd.cancel = 'N'
         group by id_cost) tjo on tjo.id_jo=a.id_jo 
where dicekqc='N' and mattype = 'F' and left(a.bpbno,2)!='FG' and a.bpbdate >= '2023-10-01' 
order by a.bpbdate desc  ";            
...
# END COPAS ADD
  ...
  <div class="box">
    ...
    <div class="box-header">
      ...
      <a href='../forms/?mod=<?php echo 231; ?>&mode=<?php echo $mode; ?>' class='btn btn-primary btn'>
