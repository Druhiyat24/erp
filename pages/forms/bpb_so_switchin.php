...
<script type='text/javascript'>
  ...
  { var bpbdate = document.form.txtbpbdate.value;
    ...
    else if (reffno == '') { document.form.txtreffno.focus(); swal({ title: 'No Reff Tidak Boleh Kosong', <?php echo $img_alert; ?> }); valid = false;}
...
<script type="text/javascript">
  ...
  { var id_jo = $('#cboJO').val();
    ...
    ({  type: "POST",
        ...
        url: 'ajax_bpb_so_switchin.php?modeajax=view_list_jo',
...
<form method='post' name='form' action='s_bpb_so_switchin.php?mod=<?php echo $mod; ?>' 
        ...
        <div class='col-md-3'>
          ...
          <div class='form-group'>
            ...
            <?php } else { ?>
              ...
              <label>Nomor BPB dan WS Asal *</label>
            ...
            <select class='form-control select2' multiple="multiple" style='width: 100%;' 
              ...
              <?php
                ...
                { $sql = "select nows_switchout isi, concat(bppbno_int,' | WS Asal =  ',bppb.ws_asal, ' | Qty = ',total) tampil 
from (select bppb.*,ac.kpno ws_asal,sum(bppb.qty) total from bppb
inner join so_det on so_det.id = bppb.id_so_det
inner join so on so.id = so_det.id_so
inner join act_costing ac on ac.id = so.id_cost
where switch_out = 'Y' group by bppbno_int) bppb 
inner join act_costing ac on bppb.nows_switchout = ac.id";
        ...
        <div class='col-md-3'>        
          ...
          <div class='form-group'>
            ...
            <label>No. Reff*</label>
                ...
                <select class='form-control select2' style='width: 100%;' name='txtreffno' required>

                  <?php 

                    $sql = "select distinct (bppbno_int) isi,bppbno_int tampil 

                      from bppb where switch_out='Y'";

                    IsiCombo($sql,$tujuan,'Pilih Nomor BPPB');

                  ?>

                </select>            

<!--            <input type='text' class='form-control' name='txtreffno' placeholder='Masukkan No. Reff #' value='<?php echo $reffno;?>' > -->
...
<div class="box">
  ...
  $fldnyacri=" left(bpbno,2)='FG' "; $mod2=311;
    ...
    <table id="examplefix3" class="display responsive" style="width:100%">
      ...
      <tbody>
        ...
        $query = mysql_query("SELECT a.*,ac.kpno,s.goods_code,$fld_desc itemdesc,supplier,
          ...
          jod.id_jo idjonya,jo_no,ac.Styleno, a.bcdate, a.dateinput, a.last_date_bpb ,a.reffno 
         ...
         where  $fldnyacri  and a.bpbdate >='$tglf' and a.bpbdate <='$tglt' and a.bpbdate<>'' and switch_in = 'Y'
