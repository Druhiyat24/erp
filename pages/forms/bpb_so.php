    ...
    <table id="examplefix3" class="display responsive" style="width:100%">
      ...
      <tbody>
        ...
        $query = mysql_query("SELECT a.*,ac.kpno,s.goods_code,$fld_desc itemdesc,supplier,
         ...
         where  $fldnyacri  and a.bpbdate >='$tglf' and a.bpbdate <='$tglt' and a.bpbdate<>''
...
$periode=mysql_query("select * from tptglperiode where gudang = 'FG'"); 
$tglperiode = mysql_fetch_array($periode); 
$tgl_awal = $tglperiode['tgl1'];              
			
			if(($data['confirm']=='N') && ($data['bpbdate']>= $tgl_awal)) {
            echo " <td></td>  
			<td>
