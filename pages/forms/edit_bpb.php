...
<script type='text/javascript'>
  ...
  { var bpbdate = document.form.bpbdate.value;
    ...
    else if (invno == '') { alert('No Inoice Kosong'); valid = false;}
...
<div class='box'>
  <div class='box-body'>
    <div class='row'>
      <form method='post' name='form' enctype='multipart/form-data' action='update_bpb_header.php?bpbno=<?php echo $bpbno; ?>' onsubmit='return validasi()'>

        <div class="row" style="margin-left:8px;">
          <div class='col-md-3'>
            <div class='form-group'>
              <label>Nomor BPB</label>
              <input type='text' class='form-control' name='bpbno_int' readonly value='<?php echo $bpbno_int;?>' >
            </div> 
          </div>
          ...
          <div class='col-md-2'>
            <div class='form-group'>
              ...
              <select class='form-control select2' style='width: 100%;' name='jenis_dok' id='jenis_dok'>
                <?php 
                $sql = "SELECT nama_pilihan isi, nama_pilihan tampil FROM masterpilihan WHERE kode_pilihan='JENIS_DOK_IN'";
          ...
          <div class='col-md-3'>
            <div class='form-group'>
              ...
              <select class='form-control select2' style='width: 100%;' name='jenis_trans' id='jenis_trans'>
                <?php 
                $sql = "select UPPER(nama_pilihan) isi, UPPER(nama_pilihan) tampil from whs_master_pilihan where type_pilihan = 'Purchasing_type'";
      ...
      <div class='col-md-12'>
        <form method="post" action="update_bpb_detail.php">
          ...
          <input type="hidden" name="bpbno" value="<?= htmlspecialchars($bpbno) ?>">
          <br>
          <div class="text-left mt-3">
            <button type="submit" name="update_all" class="btn btn-success">Update Detail</button>
          </div>
        </form>
