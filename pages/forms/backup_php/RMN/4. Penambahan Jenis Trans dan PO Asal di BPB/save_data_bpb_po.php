		    ...
		    $txtid_item=$cri[0];
		  	...
		  	$cbomat = flookup("mattype","masteritem","id_item='$txtid_item'");
				...
				$sql = "insert into bpb (id_item,id_item_fg,qty,qty_over,unit,curr,price,remark,jam_masuk,berat_bersih,berat_kotor,nomor_mobil,pono,id_supplier,
							...
							kpno,id_gudang,nomor_rak,status_retur,id_po_item,id_jo,id_sec,qty_reject,no_contract)
							...
							'$txtid_gudang','$txtnomor_rak','$retur','$line_item','$id_jo','$txtid_sec','$txtqtyr','$txtcontractno')";
						insert_log($sql,$user);
