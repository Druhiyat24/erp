...
if ($tipe_data == 'PENERIMAAN DETAIL') {
  $tipe_data_xls = 'Penerimaan Detail';
} else if ($tipe_data == 'PENGELUARAN DETAIL') {
  $tipe_data_xls = 'Pengeluaran Detail';
} else if ($tipe_data == 'MUTASI DETAIL') {
  $tipe_data_xls = 'Mutasi Detail';
}
...
header("Content-Disposition: attachment; filename=Lap $tipe_data_xls $cbotipefix_xls.xls"); //ganti nama sesuai keperluan 
...
<div class="box">
  <div class="box-header">
    <h3 class="box-title">LIST <?php echo $tipe_data; ?> - <?php echo $cbotipefix; ?></h3>
  </div>
  <div>
    ...
    <div class="box-body">
      <table border="1" class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          $sql = "select bd.*,bpb.bpbdate tgl_bpb, jd.kpno, mi.itemdesc, mi.goods_code, concat(mr.kode_rak, ' ', mr.nama_rak)rak, supplier,pono,invno from bpb_det bd
    ...
    <div class="box-body">
      <table border="1" class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          $sql = "select bd.*,bppb.bppbdate tgl_bppb, jd.kpno, mi.itemdesc, mi.goods_code, concat(mr.kode_rak, ' ', mr.nama_rak)rak, supplier from bppb_det bd
          inner join (select bppbno,bppbno_int, id_supplier, bppbdate from bppb where bppbdate >= '$fromcri' and bppbdate <= '$tocri' 
    ...
    <div class="box-body">
      <table border="1" class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          (
          select bd.id_rak_loc, id_item, id_jo,unit,sum(roll_qty) qty_awal, '0' qty_in, '0' qty_out from bpb_det bd
          where bpbdate = '$fromcri' and bpbno = 'saldoawal'
