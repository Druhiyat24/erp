...
{ $fromexc=date('d M Y',strtotime($_POST['txtfrom']));
  ...
  echo "<script>
  window.open ('index.php?mod=7779_exc&from=$fromexc&to=$toexc&mode=exc&dest=xls', '_blank');
    </script>";
...
<div class="box">
  <div class="box-header">
    <h3 class="box-title">List Laporan Mutasi Mesin & Peralatan kantor</h3>
  </div>
  <div class="box-body"> 
...
// inner join masteritem mi on bpb.id_item = mi.id_item
// inner join mapping_category mc on mi.n_code_category = mc.n_id
// where bpbdate < '$fromcri' and mi.mattype = 'N' and mc.description = 'PERSEDIAAN ATK' and non_aktif = 'N' and bpb.bpbno like 'N%'
// group by mi.id_item
// union 
// select mi.id_item, mi.goods_code, mi.itemdesc, '0' qty_sa,'0' qty_in,sum(bppb.qty) qty_out, bppb.unit from bppb 
// inner join masteritem mi on bppb.id_item = mi.id_item
// inner join mapping_category mc on mi.n_code_category = mc.n_id
// where bppbdate < '$fromcri' and mi.mattype = 'N' and mc.description = 'PERSEDIAAN ATK' and non_aktif = 'N' and bppb.bppbno like 'SJ-N%'
// group by mi.id_item
// ) trx
// group by id_item
// UNION
...
// inner join masteritem mi on bpb.id_item = mi.id_item
// inner join mapping_category mc on mi.n_code_category = mc.n_id
// where bpbdate >= '$fromcri' and bpbdate <= '$tocri' and mi.mattype = 'N' and mc.description = 'PERSEDIAAN ATK' and non_aktif = 'N' and bpb.bpbno like 'N%'
// group by mi.id_item
// UNION
// select mi.id_item, mi.goods_code, mi.itemdesc, '0' qty_sa,'0' qty_in,sum(bppb.qty) qty_out, bppb.unit from bppb 
// inner join masteritem mi on bppb.id_item = mi.id_item
// inner join mapping_category mc on mi.n_code_category = mc.n_id
// where bppbdate >= '$fromcri' and bppbdate <= '$tocri' and mi.mattype = 'N' and mc.description = 'PERSEDIAAN ATK' and non_aktif = 'N' and bppb.bppbno like 'SJ-N%'
// group by mi.id_item
// ) mutasi
// group by id_item
// having sum(qty_sa) != '0' or sum(qty_in) != '0' or sum(qty_out) != '0' or sum(qty_sa) + sum(qty_in) - sum(qty_out) != '0'
...
// inner join masteritem mi on bpb.id_item = mi.id_item
// inner join mapping_category mc on mi.n_code_category = mc.n_id
// where bpbdate < '$fromcri' and mi.mattype = 'N' and mc.description = 'PERSEDIAAN MESIN' and non_aktif = 'N' and bpb.bpbno like 'N%'
// group by mi.id_item, bpb.unit
// union 
// select mi.id_item, mi.goods_code, mi.itemdesc, '0' qty_sa,'0' qty_in,sum(bppb.qty) qty_out, bppb.unit from bppb 
// inner join masteritem mi on bppb.id_item = mi.id_item
// inner join mapping_category mc on mi.n_code_category = mc.n_id
// where bppbdate < '$fromcri' and mi.mattype = 'N' and mc.description = 'PERSEDIAAN MESIN' and non_aktif = 'N' and bppb.bppbno like 'SJ-N%'
// group by mi.id_item, bppb.unit
// ) trx
// group by id_item
// UNION
...
// inner join masteritem mi on bpb.id_item = mi.id_item
// inner join mapping_category mc on mi.n_code_category = mc.n_id
// where bpbdate >= '$fromcri' and bpbdate <= '$tocri' and mi.mattype = 'N' and mc.description = 'PERSEDIAAN MESIN' and non_aktif = 'N' and bpb.bpbno like 'N%'
// group by mi.id_item, bpb.unit
// UNION
// select mi.id_item, mi.goods_code, mi.itemdesc, '0' qty_sa,'0' qty_in,sum(bppb.qty) qty_out, bppb.unit from bppb 
// inner join masteritem mi on bppb.id_item = mi.id_item
// inner join mapping_category mc on mi.n_code_category = mc.n_id
// where bppbdate >= '$fromcri' and bppbdate <= '$tocri' and mi.mattype = 'N' and mc.description = 'PERSEDIAAN MESIN' and non_aktif = 'N' and bppb.bppbno like 'SJ-N%'
// group by mi.id_item, bppb.unit
// ) mutasi
// group by id_item
// having sum(qty_sa) != '0' or sum(qty_in) != '0' or sum(qty_out) != '0' or sum(qty_sa) + sum(qty_in) - sum(qty_out) != '0'
