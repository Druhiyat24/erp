...
echo "<div class='box'>";
  echo "<div class='box-body'>";
    echo "<div class='row'>";
      ...
      { 
        echo "<form method='post' name='form' action='?mod=view_mut_fg_out_invoice&rptid=fg_out_invoice' onsubmit='return validasi()' >";
         
      }
      echo "<div class='col-md-3'>";
      echo "Laporan Mutasi Gudang Barang Jadi Stok";
      echo "<br>";
