            ...
            <div class="tab-pane active" id="tab_1">
              <div class='col-md-3'>
                ...
                echo "<div class='form-group'>";
                  ...
                  echo "<input type='text' class='form-control' name='txtbpbdate' id='datepicker2' onchange='getSat(this.value)' placeholder='$cmas $caption[3]' value='$bpbdate'>";
                echo "</div>";
                if ($st_company!="MULTI_WHS")
                { echo "<div class='form-group'>";
              ...
              echo "<div class='form-group'>";
                ...
                { if ($nm_company=="PT. Bangun Sarana Alloy")
                  ...
                  { $sql = "select itemname isi,concat(goods_code,'|',itemname,'|',color,'|',size) tampil from 
                      ...
                      $sql_act group by goods_code,itemname order by goods_code,itemname "; 
                  }
            ...
            <div class="tab-pane" id="tab_3">
              ...
              echo "
                ...
                <div class='form-group'>
                  ...
                  <input type='text' class='form-control' id='datepicker3' name='txttglaju' placeholder='Masukan Tanggal Aju' value='$tglaju'>
                </div>";
              ?>
              </div>
              <div class='col-md-3'>
                ...
                echo "
                  ...
                  <div class='form-group'>
                    <label>$c43 *</label>
                    <input type='text' class='form-control' id='datepicker1' name='txtbcdate' placeholder='$cmas $c43' value='$bcdate'>
                  </div>";
                ?>
              </div>
            </div>
            <div class="tab-pane" id="tab_4">
              ...
              echo "
                ...
                <div class='form-group'>
                  ...
                  <input type='text' class='form-control' id='datepicker4' name='txttglfp' placeholder='Masukan Tanggal Faktur Pajak' value='$tglfp'>
                </div>";
              ?>
              </div>
            </div>
...
<div class="box">
  ...
  <div class="box-body">
    <table id="examplefix" class="display responsive" style="width:100%">
      <thead>
        <tr>
          <th width="15%">Nomor BPB</th>
          <th width="15%">Tanggal BPB</th>
      ...
      <tbody>
        ...
        $query = mysql_query("SELECT a.*,s.goods_code,$fld_desc itemdesc,supplier 
          ...
          where $fldnyacri 
          GROUP BY a.bpbno ASC limit 1000");
        ...
        { echo "<tr>";
          echo "
            ...
            <td><a class='btn btn-success btn-s' href='?mod=$mod2&mode=$mode&noid=$data[bpbno]'
              data-toggle='tooltip' title='$cub'><i class='fa fa-pencil'></i></a>"; 
            if ($print_sj=="1")
            { echo " <a class='btn btn-warning btn-s' href='cetaksj.php?mode=$mode&noid=$data[bpbno]' 
    ...
    <table id="examplefix2" class="display responsive" style="width:100%">
      <thead>
        <tr>
            ...
            <th width="20%"><?php echo $c48; ?></th>
            <th width="10%"><?php echo $c31; ?></th>
            <th width="10%"><?php echo $c32; ?></th>
            <th width="10%"><?php echo $c33; ?></th>
            <th width="5%"><?php echo $c34; ?></th>
            <th width="5%"><?php echo $c49; ?></th>
            <th width="5%"><?php echo $c35; ?></th>
            <th width="15%"><?php echo "Aksi"; ?></th>
        </tr>
      </thead>
      <tbody>
        ...
        if ($mode=="FG") { $tbl_mst="masterstyle"; $fld_desc="s.itemname"; } else { $tbl_mst="masteritem"; $fld_desc="s.itemdesc"; }
          ...
          echo "<td><a class='btn btn-success btn-s' href='?mod=$mod&mode=$mode&noid=$bpbno&id=$data[id]'
            data-toggle='tooltip' title='$cub'><i class='fa fa-pencil'></i></a>";
				  echo " <a class='btn btn-danger btn-s' href='del_data.php?mod=$mod&mode=$mode&noid=$bpbno&id=$data[id]&pro=In'
            data-toggle='tooltip' title='$chap'";?> 
            onclick="return confirm('Apakah anda yakin akan menghapus ?')">
            <?PHP echo "<i class='fa fa-trash-o'></i></a>";
				  echo "</tr>";
