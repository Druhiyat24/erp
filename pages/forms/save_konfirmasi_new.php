		...
		if (!isset($_POST['itemchk'])) {
			...
			foreach ($ItemArray as $key => $value) {
				if ($value != "") {
					...
					$cekdata = mysql_query("select phd.tipe_com, mi.itemdesc,bpb.confirm,bpbno, bpbno_int, bpb.bpbdate, bpb.id_supplier, supplier, mattype, n_code_category, 
						...
						where bpbno = '$txtbpbno'  group by bpbno,mattype, n_code_category order by supplier");
					// and ph.app = 'A'
					...
					VALUES 
					('$no_bpb', '$tgl_bpb', 'AP - BPB', '$no_coa_cre', '$nama_coa_cre', '-', '-', '-', '', '-', '-', '$curr', '$rate', '0', '$total', '0', '$idr_total', 'Approved', '$description', '$username', '$dateinput_', '$user', '$dateinput', '', '','NAG', '$supp')";
					...
					VALUES 
					('$no_bpb', '$tgl_bpb', 'AP - BPB', '$no_coa_deb', '$nama_coa_deb', '-', '-', '-', '', '-', '-', '$curr', '$rate', '$dpp', '0', '$idr_dpp', '0', 'Approved', '$description', '$username', '$dateinput_', '$user', '$dateinput', '', '', 'NAG', '$supp')";
					...
					if ($tax >= 1) {
						...
						VALUES 
						('$no_bpb', '$tgl_bpb', 'AP - BPB', '$no_coa_ppn', '$nama_coa_ppn', '-', '-', '-', '', '-', '-', '$curr', '$rate', '$ppn', '0', '$idr_ppn', '0', 'Approved', '$description', '$username', '$dateinput_', '$user', '$dateinput', '', '', 'NAG', '$supp')";
					...
					if ($tipe_com == 'BUYER') {
						...
						$queryss2 = "INSERT INTO tbl_list_journal (no_journal, tgl_journal, type_journal, no_coa, nama_coa, no_costcenter, nama_costcenter, reff_doc, reff_date, buyer, no_ws, curr, rate, debit, credit, debit_idr, credit_idr, status, keterangan, create_by, create_date, approve_by, approve_date, cancel_by, cancel_date, profit_center, supplier) 
						VALUES 
						('$no_bpb', '$tgl_bpb', 'AP - BPB', '$no_coa_cre', '$nama_coa_cre', '-', '-', '-', '', '-', '-', '$curr', '$rate', '0', '$dpp', '0', '$idr_dpp', 'Approved', '$description', '$username', '$dateinput_', '$user', '$dateinput', '', '', 'NAG', '$supp')";
						insert_log($queryss2, $user);


						$queryss3 = "INSERT INTO tbl_list_journal (no_journal, tgl_journal, type_journal, no_coa, nama_coa, no_costcenter, nama_costcenter, reff_doc, reff_date, buyer, no_ws, curr, rate, debit, credit, debit_idr, credit_idr, status, keterangan, create_by, create_date, approve_by, approve_date, cancel_by, cancel_date, profit_center, supplier) 
						VALUES 
						('$no_bpb', '$tgl_bpb', 'AP - BPB', '1.34.05', 'PIUTANG LAIN-LAIN PIHAK KETIGA - BAHAN BAKU / BAHAN PEMBANTU', '-', '-', '-', '', '-', '-', '$curr', '$rate', '$total', '0', '$total', '0', 'Approved', '$description', '$username', '$dateinput_', '$user', '$dateinput', '', '', 'NAG', '$supp')";
						insert_log($queryss3, $user);
						...
						if ($tax >= 1) {
							...
							$queryss4 = "INSERT INTO tbl_list_journal (no_journal, tgl_journal, type_journal, no_coa, nama_coa, no_costcenter, nama_costcenter, reff_doc, reff_date, buyer, no_ws, curr, rate, debit, credit, debit_idr, credit_idr, status, keterangan, create_by, create_date, approve_by, approve_date, cancel_by, cancel_date, profit_center, supplier) 
							VALUES 
							('$no_bpb', '$tgl_bpb', 'AP - BPB', '8.07.01', 'PENDAPATAN LAIN-LAIN', '-', '-', '-', '', '-', '-', '$curr', '$rate', '0', '$ppn', '0', '$idr_ppn', 'Approved', '$description', '$username', '$dateinput_', '$user', '$dateinput', '', '', 'NAG', '$supp')";
			...
			foreach ($ItemArray as $key => $value) {
				if ($value != "") {
					...
					$cekdata = mysql_query("select bppbno,bppbno_int,bppbdate,curr,id_supplier,supplier,mattype,n_code_category,matclass,curr,tax,username,dateinput,(dpp + (dpp * (tax/100))) total,dpp,(dpp * (tax/100)) ppn from (select bppbno, bppbno_int, bppb.bppbdate, bppb.id_supplier, supplier, mattype, n_code_category, 
						...
						where bppbno = '$txtbppbno' group by bppbno) a left join
					...
					$queryss2 = "INSERT INTO tbl_list_journal (no_journal, tgl_journal, type_journal, no_coa, nama_coa, no_costcenter, nama_costcenter, reff_doc, reff_date, buyer, no_ws, curr, rate, debit, credit, debit_idr, credit_idr, status, keterangan, create_by, create_date, approve_by, approve_date, cancel_by, cancel_date, profit_center, supplier) 
					VALUES 
					('$no_bpb', '$tgl_bpb', 'AP - BPB RETURN', '$no_coa_cre', '$nama_coa_cre', '-', '-', '-', '', '-', '-', '$curr', '$rate', '$total', '0', '$idr_total', '0', 'Approved', '$description', '$username', '$dateinput', '', '', '', '', 'NAG', '$supp')";
					insert_log($queryss2, $user);
					...
					$queryss3 = "INSERT INTO tbl_list_journal (no_journal, tgl_journal, type_journal, no_coa, nama_coa, no_costcenter, nama_costcenter, reff_doc, reff_date, buyer, no_ws, curr, rate, debit, credit, debit_idr, credit_idr, status, keterangan, create_by, create_date, approve_by, approve_date, cancel_by, cancel_date, profit_center, supplier) 
					VALUES 
					('$no_bpb', '$tgl_bpb', 'AP - BPB RETURN', '$no_coa_deb', '$nama_coa_deb', '-', '-', '-', '', '-', '-', '$curr', '$rate', '0', '$dpp', '0', '$idr_dpp', 'Approved', '$description', '$username', '$dateinput', '', '', '', '', 'NAG', '$supp')";
					insert_log($queryss3, $user);
					...
					if ($tax >= 1) {
						...
						$queryss4 = "INSERT INTO tbl_list_journal (no_journal, tgl_journal, type_journal, no_coa, nama_coa, no_costcenter, nama_costcenter, reff_doc, reff_date, buyer, no_ws, curr, rate, debit, credit, debit_idr, credit_idr, status, keterangan, create_by, create_date, approve_by, approve_date, cancel_by, cancel_date, profit_center, supplier) 
						VALUES 
						('$no_bpb', '$tgl_bpb', 'AP - BPB RETURN', '$no_coa_ppn', '$nama_coa_ppn', '-', '-', '-', '', '-', '-', '$curr', '$rate', '0', '$ppn', '0', '$idr_ppn', 'Approved', '$description', '$username', '$dateinput', '', '', '', '', 'NAG', '$supp')";
