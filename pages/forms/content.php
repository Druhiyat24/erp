...
{	include "lap_mut_sparepart_new.php";	}
else if ($mod=="7778_exc")
{	include "lap_mut_sparepart_new_exc.php";	}

else if ($mod=="7779")
{	include "lap_mut_mesin_dan_atk_new.php";	}
...
{	include "lap_list_barcode_exc.php";	}
//--------------------------------------------------------------------------------------
...
else if ($mod=="lap_mutasi_fabric")
{	include "lap_mutasi_fabric.php"; }
else if ($mod=="outdet")
...
{	include "lap_list_bppb_barcode_exc.php";	}
