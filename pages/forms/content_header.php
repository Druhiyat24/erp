...
else if ($mod=="lap_bc" AND $rpt=="bc30")
{	echo "Laporan BC 3.0 Export"; }
...
{
	echo "Laporan Mutasi Barang Jadi (Ekspedisi)";
}

else if ($mod=="7778")
{
	echo "Laporan Mutasi Sparepart";
}

else if ($mod=="7779")
{
	echo "Laporan Mutasi Mesin & Peralatan kantor";
}
...
else if ($mod=="list_bppb_gen" or $mod=="new_bppb_gen")
{	echo "Pengeluaran Item General (New)"; }
...
{	echo "Laporan Data"; }
else if ($mod=="bpb_po" or $mod=="bpb_po_v" or $mod=="bpb_po_item")
{	echo "Pemasukan Bahan Baku PO New"; }
else if ($mod=="bpb_po_item_lokasi")
{	echo "Pemasukan Bahan Baku PO New Lokasi"; }
else if ($mod==15)
...
{	echo "Pengeluaran Bahan Baku (Request New)"; }
