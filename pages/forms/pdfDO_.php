...
{ $head_cap = "Surat Jalan";
  ...
  $rsh=mysql_fetch_array(mysql_query("select group_concat(distinct ac.kpno) wsno,POH.pono,
    a.invno,a.bppbdate,a.id_item,a.id_jo,a.jenis_dok,a.bcno,a.bcdate,br.idws_act,a.jenis_trans  from bppb a left join jo_det jod on a.id_jo=jod.id_jo
	...
	curr, 
	price,
	cancel from po_item where cancel != 'Y') POI ON POI.id_jo = a.id_jo AND $on
...
'<div style=" margin-bottom: 2.54cm; border-collapse:collapse;  font-family: Helvetica, Arial, sans-serif;"> 
  <!-- <table style="font-size:10px;" border="1"> -->
    ...
    <tr>  
      ...
      <th style="font-size: 11px; width: 200px">Received By : </th>
    </tr>
    <tr>  
      <td class="td1">&nbsp;</td>
      <td class="td1">&nbsp;</td>
