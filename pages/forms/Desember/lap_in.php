...
echo "<div class='box'>";
  echo "<div class='box-body'>";
    echo "<div class='row'>";
        ...
        OR $rpt=='mesin' OR $rpt=='itemgen' OR $rpt=='gb_bahanbaku' OR $rpt=='mwipdet'
      ...
      { echo "<form method='post' name='form' action='?mod=view_mut_lap_data&rptid=$rpt' onsubmit='return validasi()'>"; }
      else if ($rpt=='wip') 
