...
if ($mod=="51" or $mod=="51a" or $mod=="52" or $mod=="53"
...
echo "<div class='box'>";
  ...
  echo "<div class='box-body'>";
    ...
    echo "<div class='row'>";
      ...
      echo "<form method='post' name='form' action='save_data_bpb.php?mod=$mod&mode=$mode&noid=$bpbno&id=$id_line&kp=$kp' onsubmit='return validasi()'>";
          ...
          <div class="tab-content">
                ...
                { echo "<div class='form-group'>";
                  ...
                  {	echo "<div class='form-group'>";
	                  ...
	                  echo "<div class='form-group'>";
	                    ...
	                    IsiCombo($sql,trim($txtsubtujuan),$cpil.' '.$c47);
            ...
            <div class="tab-pane" id="tab_2">
                  ...
                  { if ($mod=="51a")
                    ...
                    { echo "<label>$c_nom_order *</label>"; 
                      ...
                      $sql="select a.id_item isi,concat(a.kpno,'|',a.styleno,'|',a.buyerno,'|',a.deldate,'|',a.id_item) 
                        ...
                        and a.id_so_det is null group by kpno,buyerno,deldate,a.id_item order by kpno,styleno";
                    ...
                    { echo "<label>$c14 $titlenya *</label>"; 
                      ...
                      $sql = "select $fldclass isi,$fldclass tampil from masteritem where $filternya $sqlwhere2 
              ...
              echo "<div class='form-group'>";
                ...
                echo "<input type='text' class='form-control' name='txtqty' id='txtqty'  
...
if ($mod=="51v" or $mod=="52v" or $mod=="53v"

  or $mod=="54v" or $mod=="55v")
  ...
  <div class="box-body">
    ...
    <table id="examplefix3" class="display responsive" style="width:100%">
      ...
      <tbody>
        ...
        $sql="SELECT a.*,s.goods_code,$fld_desc itemdesc,supplier, br.bppbno
          FROM bpb a inner join $tbl_mst s on a.id_item=s.id_item
          inner join mastersupplier ms on a.id_supplier=ms.id_supplier  
          LEFT JOIN bppb_req br ON br.id_item=a.id_item
          where 1=1
          AND (bpbno_int NOT LIKE '%IN%' AND bpbno_int NOT LIKE '%RI%' AND SUBSTR(bpbno_int,8,1) !='R' AND ifnull(a.id_jo,0) > 0 and $fldnyacri ) 
		      OR(	 $fldnyacri and ifnull(a.id_po_item,0) = 0 and ifnull(a.id_jo,0) = 0   )
          GROUP BY a.bpbno ASC order by bpbdate desc #limit 10000	";
        #echo $sql;
