...
{ 
  ...
  header("Content-Disposition: attachment; filename=lap_mutasi_mesin_dan_atk.xls");//ganti nama sesuai keperluan 
...
<div class="box">
  <div class="box-header">
    <h3 class="box-title">List Laporan Mutasi Mesin dan Peralatan Kantor</h3>
  </div>
  <div>
