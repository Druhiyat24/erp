    ...
    <div class="box-body">
      <table border="1" class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          bppb.bppbno_req 
          from bppb_det bd
          inner join (select bppbno,bppbno_int,bppbno_req, id_supplier, bppbdate, remark,invno,jenis_dok,right(nomor_aju,6) no_aju,tanggal_aju, lpad(bcno,6,'0') bcno,bcdate from bppb where bppbdate >= '$fromcri' and bppbdate <= '$tocri' 
