...
SELECT d.otherscode cod,
		...
		'3' category 
		    	...
		    	where a.id='$id_item'	) X ORDER BY  X.idCostings ASC";
...
$sql="SELECT s.supplier,d.product_item,a.qty,up.fullname,up2.fullname app1_by_name,app1_date,
    dateinput,a.attach_file,a.styleno,a.cost_no 
...
<table width="50%">
    <tr>
        ...
        <td <?php echo $stylehead; ?>>No. Costing</td>
		<td <?php echo $stylehead; ?>><?php echo $rsh['cost_no']; ?></td>
		        <td rowspan="9">&nbsp&nbsp&nbsp<img src='upload_files/costing/<?php echo $rsh['attach_file']; ?>' width='150px' height='150px'></td>
    </tr>
    <tr>
...
<!-- TABLE TOTAL COST -->
    ...
    <tr>
        ...
        <th class="text-center" style="" rowspan=""><?php echo fn($grandtotalidr,2);?></th>
        <th class="text-center" style="" rowspan=""><?php echo fn($grandtotalusd,4);?></th>
    ...
    <tr class='alt' >
        ...
        <th align="center" style=""><?php echo fn($grand_total_after_fat_idr,2);?></th>
        <th align="center" style=""><?php echo fn($grand_total_after_fat_usd,2);?></th>
        <th class="text-center" style="" rowspan="">&nbsp;</th>
    </tr>
    <tr class='alt' >
