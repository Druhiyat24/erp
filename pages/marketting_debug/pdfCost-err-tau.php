...
$total_cost_plus = $cfm_price/$rate_beli;
//$total_cost_plus_idr = $total_cost_idr + $total_vat_idr + $total_deal_idr + $total_ga_cost_idr;
$total_cost_plus_idr = $cfm_price;
$deal_idr=($cfm_price-$total_cost_idr);
$deal_usd=($cfm_price/$rate_beli)-$total_cost;
$persen_deal_idr=($deal_idr/$total_cost_plus_idr)*100;
$persen_deal_usd=($deal_usd/$total_cost_plus)*100;
//echo $total_deal;
$vat_new_idr = (($vat/100))*$total_cost_idr;
$vat_new_usd = (($vat/100))*$total_cost;
$deal_new_idr = ($persen_deal_idr/100)*$vat_new_idr;
$deal_new_usd = ($persen_deal_usd/100)*$vat_new_usd;
$total_deal = ($persen_deal_usd/100)*$vat_new_usd;
$total_deal_idr = ($persen_deal_idr/100)*$vat_new_idr;


$tdeal = ($cfm_price/$rate_beli)-$total_cost-$total_ga_cost-$comm;
$tdeal_idr = $cfm_price-$total_cost_idr-$total_ga_cost_idr-$comm_idr;
...
<table width="50%">
    <tr>
        ...
        <td rowspan="5">&nbsp&nbsp&nbsp<img src='upload_files/costing/<?php echo $rsh['attach_file']; ?>' width='100px' height='150px'></td>
    </tr>
    <tr>
...
<!-- TABLE TOTAL COST -->
    ...
    <tr class='alt' >
        ...
        <th align="center" style=""><?php echo fn($vat_new_idr,2);?></th>
        <th align="center" style=""><?php echo fn($vat_new_usd,2);?></th>
        <th class="text-center" style="" rowspan="">&nbsp;</th>
    </tr>
    <tr class='alt' >
        <th align="left" colspan="6">DEAL ALLOWANCE</th>
        <!-- <th align="center" style=""><?php echo $deal; ?> %</th> -->
        <th align="center" style=""><?php echo fn($persen_deal_idr,4); ?> %</th>
        <th align="center" style="">IDR / USD</th>
        <th align="center" style=""><?php echo fn($tdeal_idr,2);?></th>
        <th align="center" style=""><?php echo fn($tdeal,2);?></th>
        <th class="text-center" style="" rowspan="">&nbsp;</th>
    </tr>
    <tr class='alt' >
