...
{ if ($row1_pro['rule_bom']=="ALL COLOR ALL SIZE")
  ...
  { $fldcol="'All Color'";
    ...
    { $fldgrp=" group by l.sku,a.status,a.id_item,a.add_info "; }

    else

    { $fldgrp=" group by a.status,a.id_item,a.add_info "; }
  ...
  { $fldcol="'All Color'";
    ...
    $fldgrp=" group by a.status,a.id_item,l.size,a.add_info";
  ...
  { $fldcol="l.color";
    ...
    $fldgrp=" group by a.status,a.id_item,l.color,a.add_info";
  ...
  { #PER COLOR RANGE SIZE
    ...
    $fldgrp=" group by a.status,a.id_item,l.color,l.size,a.add_info";
...
<!--                    <td>&nbsp;</td>-->
                ...
                <tr>
                    ...
                    <td colspan="12">Notes : <?php echo $l->notesnya;?></td>
