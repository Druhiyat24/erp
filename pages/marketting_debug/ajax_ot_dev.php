...
if ($id_ot=="")
{	$sql = "insert into act_development_oth (id_act_cost,id_item,price,jenis_rate)
		values ('$id_cs','$id_item_ot','$price_ot','$j_rate_ot')";
	insert_log($sql,$user);
}
else
{	$sql = "update act_development_oth set jenis_rate='$j_rate_ot',id_item='$id_item_ot',price='$price_ot'
