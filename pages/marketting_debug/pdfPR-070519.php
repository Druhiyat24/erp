...
class Model{
    ...
    public function get_report($jo_id)
    {
        ...
        $fld6="if(l.color!='-',concat(l.color,' '),'')";
        $fld7="if(l.size!='',concat(l.size,' '),'')";
        ...
        $fld_item="if(nama_sub_group regexp 'BARCODE' or nama_sub_group regexp 'STICKER',
          concat($fld1,$fld2,$fld3,$fld4,$fld5,$fld6,$fld7,$fld8a,l.sku,' ',l.barcode),
          concat($fld1,$fld2,$fld3,$fld4,$fld5,$fld6,$fld7,$fld8))";
        $sql = "
            SELECT k.id,a.nama_group, s.nama_sub_group, l.color,l.size,
                $fld_item item,l.qty qty_gmt,k.cons,round(l.qty*k.cons,2) qty_bom,
                k.unit,msup.supplier,s.id idsubgroup 
