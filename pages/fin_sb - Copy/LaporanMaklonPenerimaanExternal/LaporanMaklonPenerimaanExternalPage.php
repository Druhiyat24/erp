...
<div class="box list" style="display:none"> 
	...
	<table style="width:100%;font-size:11px; border-collapse: collapse; outline: none; border: none;">
		<thead>
			...
			<tr>
				<th style="font-size: 16px; border-collapse: collapse; border: none;" colspan="14"><strong>LAPORAN PENERIMAAN BARANG MAKLOON (BARANG MILIK KONSUMEN)</strong></th>
			</tr>
			<tr>
			...
			<table id="laporan_jurnal" class="table table-condensed table-bordered" style="border:1px solid #000000 !important">
				<thead>
					<tr>
						...
						<th colspan="4" style="background-color: #ffffff; text-align: center; vertical-align: middle">PO</th>
