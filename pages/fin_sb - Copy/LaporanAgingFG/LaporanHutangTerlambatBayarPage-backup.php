...
<div class="box list" style="display:none"> 
					...
					<table style="width:100%;font-size:11px; border-collapse: collapse; outline: none; border: none;">
						...
						<thead>
							...
							<tr>
								...
								<th style="font-size: 16px; border-collapse: collapse; border: none;" colspan="14"><strong>LAPORAN HUTANG DAGANG TERLAMBAT BAYAR</strong></th>
    ...
    <div id="formBs" class='box'>
         ...
         <tr>
            ...
            <th rowspan="2" style="text-align: center;background-color:#ffffff;border:1px solid #000000">AP DAYS</th>
         </tr>
            <tr>
