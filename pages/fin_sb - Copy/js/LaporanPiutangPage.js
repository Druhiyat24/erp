...
function GenerateTable(from_,to_,CoaId_){

	table = $('#laporan_jurnal_ar').DataTable( {
      'processing': true,
      'serverSide': true,
      'orderable': false,
      'columnDefs': [ {
     ...
     'aoColumnDefs': [
	  ...
	  "lengthMenu": [[999999999], ["All"]],
        ...
        "ajax":  "webservices/getDataLaporanPiutang.php?from="+from_+"&to="+to_+"&idcoa="+CoaId_,
        "columns": [
		//date_journal
        {
			"data":           "date_journal"
