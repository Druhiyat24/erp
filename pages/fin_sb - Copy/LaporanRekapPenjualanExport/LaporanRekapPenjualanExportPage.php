...
<table id="laporan_jurnal" class="table table-condensed table-bordered responsive" style="border:1px solid #000000 !important">
...
<thead>
        ...
        <tr>
            ...
            <th colspan="4" style="text-align:center;background-color:#ffffff;border:1px solid #000000">TOTAL</th>
        ...
        <tr>
            ...
            <th style="text-align:center;background-color:#ffffff;border:1px solid #000000">KODE/ID</th>
