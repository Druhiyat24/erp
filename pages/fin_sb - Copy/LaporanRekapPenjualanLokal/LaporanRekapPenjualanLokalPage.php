					...
					<table style="width:100%;font-size:11px; border-collapse: collapse; outline: none; border: none;">
						...
						<thead>
							...
							<tr>
								...
								<th style="font-size: 16px; border-collapse: collapse; border: none;" colspan="14"><strong>Laporan Rekap Penjualan Lokal</strong></th>
...
<table id="laporan_jurnal" class="table table-condensed table-bordered display responsive" style="border:1px solid #000000 !important">
...
<thead>
        ...
        <tr>
            ...
            <th colspan="3" style="text-align:center;background-color:#ffffff;border:1px solid #000000">KONSUMEN</th>
            ...
            <th colspan="3" style="text-align:center;background-color:#ffffff;border:1px solid #000000">TOTAL</th>
