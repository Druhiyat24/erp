	...
	<a href="#" id="submit" class='btn btn-primary' onclick="back()" />Back</a>
		...
		<table style="width:100%;font-size:11px; border-collapse: collapse; outline: none; border: none;">
			<thead>
				...
				<tr>
					<th style="font-size: 16px; border-collapse: collapse; border: none;" colspan="14"><strong>LAPORAN TRANSAKSI MUTASI WIP</strong></th>
				</tr>
				<tr>
					<th style="font-size: 16px; border-collapse: collapse; border: none;" colspan="14"><strong>BAGIAN : SEWING</strong></th>
				</tr>
				<tr>
...
<div id="formBs" class='box'>
	...
	<div id="formBs" class='box'>
		...
		<div class="box-body" style="font-size: 9pt;" >
			<table id="laporan_jurnal" class="table display responsive table-condensed table-bordered" style="border:1px solid #000000 !important; width:100%">
				<thead>
					<tr>
						<th style="text-align: center; vertical-align: middle">NO</th>
						<th style="text-align: center; vertical-align: middle">WORKSHEET (KARTU PROSES)</th>
						<th style="text-align: center; vertical-align: middle">ID PROSES</th>
						<th style="text-align: center; vertical-align: middle">ID KONSUMEN</th>
						<th style="text-align: center; vertical-align: middle">NAMA KONSUMEN</th>
						<th style="text-align: center; vertical-align: middle">ID ORDER</th>
						<th style="text-align: center; vertical-align: middle">IN / OUT</th>
						...
						<th style="text-align: center; vertical-align: middle">SATUAN QTY</th>
						<th style="text-align: center; vertical-align: middle">QTY</th>
						<th style="text-align: center; vertical-align: middle">UP</th>
						<th style="text-align: center; vertical-align: middle">RUPIAH</th>
  					</tr>
				</thead>
			</table>
		</div>
