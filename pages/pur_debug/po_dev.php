...
<script type='text/javascript'>
  ...
  { <?php echo "window.location.href='../pur/?mod=x3ea&id=$id_po';"; ?>
...
<script type="text/javascript">
  ...
  { var id_supp = document.form.txtid_supplier.value;
    ...
    ({  type: "POST",
        ...
        url: 'ajax_po_dev.php?modeajax=get_list_jo',
...
<div class="box">
  ...
  <div class="box-header">
    ...
    <a href='../pur/?mod=x3' class='btn btn-primary btn-s'>
      ...
      <tbody>
        ...
        $sql="select if(t_it_po_cx=t_it_po,'Cancelled','') status_po,a.app,a.id,pono,podate,supplier,
          ...
          (select group_concat(distinct jo_no) jo_no,ac.kpno,ac.styleno,poit.id_jo,poit.id_po,ms.supplier buyer,count(*) t_it_po,
            ...
            tmpbpb.tqtybpb from po_item_dev poit 
        ...
        { if ($data['tqtybpb']>=$data['tqtypo']) 
          ...
          echo "
            ...
            { echo "<td><a href='?mod=x3ea&id=$data[id]'
...
<div class="box">
  ...
  <div class="box-header">
    ...
    <h3 class="box-title">PO Development Detail</h3>
    ...
    <table id="examplefix" class="display responsive" style="width:100%">
      ...
      <tbody>
        ...
        { if($jenis_item=="P")
          ...
          { $cek=flookup("acm.price","jo_det_dev jod inner join so_dev on jod.id_so=so_dev.id 

              inner join act_development_oth acm on so_dev.id_cost=acm.id_act_cost ",
          ...
          { $cek=flookup("acm.price","jo_det_dev jod inner join so_dev on jod.id_so=so_dev.id 
              ...
              inner join act_development_mat acm on so_dev.id_cost=acm.id_act_cost ",
