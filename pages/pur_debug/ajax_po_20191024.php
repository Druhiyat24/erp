          ...
          { $id=$data['id_item'].":".$data['id_jo'];
            ...
            echo "<tr>";
              ...
              echo "<td>
                ...
                <input type ='text' style='width:70px;' name ='itemcostbts[$id]' class='costbtsclass'value='$sisacost'>
                </td>"; 
              ...
              <td>
                <input type ='text' style='width:70px;' name ='itemprice[$id]' class='form-control priceclass' 
                  value='$price_cs' onchange='calc_amt_po()'>
                <input type ='text' style='width:70px;' name ='itemtotamt[$id]' class='totamtclass'>
