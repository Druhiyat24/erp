				...
				<div class="box type" >
					<div id="formBs" class='box'>
						<div class='box-body'>
                            ...
                            <div class="col-md-3"> <!-- sini -->
                                <div class='form-group'>
                                    <label>Tipe Jurnal</label>
                                    <select class='form-control select2' id='txttipe_jurnal' style='width: 100%;' name='txttipe_jurnal'>
                                        <option selected="selected" value="">-- Pilih Tipe Jurnal --</option>
                                        <?php 
                                        foreach($journal_type as $jtype => $jtype_value) {
                                      
										echo "<option value='{$jtype}'>";
                                        echo $jtype_value;
                                         echo "</option>";
                            ...
                            <div class="col-md-3">
                                <div class='form-group'>
                                    ...
                                    foreach($posting_flag as $post_flag => $post_flag_value) {
										...
										echo "<option value='{$post_flag}'>";
                                        echo $post_flag_value;
                                         echo "</option>";
                                    }
                                    ?>
                                </select>
	...
	<table style="width:100%;font-size:11px; border-collapse: collapse; outline: none; border: none;">
		...
		<thead>
			...
			<tr>
				...
				<th style="font-size: 16px; border-collapse: collapse; border: none;" colspan="14"><strong>Laporan Jurnal</strong></th>
				...
				<div class="box-body" style="font-size: 9pt;" >
					<table id="laporan_jurnal" class="table table-condensed table-bordered" style="border:1px solid #000000 !important">
						<thead>
                          ...
                          <th style="background-color: #ffffff; text-align: center;">Periode</th>
                          <th style="background-color: #ffffff; text-align: center;">Nomor Jurnal</th>
                          <th style="background-color: #ffffff; text-align: center;">Tanggal Jurnal</th>
                          <th style="background-color: #ffffff; text-align: center;">ID COA</th>
                          <th style="background-color: #ffffff; text-align: center;">Nama COA</th>
                          <th style="background-color: #ffffff; text-align: center;">Debit</th>
                          <th style="background-color: #ffffff; text-align: center;">Kredit</th>
                          <th style="background-color: #ffffff; text-align: center;">Keterangan</th>
                          <th style="background-color: #ffffff; text-align: center;">ID Cost Center</th>
                          <th style="background-color: #ffffff; text-align: center;">Nama Cost Center</th>
