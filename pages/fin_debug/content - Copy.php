...
*/
    ...
    case "rimutpilok":
        ...
        include "lap_rincian_mutasi_piutang_lokal.php";        
    ...
    case "lapemlok": //
        ...
        //include "LaporanPembelian/LapPembelianLokalPage.php";        
    ...
    case "realSO": //
        ...
        include "LaporanPenjualan/lap_realisasi_sales_order.php";        

        break; 

    case "pantaureturj": //

        include "LaporanPenjualan/pantauan_retur_penjualan.php";        

        break; 

    case "rincjlok": //

        include "LaporanPenjualan/rincian_penjualan_lokal.php";        

        break; 

    case "rincjeks": //

        include "LaporanPenjualan/rincian_penjualan_ekspor.php";        

        break; 

    case "rekjlok": //

        include "LaporanPenjualan/rekap_penjualan_lokal.php";        

        break; 

    case "rekjeks": //

        include "LaporanPenjualan/rekap_penjualan_ekspor.php";        

        break; 

    case "retpotj": //

        include "LaporanPenjualan/lap_retur_dan_pot_penjualan.php";        
