...
/* new pph*/
	...
	WHERE AP.v_source = 'KB' AND AP.is_deleted = 'N' GROUP BY AP.v_nojournal,AP.v_listcode
	UNION ALL
...
LEFT JOIN
(masterpterms PT) ON  PPPO.id_terms = PT.id
 WHERE AP.v_source = 'PO' AND AP.is_deleted = 'N' GROUP BY AP.v_listcode) MASTER GROUP BY MASTER.v_listcode ORDER BY MASTER.v_listcode DESC
	";
