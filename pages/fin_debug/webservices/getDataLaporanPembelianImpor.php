...
FROM (SELECT mi.goods_code
                ...
                , b.curr
				, b.id_jo
				, if(b.curr='IDR',(b.price*b.qty),((b.price*b.qty)*ifnull(mr.rate,0)))dpp_idr
				, if(b.curr='USD',(b.price*b.qty),'0')dpp
                ...
                #WHERE 1=1 AND (fjh.date_journal >='2020-01-01' AND fjh.date_journal <='2020-02-29' ) AND fjh.fg_post='2' AND fjh.type_journal='2' AND ms.area='I'
