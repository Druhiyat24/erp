...
SELECT 	
	...
	)OK WHERE OK.date_journal IS NOT NULL AND OK.area ='L' AND OK.date_journal >='{$d_from}' AND OK.date_journal <='{$d_to}'
...
OR X.type_journal               	LIKE'%".$searchValue."%'
OR X.reff_dokumen               	LIKE'%".$searchValue."%'
OR X.no_journal_pengurangan     	LIKE'%".$searchValue."%'
...
OR X.date_reff                  	LIKE'%".$searchValue."%'
...
OR X.tambah_pembelian_usd       	LIKE'%".$searchValue."%'
OR X.tambah_pembelian_idr       	LIKE'%".$searchValue."%'
OR X.penambahan_lain_usd        	LIKE'%".$searchValue."%'
OR X.penambahan_lain_idr        	LIKE'%".$searchValue."%'
OR X.pengurangan_lain_usd       	LIKE'%".$searchValue."%'
OR X.pengurangan_lain_idr       	LIKE'%".$searchValue."%'
OR X.pengurangan_retur_usd      	LIKE'%".$searchValue."%'
OR X.pengurangan_retur_idr      	LIKE'%".$searchValue."%'
OR X.pengurangan_pembayaran_usd 	LIKE'%".$searchValue."%'
OR X.pengurangan_pembayaran_idr 	LIKE'%".$searchValue."%'
)
";
}
...
$colomn = "		 
	...
	,X.tgl_inv
	,X.rate
	,X.tambah_pembelian_usd
	,X.tambah_pembelian_idr
	,X.penambahan_lain_usd
	,X.penambahan_lain_idr
	,X.pengurangan_lain_usd
	,X.pengurangan_lain_idr
	,X.pengurangan_retur_usd
	,X.pengurangan_retur_idr
	,X.pengurangan_pembayaran_usd
...
"type_journal"=>htmlspecialchars($row['type_journal']),
"reff_dokumen"=>htmlspecialchars($row['reff_dokumen']),
"no_journal_pengurangan"=>htmlspecialchars($row['no_journal_pengurangan']),
...
"date_reff"=>htmlspecialchars($row['date_reff']),
...
"d_pib"=>htmlspecialchars("N/A"),
"nomor_pib"=>htmlspecialchars("N/A"),
"rate"=>htmlspecialchars($row['rate']),
"payment_voucher"=>htmlspecialchars("N/A"),
"payment_voucher_date"=>htmlspecialchars("N/A"),
"ket_pengurangan"=>htmlspecialchars("N/A"),
"tambah_pembelian_usd"=>htmlspecialchars(number_format($row['tambah_pembelian_usd'], 2, '.', ',')),
"tambah_pembelian_idr"=>htmlspecialchars(number_format($row['tambah_pembelian_idr'], 2, '.', ',')),
"penambahan_lain_usd"=>htmlspecialchars(number_format($row['penambahan_lain_usd'], 2, '.', ',')),
"penambahan_lain_idr"=>htmlspecialchars(number_format($row['penambahan_lain_idr'], 2, '.', ',')),
"pengurangan_lain_usd"=>htmlspecialchars(number_format($row['pengurangan_lain_usd'], 2, '.', ',')),
"pengurangan_lain_idr"=>htmlspecialchars(number_format($row['pengurangan_lain_idr'], 2, '.', ',')),
"pengurangan_retur_usd"=>htmlspecialchars(number_format($row['pengurangan_retur_usd'], 2, '.', ',')),
"pengurangan_retur_idr"=>htmlspecialchars(number_format($row['pengurangan_retur_idr'], 2, '.', ',')),
"pengurangan_pembayaran_usd"=>htmlspecialchars(number_format($row['pengurangan_pembayaran_usd'], 2, '.', ',')),
"diskon_idr"=>htmlspecialchars(number_format(0, 2, '.', ',')),
"diskon_usd"=>htmlspecialchars(number_format(0, 2, '.', ',')),
"pengurangan_pembayaran_idr"=>htmlspecialchars(number_format($row['pengurangan_pembayaran_idr'], 2, '.', ','))
   );
}
## Response
$response = array(
