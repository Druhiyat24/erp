  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <table id="examplelaporanaging" rules="all" class="" style="font-size:12px;" >
...
FROM (SELECT
    ...
    WHERE a.debit > 0 AND d.invno IS NOT NULL AND a.id_coa NOT IN('15204','15207') 
    AND f.id_supplier IS NOT NULL  
    GROUP BY d.invno)X 
          GROUP BY X.invno 
