...
$akses = flookup("F_L_AR_KAR_PIU","userpassword","username='$user'");
						...
						<div class="panel-body row">
							...
							<div class="col-md-3">
								...
								<div class='form-group'>
									...
									<select class="select2" name="namacoa" style='width: 500px;'>

										<?php 

										$sql = "SELECT id_coa, nm_coa FROM mastercoa WHERE v_normal='D' AND id_coa <= '13599' and id_coa >= '13000' AND fg_posting!='0'  ORDER BY id_coa ASC";
										...
										{ 
											...
											echo "<option value='".$data['id_coa']."-".$data['nm_coa']."' ".$selected.">".$data['id_coa']." - ".$data['nm_coa']."</option>"; 
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<input type="hidden" name="mod" value="lappiutang" />
...
<div class="container-fluid">
	...
	<section class="content">
			...
			<div class="box-body">
				...
				<!-- 		<table class="display responsive" style="width:100%;font-size:11px; border-collapse: collapse; outline: none; border: none;"> -->
					...
					<table style="width:100%;font-size:11px; border-collapse: collapse; outline: none; border: none;">
						...
						<table id="examplefix" class="table table-bordered table-condensed" style="width:100%;font-size:12px;overflow: scroll;" border="1">
							...
							<tbody>
								...
								if(isset($_GET['submit'])) {
									...
									ON fjh.id_journal = fjhd.v_idjournal LEFT JOIN masterrate mr ON mr.tanggal = fjh.date_journal 							

									WHERE fjd.id_coa= '".$idcoa1x[0]."' ".$sql3." ORDER BY fjd.dateadd, fjd.id_journal ASC";						
		...
		//convert kurs berdasarkan nilai rate terkahir
									...
									$sqlusd = "SELECT curr,rate FROM masterrate WHERE curr = 'USD' AND tanggal >= '".$period."' AND tanggal <= '".$periodto."'
		...
		//for($i=1;$i<10;$i++)
			...
			//echo "test";
										...
										<tr>
											...
											<td><?php echo fd_view($data['dateadd'])?></td>
											...
											<td><?php echo number_format($data['rate'] ,0,',','.') ; ?></td>

											<td style='text-align: right'><?php echo number_format($debitidr ,0,',','.') ; ?></td>

											<td style='text-align: right'><?php echo number_format($kreditori,0,',','.') ; ?></td>
								...
								<tr>
									...
									<td style="text-align: right;" colspan="6"><b>TOTAL MUTASI<b></th>
