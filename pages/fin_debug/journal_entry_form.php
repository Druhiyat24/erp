            ...
            <div class='row'>
                <div class='col-md-3'>
                    <div class='form-group'>
                        ...
                        <input type='text' id='periodpicker' class='form-control' name='period'
                    ...
                    <div class='form-group'>
                        ...
                        <select id='type_journal' class='form-control select2' name='type_journal'>
                            ...
                            <?php foreach(Config::$journal_type as $_id=>$_v):?>
                                <option value="<?=$_id?>" <?=(@$row->type_journal==$_id) ? 'selected':''?> ><?=$_v?></option>
                            <?php endforeach;?>
                        </select>
                    </div>
                </div>
                 <div class='col-md-3'>
                     ...
                     <div class='form-group'>
                         ...
                         <input type='text' id='datepicker1' class='form-control' name='date_journal'
