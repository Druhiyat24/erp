...
function GenerateTable(from,to){
	table = $('#laporan_jurnal').DataTable( {
	  ...
	  "lengthMenu": [[10, 25, 50, 999999999], [10, 25, 50, "All"]],
        ...
        "ajax":  "webservices/getDataLaporanMutasiDPdanCBD.php?from="+from+"&to="+to,
        "columns": [
		//tgl_bukti
        {
			"data":           "tgl_bukti",
        ...
        //qty_po
        {
            "data":           "qty_po", className: "right",
        } ,
        //up_po
        {
            "data":           "up_po", className: "right",
        } ,
        //total_price_po
        {
            "data":           "total_price_po", className: "right",
        } ,
        //tgl_inv
        {
            "data":           "tgl_inv",
        ...
        //qty_bpb
        {
            "data":           "qty_bpb", className: "right",
        } ,
        //up_bpb
        {
            "data":           "up_bpb", className: "right",
        } ,
        //total_price_bpb
        {
            "data":           "total_price_bpb", className: "right",
        } ,
        //bpbdate
        {
            "data":           "bpbdate",
        ...
        //debit
        {
            "data":           "debit", className: "right",
        } ,
        //credit
        {
            "data":           "credit", className: "right",
        } ,
        //saldo
        {
            "data":           "saldo", className: "right",
        } ,
