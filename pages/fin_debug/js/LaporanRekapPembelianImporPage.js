...
table = $('#laporan_jurnal').DataTable( {
	...
	'serverMethod': 'post',
		...
		//vendor_cat
		{
			"data":           "curr", className: 'dt-body-right'
		} ,	
		...
		//dpp
		{
			"data":           "dpp_idr", className: 'dt-body-right'
		} ,			  
		//bea masuk
		{
			"data":           "bm", className: 'dt-body-right'
		} ,		
		//pph22
		{
			"data":           "pph22", className: 'dt-body-right'
		} ,		
		...
		//total_idr
		{
			"data":           "total_idr", className: 'dt-body-right'
		}
