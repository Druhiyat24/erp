	...
	table = $('#laporan_jurnal').DataTable( {
      ...
      'ordering': false,
	   ...
	   "lengthMenu": [[999999999], ["All"]],
        ...
        "ajax":  "webservices/getDataLaporanRincianMutasiPiutangLokal.php?from="+from_+"&to="+to_,
        "columns": [
		//id_coa
        {
			"data":           "id_coa",/* 
 		...
 		//retur
        {
 		...
 		//pengurangan_lain_lain_usd
        {
			"data":           "pengurangan_lain_lain_usd",
			"className" : "right",/*
             "render":        function (data) {
							return decodeURIComponent(data.nm_costcenter);
                            } */
