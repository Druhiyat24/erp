...
{	echo "Mutation Sewing - Steam Page"; }


else if ($mod=="MUT_SEW_FORM")
{	echo "Mutation Sewing - Steam Form"; }


else if ($mod=="MUT_QC_FIN_PAGE")
{	echo "Mutation Qc Final - Packing Page"; }


else if ($mod=="MUT_QC_FIN_FORM")
{	echo "Mutation Qc Final - Packing Form"; }
...
{	echo "Reject Qc Sewing Page"; }


else if ($mod=="REJ_QC_SEW_FORM")
{	echo "Reject Qc Sewing Form";}


else if ($mod=="REJ_QC_FIN_PAGE")
{	echo "Reject Qc Final Page"; }


else if ($mod=="REJ_QC_FIN_FORM")
{	echo "Reject Qc Final Form";}


else if ($mod=="REJ_QOT_PAGE")
{	echo "Reject Qotiti Page"; }
...
{	echo "Mutation DC Set-Sewing Page"; }

else if ($mod=="MUT_DC_SET_FORM")
{	echo "Mutation DC Set-Sewing Form"; }
