					...
					SELECT Y.id_cost FROM(
						...
						FROM(	
							...
							,B.qty_reject
								...
								INNER JOIN(SELECT id_qotiti_out_header,sum(ifnull(rpr,0)) qty_reject FROM prod_qotiti_out_detail WHERE rpr IS NOT NULL GROUP BY id_qotiti_out_header)B ON A.id_qotiti_out_header = B.id_qotiti_out_header
