...
//echo $row['n_post'];
	...
	$button .="<a href='../prod/excelMarkerEntry.php?url=$row[id_mark_entry]&cost=$row[id]&color=$row[color]' target='_blank' style='color: #3c8dbc;' title='Excel' class='btn btn-sm'><i class='fa fa-file-excel-o'></i></a>";
