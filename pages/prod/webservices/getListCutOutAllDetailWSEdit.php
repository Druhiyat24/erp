...
$table = "(
	...
	SELECT 
		...
		(cut_old.tot_qty_cut_out - cut_new.qty_cut_out) AS before_cumulative
	FROM (
	...
	LEFT JOIN (
		{$sql_balance}
	) AS cut_old ON cut_old.id_so_det = cut_new.id_so_det 
	AND cut_old.id_panel = cut_new.id_panel 
	AND cut_old.id_item = cut_new.id_item 
	AND cut_old.lot = cut_new.lot
