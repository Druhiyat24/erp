...
public function connect()
	...
	public function get($id_cost,$color,$id_url){
		...
		$q = "SELECT 
			...
			AND med.id_group_det = '{$id_group_det_first}' AND med.id_item ='{$id_item}' AND med.id_panel='{$id_panel}'
		...
		$sql_end = "SELECT 
					...
					WHERE med.id_cost='{$id_cost}' AND med.color = '{$color}' AND med.id_item ='{$id_item}' AND med.id_panel='{$id_panel}'
					GROUP BY med.size
					ORDER BY med.id_mark_detail ASC
		";
