...
/* 		$_str = "<input type='checkbox' onclick='check_uncheck(this)' checked class='{$_attr}[]' data-bppbno='{$bppbno_req}' data-id='".$_attr."__".$id_reff."' >"; */
			...
			if($akses == "1"){
				$_str .= "<a href='?mod={$mod_form}&id_sew_steam_out_header={$__data["id_sew_steam_out_header"]}&cr=is_edit' ><i class='fa fa-pencil'> </i></a>";
			}
			...
			if($akses == "1"){
				$_str .= "<a href='?mod={$mod_form}&id_sew_steam_out_header={$__data["id_sew_steam_out_header"]}&cr=is_view' ><i class='fa fa-eye'> </i></a>";
			}						
		}
		return $_str;
	}			
