...
/* 		$_str = "<input type='checkbox' onclick='check_uncheck(this)' checked class='{$_attr}[]' data-bppbno='{$bppbno_req}' data-id='".$_attr."__".$id_reff."' >"; */
	...
	public function get_main_query($from,$to,$id_buyer,$status){
		...
		$_get_query  = sql_summary_from_so($from,$to,$id_buyer,$status);
		$_sql ="(
			{$_get_query}
		)X";  
/*    echo $_sql;
die();    */
	...
	public function populasi_kolom(){
		return array(
			...
			"2" =>"qty_so",
			"3" =>"tot_qty_cut_out",
			"4" =>"balance_qty_cut_out",
			"5" =>"tot_qty_cut_num",
			"6" =>"balance_qty_cut_num",
			"7" =>"tot_qty_cut_qc",
			"8" =>"balance_qty_cut_qc",
			"9" =>"tot_qty_sec_in",
			"10" =>"balance_sec_in",
			"11" =>"tot_qty_sec_out",
			"12" =>"balance_sec_out",
			...
			"14" =>"balance_sec_qc",
			"15" =>"tot_qty_dc_join",
			"16" =>"balance_qty_dc_join",
			"17" =>"tot_qty_dc_set",
			"18" =>"balance_qty_dc_set",
			"19" =>"tot_qty_sew_in",
			"20" =>"balance_qty_sew_in",
			"21" =>"tot_qty_sew_out",
			"22" =>"balance_qty_sew_out",
			"23" =>"tot_qty_sew_qc_in",
			"24" =>"balance_qty_sew_qc_in",
			"25" =>"tot_qty_sew_qc_out",
			"26" =>"balance_qty_sew_qc_out",
			"27" =>"tot_qty_steam_out",
			"28" =>"balance_steam_output",
			"29" =>"tot_qty_qc_final_in",
			"30" =>"balance_qc_final_input",
			"31" =>"tot_qty_qc_final_out",
			"32" =>"balance_qc_final_output",
			"33" =>"tot_qty_packing",
			"34" =>"balance_packing",
			"35" =>"tot_qty_mat_dec",
			"36" =>"balance_met_det",
			...
			"41" =>"tot_shp",
			"42" =>"balance_shp",
			"43" =>"balance_qty_mut_sew_qc_out",
			"44" =>"tot_qty_mut_sew_qc_out",
			"45" =>"tot_qty_steam_in",
			"46" =>"balance_steam_input",
			"47" =>"balance_qotiti",
			"48" =>"tot_qty_qotiti",
			"49" =>"balance_mut_qotiti",
			"50" =>"tot_qty_mut_qc_fin_out",
			"51" =>"tot_qty_mut_dc_set",
			"52" =>"balance_mut_dc_set",
			"53" =>"nm_buyer"		
		);
