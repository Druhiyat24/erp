...
class getListData {
	...
	public function get($id_cost,$color,$id_url,$id_item,$id_panel,$sequence){
		...
		$sql_group = "SELECT 
				...
				med.id_group_det,
				s.id_jo,
				IFNULL(srn.id_number, 0) AS id_number
			...
			LEFT JOIN (
				...
				GROUP BY srd.id_number
			) AS srn ON srn.id_mark_entry = meg.id_mark_entry
			AND srn.color = meg.color 
			AND srn.id_panel = med.id_panel
			AND srn.id_item = med.id_item
			AND srn.id_group_det = med.id_group_det
		...
		while($rowG = mysql_fetch_array($stmt_group)){
			...
			while($row3 = mysql_fetch_array($stmt_3)){
				...
				$table .="<td  style='text-align: center;'>
							<input type='number' onkeyup='handleKeyUp(this);' name='ratio' id='ratio_".$_id_md."_".$sequence."' class='form-control scroll-th' value=".$_ratio." style='
							min-width: 100px;
							text-align: center;
							margin-left: auto;
							margin-right: auto;
			...
			if($rowG['id_number'] == '0'){
				$table .="<td style='text-align: center' rowspan='3'>
					...
					onclick='remove(".'"'.$_group_id.'&'.$rowG['id_panel'].'&'.$rowG['id_item'].'"'.")'>
			...
			$table .="<input type='number' name='spread' id='spread_".$rowG['id_group']."_".$sequence."' onkeyup='handleKeyUp(this);' class='form-control' value=".$rowG['spread']." 
					style='
					max-width: 69px;
					text-align: center;
					float: right;
		...
		while($rowG2 = mysql_fetch_array($stmt_group2)){
			...
			$table .="<td style='text-align: center;'>
					<input type='number' name='yds' id='yds_".$rowG2['id_group']."_".$sequence."' onkeyup='handleKeyUp(this);' class='form-control' value=".$rowG2['unit_yds']." 
					style='
					width: 30%;
					text-align: center;
					margin-left: auto;
			...
			$table .="<td style='text-align: center;'>
					<input type='number' name='inch' id='inch_".$rowG2['id_group']."_".$sequence."' onkeyup='handleKeyUp(this);' class='form-control' value='".$rowG2['unit_inch']."' 
					style='
					width: 30%;
					text-align: center;
					margin-left: auto;
		...
		$table .="<td style='text-align: center;'>
				<input type='number' onkeyup='handleKeyUp(this)' name='gsm' id='gsm_".$sequence."' class='form-control' value=".$rowgg['gsm']." style='
				width: 30%;
				text-align: center;
				margin-left: auto;
				margin-right: auto;
		...
		$table .="<td style='text-align: center;'>
				<input type='number' onkeyup='handleKeyUp(this)' name='width' id='width_".$sequence."' class='form-control' value=".$rowgg['width']." style='
				width: 30%;
				text-align: center;
				margin-left: auto;
				margin-right: auto;
		...
		$table .="<td style='text-align: center;'>
				<input type='number' onkeyup='handleKeyUp(this)' name='allow' id='allow_".$sequence."' class='form-control' value=".$rowgg['allowance']." style='
				width: 30%;
				text-align: center;
				margin-left: auto;
				margin-right: auto;
		...
		$table .="<td style='text-align: center;'>
				<input type='number' onkeyup='handleKeyUp(this)' name='bcg' id='bcg_".$sequence."' class='form-control' value=".$rowgg['b_cons_kg']." style='
				width: 30%;
				text-align: center;
				margin-left: auto;
				margin-right: auto;
