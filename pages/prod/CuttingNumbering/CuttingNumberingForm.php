...
<div class="box">
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="col-md-5">
                    <label>Cutting Numbering</label>
                </div>
                <div class="col-md-7">
                    <input type="text" id="cutNum" class="form-control form" value="" readonly>
                </div>
            </div>
...
<div class="box boxxer">
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-md-12">
                <table id="tbl_cut_num" class="table-bordered table-striped" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center;background-color:#FFFFFF">Qty Reject</th>
                            <th style="text-align: center;background-color:#FFFFFF">Qty Number</th>
