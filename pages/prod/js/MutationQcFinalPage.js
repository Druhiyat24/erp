...
function GenerateTable() {
	table = $("#List").DataTable({
		...
		"ajax": {
			"url": "webservices/getListMutQcFinal.php?mod="+$populasi_id_url.mod,
			"type": "POST"
		},
		"columns": [
			//description
			{
				...
				"render": function (data) {
					console.log(data);
					return decodeURIComponent(data.no_mut_qc_fin);
				},
				"className": "center"
			},
			{
...
function addNew_() {
	// alert("ok");
	window.location = "./?mod=MUT_QC_FIN_FORM&cr=is_add";
}
