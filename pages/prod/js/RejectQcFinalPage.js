...
function GenerateTable() {
	table = $("#List").DataTable({
		...
		"ajax": {
			"url": "webservices/getListRejQcFinal.php?mod="+$populasi_id_url.mod,
			"type": "POST"
		},
		"columns": [
			//description
			{
				...
				"render": function (data) {
					console.log(data);
					return decodeURIComponent(data.no_rej_qc_fin);
				},
				"className": "center"
			},
			{
...
function addNew_() {
	// alert("ok");
	window.location = "./?mod=REJ_QC_FIN_FORM&cr=is_add";
}
