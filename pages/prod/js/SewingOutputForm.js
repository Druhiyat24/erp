...
function error_css(_table,_row,_color){
	$(_table[_row]).css("background-color",_color);
	setTimeout(function(){
		$(_table[_row]).css("background-color","white");
	},3000)
}
...
function Save() {
	...
	//$(getTable[0]).css("background-color","red");
