...
function GenerateTable() {
	table = $("#List").DataTable({
		...
		"ajax": {
			"url": "webservices/getListQcAuditBuyer.php?mod="+$populasi_id_url.mod,
			"type": "POST"
		},
		"columns": [
			//description
			{
				...
				"render": function (data) {
					console.log(data);
					return decodeURIComponent(data.no_finishing_qc_audit);
				},
				"className": "center"
			},
			{
...
function addNew_() {
	// alert("ok");
	window.location = "./?mod=QC_A_Form&cr=is_add";
}
