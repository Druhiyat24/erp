...
function GenerateTable() {
	table = $("#List").DataTable({
		...
		"ajax": {
			"url": "webservices/getListMetalDetector.php?mod="+$populasi_id_url.mod,
			"type": "POST"
		},
		"columns": [
			//description
			{
				...
				"render": function (data) {
					console.log(data);
					return decodeURIComponent(data.no_finishing_metal_detector);
				},
				"className": "center"
			},
			{
...
function addNew_() {
	// alert("ok");
	window.location = "./?mod=Met_Dec_Form&cr=is_add";
}
