...
<div class="box list"></div>
       <table rules="all" id="laporan" class="" style="width:100%;font-size:12px">
          <thead>
			<tr border=1>
				<th rowspan="4" style="text-align: center;background-color:#ffffff;border:1px solid #000000">Buyer</th>
				...
				<th colspan="18" style="text-align: center;background-color:#ffffff;border:1px solid #000000">Cutting</th>
				<th colspan="22" style="text-align: center;background-color:#ffffff;border:1px solid #000000">Sewing</th>
			...
			<!-- Cutting Out -->
				...
				<th colspan="6" style="text-align: center;background-color:#ffffff;border:1px solid #000000">Distributin Center</th>
			<!-- Sewing -->	
				<th colspan="4" style="text-align: center;background-color:#ffffff;border:1px solid #000000">Sewing</th>				
				<th colspan="6" style="text-align: center;background-color:#ffffff;border:1px solid #000000">Qc</th>	
				<th colspan="4" style="text-align: center;background-color:#ffffff;border:1px solid #000000">Steam</th>
				<th colspan="8" style="text-align: center;background-color:#ffffff;border:1px solid #000000">Qc Final</th>
			...
			<tr border=1>
				...
				<th colspan="2" style="text-align: center;background-color:#ffffff;border:1px solid #000000">Mut. To Sewing</th>
				...
				<th colspan="2" style="text-align: center;background-color:#ffffff;border:1px solid #000000">In</th>
				<th colspan="2" style="text-align: center;background-color:#ffffff;border:1px solid #000000">Out</th>		
				<th colspan="2" style="text-align: center;background-color:#ffffff;border:1px solid #000000">Mut. To Steam</th>

				<th colspan="2" style="text-align: center;background-color:#ffffff;border:1px solid #000000">In</th>
				<th colspan="2" style="text-align: center;background-color:#ffffff;border:1px solid #000000">Out</th>
				<th colspan="2" style="text-align: center;background-color:#ffffff;border:1px solid #000000">In</th>
				<th colspan="2" style="text-align: center;background-color:#ffffff;border:1px solid #000000">Out</th>
			<th colspan="2" style="text-align: center;background-color:#ffffff;border:1px solid #000000">Qotiti Out</th>						
				<th colspan="2" style="text-align: center;background-color:#ffffff;border:1px solid #000000">Mut. To Packing</th>
