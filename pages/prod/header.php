                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                $akses = $rsU['dc_set_page'];
                                if ($akses=="1") { echo "<li><a href='?mod=MUT_DC_SET_PAGE'>Mutation Distribution Center Set</a></li>"; }								
                                ?>
                            </ul>
                        <li>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-submenu">
                                    ...
                                    <ul class="dropdown-menu">
									   ...
									   if ($akses=="1") { echo "<li><a href='?mod=11WP'>QC Output</a></li>"; }
										 $akses = $rsU['PROD_REJ_QC_SEW_P'];
									   if ($akses=="1") { echo "<li><a href='?mod=REJ_QC_SEW_PAGE'>Reject Qc Sewing</a></li>"; }	
										 $akses = $rsU['PROD_MUT_SEW_P'];
									   if ($akses=="1") { echo "<li><a href='?mod=MUT_SEW_PAGE'>Mutation Sewing - Steam</a></li>"; }									   
                                        ?>
                                    </ul>
                                </li>
                                <li class="dropdown-submenu">
                                    ...
                                    <ul class="dropdown-menu">
                                        <?php 
										$akses = $rsU['PROD_STE_IN_P'];
										if ($akses=="1") { echo "<li><a href='?mod=STEAM_IN_PAGE'>Steam Input</a></li>"; }										
                                ...
                                <li class="dropdown-submenu">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        $akses = $rsU['PROD_REJ_QC_FIN_P'];
										if ($akses=="1") { echo "<li><a href='?mod=REJ_QC_FIN_PAGE'>Reject Qc Final</a></li>"; }	
                                        $akses = $rsU['PROD_QOT_OUT_P'];
										if ($akses=="1") { echo "<li><a href='?mod=QOT_OUT_PAGE'>Qotiti</a></li>"; }			
                                        $akses = $rsU['PROD_REJ_QOT_P'];
										if ($akses=="1") { echo "<li><a href='?mod=REJ_QOT_PAGE'>Reject Qotiti</a></li>"; }			
                                        $akses = $rsU['PROD_MUT_QC_FIN_P'];
										if ($akses=="1") { echo "<li><a href='?mod=MUT_QC_FIN_PAGE'>Mutation Qc Final - Packing</a></li>"; }												
                                        ?>
                                    </ul>
                                </li>
                            </ul>
