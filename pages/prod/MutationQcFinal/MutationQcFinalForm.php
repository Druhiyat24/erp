    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-8">
                    <input type="text" disabled id="no_mut_qc_fin" class="form-control form" placeholder="(Auto)">
                </div>			
	        ...
	        <div class="col-md-6">
               ...
               <div class='col-md-3'>
                ...
                <a type='submit' name='cancel' onclick="my_back('../prod/?mod=SHP_Page')" class='btn btn-warning'>Back</a>
            </div>     
        </div>
                ...
                <table id="table_detail" class="table-bordered" style="width:100%">
                    <thead>
                        <tr>
							...
							<th style="background-color:#FFFFFF">Qty Qotiti</th>
							<th style="background-color:#FFFFFF">Tot. Qty Transfered To Packing</th>
							<th style="background-color:#FFFFFF">Balance</th>
							<th style="background-color:#FFFFFF">Ready Qty Transfer</th>
							<th style="background-color:#FFFFFF">Qty Transfer Ready </th>
                        </tr>
                    </thead>
                </table>
            </div>
