...
<div class="box">
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="col-md-4">
                    <label>Sewing Input Number</label>
                </div>
                <div class="col-md-8">
                    <input type="text" disabled id="no_sew_in" class="form-control form" placeholder="(Auto)">
                </div>			
	        ...
	        <div class="col-md-6">
               ...
               <div class='col-md-3'>
                ...
                <a type='submit' name='cancel' onclick="my_back('../prod/?mod=8WP')" class='btn btn-warning'>Back</a>
            </div>     
        </div>
                ...
                <table id="table_detail" class="table-bordered" style="width:100%">
                    <thead>
                        <tr>
							...
							<th style="background-color:#FFFFFF">Qty DC Out</th>
							<th style="background-color:#FFFFFF">Tot. Qty Sew In</th>
							<th style="background-color:#FFFFFF">Qty Transfer To Sewing</th>
							<th style="background-color:#FFFFFF">Qty Input</th>
							<th style="background-color:#FFFFFF"><input type="checkbox" onclick="all_check(this)"></th>
                        </tr>
                    </thead>
                </table>
            </div>
