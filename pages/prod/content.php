...
else if ($mod=="STEAM_IN_PAGE")
{	include "SteamInput/HeaderPage.php"; }


else if ($mod=="STEAM_IN_FORM")
{	include "SteamInput/HeaderForm.php"; }


else if ($mod=="MUT_SEW_PAGE")
{	include "MutationSewing/HeaderPage.php"; }


else if ($mod=="MUT_SEW_FORM")
{	include "MutationSewing/HeaderForm.php"; }


else if ($mod=="MUT_QC_FIN_PAGE")
{	include "MutationQcFinal/HeaderPage.php"; }


else if ($mod=="MUT_QC_FIN_FORM")
{	include "MutationQcFinal/HeaderForm.php"; }


else if ($mod=="QOT_OUT_PAGE")
{	include "QotitiOutput/HeaderPage.php"; }


else if ($mod=="QOT_OUT_FORM")
{	include "QotitiOutput/HeaderForm.php"; }


else if ($mod=="REJ_QC_SEW_PAGE")
{	include "RejectQcSewing/HeaderPage.php"; }


else if ($mod=="REJ_QC_SEW_FORM")
{	include "RejectQcSewing/HeaderForm.php"; }


else if ($mod=="REJ_QC_FIN_PAGE")
{	include "RejectQcFinal/HeaderPage.php"; }


else if ($mod=="REJ_QC_FIN_FORM")
{	include "RejectQcFinal/HeaderForm.php"; }


else if ($mod=="REJ_QOT_PAGE")
{	include "RejectQotiti/HeaderPage.php"; }


else if ($mod=="REJ_QOT_FORM")
{	include "RejectQotiti/HeaderForm.php"; }


else if ($mod=="MUT_DC_SET_PAGE")
{	include "MutationDcSet/HeaderPage.php"; }

else if ($mod=="MUT_DC_SET_FORM")
{	include "MutationDcSet/HeaderForm.php"; }
