...
<div class="box">
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="col-md-4">
                    <label>No Steam In</label>
                </div>
                <div class="col-md-8">
                    <input type="text" disabled id="no_steam_in" class="form-control form" placeholder="(Auto)">
                </div>			
	        ...
	        <div class="col-md-6">
               ...
               <div class='col-md-3'>
                ...
                <a type='submit' name='cancel' onclick="my_back('../prod/?mod=STEAM_IN_PAGE')" class='btn btn-warning'>Back</a>
            </div>     
        </div>
                ...
                <table id="table_detail" class="table-bordered" style="width:100%">
                    <thead>
                        <tr>
							...
							<th style="background-color:#FFFFFF">Qty Mut. Sewing</th>
							<th style="background-color:#FFFFFF">Tot. Qty Steam In</th>
							<th style="background-color:#FFFFFF">Qty Transfer to Steam</th>
