...
<div class="box">
    <div class="box-header">
        <h3 class="box-title">List Reject Qc Sewing</h3>
        <button type="submit" class="btn btn-primary" onclick="addNew_()"><i class="fa fa-plus"></i>&nbsp;New</button>
    </div>

    <div class="box-body">
        <table id="List" class="table-bordered table-striped" style="width: 100%">
            <thead>
                <tr>
                    <th style="text-align: center">No Reject Qc Sewing</th>
