...
<div class="box">
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="col-md-4">
                    <label>No Qotiti</label>
                </div>
                <div class="col-md-8">
                    <input type="text" disabled id="no_qotiti_out" class="form-control form" placeholder="(Auto)">
                </div>			
                ...
                <table id="table_detail" class="table-bordered" style="width:100%">
                    <thead>
                        <tr>
							...
							<th style="background-color:#FFFFFF">Qty Qc Final Out</th>
							<th style="background-color:#FFFFFF">Tot. Qotiti Out</th>
							<th style="background-color:#FFFFFF">Balance</th>
							<th style="background-color:#FFFFFF">Qty Input</th>
							<th style="background-color:#FFFFFF">Qty Reject</th>
                        </tr>
                    </thead>
                </table>
            </div>
