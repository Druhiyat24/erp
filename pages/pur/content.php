...
{	include "po_draft_edit_new.php"; }

else if ($mod=="33x")

{	include "po_edit_new.php"; }
...
{   include "trans_post_dev.php"; }
	...
	include "lap_gen_req.php";
}
else if($mod=="lap_gen_req_exc"){
	include "lap_gen_req_exc.php";
}
else if($mod=="draft_po_global_create"){
	include "po_global_create.php";
}
else
