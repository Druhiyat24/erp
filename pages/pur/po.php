...
//	  {
  ...
  { <?php echo "window.location.href='../pur/?mod=3ea&id=$id_po';"; ?>
      ...
      <form method='post' name='form' action='s_po.php?mod=<?php echo $mod; ?>' onsubmit='return validasi()'>
        ...
        <div class='col-md-3'>          
          ...
          <div class='form-group'>
            ...
            <select class='form-control select2' style='width: 100%;' name='txtcurr' onchange='getJOList()'>
                ...
                <select class='form-control select2' <?=disabled ?> id="triger_ppn" style='width: 100%;' onchange="$('#ppn_nya').val(this.value)" name='tax_nya'>
                  ...
                  <?php 
                    ...
                    $sql = "select percentage isi,concat(kriteria,' ',percentage, ' %') tampil
                      ...
                      from mtax where category_tax = 'PPN' and percentage = '11'";
...
-->
 ...
 <div class="box-body" style="font-size: 9pt;" >
                ...
                <table id="list_po" class="table table-condensed table-bordered" style="border:1px solid #000000 !important">
