...
$id_po=$_GET['id'];
$rs=mysql_fetch_array(mysql_query("select * from po_header where id='$id_po'"));
$pono=$rs['pono'];
$notes=$rs['notes'];
...
# COPAS ADD
?>
<form method='post' name='form' action='s_po_notes.php?mod=3L&id=<?php echo $id_po;?>' onsubmit='return validasi()'>
  <div class='box'>
    <div class="box-header">
      <h3 class="box-title">Update PO Notes</h3>
    </div>
    <div class='box-body'>
      <div class='row'>
        <div class='col-md-3'>
