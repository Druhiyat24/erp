...
if (isset($_GET['dest'])) {
  ...
  header("Content-Disposition: attachment; filename=lap_mcc.xls"); //ganti nama sesuai keperluan 
...
<body class="hold-transition skin-purple layout-top-nav fixed">
  ...
  <script>
    ...
    $(document).ready(function() {
      var table = $('#examplemcc').DataTable({
        scrollY: "300px",
        scrollX: true,
        scrollCollapse: true,
        paging: false,
  ...
  <script type="text/javascript" src="../../plugins/jQuery/1.10.11/js/jquery.dataTables.min.js"></script>
  <script type="text/javascript" src="../../plugins/jQuery/1.10.20/js/dataTables.bootstrap.min.js"></script>

  <link rel="stylesheet" type="text/css" href="../../plugins/jQuery/1.10.20/css/jquery.dataTables.min.css" />
  <link rel="stylesheet" type="text/css" href="../../plugins/buttons/1.6.1/css/buttons.dataTables.min.css" />

  <script type="text/javascript" src="../../plugins/ajax/libs/jszip/2.5.0/jszip.min.js"></script>
  <!-- <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.36/pdfmake.min.js"></script>
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.36/vfs_fonts.js"></script> -->
  <script type="text/javascript" src="../../plugins/jQuery/1.10.20/js/jquery.dataTables.min.js"></script>
  <script type="text/javascript" src="js/dataTables.buttons.min.js"></script>
  <!-- <script type="text/javascript" src="https://cdn.datatables.net/1.10.20/js/jquery.dataTables.min.js"></script> -->
  <script type="text/javascript" src="../../plugins/buttons/1.6.1/js/buttons.flash.min.js"></script>
  <script src="js/CustomDatatable.js"> </script>
  <!--<script type="text/javascript" src="https://cdn.datatables.net/buttons/1.6.1/js/buttons.html5.min.js"></script>-->
  <script type="text/javascript" src="../../plugins/buttons/1.6.1/js/buttons.print.min.js"></script>
