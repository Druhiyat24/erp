...
{ echo "<div class='box'>";
    echo "<div class='box-body'>";
      ...
      { echo "<form method='post' name='form' action='?mod=12&mode=Detail_In' onsubmit='return validasi()'>"; }
        ...
        <div class='col-md-3'>
          <div class='form-group'>
            ...
            $sql = "select id_supplier isi, supplier tampil from 
              mastersupplier where tipe_sup='S' order by supplier asc";
            echo "<select class='form-control select2' style='width: 100%;' 
              name='txtsupplier'>";
          ...
          <div class='form-group'>
            <label>Buyer</label>";
            $sql = "select id_supplier isi, supplier tampil from 
              mastersupplier where tipe_sup='C'  order by supplier asc";
            echo "<select class='form-control select2' style='width: 100%;' 
              name='txtbuyer'>";
