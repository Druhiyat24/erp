    ...
    <table id="examplefix" class="display responsive" style="width:100%">
      ...
      <tbody>
        ...
        # QUERY TABLE
          ...
          echo "<td>$data[kode_contents]</td>";
          echo "<td>$data[nama_contents]</td>";
          echo "<td><a href='../master/?mod=$mod&mode=$mode&id=$data[id]' $tt_ubah </a></td>";
				  echo "
          <td>
            <a href='d_cont.php?mod=$mod&mode=$mode&id=$data[id]' $tt_hapus";?> 
              onclick="return confirm('Apakah anda yakin akan menghapus ?')"><?php echo $tt_hapus2."
            </a>
          </td>";
          echo "
            <td>
              <a href='dea_cont.php?mod=$mod&mode=$mode&id=$data[id]' data-toggle='tooltip' title='Inactive'";?> 
                onclick="return confirm('Apakah anda yakin akan men non aktifkan ?')"><?php echo "<i class='fa fa-ban'></i>
              </a>
            </td>";
          echo "</tr>";
