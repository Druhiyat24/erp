...
// $tglprawal = date('Y-m-d');
// $tglprakhir = date('Y-m-d');

// if (isset($_POST['submitfilter']))
// {
//   $tglprawal = $_POST['tglprawal'];
//   $tglprakhir = $_POST['tglprakhir'];  
// }
...
<!-- <div class='row'>
    ...
    <div class="box-header">
      <div class='col-md-2'>                            
        <label>Tgl JO (Awal) : </label>
        <input type='date' class='form-control' id='tglprawal' name='tglprawal' placeholder='Masukkan Tgl JO Awal' value='<?php echo $tglprawal;?>' >             
      </div>
      <div class='col-md-2'>                            
        <label>Tgl JO (Akhir) : </label>
        <input type='date' class='form-control' id='tglprakhir' name='tglprakhir' placeholder='Masukkan Tgl JO Akhir' value='<?php echo $tglprakhir;?>' >             
      </div>      
      <div class='col-md-3'>
          <div>
          <br>
...
<div class="box">
  ...
  <div class="box-body">
    <form name="frmsup" method="post" action="s_upd_supp_pr.php?mod=<?php echo $mod;?>&id=<?php echo $id_jo;?>">
      <table id="MarketingTablePR"  style="width:100%">
        <thead>
          <tr>
            <th>No</th>
            <th>Item</th>
