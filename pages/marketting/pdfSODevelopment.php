...
<table width="50%">
    <tr>
        ...
        <td rowspan="7">&nbsp;&nbsp;&nbsp;<img src='upload_files/costing/<?php echo $rsh['attach_file']; ?>' width='150px' height='150px'></td>
    </tr>
    <tr>
...
<!--COSTING TABLE-->
    <tr>
        <td colspan="23" align="left" style="background-color:#292931;color:white;font-size:20px;border:0px solid #98bf21;">SALES ORDER TABLE</td>
    </tr>
    <tr>
