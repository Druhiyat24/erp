...
{	$cri = $_REQUEST['cri_item'];
	...
	if ($cri=="M")
	{	$sql = "SELECT h.id isi,concat(h.id,' - ' ,nama_group,' ',nama_sub_group,' ',nama_type,' ',nama_contents) tampil
...
{	$j_item = $_REQUEST['j_item'];
	...
	{	if ($rulebom=="All Color All Size")
		...
		echo "<table style='width: 100%;'>";
			...
			echo "<tr>"; show_roll(136,138,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(139,141,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(142,144,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(145,147,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(148,150,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(151,153,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(154,156,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(157,159,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(160,162,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(163,165,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(166,168,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(169,171,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(172,174,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(175,177,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(178,180,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(181,183,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(184,186,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(187,189,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(190,192,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(193,195,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(196,198,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(199,201,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(202,204,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(205,207,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(208,210,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(211,213,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(214,216,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(217,219,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(220,222,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(223,225,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(226,228,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(229,231,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(232,234,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(235,237,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(238,240,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(241,243,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(244,246,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(247,249,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(250,252,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(253,255,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(256,258,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(259,261,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(262,264,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(265,267,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(268,270,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(271,273,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(274,276,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(277,279,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(280,282,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(283,285,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(286,288,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(289,291,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(292,294,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(295,297,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(298,300,$crinya,$ket); echo "</tr>";
			echo "<tr>"; show_roll(301,303,$crinya,$ket); echo "</tr>";
