...
$akses = flookup("sales_order_sample","userpassword","username='$user'");
if ($akses=="0") 
...
echo "<script type='text/javascript'>
	...
	{	var buyerno = document.form.txtbuyerno.value;
		...
		var fob = document.form.txtfob.value;
 		...
 		if (buyerno == '') { document.form.txtbuyerno.focus(); swal({ title: 'PO Buyer # Tidak Boleh Kosong', $img_alert }); valid = false;}
...
<!--END COPAS ADD-->
<?php if ($id_so!="") { ?>
<form method='post' action='d_so_mul.php?mod=26&id=<?php echo $id_so;?>'>
<div class="box">
...
<div class="box">
  <div class="box-header">
    <h3 class="box-title">List Sales Order</h3>
  	<a href='../marketting/?mod=26' class='btn btn-primary btn-s'>
    ...
    <table id="examplefix3" class="display responsive" style="width:100%;font-size:10px;">
      ...
      <tbody>
        ...
        $query = mysql_query("select a.id_cost,cancel_h,a.username,a.id,so_no,buyerno,kpno,cost_no,
          ...
          where so_type='S' order by a.so_date desc"); 
        ...
        { $id=$data['id'];
          echo "<tr>";
            ...
            echo "<td>";
           		echo "<a href='?mod=26&id=$data[id]&pro=Copy'
