...
header("Content-Disposition: attachment; filename=LAPORAN COSTING vs SO GLOBAL.xls"); //ganti nama sesuai keperluan 
...
<div class="box">
  <div class="box-header">
    <h3 class="box-title">LIST DATA COSTING</h3>
  </div>
  <div>
