...
<?php 
  ...
  if (isset($_POST['submit'])) //KLIK SUBMIT
  {
    ...
    $nama_buyer = '';
    echo "<script>
    window.open ('?mod=lap_excel_cso_detail&from=$from&to=$to&dest=xls', '_blank');
    </script>";
  } else {
  }
