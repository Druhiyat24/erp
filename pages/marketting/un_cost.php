...
$akses = flookup("unlock_costing","userpassword","username='$user'");
if ($akses=="0") 
...
<script type='text/javascript'>
  ...
  { var reason = document.form.txtreason.value;
    ...
    if (costno == '') { swal({ title: 'Cost # Tidak Boleh Kosong', <?php echo $img_alert; ?> }); valid = false;}
...
echo "<div class='box'>";
  echo "<div class='box-body'>";
    echo "<div class='row'>";
      echo "<form method='post' name='form' enctype='multipart/form-data' action='s_unl_cost.php?mod=$mod' onsubmit='return validasi()'>";
        echo "<div class='col-md-3'>";
          ...
          <div class='form-group'>
            ...
            <select class='form-control select2' style='width: 100%;' name='txtid_cost'>
              <?php
                $sql = "select concat(a.id,':',a.cost_no) isi,concat(a.cost_no,' - ',a.styleno) tampil from 
                  act_costing a inner join so s on a.id=s.id_cost 
                  group by a.id";
