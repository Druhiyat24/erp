      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            $akses = $rsUser["bom_jo"];
            if ($akses=="1") 
            { echo "<li><a href='?mod=144L'><i class='fa fa-globe'></i>Bill Of Material Global</a></li>"; }
            $akses = $rsUser["update_cons_fabric"];            
            if ($akses=="1") 
            { echo "<li><a href='?mod=15LC'>Update Fabric Consumption</a></li>"; }
            $akses = $rsUser["purch_req"];
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            $akses = $rsUser["quote_inq"];
            echo "<li><a href='?mod=22Z&mode=Bahan_Baku'>Master Content</a></li>";
            $akses = $rsUser["quote_inq"];            
            if ($akses=="1") 
            ...
            $akses = $rsUser["sales_order"];
            if ($akses=="1") 
            { echo "<li><a href='?mod=28'>BOM Detail</a></li>";
              echo "<li><a href='?mod=17'>Sales Order</a></li>";
              echo "<li><a href='?mod=177'>Sales Order New</a></li>";
              echo "<li><a href='?mod=27'>Sales Order Detail</a></li>";
              echo "<li><a href='?mod=29'>Sales Order Detail Per Warna</a></li>"; }        
            if($jenis_company!="VENDOR LG")
            {echo "<li><a href='?mod=18'>Costing vs Sales Order</a></li>";
             echo "<li><a href='?mod=26'>Costing vs Sales Order Per Buyer</a></li>"; 
             echo "<li><a href='?mod=monorder'>Monitoring Order</a></li>";
			       echo "<li><a href='?mod=cekclose'>Pre-Checking Closing WS</a></li>";	
             echo "<li><a href='?mod=cekclose_bhnbaku'>Pre-Checking Closing WS Bahan Baku</a></li>"; 
             echo "<li><a href='?mod=cek_data_ws'>Checking WS</a></li>";  
            }
