...
left join masterpterms mp on so.id_terms = mp.id
...
if (mysqli_num_rows($hasil2)) {
    ...
    $isitable .='<tr>
        ...
        <td style="border-collapse: collapse; border-bottom:solid 2px #f5f5f5; padding:5px; width:25%"><p style="text-align:left;">'.$row["product_item"].' '.$row["styleno"].' ('.$row["color"].','.$row["size"].','.$row["reff_no"].')</p></td>
...
<table style="width:100%;  border-collapse: collapse;" >
    ...
    <div style="width:100%;">
    <p>'.$styleno.' '.$buyerno.'</p>
    <p>Confirm Price : '.$curr.' '.number_format($fob, 2).'</p>
    <p>Jenis SO : '.$jns_so.'</p>
    <p>Season : '.$season.'</p>
    <p>Day Terms : '.$ket_terms.'</p>
    </div>
    <table style="width:100%; border-collapse: collapse;">
        <tr>
