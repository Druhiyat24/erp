...
$id_item=$_GET['id'];
$rscs=mysql_fetch_array(mysql_query("select * from act_costing where id='$id_item'"));
...
class Model{
    ...
    public function get_report_other($act_costing_id){
        return $this->query("SELECT * FROM act_costing a INNER JOIN act_costing_oth s ON a.id=s.id_act_cost 
                             ...
                             INNER JOIN mastersupplier h ON a.id=h.Id_Supplier
                             WHERE a.id = $act_costing_id
                             ")->result();
    }
...
<table width="30%">
    ...
    <tr>
        <th class="text-center" style="background-color:#ffffff;border-bottom-color:#005ce6;text-align:right;" rowspan="2">Buyer / Brand</th>
        <th class="text-center" style="background-color:#ffffff;border-bottom-color:#005ce6;" rowspan="2"><?php echo $rsh['supplier']; ?></th>
        <th rowspan="3"><img src='upload_files/costing/<?php echo $rsh['attach_file']; ?>' width=50px></th>
    </tr>
    <tr>
        </th>
    </tr>
    <tr>
        <th class="text-center" style="background-color:#ffffff;text-align:right;">Item</th>
        <th class="text-center" style="background-color:#ffffff;"><?php echo $rsh['product_item']; ?></th>
    </tr>
    <tr>
        <th class="text-center" style="background-color:#ffffff;border-bottom-color:#005ce6;text-align:right;" rowspan="2">Planned Qtty</th>
        <th class="text-center" style="background-color:#ffffff;border-bottom-color:#005ce6" rowspan="2"><?php echo $rsh['qty']; ?></th>
    </thead>
    <tr></tr>
</table>
<table class="table produk">
    ...
    <tr>
        <th class="text-center" style="background-color:#ffffff;border-bottom-color:#ffffff" rowspan="2">FABRIC</th>
        <th class="text-center" style="background-color:#ffffff;border-bottom-color:#ffffff" rowspan="2">DESC</th>
        <th class="text-center" style="background-color:#ffffff;" colspan="13"></th>
    </tr>
    <tr>
        <th class="text-center" style="background-color:#ffffff;" colspan="13"></th>
    </tr>
    <tr>
        <th class="" style="background-color:#ffffff;border-top-color:#000000" colspan="1"></th>
        <th class="" style="background-color:#ffffff;" colspan="1"></th>
...
<table class="table produk">
    ...
    <tr>
        <th class="text-center" style="background-color:#ffffff;border-bottom-color:#ffffff" rowspan="2"><?=$acc[0]->nama_group?></th>
        <th class="text-center" style="background-color:#ffffff;border-bottom-color:#ffffff" rowspan="2">DESC</th>
        <th class="text-center" style="background-color:#ffffff;" colspan="13"></th>
    </tr>
    <tr>
    ...
    <tr>
        <th class="" style="background-color:#ffffff;border-top-color:#005ce6" colspan="1"></th>
        <th class="" style="background-color:#ffffff;" colspan="1"></th>
        <th class="text-center" style="background-color:#ffffff;">SUPPLIER</th>
        <th class="text-center" style="background-color:#ffffff;">UNIT px, IDR</th>
        <th class="text-center" style="background-color:#ffffff;">Unit Px, USD</th>
    ...
    <?php endforeach;?>
    <?php
    $totalcost_IDR += $sum['Value_IDR1'];
    $totalcost_USD += $sum['Value_USD1'];
    ?>
    <?php endif;?>
    <tr class='alt' >
...
<table class="table produk">
    ...
    <tr>
        <th class="text-center" style="background-color:#ffffff;border-bottom-color:#ffffff" rowspan="2">WORK</th>
        <th class="text-center" style="background-color:#ffffff;border-bottom-color:#ffffff" rowspan="2">DESC</th>
        <th class="text-center" style="background-color:#ffffff;" colspan="13"></th>
    </tr>
    <tr>
...
<table class="table produk">
    ...
    <tr>
        <th class="text-center" style="background-color:#ffffff;border-bottom-color:#ffffff" rowspan="2">OTHER COST</th>
        <th class="text-center" style="background-color:#ffffff;border-bottom-color:#ffffff" rowspan="2">DESC</th>
        <th class="text-center" style="background-color:#ffffff;" colspan="13"></th>
    </tr>
    <tr>
...
<table class="table produk">
    <thead>
    <tr>
        <th class="text-center" style="background-color:#ffffff;border-bottom-color:#ffffff" rowspan="2">TOTAL COST</th>
        <th class="text-center" style="background-color:#ffffff;border-bottom-color:#ffffff" rowspan="2">VAT</th>
        <th class="text-center" style="background-color:#ffffff;border-bottom-color:#ffffff" rowspan="2">IDR / USD</th>
        <th class="text-center" style="background-color:#ffffff;border-bottom-color:#ffffff" rowspan="2"></th>
        <th class="text-center" style="background-color:#ffffff;border-bottom-color:#ffffff" rowspan="2"></th>
    </tr>
    </thead>
    <tbody>
                <tr>
                <td align="center" nowrap style="background-color:;"></td>
                <td align="center" style="background-color:;"></td>
                <td align="center" style="background-color:;"></td>
                <td align="center" style="background-color:;"><?php echo number_format($totalcost_IDR) ?></td>
                <td align="center" style="background-color:;"><?php echo number_format($totalcost_USD) ?></td>
            </tr>
        <tr class='alt' >
        <td align="center" nowrap style="background-color:#ffffff;"></td>
        <td align="center" style="background-color:#ffffff;">10 %</td>
        <td align="center" style="background-color:#ffffff;">IDR / USD</td>
        <td align="center" style="background-color:#ffffff;"><?php echo number_format($VAT * $totalcost_IDR) ?></td>
        <td align="center" style="background-color:#ffffff;"><?php echo number_format($VAT * $totalcost_USD) ?></td>
    </tr>
    <tr class='alt' >
        <td align="center" nowrap style="background-color:#ffffff;">DEAL ALLOWANCE</td>
        <td align="center" style="background-color:#ffffff;">10 %</td>
        <td align="center" style="background-color:#ffffff;">IDR / USD</td>
        <td align="center" style="background-color:#ffffff;"><?php echo number_format($VAT *($VAT * $totalcost_IDR)) ?></td>
        <td align="center" style="background-color:#ffffff;"><?php echo number_format($VAT *($VAT * $totalcost_USD)) ?></td>
    </tr>
    </tbody>
</table>
<table>
