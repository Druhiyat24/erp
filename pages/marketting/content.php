...
{	case "1":
	...
	case "11":
		...
		break;
	case "CSO_Global":
		include "laporan_cso_global.php";
		break;	
	case "lap_excel_cso_global":
		include "lap_excel_cso_global.php";
		break;	
	case "lap_excel_cso_detail":
		include "lap_excel_cso_detail.php";
		break;	
	case "CSO_Detail":
		include "laporan_cso_detail.php";
		break;	
	case "11v":
	...
	case "cekclose_bhnbaku":
	  include "cek_close_ws_bhnbaku.php"; break;
	 case "vclose_bhnbaku":
	  include "view_cek_close_ws_bhnbaku.php"; break;	  
	 case "12L":
		include "ws.php"; break;
	case "12v":
		include "list_so.php";
	...
	case "14e":
		...
		case "144":
			include "bom_jo_global.php"; break;
		case "144md":
			include "bom_jo_global.php"; break;
		case "144mu":
			include "bom_jo_mul_upd_global.php"; break;
		case "144L":
			include "bom_jo_global.php"; break;
		case "144d":
			include "bom_jo_item_global.php";break;
		case "144e":
			include "bom_jo_item_ed_global.php";break;
		case "144t":
			include "bom_jo_global.php";break;	
		case "144add_c":
			include "bom_jo_global.php";break;						
	...
	case "17v":
		...
		break;
	case "177":
		include "laporan_new.php";
		break;
	case "177v":
		include "lap_so_new.php";
		break;
	case "177x":
		include "lap_so_new_excel.php";
		break;						
	case "27":
		include "laporan_detail.php";
		break;
	case "27v":
		include "lap_so_detail.php";
		break;
	case "29":
		include "laporan_detail_warna.php";
		break;
	case "29v":
		include "lap_so_detail_warna.php";
		break;					
	case "18":
	...
	case "22Z":
		include "lap_mst_cont.php"; break;		
	case "23":
	...
	case "26":
		include "lap_cost_vs_so_perbuyer.php"; break;		
	case "updsmv":
 ...
 case "12A":
  ...
  break;
   case "cek_data_ws":
  include "cek_data_ws.php";
  break;   
   case "cek_data_ws_exc":
  include "cek_data_ws_exc.php";
  break;    
  default:
