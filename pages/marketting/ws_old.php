...
$tgljoawal = date('Y-m-d');
$tgljoakhir = date('Y-m-d');

if (isset($_POST['submitfilter']))
{
  $tgljoawal = $_POST['tgljoawal'];
  $tgljoakhir = $_POST['tgljoakhir'];
}
...
<div class='row'>
    ...
    <div class="box-header">
      <div class='col-md-2'>                            
        <label>Tgl JO / Worksheet (Awal) : </label>
        <input type='date' class='form-control' id='tgljoawal' name='tgljoawal' placeholder='Masukkan Tgl JO /  Worksheet' value='<?php echo $tgljoawal;?>' >             
      </div>
      <div class='col-md-2'>                            
        <label>Tgl JO / Worksheet (Akhir) : </label>
        <input type='date' class='form-control' id='tgljoakhir' name='tgljoakhir' placeholder='Masukkan Tgl JO /  Worksheet' value='<?php echo $tgljoakhir;?>' >             
      </div>      
      <div class='col-md-3'>
          <div>
          <br>
