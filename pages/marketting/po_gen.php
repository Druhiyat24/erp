...
<script type="text/javascript">
  function getReqList()
  { var kode_dept = document.form.txtkode_dept.value;
    var html = $.ajax
    ({  type: "POST",
    ...
    <table id="examplefix" class="display responsive" style="width:100%">
      ...
      <tbody>
        ...
        $query = mysql_query("select a.app,a.id,pono,podate,supplier,
          ...
          inner join 
          (select poit.id_jo,poit.id_po,'' buyer from po_item poit group by poit.id_po) 
  ...
  <div class="box-body">
    <table id="examplefix" class="display responsive" style="width:100%">
      ...
      <tbody>
        <?php
        # QUERY TABLE
        $query = mysql_query("select l.id,reqno,itemdesc item,l.qty,l.unit,l.curr,l.price 
