...
class Model{
...

    {
        ...
        (
            ...
            ORDER BY nama_group,color,size  ) a
...
{ if ($row1['rule_bom']=="ALL COLOR ALL SIZE")
  ...
  { $fldcol="'All Color'";
    ...
    { $fldgrp=" group by l.sku,a.status,a.id_item,a.id_panel, a.notes "; }

    else

    { $fldgrp=" group by a.status,a.id_item,a.id_panel, a.notes "; }
  ...
  { $fldcol="concat('All Color - ',l.size)";
    ...
    $fldgrp=" group by a.status,a.id_item,l.size,a.id_panel, a.notes";
  ...
  { $fldcol="l.color";
    ...
    $fldgrp=" group by a.status,a.id_item,l.color,a.id_panel, a.notes";
  ...
  { #PER COLOR RANGE SIZE
    ...
    $fldgrp=" group by a.status,a.id_item,l.color,l.size,a.id_panel, a.notes";
...
{ if ($row1_pro['rule_bom']=="ALL COLOR ALL SIZE")
  ...
  { $fldcol="'All Color'";
    ...
    $fldgrp=" group by a.status,a.id_item,l.size,a.id_panel";
  ...
  { $fldcol="l.color";
    ...
    $fldgrp=" group by a.status,a.id_item,l.color,a.id_panel";
  ...
  { #PER COLOR RANGE SIZE
    ...
    $fldgrp=" group by a.status,a.id_item,l.color,l.size,a.id_panel";
