...
$jo_date_awal = isset($_GET['jo_date_awal']) ? $_GET['jo_date_awal'] : '';
$jo_date_akhir = isset($_GET['jo_date_akhir']) ? $_GET['jo_date_akhir'] : ''; 
$dest = isset($_GET['dest']) ? $_GET['dest'] : '';

// jika export ke Excel
if ($dest == 'excel') {
    header("Content-type: application/octet-stream");
    header("Content-Disposition: attachment; filename=LIST BOM GLOBAL $jo_date_awal to $jo_date_akhir.xls");
...
WHERE jo.jo_date >= '$jo_date_awal' and jo.jo_date <= '$jo_date_akhir'
