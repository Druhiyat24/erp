...
echo "<div class='box'>";
  echo "<div class='box-body'>";
    echo "<div class='row'>"; 
    	echo "<form method='post' name='form' action='?mod=23v' onsubmit='return validasi()'>";
      ...
      { echo "<div class='col-md-3'>";
        ...
        echo "</div>";
		 ...
		 echo "<div>";
          echo "<div class='form-group'>";
						echo "<label>Attach File *</label>";
						?>
      			<input type="file" name='txtattach_file' accept="image/*" onchange="loadFile(event)">
					</div>
				</div>
				<div class='col-md-3'>								
					<img src="<?php echo $nm_filex; ?>" id="output" width="270px" height="270px">	
					<script>
