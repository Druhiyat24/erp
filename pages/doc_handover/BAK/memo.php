      ...
      <form method='post' name='form1'>
        ...
        <div class='row'>
          ...
          <div class='col-md-2'>
            <div class='form-group'>
              <label>Biaya :</label>
              <input type='text' class='form-control' name='txtbiaya' onfocus="this.value=''" id='txtbiaya' autocomplete="off">
            </div>
          </div>
      ...
      <div class='row'>
        <form method='post' name='form' action='save_memo.php?mod=update_header&id_h=<?php echo $id_h; ?>'>
          ...
          <div class='col-md-7'>
            <div class='form-group'>
              <label>Invoice Vendor * :</label>
              <input type='text' class='form-control' name='inv_buyer' required value='<?php echo $inv_vendor; ?> ' placeholder='Masukkan No Invoice' readonly>
            </div>
            <div class='form-group'>
              <label>Notes :</label>
