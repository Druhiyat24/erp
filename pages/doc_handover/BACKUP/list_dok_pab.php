          ...
          <table id="examplefix" class="display responsive" style="width:100%">
            ...
            <tbody>
              ...
              $sql="select trx.jenis_dok,trx.id line_id,mi.goods_code,concat($flddesc,' ',ifnull(mi.color,''),' ',ifnull(mi.size,'')) item,
                trx.qty,trx.unit,trx.curr,trx.price,tmpjo.kpno,tmpjo.jo_no,tmpjo.styleno,trx.remark from $tbl trx inner join $tblmst mi on trx.id_item=mi.id_item 
                left join 
