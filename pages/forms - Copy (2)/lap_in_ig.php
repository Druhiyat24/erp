...
echo "<div class='box'>";
  echo "<div class='box-body'>";
    echo "<div class='row'>";
        ...
        OR $rpt=='mesin' OR $rpt=='itemgen2' OR $rpt=='gb_bahanbaku' OR $rpt=='mwipdet' OR $rpt=='mwiptot'
        OR $rpt=='hasil' OR $rpt=='hasilfg' OR $rpt=='hasilsl' OR $rpt=='hasilwip' OR $rpt=='hasilmes') 
      { echo "<form method='post' name='form' action='?mod=view_mut_ig&rptid=$rpt' onsubmit='return validasi()'>"; }
      else
     ...
     if ($rpt=="itemgen2")
        { 
          echo "<div class='form-group'>";
            echo "<label>Laporan Mutasi Item General 2 (CUTT OFF)</label>"; 
            echo "<select class='form-control select2' style='width: 100%;' name='txtparitem'>";
            $sql = "select description isi, DESCRIPTION as tampil from mapping_category where description = 'PERSEDIAAN SPAREPARTS - FACTORY SUPPLIES'"; 
