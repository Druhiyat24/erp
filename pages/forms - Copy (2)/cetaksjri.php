...
{ $head_cap = "Bukti Pengembalian Retur";

  $rsh=mysql_fetch_array(mysql_query("select a.bppbno,group_concat(distinct ac.kpno) wsno,POH.pono,
    a.invno,a.bpbdate,id_item,a.id_jo,a.qty_reject from bpb a left join jo_det jod on a.id_jo=jod.id_jo
    left join (select id, 
id_po, 
id_jo, 
id_gen, 
...
cancel from po_item where cancel != 'Y') POI ON POI.id = a.id_po_item 
  ...
  <table width="100%" style="border:none; font-size:8pt">
...
<table class='main' repeat_header="1" border="1" cellspacing="0" width="100%" 
  ...
  style="border-collapse: collapse; width:100%; font-size:7pt;">
