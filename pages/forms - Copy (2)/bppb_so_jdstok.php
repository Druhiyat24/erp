...
<form method='post' name='form' action='s_bppb_so_jdstok.php?mod=<?php echo $mod; ?>' 
          ...
          <div class='form-group'>
            ...
            <select class='form-control select2' id="my_sup" onchange='check_customer("N",this.value,"INV")' style='width: 100%;' name='txtid_supplier'>
              ...
              <?php 
                ...
                $sql = "select id_supplier isi,supplier tampil from mastersupplier where tipe_sup='C' and id_supplier = '1038' order by supplier";
...
<div class="box">
  ...
  $fldnyacri=" mid(bppbno,4,2)='FG' "; $mod2=323;
    ...
    <table id="examplefix3" class="display responsive" style="width:100%">
      ...
      <tbody>
        ...
        $sql="SELECT a.*,ac.kpno,s.styleno,s.goods_code,$fld_desc itemdesc,supplier , a.last_date_bppb,
          ...
          where $fldnyacri and a.id_so_det!='' and a.id_supplier = '1038' and bppbdate >= '$tglf' and bppbdate <= '$tglt'
