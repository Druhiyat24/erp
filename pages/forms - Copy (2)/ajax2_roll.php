...
if ($modenya == "cari_qty_bpb") {
	...
	if ($qty_over > 0 and $cek_over != "C") {
		...
		$sql = "select concat(itemdesc,' ',ifnull(color,''),' ',ifnull(size,''),' ',ifnull(add_info,'')) item,
			nomor_rak,
			case when substr(bpbno_int,1,2) = 'GK' and right(bpbno,1) = 'R' then sum(bpb.qty_temp)
			else sum(bpb.qty)
			end as qtybpb,
			bpb.unit unitbpb,konv.unit2 unitkonv,konv.qty1,konv.
			qty2,pono,supplier,ac.kpno    
			from bpb inner join mastersupplier msu on bpb.id_supplier=msu.id_supplier 
			inner join masteritem mi on bpb.id_item=mi.id_item 
			inner join (select * from jo_det group by id_jo) jod on bpb.id_jo=jod.id_jo 
...
if ($modenya == "view_list_roll" or $modenya == "view_list_detail" or $modenya == "view_list_size") {
	$crinya = $_REQUEST['cri_item'];
	if (isset($_REQUEST['sat_nya'])) {
		$defsat = $_REQUEST['sat_nya'];
	} else {
		$defsat = "";
	}
	if ($crinya != "") {
		...
		if ($modenya == "view_list_size") {
			echo "<tr>";
			show_roll_size(1, 5, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll_size(6, 10, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll_size(11, 15, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll_size(16, 20, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll_size(21, 25, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll_size(26, 30, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll_size(31, 35, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll_size(36, 40, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll_size(41, 45, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll_size(46, 50, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll_size(51, 55, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll_size(56, 60, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll_size(61, 65, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll_size(66, 70, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll_size(71, 75, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll_size(76, 80, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll_size(81, 85, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll_size(86, 90, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll_size(91, 95, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll_size(96, 100, $crinya, $ket);
			echo "</tr>";
		} else if ($modenya == "view_list_detail") {
			echo "<tr>";
			show_roll(1, 5, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll(6, 10, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll(11, 15, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll(16, 20, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll(21, 25, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll(26, 30, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll(31, 35, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll(36, 40, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll(41, 45, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll(46, 50, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll(51, 55, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll(56, 60, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll(61, 65, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll(66, 70, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll(71, 75, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll(76, 80, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll(81, 85, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll(86, 90, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll(91, 95, $crinya, $ket);
			echo "</tr>";
			echo "<tr>";
			show_roll(96, 100, $crinya, $ket);
			echo "</tr>";
		} else {
			for ($x = 1; $x <= 800; $x++) {
				echo "<tr>";
				show_roll_bpb($x, $x + 1, $crinya, $ket);
				echo "</tr>";
				$x = $x + 1;
			}
		}
...
if ($modenya == "cari_list_bpb" or $modenya == "cari_list_bpb_loc" or $modenya == "cari_list_bpb_det") {
	$crinya = $_REQUEST['cri_item'];
	if (isset($_REQUEST['mat_nya'])) {
		$crimat = $_REQUEST['mat_nya'];
	} else {
		$crimat = "";
	}
