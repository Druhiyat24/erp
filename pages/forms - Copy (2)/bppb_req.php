      ...
      <form method='post' name='form' action='s_bppb_req.php?mod=<?php echo $mod; ?>&id=<?php echo $id_req; ?>' onsubmit='return validasi()'>
        ...
        <div class='col-md-3'>
          ...
          <div class='form-group'>
            ...
            { if($logo_company=="Z") 
              ...
              $sql="select a.id isi, $tmpl tampil 
                ...
                inner join bpb on a.id=bpb.id_jo  
                group by a.id";
            }
            else
          ...
          <div class='form-group'>
                ...
                <select class='form-control select2' style='width: 100%;' name='txtidws_act'>

                  <?php 

                    $sql = "select distinct(kpno) isi, kpno tampil from act_costing 
                    
                    order by kpno asc";

                    IsiCombo($sql,'','Masukan No WS Actual');
