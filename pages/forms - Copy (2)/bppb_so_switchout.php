...
<script type="text/javascript">
  ...
  { var id_jo = $('#cboJO').val();
    ...
    ({  type: "POST",
        ...
        url: 'ajax_bppb_so_switchout.php?modeajax=view_list_jo_switchout',
...
<form method='post' name='form' action='s_bppb_so_switchout.php?mod=<?php echo $mod; ?>' 
      ...
      <div class='row'>
        ...
        <div class='col-md-3'>        
          ...
          <div class='form-group'>
            ...
            <label>Ws Tujuan</label>

            <select class='form-control select2' style='width: 100%;' name='txtwstujuan' required>
...
<div class="box">
  ...
  $fldnyacri=" mid(bppbno,4,2)='FG' "; $mod2=322;
    ...
    <table id="examplefix3" class="display responsive" style="width:100%">
      ...
      <tbody>
        ...
        $sql="SELECT a.*,ac.kpno,s.styleno,s.goods_code,$fld_desc itemdesc,supplier , a.last_date_bppb,
          if(ms.area='F' or ms.area='LINE','INTERNAL','EXTERNAL') out_to,a.confirm,if(a.switch_out='Y','On Proses','Done') switchout_status,ac1.kpno wstujuan   
          ...
          inner join act_costing ac1 on nows_switchout = ac1.id
          where $fldnyacri and a.id_so_det!='' and bppbdate >= '$tglf' and bppbdate <= '$tglt' and switch_out in ('Y','D')
        ...
        { 
            ...
            if($data['switch_out']=="Y")
            {
              $fontcol="style='color:blue;'";
            }
            else
            {
