...
if ($modenya=="cari_list_sj_ri" or $modenya=="cari_list_sj_ri_gen" or $modenya=="cari_list_sj_ri_fg")
{	$crinya = $_REQUEST['cri_item'];
	if ($crinya!="")
	{	$cridtnya=fd($crinya);
		if($modenya=="cari_list_sj_ri_fg")
		{	$crimat="a.bppbno like 'SJ-FG%' "; }
		else if($modenya=="cari_list_sj_ri_gen")
		{	$crimat="(a.bppbno like 'SJ-N%' or a.bppbno like 'SJ-M%') "; }
		else
		{	$crimat="a.bppbno not like 'SJ-FG%' and a.bppbno not like 'SJ-N%' "; }
