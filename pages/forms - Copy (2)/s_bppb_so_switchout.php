...
$txtwstujuan = nb($_POST['txtwstujuan']);
	...
	{	if ($value>0)
		{	$id_so_det=$key;
			...
			$sql = "insert into bppb (username,bppbno,bppbno_int,bppbdate,id_supplier,invno,jenis_dok,tujuan,
				...
				id_item,id_so_det,qty,unit,curr,price,switch_out,nows_switchout)
				...
				'$qty','$unit','$curr','$price','Y','$txtwstujuan')";
			insert_log($sql,$user);
...
echo "<script>
	 window.location.href='../forms/?mod=32x&mode=FG';
</script>";
?>