      ...
      <div class='row'>
        ...
        <div class='col-md-3'>
          ...
          echo "<div class='form-group'>";
            ...
            echo "<input type='text' class='form-control' name='txtbpbdate' id='datepicker2' placeholder='$cmas $caption[3]' readonly value='$bpbdate'>";
        ...
        <div class='col-md-3'>
          ...
          echo "<div class='form-group'>";
            ...
            echo "<input type='text' class='form-control' name='txtjam_masuk' id='txtjam_masuk'  
              ...
              placeholder='$cmas $c36' value='$jam_masuk'>";
          ...
          echo "<div class='form-group'>";
            ...
            echo "<input type='text' class='form-control' name='txtnomor_mobil' id='txtnomor_mobil' 
              ...
              placeholder='$cmas $c39' value='$nomor_mobil' >";
