...
<script type="text/javascript">
  ...
  {   var res_cri_item = cri_item.replace(/[+]/g,"X");
      ...
      ({  type: "POST",
          ...
          { echo "url: 'ajax.php?modeajax=cari_list_item_gen_out',"; }
        ...
        echo "<div class='col-md-3'>";
          ...
          echo "
            ...
            <div class='form-group'>
              ...
              <input ".$readonly." type='text' class='form-control' name='txtprice' id='txtprice' 
            ...
            <div class='form-group'>
              ...
              <input ".$readonly." type='text' class='form-control' name='txttotal' id='txttotal' 
...
/* 		if ($mod=="61v") {
		...
		if($mod = "62v"){
			$kondisi = " and a.bppbdate >='$tglf' and a.bppbdate <='$tglt' AND $fldnyacri AND a.bppbno_int NOT LIKE '%RO%' AND substr(a.bppbno,11,1)!='R' and ifnull(a.id_so_det,0)='0' #and ifnull(a.id_jo,0)='0'";			
		}else{
			$kondisi = " and a.bppbdate >='$tglf' and a.bppbdate <='$tglt' AND $fldnyacri  AND a.bppbno_req ='' AND a.bppbno_int NOT LIKE '%RO%' AND substr(a.bppbno,11,1)!='R' and ifnull(a.id_so_det,0)='0' #and ifnull(a.id_jo,0)='0'";			
		}
