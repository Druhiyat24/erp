      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            { $akses = $rsUser["bpb_po"];
              if ($akses=="1") {echo "<li><a href='?mod=91v&mode=Bahan_Baku'>Barang Sample</a></li>";}
              $akses = $rsUser["mnuBPB"];
              if ($akses=="1") {echo "<li><a href='?mod=bpb_global&mode=Bahan_Baku'>Bahan Baku Global</a></li>";}
              $akses = $rsUser["mnuBPB"];
              ...
              $akses = $rsUser["bpb_gen"];
              if ($akses=="1") {echo "<li><a href='?mod=26z&mode=General'>Item General (PO) (New)</a></li>";}                
              ...
              if ($akses=="1") {echo "<li><a href='?mod=23v&mode=Bahan_Baku'>QC Pass Accs</a></li>";}
              if ($akses=="1") {echo "<li><a href='?mod=23z&mode=Bahan_Baku'>QC Pass Fabric</a></li>";}
            }
            ...
            $akses = $rsUser["mnuBPBFG_so"];
            if ($akses=="1") {echo "<li><a href='?mod=31z'>$c8 (Switch In)</a></li>";}                           
            ...
            $akses = $rsUser["bpb_roll"];
             //--ADYZ BARCODE ========================================================================================
            if ($akses=="1") {echo "<li><a href='?mod=18z'>Print Barcode BPB</a></li>";}
            $akses = $rsUser["bpb_roll"];
            //----------------------------------------------------------------------------------------------              
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            { $akses = $rsUser["req_mat"];
              ...
              if ($akses=="1") {echo "<li><a href='?mod=list_bppb_req'>Permintaan Bahan Baku New</a></li>"; }
              ...
              if ($akses=="1") {echo "<li><a href='?mod=35v&mode=Bahan_Baku'>Pengeluaran $c5 (Request)</a></li>";}
              $akses = $rsUser["bppb_req"];
              if ($akses=="1") {echo "<li><a href='?mod=355&mode=Bahan_Baku'>Pengeluaran Bahan Baku (Request Barcode)</a></li>"; }			  
...
////// RMN              
              ...
              $akses = $rsUser["bppb_gen"];
              if ($akses=="1") {echo "<li><a href='?mod=61v&mode=General'>Item General (Umum)</a></li>";}
              $akses = $rsUser["bppb_gen"];
              if ($akses=="1") {echo "<li><a href='?mod=61z&mode=General'>Item General (ATK dan Sparepart)</a></li>";}   
////// RMN
            ...
            $akses = $rsUser["mnuBPPBFG_so"];
            if ($akses=="1") {echo "<li><a href='?mod=32z&mode=FG'>$c8 (SO) (New)</a></li>";}
            $akses = $rsUser["mnuBPPBFG_so"];
            if ($akses=="1") {echo "<li><a href='?mod=32y&mode=FG'>$c8 (Barang Jadi Stok)</a></li>";}            
            $akses = $rsUser["mnuBPPBFG_so"];
            if ($akses=="1") {echo "<li><a href='?mod=32x&mode=FG'>$c8 (SO) (Switch Out)</a></li>";}                             
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            echo "<li><a href='?mod=77&mode=mut_new&rptid=itemgen2'>Mutasi Itm General 2</a></li>";            
            ?>
          </ul>
        </li>
        <?php } ?>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            { if ($nm_company=="PT. Buntara Multi Industry")
              ...
              echo "<li><a href='?mod=778'>Laporan Mutasi Barang Jadi New</a></li>";
              $akses = $rsUser["mut_brgjadi_stok"];
              $cekmutbrgjdstok = flookup("username","userpassword","mut_brgjadi_stok='1'");
              if ($akses=="1")
              {
                echo "<li><a href='?mod=788&mode=mut&rptid=brgjadistok'>Barang Jadi Stok</a></li>";
              }
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            $akses = $rsUser["mut_rak"];
            if ($akses=="1") {echo "<li><a href='?mod=mr_hist'>History Mutasi Rak</a></li>";}
            $akses = $rsUser["mut_rak"];
            if ($akses=="1") {echo "<li><a href='?mod=adj_rak'>Adjustment Qty Rak</a></li>";}
            $akses = $rsUser["mut_rak"];
            if ($akses=="1") {echo "<li><a href='?mod=adj_rak_hist'>History Adjustment Qty Rak</a></li>";}
