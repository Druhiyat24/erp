    ...
    <div class="box-body">
      <table id="examplefix3" class="display responsive" style="width:100%;font-size:12px;">
        ...
        <tbody>
          <?php
          # QUERY TABLE
          $sql="SELECT brh.cancel,brh.dateinput,brh.location,brh.id,brh.bpbno,ac.kpno,mi.goods_code,mi.itemdesc,br.roll_no,
            ...
            where brh.location='Ok' and brh.dateinput >= '$tglf' and brh.dateinput <= '$tglt' 
