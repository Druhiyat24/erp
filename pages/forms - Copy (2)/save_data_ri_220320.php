...
{	$QtySJ = $_POST['itemstock'];
	...
	{	if (is_numeric($value))
	    ...
	    $sql = "insert into bpb (id_item,id_item_fg,qty,unit,curr,price,remark,jam_masuk,berat_bersih,berat_kotor,nomor_mobil,pono,id_supplier,
				invno,bcno,bcdate,bpbno,bpbdate,jenis_dok,tujuan,username,use_kite,nomor_aju,tanggal_aju,
				...
				'$txtberat_kotor','$txtnomor_mobil','$txtpono','$txtid_supplier','$txtinvno','$txtbcno','$txtbcdate','$txtrino',
				'$tgl_ri','$jenis_dok','$txttujuan','$user','1','$txtbcaju','$txttglaju','$txtkpno',
				'$txtid_gudang','$txtnomor_rak','$retur','$txtbppbno_ri','$txtbppbno_ri','$id_jo','$txtid_so_det')";
			insert_log($sql,$user);
			calc_stock($cbomat,$id_item);
	  }
	}	
	$_SESSION['msg'] = "Data Berhasil Disimpan Dengan Nomor RI : ".$txtrino;
