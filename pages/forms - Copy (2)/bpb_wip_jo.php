...
echo "<script type='text/javascript'>";
  ...
  echo "{";
    ...
    var kkbc = document.form.txtkkbc.value;
    ...
    echo "else if (status_kb == '') { swal({ title: 'Jenis Dokumen Tidak Boleh Kosong', imageUrl: $img_err });valid = false;}";
        ...
        echo "else if (kkbc == '') { swal({ title: 'Nomor KK Tidak Boleh Kosong', imageUrl: $img_err });valid = false;}";
      ...
      echo "<form method='post' name='form' action='s_bpb_wip_jo.php?mod=$mod&mode=$mode&noid=$bppbno&id=$id_line' onsubmit='return validasi()'>";
        ...
        echo "<div class='col-md-3'>";
          ...
          echo "<div class='form-group'>";
            ...
            $sql="select a.id isi,concat(a.jo_no,'|',ac.styleno,'|',$fldws) tampil 
              ...
              inner join bom_jo_item bi on a.id=bi.id_jo and 'P'=bi.status  
          ...
          echo "<div class='form-group'>";
            ...
            $sql = "select id_supplier isi,supplier tampil from mastersupplier WHERE Id_Supplier IN ('432')";
        ...
        echo "<div class='col-md-3'>";
          ...
          echo "<div class='form-group'>";
		   ...
		   echo "<option value='' disabled>Pilih Jenis Dokumen</option>";
  ...
  <div class="box-body">
    ...
    <table id="examplefix3" class="display responsive" style="width:100%">
      ...
      <tbody>
        ...
        $sql="SELECT ac.styleno stylecs,ac.kpno ws,a.*,s.goods_code,$fld_desc itemdesc,supplier,a.qty_reject, a.last_date_bpb 
          ...
          where ms.area IN('F','LINE') AND $fldnyacri and a.id_jo!='' and bpbdate >= '2023-01-01'
          ...
          echo "
            ...
            { echo "
              ...
              <td>
                ...
                <a href='?mod=WIP_INHOUSE&mode=$mode&noid=$data[bpbno]'
