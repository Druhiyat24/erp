...
<div class="box list" style="display:none"> 
	...
	<table style="width:100%;font-size:11px; border-collapse: collapse; outline: none; border: none;">
		<thead>
			...
			<tr>
				<th style="font-size: 16px; border-collapse: collapse; border: none;" colspan="14"><strong>Laporan Rincian Mutasi Hutang Dagang</strong></th>
			</tr>
			<tr>
...
<div id="formBs" class='box'>
	...
	<div id="formBs" class='box'>
		...
		<div class="box-body" style="font-size: 9pt;" >
			<table id="laporan_jurnal" class="table table-condensed table-bordered display" style="border:1px solid #000000 !important">
			<thead>
					<tr>
