...
$akses = flookup("F_P_Adjustment","userpassword","username='$_SESSION[username]'");
if ($akses=="0")
                ...
                <div class='col-md-3'>
                    <div class='form-group' style="display:none">
                     ...
                     <div class='form-group'>
                         ...
                         <input type='text' id='datepicker1' onchange="getPeriodAccounting(this)" autocomplete="off" class='form-control' name='date_journal'
                    ...
                    <!--<div class='form-group'>
                        ...
                        <select id='type_journal' class='form-control select2' name='type_journal'>
                            <option value="<? // =Config::$journal_usage['ADJUSMENT']?>" ><?=Config::$journal_type[Config::$journal_usage['ADJUSMENT']]?></option>
                        </select>
                    </div> -->
                </div>
                 <div class='col-md-3'>
