	...
	<table style="width:100%;font-size:11px; border-collapse: collapse; outline: none; border: none;">
		...
		<thead>
			...
			<tr>
				...
				<th style="font-size: 16px; border-collapse: collapse; border: none;" colspan="14"><strong>Laporan Rincian Penjualan Ekspor</strong></th>
...
<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" colspan="4">KONSUMEN</th>
<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" rowspan="2">NOMOR SO</th>
<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" rowspan="2">NOMOR PO</th>
<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" rowspan="2">NOMOR WS</th>
<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" rowspan="2">ID ORDER</th>
<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" rowspan="2">TOP</th>
<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" rowspan="2">PERIODE TAGIHAN</th>
<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" colspan="2">INVOICE</th>
<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" colspan="2">PACKINGLIST</th>
<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" colspan="2">PEB</th>
<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" colspan="2">BILL OF LADING</th>
<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" colspan="2">SURAT JALAN</th>
<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" rowspan="2">NOMOR DOKUMEN BC</th>
<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" colspan="9">DESCRIPTIONS BARANG</th>
<th style="text-align: center; background-color:#ffffff;border:1px solid #000000" rowspan="2">KETERANGAN</th>
</tr>
<tr>
...
<th style="text-align: center; background-color:#ffffff;border:1px solid #000000">NEGARA</th>
...
<th style="text-align: center; background-color:#ffffff;border:1px solid #000000">ORIGINAL CURRENCY</th>
<th style="text-align: center; background-color:#ffffff;border:1px solid #000000">KURS</th>
<th style="text-align: center; background-color:#ffffff;border:1px solid #000000">RUPIAH</th>
