...
//overlayon();
	table = $('#laporan_jurnal').DataTable( {
	  ...
	  "lengthMenu": [[10, 25, 50, 999999999], [10, 25, 50, "All"]],
        ...
        "ajax":  "webservices/getDataLaporanPembelianLokal.php?from="+from_+"&to="+to_,
 		...
 		//tgl_fp
        {
 		...
 		//unit
        {
			"data":           "unit", className: 'dt-body-right'
         } ,	
 		...
 		//usd dpp
		{
                ...
                "data":          "USD_dpp", className: 'dt-body-right'
            },	

 		//rate
		{
			
                "data":       "rate", className: 'dt-body-right'
            }, 		

 		//dpp
        {
			"data":           "dpp", className: 'dt-body-right'
         } ,	

 		//usd after ppn
		{
			
                "data":           "USD_after_ppn", className: 'dt-body-right'
            },		
  		...
  		//rate
		{
 		...
 		//ppn
        {
			"data":           "ppn", className: 'dt-body-right'
         } ,	

		//total usd after ppn
		{
			
                "data":           "total_usd_after_ppn", className: 'dt-body-right'
            },	
  		...
  		//rate
		{
 		...
 		//after_ppn
        {
			"data":           "after_ppn", className: 'dt-body-right'
         } ,			
