...
<div class="box list" style="display:none"> 
					...
					<table style="width:100%;font-size:11px; border-collapse: collapse; outline: none; border: none;">
						...
						<thead>
							...
							<tr>
								...
								<th style=" border-collapse: collapse; border: none;"><strong>LAPORAN BANK: </strong>
    ...
    <div id="formBs" class='box'>
			...
			<th style="text-align: center; background-color: #ffffff; border: 1px solid #000000;" rowspan="2">Nomor Journal</th>
			<th style="text-align: center; background-color: #ffffff; border: 1px solid #000000;" rowspan="2">Nomor Voucher</th>
			<th style="text-align: center; background-color: #ffffff; border: 1px solid #000000;" colspan="2">Chart of Account/Address</th>
			<th style="text-align: center; background-color: #ffffff; border: 1px solid #000000;" rowspan="2">No Bill Yet</th>
			<th style="text-align: center; background-color: #ffffff; border: 1px solid #000000;" colspan="2">Pihak Lawan Transaksi</th>
			<th style="text-align: center; background-color: #ffffff; border: 1px solid #000000;" rowspan="2">Nomor Faktur Pajak</th>
			<th style="text-align: center; background-color: #ffffff; border: 1px solid #000000;" rowspan="2">Nomor Invoice</th>
			<th style="text-align: center; background-color: #ffffff; border: 1px solid #000000;" rowspan="2">Kurs</th>
			<th style="text-align: center; background-color: #ffffff; border: 1px solid #000000;" colspan="2">Debit</th>
			<th style="text-align: center; background-color: #ffffff; border: 1px solid #000000;" colspan="2">Credit</th>
						<th style="text-align: center; background-color: #ffffff; border: 1px solid #000000;" colspan="2">Saldo</th>
			</tr>
			<tr>
			...
			<th style="text-align: center; background-color: #ffffff; border: 1px solid #000000;">USD</th>
			<th style="text-align: center; background-color: #ffffff; border: 1px solid #000000;">Rupiah</th>
			<th style="text-align: center; background-color: #ffffff; border: 1px solid #000000;">USD</th>
			<th style="text-align: center; background-color: #ffffff; border: 1px solid #000000;">Rupiah</th>
			<th style="text-align: center; background-color: #ffffff; border: 1px solid #000000;">USD</th>			
