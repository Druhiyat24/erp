  ...
  <!--   STATUS: <?php echo $status; ?> -->
    ...
    <table style="width:100%;font-size:10px;" border="1" >
        <tr>
            ...
            <th style="text-align: center;vertical-align: middle;">Category 6</th>
...
left join
(select no_coa,nama_coa,'' beg_balance,ind_categori1,ind_categori2,ind_categori3,ind_categori4,ind_categori6,id_ctg5 from mastercoa_sb order by no_coa asc) coa
