...
<?php
    $no_mj = base64_decode($_GET['no_mj']);
    $sqlpv = mysqli_query($conn1,"select a.no_coa,concat(c.no_coa,' ', c.nama_coa) as coa ,a.no_costcenter, d.cc_name, a.no_reff, a.reff_date,a.buyer,a.no_ws,a.curr,a.rate,a.debit,a.credit,a.keterangan from (select * from sb_memorial_journal  where no_mj = '$no_mj') a left join master_category_mj b on b.id_cmj = a.id_cmj left join mastercoa_v2 c on c.no_coa = a.no_coa left join b_master_cc d on d.no_cc = a.no_costcenter");
