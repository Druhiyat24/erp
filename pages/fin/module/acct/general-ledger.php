...
FROM
   (select no_journal,tgl_journal,keterangan,ROUND(credit * rate,2) credit_idr,ROUND(debit * rate,2) debit_idr from sb_list_journal where no_coa = '$coa_number' and tgl_journal = '$date_now' and status != 'Cancel' and debit != 0 OR no_coa = '$coa_number' and tgl_journal = '$date_now' and status != 'Cancel' and credit != 0 order by tgl_journal,id ASC) AS q1 JOIN
