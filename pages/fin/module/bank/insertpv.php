...
$query = "INSERT INTO sb_pv (no_pv,coa,no_cc,reff_doc,reff_date,deskripsi,amount,due_date,ded_add,pph,id_pph,ppn,id_ppn) 
VALUES 
...
$query2 = "delete from sb_pv_memo_temp where no_memo = '$no_ref' and user = '$user' ";
