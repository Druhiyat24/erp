...
<?php
$sql= "select * from sb_pv_h where no_pv = '$no_pv' UNIOn select * from tbl_pv_h where no_pv = '$no_pv'";
...
$sqlys = " select * from (select a.no_pv,concat(b.no_coa,' - ',b.nama_coa) as nama_coa,if(d.cc_name is null,'-',d.cc_name) cc_name, if(a.reff_doc = '','-',a.reff_doc) as reff_doc,a.reff_date,if(a.deskripsi = '','-',a.deskripsi) as deskripsi,a.amount,a.ded_add,a.due_date, (a.amount * (a.pph/100)) as pph from sb_pv a left join mastercoa_v2 b on b.no_coa = a.coa left join b_master_cc d on d.no_cc = a.no_cc where no_pv = '$no_pv' and amount != '0' OR no_pv = '$no_pv' and ded_add != '0' order by a.reff_doc asc) a
UNION
select * from (select a.no_pv,concat(b.no_coa,' - ',b.nama_coa) as nama_coa,if(d.cc_name is null,'-',d.cc_name) cc_name, if(a.reff_doc = '','-',a.reff_doc) as reff_doc,a.reff_date,if(a.deskripsi = '','-',a.deskripsi) as deskripsi,a.amount,a.ded_add,a.due_date, (a.amount * (a.pph/100)) as pph from tbl_pv a left join mastercoa_v2 b on b.no_coa = a.coa left join b_master_cc d on d.no_cc = a.no_cc where no_pv = '$no_pv' and amount != '0' OR no_pv = '$no_pv' and ded_add != '0' order by a.reff_doc asc) a";

$sqlas = "select curr from sb_pv_h where no_pv = '$no_pv' UNION select curr from tbl_pv_h where no_pv = '$no_pv'";
  ...
  <div class="header">
        ...
        <table width="100%" border="1">
            ...
            <tr>
                ...
                <td style="border-left: none;font-size: 12px;width: 38%;border-top: none;border-right: none;">
                    <?php
      					$sql3 = mysqli_query($conn2," select for_pay,ke,dari from sb_pv_h where no_pv = '$no_pv' UNION select for_pay,ke,dari from tbl_pv_h where no_pv = '$no_pv'");
            ...
            <tr>
                ...
                <td style="border-left: none;font-size: 12px;width: 38%;border-top: none;border-right: none;">
                   <?php
      					$sql3 = mysqli_query($conn2," select frm_akun from sb_pv_h where no_pv = '$no_pv' UNION select frm_akun from tbl_pv_h where no_pv = '$no_pv'");
      					$rows3 = mysqli_fetch_array($sql3);
                ...
                <td style="border-left: none;font-size: 12px; border-top: none;border-right: none;">
                    <?php
      					$sql3 = mysqli_query($conn2," select to_akun from sb_pv_h where no_pv = '$no_pv' UNION select to_akun from tbl_pv_h where no_pv = '$no_pv'");
      					$rows3 = mysqli_fetch_array($sql3);
            ...
            <tr>
                ...
                <td style="border-left: none;font-size: 12px;width: 38%;border-top: none;border-right: none;">
                     <?php
      					$sql3 = mysqli_query($conn2," select no_cek from sb_pv_h where no_pv = '$no_pv' UNION select no_cek from tbl_pv_h where no_pv = '$no_pv'");
      					$rows3 = mysqli_fetch_array($sql3);
      					$no_cek = $rows3['no_cek'];
						if ($no_cek == '') {
							echo '-'; 
                ...
                <td style="border-left: none;font-size: 12px; border-top: none;border-right: none;">
                    <?php
      					$sql3 = mysqli_query($conn2," select cek_date from sb_pv_h where no_pv = '$no_pv' UNION select cek_date from tbl_pv_h where no_pv = '$no_pv'");
      					$rows3 = mysqli_fetch_array($sql3);
            ...
            <tr>
                ...
                <td style="border-left: none;font-size: 12px;width: 38%;border-top: none;border-right: none;">
                    <?php
      					$sql3 = mysqli_query($conn2," select GROUP_CONCAT(reff_doc) as reff_doc from (select if(reff_doc = '', '-', CONCAT(' ',reff_doc)) as reff_doc from sb_pv where no_pv = '$no_pv' group by reff_doc ORDER BY id asc) b
                            UNION
                            select GROUP_CONCAT(reff_doc) as reff_doc from (select if(reff_doc = '', '-', CONCAT(' ',reff_doc)) as reff_doc from tbl_pv where no_pv = '$no_pv' group by reff_doc ORDER BY id asc) b");
      					$rows3 = mysqli_fetch_array($sql3);
            ...
            <tr>
                ...
                <td style="border-left: none;font-size: 12px;width: 38%;border-top: none;border-right: none;">
                    <?php
      					$sql3 = mysqli_query($conn2,"select GROUP_CONCAT(reff_date) as reff_date from (select if(reff_date = '1970-01-01', '-', CONCAT(' ',reff_date)) as reff_date from sb_pv where no_pv = '$no_pv' group by reff_doc ORDER BY id asc) a
                            UNION
                            select GROUP_CONCAT(reff_date) as reff_date from (select if(reff_date = '1970-01-01', '-', CONCAT(' ',reff_date)) as reff_date from tbl_pv where no_pv = '$no_pv' group by reff_doc ORDER BY id asc) a");
      					$rows3 = mysqli_fetch_array($sql3);
            ...
            <tr>
                <td style="border-right: none;font-size: 12px;border-top: none;border-bottom: none;padding-left: 10px;">
                	<?php
      					$sql3 = mysqli_query($conn2,"select max(pph) as pph from sb_pv where no_pv = '$no_pv' UNION select max(pph) as pph from tbl_pv where no_pv = '$no_pv'");
      					$rows3 = mysqli_fetch_array($sql3);
      					$pph = $rows3['pph'];
...
<br>
<?php
$sql2 = mysqli_query($conn1,"select no_pv,subtotal,adjust,pph,ppn,total from sb_pv_h where no_pv = '$no_pv' UNION select no_pv,subtotal,adjust,pph,ppn,total from tbl_pv_h where no_pv = '$no_pv'");
