...
$no_bankout=$_GET['no_bankout'];
?>

<?php
$sql= "select no_bankout,bankout_date,nama_supp,akun,reff_doc,bank,deskripsi,curr,create_by,approve_by FROM sb_b_bankout_h where no_bankout = '$no_bankout'
UNION
select no_bankout,bankout_date,nama_supp,akun,reff_doc,bank,deskripsi,curr,create_by,approve_by FROM b_bankout_h where no_bankout = '$no_bankout'";
$rs=mysqli_fetch_array(mysqli_query($conn2,$sql));

$sqlys = "select no_coa,nama_coa,nama_costcenter,reff_doc,reff_date,curr,debit,credit, keterangan from sb_list_journal where debit > 0 and no_journal = '$no_bankout' || credit > 0 and no_journal = '$no_bankout'";
