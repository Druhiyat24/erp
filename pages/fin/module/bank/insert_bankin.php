...
$sqlnkb = mysqli_query($conn2,"select max(doc_num),date,create_by,create_date from sb_bankin_arcollection where id = '$maxid'");
...
$query = "INSERT INTO sb_bankin (no_doc,id_coa,id_cost_center,buyer,no_ws,curr,t_debit,t_credit,keterangan) 
VALUES 
