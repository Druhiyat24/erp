...
<?php
$sql= "select doc_num,date,customer,akun,ref_data,bank,deskripsi,curr,create_by,approve_by FROM sb_bankin_arcollection where doc_num = '$doc_num'
UNION
select doc_num,date,customer,akun,ref_data,bank,deskripsi,curr,create_by,approve_by FROM tbl_bankin_arcollection where doc_num = '$doc_num'";
$rs=mysqli_fetch_array(mysqli_query($conn2,$sql));

$sqlys = "select no_coa,nama_coa,nama_costcenter,reff_doc,reff_date,curr,debit,credit, keterangan from sb_list_journal where debit > 0 and no_journal = '$doc_num' || credit > 0 and no_journal = '$doc_num'
UNION
select no_coa,nama_coa,nama_costcenter,reff_doc,reff_date,curr,debit,credit, keterangan from tbl_list_journal where debit > 0 and no_journal = '$doc_num' || credit > 0 and no_journal = '$doc_num'";
        ...
        <table width="100%" border="1">
            ...
            <tr>
                ...
                <td style="border-left: none;font-size: 12px;border-bottom: none;border-top: none;">
                    <?php 
                    echo date("d F Y",strtotime($rs['date']));
                    ?>
                </td>
            </tr>
            <tr>
...
<table width="100%" border="1">
        ...
        <!-- <tr>
            ...
            <tr>
                ...
                <td style="width: 1%; border-left: none;width: 13%;border-right: none;font-size: 12px;border-top: none;border-bottom: none;"></td>
                <td style="border-left: none;font-size: 12px;width: 12%;border-top: none;border-right: none;border-bottom: none;"></td>
                <td style="width: 13%; border: none;font-size: 15px"><b>Staff Bank</b></td>
                <td style="border-right: none;font-size: 12px; width: 12%; border-top: none;border-left: none;border-bottom: none;"></td>
                <td style="width: 1%; border-left: none;width: 6%;border-right: none;font-size: 12px; border-top: none;border-bottom: none;"></td>
