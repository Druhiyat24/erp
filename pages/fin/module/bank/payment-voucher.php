...
.modal-dialog {
  ...
  vertical-align: middle;
    ...
    <!-- MAIN -->    
    <div class="col p-4">
        <h4 class="text-center">LIST PAYMENT VOUCHER</h4>
<div class="box">
...
<table id="mytable" class="table table-striped table-bordered" role="grid" cellspacing="0" width="100%">
    <thead>
        <tr class="thead-dark">
            ...
            $sql = mysqli_query($conn1,"select  a.*,b.beneficiary_name from (select * from (select a.no_pv,a.pv_date,max(b.due_date) as due_date,a.curr,a.total,a.outstanding,a.status,a.no_cek,a.cek_date, a.nama_supp as pay_to,a.pay_date,a.pay_meth,a.frm_akun, a.to_akun, a.for_pay from sb_pv_h a inner join sb_pv b on b.no_pv = a.no_pv $where group by a.no_pv) a
                UNION
                select * from (select a.no_pv,a.pv_date,max(b.due_date) as due_date,a.curr,a.total,a.outstanding,a.status,a.no_cek,a.cek_date, a.nama_supp as pay_to,a.pay_date,a.pay_meth,a.frm_akun, a.to_akun, a.for_pay from tbl_pv_h a inner join tbl_pv b on b.no_pv = a.no_pv $where group by a.no_pv) a) a left join b_masterbank b on a.frm_akun = b.bank_account where beneficiary_name = 'PT Nirwana Alabare Garment'");                                                        
                while($row = mysqli_fetch_array($sql)){
...
<div class="box footer">   
        <form id="form-simpan">
           <div class="form-row col">
            ...
            $jml = 0;
            $ost = 0;
            $sql = mysqli_query($conn1,"select sum(a.total) as nominal, sum(a.outstanding) as outstanding from sb_pv_h a $where");
