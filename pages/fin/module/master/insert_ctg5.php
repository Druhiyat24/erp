...
$sqlx = mysqli_query($conn2,"select id_ctg5 FROM sb_master_coa_ctg5 where id_ctg5 = '$txt_idctg5' ");
...
if ($id_ctg5 != '') {
	$query = 'select max(id) from sb_master_coa_ctg5';
	$execute = mysqli_query($conn2,$query);
	// echo "COA Already Exist";
}else{


$query = "INSERT INTO sb_master_coa_ctg5 (id_ctg1,id_ctg2,id_ctg3,id_ctg4,id_ctg5,ind_name,eng_name) 
VALUES 
