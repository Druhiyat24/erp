<?php include '../header2.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h4 class="text-center">MASTER BANK</h4>
<div class="box">
        ...
        <div class="form-row">
            ...
            <label for="nama_supp"><b>Bank</b></label>            
              <select class="form-control selectpicker" name="nama_supp" id="nama_supp" data-dropup-auto="false" data-live-search="true">
                ...
                $sql = mysqli_query($conn2,"select distinct(bank_name) as nama_bank from b_masterbank where jurnal_sb = 'Y' order by bank_name ASC");
...
<table id="datatable" class="table table-striped table-bordered" role="grid" cellspacing="0" width="100%">
    ...
    if($nama_supp == 'ALL' and $status == 'ALL' and $curren == 'ALL'){
     $sql = mysqli_query($conn2,"select DATE_FORMAT(date_active, '%Y-%m-%d') as active_date,DATE_FORMAT(non_active_date, '%Y-%m-%d') as nonactive_date,UPPER(doc_number) as doc_number,UPPER(sob) as sob,bank_account as account, bank_name as bank,curr, deskripsi, status, create_by, create_date FROM b_masterbank where jurnal_sb = 'Y' order by id asc");
    }
    elseif ($nama_supp != 'ALL' and $status == 'ALL' and $curren == 'ALL') {            
     $sql = mysqli_query($conn2,"select DATE_FORMAT(date_active, '%Y-%m-%d') as active_date,DATE_FORMAT(non_active_date, '%Y-%m-%d') as nonactive_date,UPPER(doc_number) as doc_number,UPPER(sob) as sob,bank_account as account, bank_name as bank,curr, deskripsi, status, create_by, create_date FROM b_masterbank where jurnal_sb = 'Y' and bank_name = '$nama_supp'order by id asc");
    }
    elseif ($nama_supp == 'ALL' and $status != 'ALL' and $curren == 'ALL') {
     $sql = mysqli_query($conn2,"select DATE_FORMAT(date_active, '%Y-%m-%d') as active_date,DATE_FORMAT(non_active_date, '%Y-%m-%d') as nonactive_date,UPPER(doc_number) as doc_number,UPPER(sob) as sob,bank_account as account, bank_name as bank,curr, deskripsi, status, create_by, create_date FROM b_masterbank where jurnal_sb = 'Y' and status = '$status'order by id asc");
    }elseif ($nama_supp == 'ALL' and $status == 'ALL' and $curren != 'ALL') {
     $sql = mysqli_query($conn2,"select DATE_FORMAT(date_active, '%Y-%m-%d') as active_date,DATE_FORMAT(non_active_date, '%Y-%m-%d') as nonactive_date,UPPER(doc_number) as doc_number,UPPER(sob) as sob,bank_account as account, bank_name as bank,curr, deskripsi, status, create_by, create_date FROM b_masterbank where jurnal_sb = 'Y' and curr = '$curren'order by id asc");
    }elseif ($nama_supp != 'ALL' and $status != 'ALL' and $curren == 'ALL') {
     $sql = mysqli_query($conn2,"select DATE_FORMAT(date_active, '%Y-%m-%d') as active_date,DATE_FORMAT(non_active_date, '%Y-%m-%d') as nonactive_date,UPPER(doc_number) as doc_number,UPPER(sob) as sob,bank_account as account, bank_name as bank,curr, deskripsi, status, create_by, create_date FROM b_masterbank where jurnal_sb = 'Y' and bank_name = '$nama_supp' and status = '$status'order by id asc");
    }elseif ($nama_supp != 'ALL' and $status == 'ALL' and $curren != 'ALL') {
     $sql = mysqli_query($conn2,"select DATE_FORMAT(date_active, '%Y-%m-%d') as active_date,DATE_FORMAT(non_active_date, '%Y-%m-%d') as nonactive_date,UPPER(doc_number) as doc_number,UPPER(sob) as sob,bank_account as account, bank_name as bank,curr, deskripsi, status, create_by, create_date FROM b_masterbank where jurnal_sb = 'Y' and bank_name = '$nama_supp' and curr = '$curren'order by id asc");
    }elseif ($nama_supp == 'ALL' and $status != 'ALL' and $curren != 'ALL') {
     $sql = mysqli_query($conn2,"select DATE_FORMAT(date_active, '%Y-%m-%d') as active_date,DATE_FORMAT(non_active_date, '%Y-%m-%d') as nonactive_date,UPPER(doc_number) as doc_number,UPPER(sob) as sob,bank_account as account, bank_name as bank,curr, deskripsi, status, create_by, create_date FROM b_masterbank where jurnal_sb = 'Y' and status = '$status' and curr = '$curren' order by id asc");
    }else{
    $sql = mysqli_query($conn2,"select DATE_FORMAT(date_active, '%Y-%m-%d') as active_date,DATE_FORMAT(non_active_date, '%Y-%m-%d') as nonactive_date,UPPER(doc_number) as doc_number,UPPER(sob) as sob,bank_account as account, bank_name as bank,curr, deskripsi, status, create_by, create_date FROM b_masterbank where jurnal_sb = 'Y' and bank_name = '$nama_supp' and status = '$status' and curr = '$curren'order by id asc");
}
    while($row = mysqli_fetch_array($sql)){
    if (!empty($row)) {
    $status = $row['status']; 
