...
$sqlx = mysqli_query($conn2,"select id_ctg2 FROM sb_master_coa_ctg2 where id_ctg2 = '$txt_idctg2' ");
...
if ($id_ctg2 != '') {
	$query = 'select max(id) from sb_master_coa_ctg2';
	$execute = mysqli_query($conn2,$query);
	// echo "COA Already Exist";
}else{
$query = "INSERT INTO sb_master_coa_ctg2 (id_ctg1,id_ctg2,ind_name,eng_name) 
VALUES 
