...
if($status == "Active"){
$sql = "update sb_master_cashflow set status = 'Deactive', deactive_by = '$update_user', deactive_date = '$active_date' where id = '$id_cf'";
$execute = mysqli_query($conn2,$sql);
}else{
$sql = "update sb_master_cashflow set status = 'Active', active_by = '$update_user', active_date = '$active_date' where id = '$id_cf'";
$execute = mysqli_query($conn2,$sql);		
}
...
$sql = mysqli_query($conn1,"select a.id,b.type,b.eng_name as grup,a.eng_name as cf_name,a.status from sb_master_cashflow a inner join tbl_master_group_cf b on b.id=a.id_group");
