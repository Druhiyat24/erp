...
<body>
    ...
    header("Content-Disposition: attachment; filename=coa-category3.xls");
     ?>

    <center>
        <h4>DATA COA CATEGORY 3 <br/></h4>
    </center>
    ...
    <table style="width:100%;font-size:10px;" border="1" >
        ...
        $sql = mysqli_query($conn2,"select id_ctg3,ind_name,eng_name from sb_master_coa_ctg3 $where");
