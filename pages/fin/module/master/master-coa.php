...
.modal-dialog {
  ...
  vertical-align: middle;
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h4 class="text-center">LIST CHART OF ACCOUNT</h4>
<div class="box">
           ...
           <div class="col-md-3">
            <label for="nama_type"><b>Category 2</b></label>            
              <select style="background-color: gray;" class="form-control select2bs4" name="nama_ctg2" id="nama_ctg2" required>
                ...
                $sql = mysqli_query($conn1,"select DISTINCT ind_categori2,eng_categori2 from mastercoa_sb");
                while ($row = mysqli_fetch_array($sql)) {
                    $data = $row['ind_categori2'];
                    $id_ctg2 = $row['ind_categori2'];
                    if($row['ind_categori2'] == $_POST['nama_ctg2']){
            ...
            <label for="nama_group"><b>Category 5</b></label>            
              <select style="background-color: gray;" class="form-control select2bs4" name="nama_ctg5" id="nama_ctg5" required>
                ...
                $sql = mysqli_query($conn1,"select DISTINCT ind_categori5,eng_categori5 from mastercoa_sb");
                while ($row = mysqli_fetch_array($sql)) {
                    $data = $row['ind_categori5'];
                    $id_ctg5 = $row['ind_categori5'];
                    if($row['ind_categori5'] == $_POST['nama_ctg5']){
                        $isSelected = ' selected="selected"';
                    }else{
                        $isSelected = '';
                    }
    ...
    if($nama_ctg2 == 'ALL' and $nama_ctg5 == 'ALL' and $Status == 'ALL'){
     ...
     $where = "where ind_categori2 = '$nama_ctg2'";
    }elseif($nama_ctg2 == 'ALL' and $nama_ctg5 != 'ALL' and $Status == 'ALL'){
     $where = "where ind_categori5 = '$nama_ctg5'";
    }elseif($nama_ctg2 == 'ALL' and $nama_ctg5 == 'ALL' and $Status != 'ALL'){
     $where = "where status = '$Status'";
    }elseif($nama_ctg2 != 'ALL' and $nama_ctg5 != 'ALL' and $Status == 'ALL'){
     $where = "where ind_categori2 = '$nama_ctg2' and ind_categori5 = '$nama_ctg5'";
    }elseif($nama_ctg2 != 'ALL' and $nama_ctg5 == 'ALL' and $Status != 'ALL'){
     $where = "where ind_categori2 = '$nama_ctg2' and status = '$Status'";
    }elseif($nama_ctg2 == 'ALL' and $nama_ctg5 != 'ALL' and $Status != 'ALL'){
     $where = "where ind_categori5 = '$nama_ctg5' and status = '$Status'";
    }else{
     $where = "where ind_categori2 = '$nama_ctg2' and ind_categori5 = '$nama_ctg5' and status = '$Status'";  
    }
...
<table id="datatable" class="table table-striped table-bordered" role="grid" cellspacing="0" width="100%">
    <thead style="font-size: 12px;">
        <tr class="thead-dark">
            ...
            <th rowspan="2" style="text-align: center;vertical-align: middle;">Category 6</th>
            <th rowspan="2" style="text-align: center;vertical-align: middle;">Category 7</th>
    ...
    $sql = mysqli_query($conn1,"select * from mastercoa_sb $where");
    ...
    while($row = mysqli_fetch_array($sql)){
        ...
        echo '<tr style="font-size:11px;text-align:center;">
            ...
            <td value = "'.$row['ind_categori1'].'">'.$row['ind_categori1'].'</td>
            <td style="display: none" value = "'.$row['eng_categori1'].'">'.$row['eng_categori1'].'</td>
            <td value = "'.$row['ind_categori2'].'">'.$row['ind_categori2'].'</td>
            <td style="display: none" value = "'.$row['eng_categori2'].'">'.$row['eng_categori2'].'</td>
            <td value = "'.$row['ind_categori3'].'">'.$row['ind_categori3'].'</td>
            <td style="display: none" value = "'.$row['eng_categori3'].'">'.$row['eng_categori3'].'</td>
            <td value = "'.$row['ind_categori4'].'">'.$row['ind_categori4'].'</td>
            <td style="display: none" value = "'.$row['eng_categori4'].'">'.$row['eng_categori4'].'</td>
            <td value = "'.$row['ind_categori5'].'">'.$row['ind_categori5'].'</td>
            <td style="display: none" value = "'.$row['eng_categori5'].'">'.$row['eng_categori5'].'</td>
            <td value = "'.$row['ind_categori6'].'">'.$row['ind_categori6'].'</td>
            <td style="display: none" value = "'.$row['eng_categori6'].'">'.$row['eng_categori6'].'</td>
            <td value = "'.$row['ind_categori7'].'">'.$row['ind_categori7'].'</td>
            <td style="display: none" value = "'.$row['eng_categori7'].'">'.$row['eng_categori7'].'</td>
            <td value = "'.$row['ind_debit_direct'].'">'.$idndirdebit.'</td>
            <td style="display: none" value = "'.$row['eng_debit_direct'].'">'.$engdirdebit.'</td>
            <td value = "'.$row['ind_credit_direct'].'">'.$idndircredit.'</td>
            <td style="display: none" value = "'.$row['eng_credit_direct'].'">'.$engdircredit.'</td>
            <td value = "'.$row['ind_indirect'].'">'.$idnindir.'</td>
            <td style="display: none" value = "'.$row['eng_indirect'].'">'.$engindir.'</td>
        ...
        <h4 class="modal-title" id="Heading">FORM CREATE CASH FLOW</h4>
          ...
          <div class="form-group">
            <form id="modal-form3" method="post">
                ...
                $sql = mysqli_query("select DISTINCT type from tbl_master_group_cf",$conn1);
                while ($row = mysqli_fetch_array($sql)) {
                    $data = $row['type'];
