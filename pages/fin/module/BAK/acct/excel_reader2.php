...
function gmgetdate($ts = null){
    $k = array('day','mon','year',0);
    return(array_comb($k,explode("-",gmdate('d-m-y',is_null($ts)?time():$ts))));
    } 

// function gmgetdate($ts = null){
//     $k = array('seconds','minutes','hours','mday','wday','mon','year','yday','weekday','month',0);
//     return(array_comb($k,explode(":",gmdate('s:i:G:j:w:mm:yyyy:dd:l:F:U',is_null($ts)?time():$ts))));
//     } 
