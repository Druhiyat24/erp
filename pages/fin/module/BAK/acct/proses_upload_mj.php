...
$periode=$_GET['periode'];
            ...
            for ($i=2; $i<=$jumlah_baris; $i++){
                ...
                if($no_mj != "" && $mj_date != "" && $id_cmj != "" && $debit != "" || $no_mj != "" && $mj_date != "" && $id_cmj != "" && $credit != "")
                {
                    ...
                    mysqli_query($koneksi,"INSERT into sb_memorial_journal_temp values('','$kode_mj','$mj_date','$id_cmj', '$no_coa','$no_costcenter','$no_reff','$reff_date', '$buyer','$no_ws','$curr','$rate', '$debit','$credit','$debit_idr','$credit_idr', '$keterangan','$status','$create_user', '$create_date','','','','')");
                }
            }
