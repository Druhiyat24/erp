...
<div class="box footer">   
        ...
        <!--     <div class="input-group" >
           ...
           <div class="col-md-4">
            ...
            $sqldes = mysqli_query($conn2,"select format(sum(credit),2) as credit from sb_memorial_journal_temp");
           ...
           if($credit != '0') {
            ...
            $sqldes = mysqli_query($conn2,"select sum(credit) as credit from sb_memorial_journal_temp");
            $row = mysqli_fetch_array($sqldes);      
            $credit = isset($row['credit']) ? $row['credit'] : 0;                  
            ...
            $sqldes = mysqli_query($conn2,"select format(sum(debit),2) as debit from sb_memorial_journal_temp");
            $row = mysqli_fetch_array($sqldes);      
            ...
            $sqldes = mysqli_query($conn2,"select sum(debit) as debit from sb_memorial_journal_temp");
            $row = mysqli_fetch_array($sqldes);      
            $debit = isset($row['debit']) ? $row['debit'] : 0;                    
                echo $debit;
            ?>">
            ...
            $sqldes = mysqli_query($conn2,"select format(sum(credit_idr),2) as credit_idr from sb_memorial_journal_temp");
            $row = mysqli_fetch_array($sqldes);      
            ...
            $sqldes = mysqli_query($conn2,"select sum(credit_idr) as credit_idr from sb_memorial_journal_temp");
            $row = mysqli_fetch_array($sqldes);      
            $credit_idr = isset($row['credit_idr']) ? $row['credit_idr'] : 0;                                    
                echo $credit_idr;
             ?>">
            ...
            $sqldes = mysqli_query($conn2,"select format(sum(debit_idr),2) as debit_idr from sb_memorial_journal_temp");
            $row = mysqli_fetch_array($sqldes);      
            ...
            $sqldes = mysqli_query($conn2,"select sum(debit_idr) as debit_idr from sb_memorial_journal_temp");
            $row = mysqli_fetch_array($sqldes);      
            $debit_idr = isset($row['debit_idr']) ? $row['debit_idr'] : 0;                 
                echo $debit_idr;
             ?>">
