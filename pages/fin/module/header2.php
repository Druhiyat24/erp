    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      ...
      <li class="nav-item dropdown active">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <span class="fa fa-folder-open mr-1"> Master
        </a>
        <!-- <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Master
      </a> -->
      <div class="dropdown-menu bg-dark " aria-labelledby="navbarDropdown" style="width:230px;">
        <a href="../master/master-cash-flow.php" class="dropdown-item bg-dark text-white">
            <span class="fa fa-paperclip fa-fw"></span>
            <span class="menu-collapsed">Cash Flow</span>

        </a>
        <a href="../master/master-coa-category1.php" class="dropdown-item bg-dark text-white">
            <span class="fa fa-paperclip fa-fw "></span>
        ...
        <a href="../master/master-costcenter.php" class="dropdown-item bg-dark text-white">
            <span class="fa fa-paperclip fa-fw "></span>
            <span class="menu-collapsed">Cost Center</span>
        </a> 
        <a href="../master/master-profit-center.php" class="dropdown-item bg-dark text-white">
            <span class="fa fa-paperclip fa-fw "></span>
            <span class="menu-collapsed">Profit Center</span>
        </a>    
        <a href="../master/master-bank.php" class="dropdown-item bg-dark text-white">
            <span class="fa fa-paperclip fa-fw "></span>
            <span class="menu-collapsed">Bank</span>
        </a>   
        <!-- <a href="../master/mapping-explanation.php" class="dropdown-item bg-dark text-white">
            <span class="fa fa-paperclip fa-fw "></span>
            <span class="menu-collapsed">Mapping Explanation</span>
        </a>    -->
    </div>
</li>
...
<!-- navbar AR -->
<li class="nav-item dropdown active">
    <a href="" class="nav-link dropdown-toggle" data-toggle="dropdown"><span class="fa fa-book mr-1"> AR<span class="caret"></span></a>
    <!-- <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      AR
  </a> -->
  <div class="dropdown-menu bg-dark " aria-labelledby="navbarDropdown" style="width:250px;">
...
<li class="nav-item dropdown active">
  ...
  <div class="dropdown-menu bg-dark " aria-labelledby="navbarDropdown" style="width:270px;">
    ...
    <a href="../acct/edit-journal.php" class="dropdown-item bg-dark text-white">
        <span class="fa fa-pencil-square fa-fw "></span>
        <span class="menu-collapsed">Edit Journal</span>
    </a> 
...
<!-- <li class="nav-item dropdown active">
  ...
  <div class="dropdown-menu bg-dark " aria-labelledby="navbarDropdown" style="width:250px;">
    <a href="../tax/fiscal.php" class="dropdown-item bg-dark text-white">
        <span class="fa fa-paperclip fa-fw "></span>
...
<li class="nav-item dropdown active">
    <a href="" class="nav-link dropdown-toggle" data-toggle="dropdown"><span class="fa fa-area-chart mr-1"> Tax<span class="caret"></span></a>
    <ul class="dropdown-menu bg-dark text-white" role="menu">
        <li class="dropdown-submenu ">
          <a class="dropdown-item bg-dark text-white" href="#">
            ...
            <span class="menu-collapsed">Fiskal</span>
        </a>
        <ul class="dropdown-menu bg-dark text-white" role="menu">
            <a href="../tax/koreksi-fiscal.php" class="dropdown-item bg-dark text-white">
                <span class="fa fa-paperclip fa-fw "></span>
                <span class="menu-collapsed">Koreksi Fiskal</span>
            </a>     
            <a href="../tax/koreksi-fiscal-jurnal.php" class="dropdown-item bg-dark text-white">
                <span class="fa fa-paperclip fa-fw "></span>
                <span class="menu-collapsed">Koreksi Fiskal Per Jurnal</span>
            </a>  
        </ul>
    </li>
    <a href="../tax/financial-statement-fiskal.php" class="dropdown-item bg-dark text-white">
        <span class="fa fa-calendar fa-fw "></span>
        <span class="menu-collapsed">Financial Statement YTD</span>
    </a> 
</ul>
