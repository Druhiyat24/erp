...
$no_inv = isset($_POST['no_inv']) ? $_POST['no_inv']: null;
    ...
    $sql = mysqli_query($conn1,"select a.no_invoice,c.supplier,a.shipp,a.value,a.doc_type,b.type from sb_book_invoice a inner join tbl_type b on b.id_type = a.id_type inner join mastersupplier c on c.id_supplier = a.id_customer where no_invoice = '$no_inv'");
