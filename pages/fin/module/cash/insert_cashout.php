...
$sqlx = mysqli_query($conn2,"select max(id) as id FROM sb_tbl_log_cash where doc_num like '%RCO%' ");
$rowx = mysqli_fetch_array($sqlx);
$maxid = $rowx['id'];

$sqlnkb = mysqli_query($conn2,"select max(doc_num) from sb_tbl_log_cash where id = '$maxid'");
...
if($amount != ''){
$query = "INSERT INTO sb_c_cash_out (no_co, tgl_co, type_co, dokumen, no_coa, no_costcenter, buyer, ws, req_by, curr, amount, deskrip, status, deskrip_global, create_date, create_by,stat_pci) 
VALUES 
