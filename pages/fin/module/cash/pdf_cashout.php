...
<?php
$sql= "select no_co,tgl_co,'KAS BESAR' akun,type_co,deskrip,curr,create_by,approve_by FROM sb_c_cash_out where no_co = '$no_co'
UNION
select no_co,tgl_co,'KAS BESAR' akun,type_co,deskrip,curr,create_by,approve_by FROM c_cash_out where no_co = '$no_co'";
$rs=mysqli_fetch_array(mysqli_query($conn2,$sql));

$sqlys = "select no_coa,nama_coa,nama_costcenter,reff_doc,reff_date,curr,debit,credit, keterangan from sb_list_journal where debit > 0 and no_journal = '$no_co' || credit > 0 and no_journal = '$no_co'";
        ...
        <table width="100%" border="1">
            ...
            <tr>
                ...
                <td style="border-left: none;font-size: 12px;border-bottom: none;border-top: none;">
                    <?php 
                    echo date("d F Y",strtotime($rs['tgl_co']));
                    ?>
                </td>
            </tr>
            <tr>
