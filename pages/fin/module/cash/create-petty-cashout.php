<?php include '../header2.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h4 class="text-center">FORM PETTY CASH OUT</h4>
<div class="box">
...
<!--            <div class="col-md-3 mb-3">            
    ...
    <div class="box body">
        <div class="row">
            ...
            if ($ref_num == 'List Payment') {
                $sql = mysqli_query($conn2,"select curr,nama_supp,no_payment,tgl_payment,tgl_tempo,curr,(sum(total_kbon) - (select COALESCE(sum(amount),0) from c_petty_cashout_det where no_reff = no_payment)) as total_kbon,sum(pph_value) as pph_value, 'REG' as kode from sb_list_payment where status_int = '4' and nama_supp = '$nama_supp' and tgl_payment BETWEEN '$start_date' and '$end_date' group by no_payment
union
                ...
                '';
                    ...
                    if ($ref_num == 'List Payment'){
                         ...
                         while($row = mysqli_fetch_array($sql)){
                            ...
                            $querys = mysqli_query($conn2,"select sum(a.subtotal) as sub,sum(a.tax) as ppn from sb_kontrabon_h a inner join sb_list_payment b on b.no_kbon = a.no_kbon where b.no_payment = '$no_pay' group by b.no_payment");
