...
// echo "< -- >";
// echo $ref_date;
$sqlx = mysqli_query($conn2,"select max(id) as id FROM sb_tbl_log_cash where doc_num like '%RCI%' ");
...
if($amount != ''){
$query = "INSERT INTO sb_c_cash_in (no_ci, tgl_ci, type_ci, dokumen, no_coa, no_costcenter, buyer, ws, submit_by, curr, amount, deskrip, status,deskrip_global, create_date, create_by) 
VALUES 
