...
<?php
$sql= "select no_pco,tgl_pco,coa_akun akun,reff,deskripsi,curr,create_by,approve_by,nama_supp FROM sb_c_petty_cashout_h where no_pco = '$no_pco'
UNION
select no_pco,tgl_pco,coa_akun akun,reff,deskripsi,curr,create_by,approve_by,nama_supp FROM c_petty_cashout_h where no_pco = '$no_pco'";
...
$sqlys = "select distinct no_coa,nama_coa,nama_costcenter,reff_doc,reff_date,curr,debit,credit, keterangan from tbl_list_journal where debit > 0 and no_journal = '$no_pco' || credit > 0 and no_journal = '$no_pco'";
...
<body style=" padding-left:-5%; padding-right:-5%;">
        <table width="100%" border="1">
            ...
            <tr>
                ...
                <td style="border-left: none;font-size: 12px;border-bottom: none;border-top: none;">
                    <?php 
                    echo date("d F Y",strtotime($rs['tgl_pco']));
                    ?>
                </td>
            </tr>
            <tr>
        ...
        <table width="100%" border="1">
            ...
            <tr>
                <td style="border-right: none;font-size: 13px;width: 11%;border-top: none;border-bottom: none;">
                    Description
                </td>
                <td style="width: 1%; border-left: none;border-right: none;font-size: 12px;border-top: none;border-bottom: none;">
                    :
                </td>
                <td style="border-left: none;font-size: 12px;width: 80%;border-top: none;border-right: none;border-bottom: none;">
                    <?php 
                    echo $rs['deskripsi'];
                    ?>
                </td>
                ...
                <td style="border-right: none;font-size: 12px; width: 1%; border-top: none;border-left: none;border-bottom: none;">
                </td>
                <td style="width: 1%; border-left: none;border-right: none;font-size: 12px; border-top: none;border-bottom: none;">
                </td>
                <td style="border-left: none;font-size: 12px; border-top: none;border-right: none;border-bottom: none;">
