<?php include '../header2.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h4 class="text-center">FORM PETTY CASH IN</h4>
<div class="box">
...
<form id="form-data" method="post">
    ...
    <?php 
        ...
        echo'">
           ...
           $reff_doc = isset($_POST['reff_doc']) ? $_POST['reff_doc']: null;
            $sql = mysqli_query($conn2,"select round(sum(amount),0) as amount from sb_c_cash_out where no_co = '$reff_doc'");
            $row = mysqli_fetch_array($sql);
...
<!--            <div class="col-md-3 mb-3">            
    ...
    <div class="box body">
        ...
        echo '<table id="mytable" class="table table-striped table-bordered" cellspacing="0" width="100%" style="font-size: 12px;text-align:center;">
            ...
            if ($ref_num == 'Cash Out') {
                $sql = mysqli_query($conn2,"select a.no_co,a.tgl_co,a.no_coa,if(a.no_coa = '-','-',CONCAT(b.no_coa,' ',b.nama_coa)) as coa,a.no_costcenter, if(a.no_costcenter = '-','-',c.cc_name) as costcenter, a.buyer,a.ws,a.req_by,round(sum(a.amount)) as amount,if(a.deskrip = '','-',a.deskrip) as deskripsi from sb_c_cash_out a left join mastercoa_v2 b on b.no_coa = a.no_coa left join b_master_cc c on c.no_cc = a.no_costcenter where a.no_co = '$reff_doc'");
            }else{
                '';
            }
