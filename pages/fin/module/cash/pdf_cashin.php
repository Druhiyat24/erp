...
<?php
$sql= "select no_ci,tgl_ci,'KAS BESAR' akun,type_ci,deskrip,curr,create_by,approve_by FROM sb_c_cash_in where no_ci = '$no_ci'
UNION
select no_ci,tgl_ci,'KAS BESAR' akun,type_ci,deskrip,curr,create_by,approve_by FROM c_cash_in where no_ci = '$no_ci'";
$rs=mysqli_fetch_array(mysqli_query($conn2,$sql));

$sqlys = "select no_coa,nama_coa,nama_costcenter,reff_doc,reff_date,curr,debit,credit, keterangan from sb_list_journal where debit > 0 and no_journal = '$no_ci' || credit > 0 and no_journal = '$no_ci'";
        ...
        <table width="100%" border="1">
            ...
            <tr>
                ...
                <td style="border-left: none;font-size: 12px;border-bottom: none;border-top: none;">
                    <?php 
                    echo date("d F Y",strtotime($rs['tgl_ci']));
                    ?>
                </td>
            </tr>
            <tr>
