...
$sqlx = mysqli_query($conn2,"select max(id) as id FROM sb_c_petty_cashout_h ");
$rowx = mysqli_fetch_array($sqlx);
$maxid = $rowx['id'];

$sqlnkb = mysqli_query($conn2,"select max(no_pco),reff,create_date,create_by from sb_c_petty_cashout_h where id = '$maxid'");
...
$query = "INSERT INTO sb_c_petty_cashout_adj_det (no_pco, tgl_pco,id_coa,reff_doc,reff_date,deskripsi,t_debit,t_credit) 
VALUES 
...
$query2 = "INSERT INTO sb_c_petty_cashout_det (no_pco, tgl_pco,no_reff,reff_date,due_date,dpp,ppn,pph,total,curr, eqv_idr,amount) 
VALUES 
