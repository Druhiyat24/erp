<?php include '../header2.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h4 class="text-center">FORM LIST PAYMENT</h4>
<div class="box">
...
<form id="form-data" method="post">
        <div class="form-row">
            ...
            <?php
            $sql = mysqli_query($conn2,"select max(no_payment) from sb_list_payment where id = (select max(id) from list_payment)");
            ...
            $sql = mysqli_query($conn2,"select distinct max(tgl_kbon) from sb_kontrabon_h where nama_supp = '$nama_supp'and status = 'Approved' and balance >= 1 and tgl_kbon between '$start_date' and '$end_date' ");
            $row = mysqli_fetch_array($sql);
        ...
        ?>">
            ...
            $nama_supp = isset($_POST['nama_supp']) ? $_POST['nama_supp']: null;
            $sql = mysqli_query($conn2,"select max(b.tgl_tempo) as tgl_tempo from sb_kontrabon b inner join sb_kontrabon_h a on a.no_kbon = b.no_kbon where b.tgl_kbon between '$start_date' and '$end_date' and b.nama_supp = '$nama_supp' and b.status = 'Approved' and a.balance != '0' ");
            $row = mysqli_fetch_array($sql);
            $tgl = $row['tgl_tempo'];         
...
<!--            <div class="col-md-3 mb-3">            
    ...
    <div class="box body">
        <div class="row">
            ...
            $sql = mysqli_query($conn2,"select sb_kontrabon.no_kbon as no_kbon, sb_kontrabon.tgl_kbon as tgl_kbon, sb_kontrabon.no_bpb as no_bpb, sb_kontrabon.no_po as no_po, sb_kontrabon.tgl_bpb as tgl_bpb, sb_kontrabon.tgl_po as tgl_po, SUM(sb_kontrabon.pph_value) as pph_value, sb_kontrabon_h.total as total, sb_kontrabon.nama_supp as supplier, sb_kontrabon_h.balance as balance, sb_kontrabon.tgl_tempo as tgl_tempo, sb_kontrabon.curr as matauang, sb_kontrabon.status as status, sb_kontrabon.create_user as create_user, sb_kontrabon.no_faktur as no_faktur, sb_kontrabon.supp_inv as supp_inv, sb_kontrabon.tgl_inv as tgl_inv,sb_kontrabon_h.no_coa,sb_kontrabon_h.nama_coa from sb_kontrabon inner join sb_kontrabon_h on sb_kontrabon_h.no_kbon = sb_kontrabon.no_kbon where sb_kontrabon.tgl_kbon between '$start_date' and '$end_date' and sb_kontrabon.nama_supp = '$nama_supp' and sb_kontrabon.status = 'Approved' and sb_kontrabon_h.balance != '0' group by no_kbon");
...
<div class="box footer">   
        <form id="form-simpan">
            <div class="form-row col" style="padding-top: 15px;">
