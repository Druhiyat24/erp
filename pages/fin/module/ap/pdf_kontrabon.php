...
$sql= "select * from (select bpb.id, sb_kontrabon.no_kbon, sb_kontrabon.tgl_kbon, bpb.bpbno_int no_bpb, bpb.bpbdate tgl_bpb, bpb.pono, po_header.podate tgl_po, act_costing.kpno ws, sb_kontrabon.nama_supp supplier, masteritem.itemdesc ,IF(bpb.qty_reject IS NULL,(bpb.qty), (bpb.qty - bpb.qty_reject)) qty, IF(bpb.qty_reject IS NULL,(bpb.qty), (bpb.qty - bpb.qty_reject)) as qty1, bpb.price, IF(bpb.qty_reject IS NULL,(bpb.qty), (bpb.qty - bpb.qty_reject)) * bpb.price as subtotal, IF(bpb.qty_reject IS NULL,(bpb.qty), (bpb.qty - bpb.qty_reject)) * bpb.price as subtotal1, sb_kontrabon.tax, '0' as tax1, sb_kontrabon.tgl_tempo, sb_kontrabon.supp_inv, sb_kontrabon.no_faktur, sb_kontrabon.create_date, bpb.curr, bpb.unit uom, sb_kontrabon.pph_value, sb_kontrabon.dp_value from bpb inner join sb_kontrabon on sb_kontrabon.no_bpb = bpb.bpbno_int inner join po_header on po_header.pono = bpb.pono left JOIN jo on jo.id = bpb.id_jo left JOIN jo_det on jo_det.id_jo = jo.id left JOIN so on so.id = jo_det.id_so left JOIN act_costing on act_costing.id = so.id_cost left JOIN masteritem on masteritem.id_item = bpb.id_item where sb_kontrabon.no_kbon = '$no_kbon'
union
	select bppb_new.id, sb_kontrabon.no_kbon, sb_kontrabon.tgl_kbon, bppb_new.no_bppb as no_bpb, bppb_new.tgl_bppb as tgl_bpb, bppb_new.no_po, bppb_new.tgl_po, '' as ws, bppb_new.supplier, bppb_new.itemdesc, (- bppb_new.qty) as qty, '0' as qty4, bppb_new.price, (- bppb_new.qty * bppb_new.price) as subtotal,'0' as subtotal4,'0' as tax, (- (bppb_new.qty * bppb_new.price) * (bppb_new.tax / 100)) as tax1, sb_kontrabon.tgl_tempo, sb_kontrabon.supp_inv, sb_kontrabon.no_faktur, sb_kontrabon.create_date, bppb_new.curr, bppb_new.uom, sb_kontrabon.pph_value, sb_kontrabon.dp_value from bppb_new inner join sb_return_kb on sb_return_kb.no_bpbrtn = bppb_new.no_bppb inner join sb_kontrabon on sb_kontrabon.no_kbon = sb_return_kb.no_kbon where sb_kontrabon.no_kbon = '$no_kbon' and bppb_new.status != 'Cancel' GROUP BY bppb_new.id order by no_bpb asc,id asc) a
	UNION
	select bpb.id, kontrabon.no_kbon, kontrabon.tgl_kbon, bpb.bpbno_int no_bpb, bpb.bpbdate tgl_bpb, bpb.pono, po_header.podate tgl_po, act_costing.kpno ws, kontrabon.nama_supp supplier, masteritem.itemdesc ,IF(bpb.qty_reject IS NULL,(bpb.qty), (bpb.qty - bpb.qty_reject)) qty, IF(bpb.qty_reject IS NULL,(bpb.qty), (bpb.qty - bpb.qty_reject)) as qty1, bpb.price, IF(bpb.qty_reject IS NULL,(bpb.qty), (bpb.qty - bpb.qty_reject)) * bpb.price as subtotal, IF(bpb.qty_reject IS NULL,(bpb.qty), (bpb.qty - bpb.qty_reject)) * bpb.price as subtotal1, kontrabon.tax, '0' as tax1, kontrabon.tgl_tempo, kontrabon.supp_inv, kontrabon.no_faktur, kontrabon.create_date, bpb.curr, bpb.unit uom, kontrabon.pph_value, kontrabon.dp_value from bpb inner join kontrabon on kontrabon.no_bpb = bpb.bpbno_int inner join po_header on po_header.pono = bpb.pono left JOIN jo on jo.id = bpb.id_jo left JOIN jo_det on jo_det.id_jo = jo.id left JOIN so on so.id = jo_det.id_so left JOIN act_costing on act_costing.id = so.id_cost left JOIN masteritem on masteritem.id_item = bpb.id_item where kontrabon.no_kbon = '$no_kbon'
union
	...
	//$sql= "select bpb_new.id, sb_kontrabon.no_kbon, sb_kontrabon.tgl_kbon, bpb_new.no_bpb, bpb_new.tgl_bpb, bpb_new.pono, bpb_new.tgl_po, bpb_new.ws, bpb_new.supplier, bpb_new.itemdesc, bpb_new.qty, bpb_new.qty as qty1, bpb_new.price, bpb_new.qty * bpb_new.price as subtotal, bpb_new.qty * bpb_new.price as subtotal1, (bpb_new.qty * bpb_new.price) * (bpb_new.tax / 100) as tax, '0' as tax1, sb_kontrabon.tgl_tempo, sb_kontrabon.supp_inv, sb_kontrabon.no_faktur, sb_kontrabon.create_date, bpb_new.curr, bpb_new.uom, sb_kontrabon.pph_value, sb_kontrabon.dp_value from bpb_new inner join sb_kontrabon on sb_kontrabon.no_bpb = bpb_new.no_bpb  where sb_kontrabon.no_kbon = '$no_kbon' and bpb_new.status != 'Cancel'";


// $sql= "select bpb.id, sb_kontrabon.no_kbon, sb_kontrabon.tgl_kbon, bpb.bpbno_int no_bpb, bpb.bpbdate tgl_bpb, bpb.pono, po_header.podate tgl_po, act_costing.kpno ws, sb_kontrabon.nama_supp supplier, masteritem.itemdesc ,IF(bpb.qty_reject IS NULL,(bpb.qty), (bpb.qty - bpb.qty_reject)) qty, IF(bpb.qty_reject IS NULL,(bpb.qty), (bpb.qty - bpb.qty_reject)) as qty1, bpb.price, IF(bpb.qty_reject IS NULL,(bpb.qty), (bpb.qty - bpb.qty_reject)) * bpb.price as subtotal, IF(bpb.qty_reject IS NULL,(bpb.qty), (bpb.qty - bpb.qty_reject)) * bpb.price as subtotal1, (IF(bpb.qty_reject IS NULL,(bpb.qty), (bpb.qty - bpb.qty_reject)) * bpb.price) * (po_header.tax / 100) as tax, '0' as tax1, sb_kontrabon.tgl_tempo, sb_kontrabon.supp_inv, sb_kontrabon.no_faktur, sb_kontrabon.create_date, bpb.curr, bpb.unit uom, sb_kontrabon.pph_value, sb_kontrabon.dp_value from bpb inner join sb_kontrabon on sb_kontrabon.no_bpb = bpb.bpbno_int inner join po_header on po_header.pono = bpb.pono left JOIN jo on jo.id = bpb.id_jo left JOIN jo_det on jo_det.id_jo = jo.id left JOIN so on so.id = jo_det.id_so left JOIN act_costing on act_costing.id = so.id_cost left JOIN masteritem on masteritem.id_item = bpb.id_item where sb_kontrabon.no_kbon = '$no_kbon' union select bppb_new.id, sb_kontrabon.no_kbon, sb_kontrabon.tgl_kbon, bppb_new.no_bppb as no_bpb, bppb_new.tgl_bppb as tgl_bpb, bppb_new.no_po, bppb_new.tgl_po, '' as ws, bppb_new.supplier, bppb_new.itemdesc, (- bppb_new.qty) as qty, '0' as qty4, bppb_new.price, (- bppb_new.qty * bppb_new.price) as subtotal,'0' as subtotal4,'0' as tax, (- (bppb_new.qty * bppb_new.price) * (bppb_new.tax / 100)) as tax1, sb_kontrabon.tgl_tempo, sb_kontrabon.supp_inv, sb_kontrabon.no_faktur, sb_kontrabon.create_date, bppb_new.curr, bppb_new.uom, sb_kontrabon.pph_value, sb_kontrabon.dp_value from bppb_new inner join return_kb on return_kb.no_bpbrtn = bppb_new.no_bppb inner join sb_kontrabon on sb_kontrabon.no_kbon = return_kb.no_kbon where sb_kontrabon.no_kbon = '$no_kbon' and bppb_new.status != 'Cancel' GROUP BY bppb_new.id order by no_bpb asc,id asc";

$rs=mysqli_fetch_array(mysqli_query($conn2,$sql));

$sqll = mysqli_query($conn2,"select jml_return, jml_potong from sb_potongan where no_kbon = '$no_kbon' group by no_kbon
	UNION
	select jml_return, jml_potong from potongan where no_kbon = '$no_kbon' group by no_kbon");    
$rowl = mysqli_fetch_assoc($sqll);

$sqll12 = mysqli_query($conn2,"select sum(pph_value) as pph from sb_kontrabon where no_kbon = '$no_kbon'
union
select sum(pph_value) as pph from kontrabon where no_kbon = '$no_kbon' ");    
...
<tr>
	...
	<td align="right"><h4>
      <?php
      $sql1 = mysqli_query($conn2,"select nama_supp from sb_kontrabon where no_kbon = '$no_kbon'");
...
<!--       <td style="text-align:center;padding-top: -25px;padding-bottom: -10px;">
      <?php
      $querys = mysqli_query($conn2,"select distinct bpb_new.ws from bpb_new inner join sb_kontrabon on sb_kontrabon.no_bpb = bpb_new.no_bpb where sb_kontrabon.no_kbon = '$no_kbon'");
	...
	<td style="text-align:center;padding-top: -15px;padding-bottom: -10px;">
      <?php
      $sql1 = mysqli_query($conn2,"select create_date from sb_kontrabon where no_kbon = '$no_kbon' union select create_date from kontrabon where no_kbon = '$no_kbon'");
      $rows = mysqli_fetch_array($sql1);
	...
	<td style="text-align:center;padding-top: -15px;padding-bottom: -10px;">
      <?php
      $sql3 = mysqli_query($conn2,"select tgl_kbon from sb_kontrabon where no_kbon = '$no_kbon' UNION select tgl_kbon from kontrabon where no_kbon = '$no_kbon'");
	...
	<td style="text-align:center;padding-top: -15px;padding-bottom: -10px;">
      <?php
      $sql2 = mysqli_query($conn2,"select tgl_tempo from sb_kontrabon where no_kbon = '$no_kbon' UNION select tgl_tempo from kontrabon where no_kbon = '$no_kbon'");
	...
	<!-- <td style="text-align:center;padding-top: -15px;padding-bottom: -10px;">
      <?php
      $sql3 = mysqli_query($conn2,"select supp_inv from sb_kontrabon where no_kbon = '$no_kbon'");
	...
	<td style="text-align:center;padding-top: -15px;padding-bottom: -10px;">
      <?php
      $sql4 = mysqli_query($conn2,"select no_faktur from sb_kontrabon where no_kbon = '$no_kbon'");
...
<td style="width:1%">:</td>
		<td style="text-align:right">
			<?php
      $sqltax = mysqli_query($conn2,"select tax from sb_kontrabon_h where no_kbon = '$no_kbon' UNION select tax from kontrabon_h where no_kbon = '$no_kbon'");
...
<td style="width:1%">:</td>
	...
	<tr>
		...
		<td style="text-align:right;font-weight: bold;">
			<?php
      $sqltotal = mysqli_query($conn2,"select total from sb_kontrabon_h where no_kbon = '$no_kbon' UNION select total from kontrabon_h where no_kbon = '$no_kbon'");
	...
	<table style="page-break-inside: avoid;" cellpadding="0" cellspacing="0" border="1" width='500';>
		...
		<tr>	  
            <td style="font-size:12px;text-align:center; width: 150px;text-decoration:underline;">
              <?php
            $sql1 = mysqli_query($conn2,"select create_user from sb_kontrabon_h where no_kbon = '$no_kbon' union select create_user from kontrabon_h where no_kbon = '$no_kbon'");
            $rows = mysqli_fetch_array($sql1);
