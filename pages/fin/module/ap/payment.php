<?php include '../header2.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h4 class="text-center">LIST PAYMENT</h4>
<div class="box">
...
<table id="datatable" class="table table-striped table-bordered" role="grid" cellspacing="0" width="100%">
    ...
    if(empty($nama_supp) and empty($status) and empty($start_date) and empty($end_date)){
     $sql = mysqli_query($conn2,"(select no_payment, tgl_payment, nama_supp, no_bpb, tgl_bpb, no_po, tgl_po,no_kbon, tgl_kbon, pph_value, SUM(total_kbon) as total, SUM(outstanding) as outstanding, SUM(amount) as amount, curr, create_user, status, top, tgl_tempo, memo from sb_list_payment where tgl_payment = '$date_now'  group by no_payment)
        union
        (select no_pay as no_payment, tgl_pay as tgl_payment, supplier as nama_supp, '-' as no_bpb, '' as tgl_bpb, '-' as no_po, '' as tgl_po, '-' as no_kbon, '' as tgl_kbon, pph as pph_value, sum(total) as total,SUM(outstanding) as outstanding, sum(total) as amount,valuta as curr, '-' as create_user,`status`,'' as top,'' as tgl_tempo,'' as memo from sb_saldo_awal where no_pay not like '%LP/NAG%' and tgl_pay = '$date_now' group by no_pay)
        UNION
        (select no_payment, tgl_payment, nama_supp, no_bpb, tgl_bpb, no_po, tgl_po,no_kbon, tgl_kbon, pph_value, SUM(total_kbon) as total, SUM(outstanding) as outstanding, SUM(amount) as amount, curr, create_user, status, top, tgl_tempo, memo from list_payment where tgl_payment = '$date_now'  group by no_payment)
        union
    ...
    elseif ($nama_supp == 'ALL' and $status == 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {            
     $sql = mysqli_query($conn2,"(select no_payment, tgl_payment, nama_supp, no_bpb, tgl_bpb, no_po, tgl_po,no_kbon, tgl_kbon, pph_value, SUM(total_kbon) as total, SUM(outstanding) as outstanding, SUM(amount) as amount, curr, create_user, status, top, tgl_tempo, memo from sb_list_payment  group by no_payment)
        union
        (select no_pay as no_payment, tgl_pay as tgl_payment, supplier as nama_supp, '-' as no_bpb, '' as tgl_bpb, '-' as no_po, '' as tgl_po, '-' as no_kbon, '' as tgl_kbon, pph as pph_value, sum(total) as total,SUM(outstanding) as outstanding, sum(total) as amount,valuta as curr, '-' as create_user,`status`,'' as top,'' as tgl_tempo,'' as memo from sb_saldo_awal where no_pay not like '%LP/NAG%' group by no_pay)
        UNION
        (select no_payment, tgl_payment, nama_supp, no_bpb, tgl_bpb, no_po, tgl_po,no_kbon, tgl_kbon, pph_value, SUM(total_kbon) as total, SUM(outstanding) as outstanding, SUM(amount) as amount, curr, create_user, status, top, tgl_tempo, memo from list_payment  group by no_payment)
        union
    ...
    elseif ($nama_supp != 'ALL' and $status == 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
     $sql = mysqli_query($conn2,"(select no_payment, tgl_payment, nama_supp, no_bpb, tgl_bpb, no_po, tgl_po,no_kbon, tgl_kbon, pph_value, SUM(total_kbon) as total, SUM(outstanding) as outstanding, SUM(amount) as amount, curr, create_user, status, top, tgl_tempo, memo from sb_list_payment where nama_supp = '$nama_supp'  group by no_payment)
        union
        (select no_pay as no_payment, tgl_pay as tgl_payment, supplier as nama_supp, '-' as no_bpb, '' as tgl_bpb, '-' as no_po, '' as tgl_po, '-' as no_kbon, '' as tgl_kbon, pph as pph_value, sum(total) as total,SUM(outstanding) as outstanding, sum(total) as amount,valuta as curr, '-' as create_user,`status`,'' as top,'' as tgl_tempo,'' as memo from sb_saldo_awal where no_pay not like '%LP/NAG%' and supplier = '$nama_supp' group by no_pay)
        UNION
        (select no_payment, tgl_payment, nama_supp, no_bpb, tgl_bpb, no_po, tgl_po,no_kbon, tgl_kbon, pph_value, SUM(total_kbon) as total, SUM(outstanding) as outstanding, SUM(amount) as amount, curr, create_user, status, top, tgl_tempo, memo from list_payment where nama_supp = '$nama_supp'  group by no_payment)
        union
        (select no_pay as no_payment, tgl_pay as tgl_payment, supplier as nama_supp, '-' as no_bpb, '' as tgl_bpb, '-' as no_po, '' as tgl_po, '-' as no_kbon, '' as tgl_kbon, pph as pph_value, sum(total) as total,SUM(outstanding) as outstanding, sum(total) as amount,valuta as curr, '-' as create_user,`status`,'' as top,'' as tgl_tempo,'' as memo from saldo_awal where no_pay not like '%LP/NAG%' and supplier = '$nama_supp' group by no_pay)");
    }
    elseif ($nama_supp != 'ALL' and $status == 'ALL' and !empty($start_date) and !empty($end_date)) {
     $sql = mysqli_query($conn2,"(select no_payment, tgl_payment, nama_supp, no_bpb, tgl_bpb, no_po, tgl_po,no_kbon, tgl_kbon, pph_value, SUM(total_kbon) as total, SUM(outstanding) as outstanding, SUM(amount) as amount, curr, create_user, status, top, tgl_tempo, memo from sb_list_payment where nama_supp = '$nama_supp' and tgl_payment between '$start_date' and '$end_date' group by no_payment)
        union
    ...
    elseif ($nama_supp == 'ALL' and $status != 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
     $sql = mysqli_query($conn2,"(select no_payment, tgl_payment, nama_supp, no_bpb, tgl_bpb, no_po, tgl_po,no_kbon, tgl_kbon, pph_value, SUM(total_kbon) as total, SUM(outstanding) as outstanding, SUM(amount) as amount, curr, create_user, status, top, tgl_tempo, memo from sb_list_payment where status = '$status'  group by no_payment)
        union
        (select no_pay as no_payment, tgl_pay as tgl_payment, supplier as nama_supp, '-' as no_bpb, '' as tgl_bpb, '-' as no_po, '' as tgl_po, '-' as no_kbon, '' as tgl_kbon, pph as pph_value, sum(total) as total,SUM(outstanding) as outstanding, sum(total) as amount,valuta as curr, '-' as create_user,`status`,'' as top,'' as tgl_tempo,'' as memo from sb_saldo_awal where no_pay not like '%LP/NAG%' and status = '$status' group by no_pay)
        UNION
        (select no_payment, tgl_payment, nama_supp, no_bpb, tgl_bpb, no_po, tgl_po,no_kbon, tgl_kbon, pph_value, SUM(total_kbon) as total, SUM(outstanding) as outstanding, SUM(amount) as amount, curr, create_user, status, top, tgl_tempo, memo from list_payment where status = '$status'  group by no_payment)
        union
        (select no_pay as no_payment, tgl_pay as tgl_payment, supplier as nama_supp, '-' as no_bpb, '' as tgl_bpb, '-' as no_po, '' as tgl_po, '-' as no_kbon, '' as tgl_kbon, pph as pph_value, sum(total) as total,SUM(outstanding) as outstanding, sum(total) as amount,valuta as curr, '-' as create_user,`status`,'' as top,'' as tgl_tempo,'' as memo from saldo_awal where no_pay not like '%LP/NAG%' and status = '$status' group by no_pay)");
    }
    elseif ($nama_supp == 'ALL' and $status != 'ALL' and !empty($start_date) and !empty($end_date)) {
     $sql = mysqli_query($conn2,"(select no_payment, tgl_payment, nama_supp, no_bpb, tgl_bpb, no_po, tgl_po,no_kbon, tgl_kbon, pph_value, SUM(total_kbon) as total, SUM(outstanding) as outstanding, SUM(amount) as amount, curr, create_user, status, top, tgl_tempo, memo from sb_list_payment where status = '$status' and tgl_payment between '$start_date' and '$end_date'  group by no_payment)
        union
        (select no_pay as no_payment, tgl_pay as tgl_payment, supplier as nama_supp, '-' as no_bpb, '' as tgl_bpb, '-' as no_po, '' as tgl_po, '-' as no_kbon, '' as tgl_kbon, pph as pph_value, sum(total) as total,SUM(outstanding) as outstanding, sum(total) as amount,valuta as curr, '-' as create_user,`status`,'' as top,'' as tgl_tempo,'' as memo from sb_saldo_awal where no_pay not like '%LP/NAG%' and status = '$status' and tgl_pay between '$start_date' and '$end_date' group by no_pay)
        UNION
    ...
    elseif ($nama_supp != 'ALL' and $status != 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
     $sql = mysqli_query($conn2,"(select no_payment, tgl_payment, nama_supp, no_bpb, tgl_bpb, no_po, tgl_po,no_kbon, tgl_kbon, pph_value, SUM(total_kbon) as total, SUM(outstanding) as outstanding, SUM(amount) as amount, curr, create_user, status, top, tgl_tempo, memo from sb_list_payment where status = '$status' and nama_supp = '$nama_supp' group by no_payment)
        union
        (select no_pay as no_payment, tgl_pay as tgl_payment, supplier as nama_supp, '-' as no_bpb, '' as tgl_bpb, '-' as no_po, '' as tgl_po, '-' as no_kbon, '' as tgl_kbon, pph as pph_value, sum(total) as total,SUM(outstanding) as outstanding, sum(total) as amount,valuta as curr, '-' as create_user,`status`,'' as top,'' as tgl_tempo,'' as memo from sb_saldo_awal where no_pay not like '%LP/NAG%' and status = '$status' and supplier = '$nama_supp' group by no_pay)
        UNION
        (select no_payment, tgl_payment, nama_supp, no_bpb, tgl_bpb, no_po, tgl_po,no_kbon, tgl_kbon, pph_value, SUM(total_kbon) as total, SUM(outstanding) as outstanding, SUM(amount) as amount, curr, create_user, status, top, tgl_tempo, memo from list_payment where status = '$status' and nama_supp = '$nama_supp' group by no_payment)
        union
        (select no_pay as no_payment, tgl_pay as tgl_payment, supplier as nama_supp, '-' as no_bpb, '' as tgl_bpb, '-' as no_po, '' as tgl_po, '-' as no_kbon, '' as tgl_kbon, pph as pph_value, sum(total) as total,SUM(outstanding) as outstanding, sum(total) as amount,valuta as curr, '-' as create_user,`status`,'' as top,'' as tgl_tempo,'' as memo from saldo_awal where no_pay not like '%LP/NAG%' and status = '$status' and supplier = '$nama_supp' group by no_pay)");
    }
    else{
    $sql = mysqli_query($conn2,"(select no_payment, tgl_payment, nama_supp, no_bpb, tgl_bpb, no_po, tgl_po,no_kbon, tgl_kbon, pph_value, SUM(total_kbon) as total, SUM(outstanding) as outstanding, SUM(amount) as amount, curr, create_user, status, top, tgl_tempo, memo from sb_list_payment where status = '$status' and nama_supp = '$nama_supp' and tgl_payment between '$start_date' and '$end_date' group by no_payment)
        union
        (select no_pay as no_payment, tgl_pay as tgl_payment, supplier as nama_supp, '-' as no_bpb, '' as tgl_bpb, '-' as no_po, '' as tgl_po, '-' as no_kbon, '' as tgl_kbon, pph as pph_value, sum(total) as total,SUM(outstanding) as outstanding, sum(total) as amount,valuta as curr, '-' as create_user,`status`,'' as top,'' as tgl_tempo,'' as memo from sb_saldo_awal where no_pay not like '%LP/NAG%' and status = '$status' and supplier = '$nama_supp' and tgl_pay between '$start_date' and '$end_date' group by no_pay)
        UNION
