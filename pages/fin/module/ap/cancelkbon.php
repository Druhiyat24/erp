...
$sqljrnl = "insert into sb_list_journal_cancel (select * from sb_list_journal where no_journal='$no_kbon')";
...
if($execute){
	$query = mysqli_query($conn2,"update sb_kontrabon set status = 'Cancel', status_int = '$status_int', cancel_user = '$cancel_user', cancel_date = '$cancel_date'  where no_kbon = '$no_kbon'");
	$query2 = mysqli_query($conn2,"update sb_kontrabon_h set status = 'Cancel', cancel_user = '$cancel_user', cancel_date = '$cancel_date'  where no_kbon = '$no_kbon'");
	$query3 = mysqli_query($conn2,"update sb_potongan set status = 'Cancel' where no_kbon = '$no_kbon'");
...
$sql59 = "update sb_return_kb set status='Cancel' where no_kbon = '$no_kbon'";
$query59 = mysqli_query($conn2,$sql59);

$sqljrnl2 = "Delete from sb_list_journal where no_journal='$no_kbon'";
