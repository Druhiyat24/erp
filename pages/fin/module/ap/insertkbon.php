...
$sql123 = mysqli_query($conn2,"select no_kbon, no_bpb from sb_kontrabon where no_kbon = '$no_kbon' and no_bpb = '$no_bpb' and status != 'Cancel'");
$row123 = mysqli_fetch_array($sql123);
$dup_kbon = $row123['no_kbon'];
$dup_bpb = $row123['no_bpb'];

$sqlnkb = mysqli_query($conn2,"select no_kbon from sb_kontrabon_h where unik_code = '$unik_code'");
...
$query = "INSERT INTO sb_kontrabon (no_kbon, tgl_kbon, id_jurnal, nama_supp, no_faktur, no_bpb, no_po, tgl_bpb,tgl_po, supp_inv, tgl_inv, tgl_tempo, subtotal, tax, idtax, pph_code, pph_value, total, dp_value, curr, ceklist, post_date, update_date, status, status_int, create_user, create_date, start_date, end_date) 
VALUES 
...
$querykbon1 = "INSERT INTO sb_list_journal (no_journal, tgl_journal, type_journal, no_coa, nama_coa, no_costcenter, nama_costcenter, reff_doc, reff_date, buyer, no_ws, curr, rate, debit, credit, debit_idr, credit_idr, status, keterangan, create_by, create_date, approve_by, approve_date, cancel_by, cancel_date) 
VALUES 
...
if($no_ro != ''){
$queryess = "INSERT INTO sb_return_kb (no_kbon, no_ro, no_bpbrtn, total_ro, status) 
VALUES 
...
$queryss5 = "INSERT INTO sb_list_journal (no_journal, tgl_journal, type_journal, no_coa, nama_coa, no_costcenter, nama_costcenter, reff_doc, reff_date, buyer, no_ws, curr, rate, debit, credit, debit_idr, credit_idr, status, keterangan, create_by, create_date, approve_by, approve_date, cancel_by, cancel_date) 
VALUES 
...
$squerysss = mysqli_query($conn2,"delete from sb_kontrabon where no_bpb = '' and no_po = '' ");
