<?php include '../header2.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h4 class="text-center">LIST KONTRA BON</h4>
<div class="box">
...
<table id="datatable" class="table table-striped table-bordered" role="grid" cellspacing="0" width="100%">
    <thead>
        <tr class="thead-dark">
            ...
            <th style="text-align: center;vertical-align: middle;">Kontra Bon Date</th>
             <th style="text-align: center;vertical-align: middle;display: none;">KB Date (Sys)</th>
    ...
    if(empty($nama_supp) and empty($status) and empty($start_date) and empty($end_date)){
     $sql = mysqli_query($conn2,"select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, d.tgl_kbon2,b.jml_return, b.jml_potong from sb_kontrabon a INNER JOIN sb_potongan b on b.no_kbon = a.no_kbon inner join sb_kontrabon_h d on d.no_kbon = a.no_kbon where a.tgl_kbon = '$date_now' and a.no_bpb != '' group by a.no_kbon
        UNION
        select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, d.tgl_kbon2,b.jml_return, b.jml_potong from kontrabon a INNER JOIN potongan b on b.no_kbon = a.no_kbon inner join kontrabon_h d on d.no_kbon = a.no_kbon where a.tgl_kbon = '$date_now' and a.no_bpb != '' group by a.no_kbon");
    }
    elseif ($nama_supp == 'ALL' and $status == 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {            
     $sql = mysqli_query($conn2,"select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, d.tgl_kbon2,b.jml_return, b.jml_potong from sb_kontrabon a INNER JOIN sb_potongan b on b.no_kbon = a.no_kbon inner join sb_kontrabon_h d on d.no_kbon = a.no_kbon where a.no_bpb != ''  group by a.no_kbon
        UNION
    ...
    elseif ($nama_supp == 'ALL' and $status == 'ALL' and !empty($start_date) and !empty($end_date)) {
     $sql = mysqli_query($conn2,"select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, d.tgl_kbon2,b.jml_return, b.jml_potong from sb_kontrabon a INNER JOIN sb_potongan b on b.no_kbon = a.no_kbon inner join sb_kontrabon_h d on d.no_kbon = a.no_kbon where a.tgl_kbon between '$start_date' and '$end_date' and a.no_bpb != '' group by a.no_kbon
        UNION
    ...
    elseif ($nama_supp != 'ALL' and $status == 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
     $sql = mysqli_query($conn2,"select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, d.tgl_kbon2,b.jml_return, b.jml_potong from sb_kontrabon a INNER JOIN sb_potongan b on b.no_kbon = a.no_kbon inner join sb_kontrabon_h d on d.no_kbon = a.no_kbon where a.nama_supp = '$nama_supp' and a.no_bpb != '' group by a.no_kbon
        UNION
    ...
    elseif ($nama_supp != 'ALL' and $status == 'ALL' and !empty($start_date) and !empty($end_date)) {
     $sql = mysqli_query($conn2,"select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, d.tgl_kbon2,b.jml_return, b.jml_potong from sb_kontrabon a INNER JOIN sb_potongan b on b.no_kbon = a.no_kbon inner join sb_kontrabon_h d on d.no_kbon = a.no_kbon where a.nama_supp = '$nama_supp' and a.tgl_kbon between '$start_date' and '$end_date' and a.no_bpb != '' group by a.no_kbon
        UNION
    ...
    elseif ($nama_supp == 'ALL' and $status != 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
     $sql = mysqli_query($conn2,"select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, d.tgl_kbon2,b.jml_return, b.jml_potong from sb_kontrabon a INNER JOIN sb_potongan b on b.no_kbon = a.no_kbon inner join sb_kontrabon_h d on d.no_kbon = a.no_kbon where a.status = '$status' and a.no_bpb != '' group by a.no_kbon
        UNION
    ...
    elseif ($nama_supp == 'ALL' and $status != 'ALL' and !empty($start_date) and !empty($end_date)) {
     $sql = mysqli_query($conn2,"select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, d.tgl_kbon2,b.jml_return, b.jml_potong from sb_kontrabon a INNER JOIN sb_potongan b on b.no_kbon = a.no_kbon inner join sb_kontrabon_h d on d.no_kbon = a.no_kbon where a.status = '$status' and a.tgl_kbon between '$start_date' and '$end_date' and a.no_bpb != '' group by a.no_kbon
        UNION
    ...
    elseif ($nama_supp != 'ALL' and $status != 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
     $sql = mysqli_query($conn2,"select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, d.tgl_kbon2,b.jml_return, b.jml_potong from sb_kontrabon a INNER JOIN sb_potongan b on b.no_kbon = a.no_kbon inner join sb_kontrabon_h d on d.no_kbon = a.no_kbon where a.status = '$status' and a.nama_supp = '$nama_supp' and a.no_bpb != '' group by a.no_kbon
        UNION
    ...
    $sql = mysqli_query($conn2,"select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, d.tgl_kbon2,b.jml_return, b.jml_potong from sb_kontrabon a INNER JOIN sb_potongan b on b.no_kbon = a.no_kbon inner join sb_kontrabon_h d on d.no_kbon = a.no_kbon where a.status = '$status' and a.nama_supp = '$nama_supp' and a.tgl_kbon between '$start_date' and '$end_date' and a.no_bpb != '' group by a.no_kbon
        UNION
    ...
    $sql45 = mysqli_query($conn2,"select a.no_kbon, (c.qty * c.price) * (d.tax / 100) as tax_return from sb_kontrabon a left join bppb_new c on c.no_bpb = a.no_bpb left join bpb_new d on d.no_bpb = a.no_bpb where a.no_kbon = '$kbonno' and a.no_bpb != '' group by a.no_kbon
        UNION
        select a.no_kbon, (c.qty * c.price) * (d.tax / 100) as tax_return from kontrabon a left join bppb_new c on c.no_bpb = a.no_bpb left join bpb_new d on d.no_bpb = a.no_bpb where a.no_kbon = '$kbonno' and a.no_bpb != '' group by a.no_kbon");
    ...
    $status = $row['status'];         
        echo '<tr style="font-size:11px;text-align:center;">
            ...
            <td style="display: none;" value = "'.$row['tgl_kbon2'].'">'.date("d-M-Y",strtotime($row['tgl_kbon2'])).'</td>
