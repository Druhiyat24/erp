...
select no_doc, tgl_doc, tgl_doc tgl_doc2 from tbl_tamb_ap where no_doc = '$no_bpb' and tgl_pay < '$start_date' GROUP BY no_doc");
    ...
    if($sa_awal == '0' and $tambah == '0' and $kurang == '0' and $sa_akhir == '0'){
        ...
        echo '<tr style="font-size:12px;text-align:center;">
            ...
            <td value="'.$due_current.'">'.number_format($due_current,2).'</td>
            <td value="'.$due_1.'">'.number_format($due_1,2).'</td>
            <td value="'.$due_2.'">'.number_format($due_2,2).'</td>
            <td value="'.$due_3.'">'.number_format($due_3,2).'</td>
            <td value="'.$due_4.'">'.number_format($due_4,2).'</td>
            <td value="'.$due_5.'">'.number_format($due_5,2).'</td>
            <td value="'.$due_6.'">'.number_format($due_6,2).'</td>
            <td value="'.$due_7.'">'.number_format($due_7,2).'</td>
            <td value="'.$tot_due.'">'.number_format($tot_due,2).'</td>
            <td style="width:50px;background-color: white;border:none" value="">&nbsp;&nbsp;&nbsp;</td>
            <td value="'.$pro_due.'">'.number_format($pro_due,2).'</td>
            <td value="'.$pro_due0.'">'.number_format($pro_due0,2).'</td>
            <td value="'.$pro_due1.'">'.number_format($pro_due1,2).'</td>
            <td value="'.$pro_due2.'">'.number_format($pro_due2,2).'</td>
            <td value="'.$pro_due3.'">'.number_format($pro_due3,2).'</td>
            <td value="'.$pro_due4.'">'.number_format($pro_due4,2).'</td>
            <td value="'.$pro_due5.'">'.number_format($pro_due5,2).'</td>
            <td value="'.$tot_produe.'">'.number_format($tot_produe,2).'</td>
             ';
