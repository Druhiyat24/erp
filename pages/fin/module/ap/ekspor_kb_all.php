...
<body>
    ...
    <table style="width:100%;font-size:10px;" border="1" >
        ...
        $sql = mysqli_query($conn2,"select a.no_faktur,a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.create_user,a.create_date, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, b.jml_return, b.jml_potong from sb_kontrabon a INNER JOIN sb_potongan b on b.no_kbon = a.no_kbon where a.tgl_kbon between '$start_date' and '$end_date' and a.no_bpb != '' group by a.no_kbon
            UNION
            select a.no_faktur,a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.create_user,a.create_date, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, b.jml_return, b.jml_potong from kontrabon a INNER JOIN potongan b on b.no_kbon = a.no_kbon where a.tgl_kbon between '$start_date' and '$end_date' and a.no_bpb != '' group by a.no_kbon");
