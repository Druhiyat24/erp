<?php include '../header2.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h4 class="text-center">FORM KONTRA BON</h4>
<div class="box">
    ...
    <div class="box body">
        <div class="row">
           ...
           <div class="tableFix" style="height: 300px;">
            ...
            $Aquerrff = mysqli_query($conn2,"select DISTINCT list_payment_dp.no_po as no_po, sum(DISTINCT sb_kontrabon_h.dp_value) as amount from list_payment_dp inner join sb_kontrabon_h on sb_kontrabon_h.no_po = list_payment_dp.no_po where sb_kontrabon_h.no_po = '$pono' and list_payment_dp.status_int = '5' and sb_kontrabon_h.`status` != 'Cancel'");
            ...
            $Aquerraa = mysqli_query($conn2,"select DISTINCT list_payment_cbd.no_po as no_po, sum(DISTINCT sb_kontrabon_h.dp_value) as amount from list_payment_cbd inner join kontrabon_cbd a on a.no_kbon = list_payment_cbd.no_kbon  inner join sb_kontrabon_h on sb_kontrabon_h.no_po = a.no_po where sb_kontrabon_h.no_po = '$pono' and list_payment_cbd.status_int = '5' and sb_kontrabon_h.`status` != 'Cancel'");
            ...
            $querys = mysqli_query($conn2,"select no_bpb, status from sb_kontrabon where no_bpb = '$bpb' and status != 'Cancel'");
            $rows = mysqli_fetch_array($querys);
