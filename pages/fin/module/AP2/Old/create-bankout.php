...
<!--            <div class="col-md-3 mb-3">            
    ...
    <div class="box body">
        <div class="row">
            ...
            if ($ref_num == 'Payment') {
                $sql = mysqli_query($conn2,"select no_kbon,curr,nama_supp,no_payment,tgl_payment,tgl_tempo,curr,sum(amount) as total_kbon,sum(pph_value) as pph_value, 'REG' as kode from list_payment where status_int = '4' and nama_supp = '$nama_supp' and tgl_payment BETWEEN '$start_date' and '$end_date' group by no_payment
union
