<?php include '../header.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h2 class="text-center">PAYABLE CARD STATEMENT DETAIL DEVELOPMENT</h2>
<div class="box">
    <div class="box header">

        
       <form id="form-data" action="pcs_detail_dev.php" method="post">        
        <div class="form-row">
            <div class="col-md-6">
...
union (select nama_supp, no_bpb, tgl_bpb, top, duedate, curr, total from tbl_tamb_bpb)) as b order by b.Supplier asc");
    }
    else {
...
<script type="text/javascript">
    ...
    location.href = "pcs_detail_dev.php";
};
</script>
