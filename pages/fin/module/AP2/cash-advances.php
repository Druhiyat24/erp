<?php include '../header.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h2 class="text-center">LIST CASH ADVANCES</h2>
<div class="box">
    <div class="box header">

        <form id="form-data" action="cash-advances.php" method="post">        
        <div class="form-row">
           <div class="col-md-3">
...
<table id="datatable" class="table table-striped table-bordered" role="grid" cellspacing="0" width="100%">
    <thead>
        <tr class="thead-dark">
            ...
            <th style="text-align: center;vertical-align: middle;">Request By</th>
...
<script type="text/javascript">
    ...
    location.href = "create-cashadv.php";
};
</script>
<script type="text/javascript">
    document.getElementById('reset').onclick = function () {
    location.href = "cash-advances.php";
};
</script>
