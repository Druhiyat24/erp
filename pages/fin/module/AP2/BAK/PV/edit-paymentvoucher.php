 ...
 <div class="form-row">
    ...
    <div class="box body">
        ...
        <tr>
            ...
            <th class="text-center" style="width: 10%">Reff Doc</th>
            ...
            <th class="text-center" style="width: 11%">PPH</th>
    ...
    <tbody id="tbody2">
        ...
        <?php
    $no_pv = base64_decode($_GET['no_pv']);
    $sqlpv = mysql_query("select a.id_pph,a.coa,concat(b.no_coa,' ', b.nama_coa) as nama_coa,a.no_cc,d.cc_name,a.reff_doc,a.reff_date,a.deskripsi,a.amount,a.ded_add,a.due_date,a.pph, IF(a.pph = '0','Non PPH',CONCAT(kriteria,' (',percentage,'%)')) as kriteria  from tbl_pv a left join mastercoa_v2 b on b.no_coa = a.coa left join mtax c on c.idtax = a.id_pph left join b_master_cc d on d.no_cc = a.no_cc where a.no_pv = '$no_pv' and IF(a.pph = '0',a.no_pv = '$no_pv', category_tax = 'PPH') group by a.id",$conn1);
...
<script type="text/javascript">
    $("#form-simpan").on("click", "#simpan", function(){
        ...
        $.ajax({
            type:'POST',
            url:'insertpv.php',
            data: {'doc_number':doc_number, 'no_coa':no_coa, 'no_cc':no_cc, 'no_ref':no_ref, 'ref_date':ref_date, 'deskripsi':deskripsi, 'amount':amount, 'due_date':due_date, 'ded_add':ded_add, 'pph':pph, 'idtax':idtax},
            cache: 'false',
            close: function(e){
                e.preventDefault();
            },
