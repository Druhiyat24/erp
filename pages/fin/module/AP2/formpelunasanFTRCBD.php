<?php include '../header.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h2 class="text-center">FORM PAYMENT FTR CBD</h2>
<div class="box">
    <div class="box header">
<form id="form-data" method="post">
        <div class="form-row">
            <div class="col-md-3 mb-3">            
            <label for="nopayment"><b>No payment CBD</b></label>
            <?php
            $sql = mysqli_query($conn2,"select max(payment_ftr_id) from payment_ftrcbd");
...
<!--            <div class="col-md-3 mb-3">            
    ...
    <div class="box body">
        <div class="row">
            ...
            $sql = mysqli_query($conn2,"select list_payment_cbd.no_payment as no_pay, list_payment_cbd.tgl_payment as tgl_pay,list_payment_cbd.no_kbon as no_kbon, list_payment_cbd.tgl_kbon as tgl_kbon,list_payment_cbd.nama_supp as supplier, list_payment_cbd.total_kbon as total, list_payment_cbd.curr as valuta, SUM(list_payment_cbd.amount) as dibayar, list_payment_cbd.outstanding as outstanding, Kontrabon_cbd.pph_value as pph from list_payment_cbd inner join kontrabon_cbd on kontrabon_cbd.no_kbon = list_payment_cbd.no_kbon where list_payment_cbd.nama_supp = '$nama_supp' and list_payment_cbd.status_int = '4' and total_kbon != 0 group by no_pay");
            ...
            while($row = mysqli_fetch_array($sql)){                      
                    echo '<tr>
                            ...
                            <td style="width:100px;" class="dt_out" style="width:100px;" dataout4="'.date("d F Y",strtotime($row['tgl_kbon'])).'">'.date("d-M-Y",strtotime($row['tgl_kbon'])).'</td>
                            ...
                            <td style="width:50px;display : none;" class="dt_out" style="width:100px;" data-data="'.$row['pph'].'">'.number_format($row['pph'],2).'</td>
...
<div class="box footer">   
        <form id="form-simpan">
          ...
          <!--   <div class="form-row col">
                <label for="subtotal" class="col-form-label" style="width: 150px;">No. List Payment CBD</b></label> 
            <div class="col-md-3 mb-3">                              
            ...
            <div class="form-row col">
                <label for="subtotal" class="col-form-label" style="width: 150px;">List Payment CBD Date</b></label>
            <div class="col-md-3 mb-3">                              
            ...
            <div class="form-row col">
                <label for="subtotal" class="col-form-label" style="width: 150px;">No. Kontrabon CBD</b></label> 
            <div class="col-md-3 mb-3">                              
            ...
            <div class="form-row col">
                <label for="subtotal" class="col-form-label" style="width: 150px;">Kontrabon CBD Date</b></label>
            <div class="col-md-3 mb-3">                              
           ...
           <div class="form-row col">
            ...
            <button type="button" style="border-radius: 6px" class="btn-outline-danger btn-sm" name="batal" id="batal" onclick="location.href='pelunasanftrcbd.php'"><span class="fa fa-angle-double-left"></span> Back</button>           
            </div>
            </div>                                    
        </form>
        </div>
...
function formatMoney(amount, decimalCount = 2, decimal = ".", thousands = ",") {
  try {
    ...
    var rate = parseFloat($(this).closest('tr').find('td:eq(10)').attr('dataout8'),10) || 0;    
    ...
    $("#nominal_h").val(dibayar);
     $("#nominalrate").val(formatMoney(nomrate));
     $("#nominaljml").val(formatMoney(nomjml));
...
<script type="text/javascript">
    $("#form-simpan").on("click", "#simpan", function(){
        ...
        var ttl_bayar = parseFloat($(this).closest('tr').find('td:eq(9)').attr('dataout7'),10) || 0;
        ...
        var nomrate = 0;  
        var nominal = parseFloat($(this).closest('tr').find('td:eq(9)').attr('dataout7'),10) || 0;
        var create_user = '<?php echo $user ?>';
        var dibayar = parseFloat($(this).closest('tr').find('td:eq(9)').attr('dataout7'),10) || 0;
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                window.location = 'pelunasanftrcbd.php';
                },
