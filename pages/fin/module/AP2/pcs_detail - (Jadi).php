...
union (select a.nama_supp, a.no_bpb,a.tgl_bpb,b.top, DATE_ADD(a.tgl_bpb, INTERVAL b.top DAY) as due_date,a.curr,(a.subtotal + a.tax) from kontrabon a left join bpb_new b on b.no_bpb = a.no_bpb inner join kontrabon_h d on d.no_kbon = a.no_kbon where a.tgl_bpb < '$start_date' and DATE_FORMAT(d.create_date, '%Y-%m-%d') between '$start_date' and '$end_date' group by b.no_bpb) union (select a.supplier, a.no_bppb,a.tgl_bppb,b.jml_pterms as top, DATE_ADD(a.tgl_bppb, INTERVAL b.jml_pterms DAY) as due_date,a.curr, ROUND(- SUM((a.qty * a.price)),2) as total from bppb_new a INNER JOIN po_header b on b.pono = a.no_po inner join kontrabon_h d on d.no_kbon = a.no_kbon where a.status != 'Cancel' and a.tgl_bppb < '$start_date' and DATE_FORMAT(d.create_date, '%Y-%m-%d') between '$start_date' and '$end_date' GROUP BY a.no_bppb)

union (select a.nama_supp, a.no_bpb,a.tgl_bpb,c.top, DATE_ADD(a.tgl_bpb, INTERVAL c.top DAY) as due_date,a.curr,(a.subtotal + a.tax) from kontrabon a inner join list_payment b on b.no_kbon = a.no_kbon left join bpb_new c on c.no_bpb = a.no_bpb inner join kontrabon_h d on d.no_kbon = a.no_kbon where a.tgl_bpb < '$start_date' and DATE_FORMAT(d.create_date, '%Y-%m-%d') < '$start_date' and DATE_FORMAT(b.create_date, '%Y-%m-%d') between '$start_date' and '$end_date' group by c.no_bpb)union (select a.supplier, a.no_bppb,a.tgl_bppb,b.jml_pterms as top, DATE_ADD(a.tgl_bppb, INTERVAL b.jml_pterms DAY) as due_date,a.curr, ROUND(- SUM((a.qty * a.price)),2) as total from bppb_new a INNER JOIN po_header b on b.pono = a.no_po inner join kontrabon_h d on d.no_kbon = a.no_kbon inner join list_payment e on e.no_kbon = a.no_kbon where a.status != 'Cancel' and a.tgl_bppb < '$start_date' and DATE_FORMAT(d.create_date, '%Y-%m-%d') between '$start_date' and '$end_date' and DATE_FORMAT(e.create_date, '%Y-%m-%d') between '$start_date' and '$end_date' GROUP BY a.no_bppb)) as b order by b.Supplier asc");
    }
    else {
     $sql = mysqli_query($conn1,"select * from((select b.Supplier,a.bpbno_int,bpbdate,c.jml_pterms as top, DATE_ADD(a.bpbdate, INTERVAL c.jml_pterms DAY) as due_date,a.curr,round(sum((((IF(a.qty_reject IS NULL,(a.qty), (a.qty - a.qty_reject))) * a.price) + (((IF(a.qty_reject IS NULL,(a.qty), (a.qty - a.qty_reject))) * a.price) * (c.tax /100)))),2) as total from bpb a INNER JOIN po_header c on c.pono = a.pono INNER JOIN mastersupplier b on b.Id_Supplier = a.id_supplier left JOIN po_header_draft d on d.id = c.id_draft where a.confirm = 'y' and a.price != '0' and cancel = 'N' and d.tipe_com is null and bpbdate between '2022-04-14' and '$start_date' and b.Supplier = '$nama_supp' || a.confirm = 'y' and a.price != '0' and cancel = 'N' and d.tipe_com = 'REGULAR' and bpbdate between '2022-04-14' and '$start_date' and b.Supplier = '$nama_supp' || a.confirm = 'y' and a.price != '0' and cancel = 'N' and d.tipe_com = 'BUYER' and bpbdate between '2022-04-14' and '$start_date' and b.Supplier = '$nama_supp' group by a.bpbno_int order by bpbdate asc)
union

(select b.Supplier,a.bpbno_int,bpbdate,c.jml_pterms as top, DATE_ADD(a.bpbdate, INTERVAL c.jml_pterms DAY) as due_date,a.curr,round(sum((((IF(a.qty_reject IS NULL,(a.qty), (a.qty - a.qty_reject))) * a.price) + (((IF(a.qty_reject IS NULL,(a.qty), (a.qty - a.qty_reject))) * a.price) * (c.tax /100)))),2) as total from bpb a INNER JOIN po_header c on c.pono = a.pono INNER JOIN mastersupplier b on b.Id_Supplier = a.id_supplier left JOIN po_header_draft d on d.id = c.id_draft where a.confirm = 'y' and a.price != '0' and cancel = 'N' and d.tipe_com is null and bpbdate between '$start_date' and '$end_date' and b.Supplier = '$nama_supp' || a.confirm = 'y' and a.price != '0' and cancel = 'N' and d.tipe_com  = 'REGULAR' and bpbdate between '$start_date' and '$end_date' and b.Supplier = '$nama_supp' || a.confirm = 'y' and a.price != '0' and cancel = 'N' and d.tipe_com = 'BUYER' and bpbdate between '$start_date' and '$end_date' and b.Supplier = '$nama_supp' group by a.bpbno_int order by bpbdate asc)
...
union (select a.nama_supp, a.no_bpb,a.tgl_bpb,b.top, DATE_ADD(a.tgl_bpb, INTERVAL b.top DAY) as due_date,a.curr,(a.subtotal + a.tax) from kontrabon a left join bpb_new b on b.no_bpb = a.no_bpb inner join kontrabon_h d on d.no_kbon = a.no_kbon where a.tgl_bpb < '$start_date' and DATE_FORMAT(d.create_date, '%Y-%m-%d') between '$start_date' and '$end_date' and a.nama_supp = '$nama_supp' group by b.no_bpb)

union (select a.nama_supp, a.no_bpb,a.tgl_bpb,c.top, DATE_ADD(a.tgl_bpb, INTERVAL c.top DAY) as due_date,a.curr,(a.subtotal + a.tax) from kontrabon a inner join list_payment b on b.no_kbon = a.no_kbon left join bpb_new c on c.no_bpb = a.no_bpb inner join kontrabon_h d on d.no_kbon = a.no_kbon where a.tgl_bpb < '$start_date' and DATE_FORMAT(d.create_date, '%Y-%m-%d') < '$start_date' and DATE_FORMAT(b.create_date, '%Y-%m-%d') between '$start_date' and '$end_date' and a.nama_supp = '$nama_supp' group by c.no_bpb)) as b order by b.Supplier asc");
    }
    $sa_akhir_  = 0;
    $kurang_    = 0;
    $sa_awal_   = 0;
   ...
   if(empty($nama_supp) and empty($start_date) and empty($end_date)){
    ...
    elseif ($nama_supp == 'ALL' and !empty($start_date) and !empty($end_date)) {
     ...
     $sql = mysqli_query($conn1,"select * from(
        ...
        union (select a.nama_supp,a.no_kbon,c.tgl_kbon2 as tgl_kbon, DATE_FORMAT(c.create_date, '%Y-%m-%d') as create_date,DATEDIFF(c.tgl_tempo,c.tgl_kbon) as top, c.tgl_tempo,a.curr,(a.amount + a.pph_value) as bayar,(a.total_kbon + a.pph_value - b.jml_potong + c.dp_value + b.jml_return) as totalori,(b.jml_potong - c.dp_value) as jml_potong  from list_payment a inner join potongan b on b.no_kbon = a.no_kbon left join kontrabon_h c on c.no_kbon = a.no_kbon where DATE_FORMAT(c.create_date, '%Y-%m-%d') < '$start_date' and DATE_FORMAT(a.create_date, '%Y-%m-%d') between '$start_date' and '$end_date' and a.nama_supp = '$nama_supp' and c.status !='CANCEL')
     ) as b order by b.nama_supp asc");
    }
...
<?php
   ...
   if(empty($nama_supp) and empty($start_date) and empty($end_date)){
    ...
    elseif ($nama_supp == 'ALL' and !empty($start_date) and !empty($end_date)) {
     ...
     $sql = mysqli_query($conn1,"select * from(
        (select '' as abc,a.nama_supp, a.no_payment, a.tgl_payment, DATE_FORMAT(a.create_date, '%Y-%m-%d') as create_date,a.top,a.tgl_tempo,curr, sum(a.amount + a.pph_value) as total from list_payment a left join saldo_awal b on b.no_pay = a.no_payment where a.status != 'Cancel' and DATE_FORMAT(a.create_date, '%Y-%m-%d') between '2022-04-14' and '$start_date' and a.nama_supp = '$nama_supp' GROUP BY no_payment order by create_date asc) union 
        (select '' as abc,a.nama_supp, a.no_payment, a.tgl_payment, DATE_FORMAT(a.create_date, '%Y-%m-%d') as create_date,a.top,a.tgl_tempo,curr, sum(a.amount + a.pph_value) as total from list_payment a left join saldo_awal b on b.no_pay = a.no_payment where a.status != 'Cancel' and DATE_FORMAT(a.create_date, '%Y-%m-%d') between '$start_date' and '$end_date' and a.nama_supp = '$nama_supp' GROUP BY no_payment order by create_date asc) union 
        (select '1' as abc, nama_supp, no_payment, tgl_payment, DATE_FORMAT(create_date, '%Y-%m-%d') as create_date,DATEDIFF(duedate,tgl_payment) as top, duedate, curr, total from saldo_lp_ap where nama_supp = '$nama_supp' GROUP BY no_payment order by tgl_payment asc)) as b order by b.nama_supp asc");
    }
   ...
   while($row = mysqli_fetch_array($sql)){
    ...
    $sqllp2 = mysqli_query($conn1,"select list_payment_id,ttl_bayar from payment_ftr where list_payment_id = '$no_payment' and DATE_FORMAT(create_date, '%Y-%m-%d') < '$start_date' GROUP BY list_payment_id");
    $rowlp2 = mysqli_fetch_array($sqllp2);
