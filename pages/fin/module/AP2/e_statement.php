...
// echo '== = ' . (ini_get('max_input_time'));
    ...
    if ($akun2 == $akun && $kode_tgl == $kode_tgl2) { 
        ...
        echo '<tr style="font-size:12px;text-align:center;'.$color.'">
            ...
            $querys = mysqli_query($conn1,"select useraccess.menu as menu,useraccess.username as username, menurole.id as id from useraccess inner join menurole on menurole.menu = useraccess.menu where username = 'indro' and useraccess.menu = 'Upload E - Statement'");
            $rs = mysqli_fetch_array($querys);
            $id_upload = isset($rs['id']) ? $rs['id'] :0;
