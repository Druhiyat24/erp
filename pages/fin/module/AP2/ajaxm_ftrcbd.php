...
$sql2 = mysqli_query($conn2,"select * from pengajuan_ftrcbd where id = '$id' and no_cbd = '$no_kbon' group by id ");	
$rows = mysqli_fetch_assoc($sql2);
$sql = mysqli_query($conn2,"select no_po, tgl_po, no_pi, supp, SUM(subtotal) as sub, SUM(tax) as tax, SUM(total) as total, status from ftr_cbd where no_ftr_cbd = '$no_kbon' group by no_po");
