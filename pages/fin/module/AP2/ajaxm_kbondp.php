...
$sql = mysqli_query($conn2,"select no_dp,curr from kontrabon_dp where no_kbon = '$no_kbon' group by id ");
$sql4 = mysqli_query($conn2,"select pesan from pengajuan_kb_dp where id = '$id' and no_kbon = '$no_kbon' group by id ");
