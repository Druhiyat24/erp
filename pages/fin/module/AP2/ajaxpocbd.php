...
where po_header.app = 'A' and po_header.pono = '$no_po' and po_item.cancel != 'Y' and po_header.jenis = 'N' and masterpterms.kode_pterms = 'CBD'");	
}else{
...
where po_header.app = 'A' and po_header.pono = '$no_po' and po_item.cancel = 'N' and masterpterms.kode_pterms = 'CBD'");
}
