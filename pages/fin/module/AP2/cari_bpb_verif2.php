...
// echo $no_kbon;
 ...
 $sql = mysqli_query($conn1,"select no_bpb,tgl_bpb,supplier,curr,ROUND(SUM((qty * price) + ((qty * price) * (tax / 100))),2) total from bpb_new where status != 'Cancel' and supplier = '$nama_supp' and tgl_bpb BETWEEN '$start_date' and '$end_date' and upt_no_faktur is null && status != 'Cancel' and supplier = '$nama_supp' and tgl_bpb BETWEEN '$start_date' and '$end_date' and upt_no_faktur2 is null || status != 'Cancel' and supplier = '$nama_supp' and tgl_bpb BETWEEN '$start_date' and '$end_date' and upt_no_faktur = '' && status != 'Cancel' and supplier = '$nama_supp' and tgl_bpb BETWEEN '$start_date' and '$end_date' and upt_no_faktur2 is null GROUP BY no_bpb");
