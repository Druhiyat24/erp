...
$nama_supp ='';
    ...
    if(empty($nama_supp) and empty($status) and empty($start_date) and empty($end_date)){
     $sql = mysqli_query($conn2,"select pengajuan_kb.id as id, pengajuan_kb.no_kbon as no_kbon,pengajuan_kb.no_bpb as no_bpb, pengajuan_kb.nama_supp as nama_supp, pengajuan_kb.tgl_pengajuan as tgl_Pengajuan, pengajuan_kb.nama_pengaju as nama_pengaju, pengajuan_kb.pesan as pesan, pengajuan_kb.status as status, pengajuan_kb.approved_user as approve, pengajuan_kb.cancel_user as cancel, pengajuan_kb.total as total, kontrabon.tgl_kbon as tanggal, kontrabon.curr as curr from pengajuan_kb INNER JOIN kontrabon on kontrabon.no_kbon = pengajuan_kb.no_kbon where tgl_pengajuan = '$date_now' group by id");
    }
    elseif ($nama_supp == 'ALL' and $status == 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {            
     $sql = mysqli_query($conn2,"select pengajuan_kb.id as id, pengajuan_kb.no_kbon as no_kbon,pengajuan_kb.no_bpb as no_bpb, pengajuan_kb.nama_supp as nama_supp, pengajuan_kb.tgl_pengajuan as tgl_Pengajuan, pengajuan_kb.nama_pengaju as nama_pengaju, pengajuan_kb.pesan as pesan, pengajuan_kb.status as status, pengajuan_kb.approved_user as approve, pengajuan_kb.cancel_user as cancel, pengajuan_kb.total as total, kontrabon.tgl_kbon as tanggal, kontrabon.curr as curr from pengajuan_kb INNER JOIN kontrabon on kontrabon.no_kbon = pengajuan_kb.no_kbon group by id");
    }
    elseif ($nama_supp == 'ALL' and $status == 'ALL' and !empty($start_date) and !empty($end_date)) {
     $sql = mysqli_query($conn2,"select pengajuan_kb.id as id, pengajuan_kb.no_kbon as no_kbon,pengajuan_kb.no_bpb as no_bpb, pengajuan_kb.nama_supp as nama_supp, pengajuan_kb.tgl_pengajuan as tgl_Pengajuan, pengajuan_kb.nama_pengaju as nama_pengaju, pengajuan_kb.pesan as pesan, pengajuan_kb.status as status, pengajuan_kb.approved_user as approve, pengajuan_kb.cancel_user as cancel, pengajuan_kb.total as total, kontrabon.tgl_kbon as tanggal, kontrabon.curr as curr from pengajuan_kb INNER JOIN kontrabon on kontrabon.no_kbon = pengajuan_kb.no_kbon where tgl_pengajuan between '$start_date' and '$end_date' group by id");
    }
    elseif ($nama_supp != 'ALL' and $status == 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
     $sql = mysqli_query($conn2,"select pengajuan_kb.id as id, pengajuan_kb.no_kbon as no_kbon,pengajuan_kb.no_bpb as no_bpb, pengajuan_kb.nama_supp as nama_supp, pengajuan_kb.tgl_pengajuan as tgl_Pengajuan, pengajuan_kb.nama_pengaju as nama_pengaju, pengajuan_kb.pesan as pesan, pengajuan_kb.status as status, pengajuan_kb.approved_user as approve, pengajuan_kb.cancel_user as cancel, pengajuan_kb.total as total, kontrabon.tgl_pengajuan as tanggal, kontrabon.curr as curr from pengajuan_kb INNER JOIN kontrabon on kontrabon.no_kbon = pengajuan_kb.no_kbon where nama_supp = '$nama_supp' group by id");
    }
    elseif ($nama_supp != 'ALL' and $status == 'ALL' and !empty($start_date) and !empty($end_date)) {
     $sql = mysqli_query($conn2,"select pengajuan_kb.id as id, pengajuan_kb.no_kbon as no_kbon,pengajuan_kb.no_bpb as no_bpb, pengajuan_kb.nama_supp as nama_supp, pengajuan_kb.tgl_pengajuan as tgl_Pengajuan, pengajuan_kb.nama_pengaju as nama_pengaju, pengajuan_kb.pesan as pesan, pengajuan_kb.status as status, pengajuan_kb.approved_user as approve, pengajuan_kb.cancel_user as cancel, pengajuan_kb.total as total, kontrabon.tgl_kbon as tanggal, kontrabon.curr as curr from pengajuan_kb INNER JOIN kontrabon on kontrabon.no_kbon = pengajuan_kb.no_kbon where nama_supp = '$nama_supp' and tgl_pengajuan between '$start_date' and '$end_date' group by id");
    }
    elseif ($nama_supp == 'ALL' and $status != 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
     $sql = mysqli_query($conn2,"select pengajuan_kb.id as id, pengajuan_kb.no_kbon as no_kbon,pengajuan_kb.no_bpb as no_bpb, pengajuan_kb.nama_supp as nama_supp, pengajuan_kb.tgl_pengajuan as tgl_Pengajuan, pengajuan_kb.nama_pengaju as nama_pengaju, pengajuan_kb.pesan as pesan, pengajuan_kb.status as status, pengajuan_kb.approved_user as approve, pengajuan_kb.cancel_user as cancel, pengajuan_kb.total as total, kontrabon.tgl_kbon as tanggal, kontrabon.curr as curr from pengajuan_kb INNER JOIN kontrabon on kontrabon.no_kbon = pengajuan_kb.no_kbon where pengajuan_kb.status = '$status' group by id");
    }
    elseif ($nama_supp == 'ALL' and $status != 'ALL' and !empty($start_date) and !empty($end_date)) {
     $sql = mysqli_query($conn2,"select pengajuan_kb.id as id, pengajuan_kb.no_kbon as no_kbon,pengajuan_kb.no_bpb as no_bpb, pengajuan_kb.nama_supp as nama_supp, pengajuan_kb.tgl_pengajuan as tgl_Pengajuan, pengajuan_kb.nama_pengaju as nama_pengaju, pengajuan_kb.pesan as pesan, pengajuan_kb.status as status, pengajuan_kb.approved_user as approve, pengajuan_kb.cancel_user as cancel, pengajuan_kb.total as total, kontrabon.tgl_kbon as tanggal, kontrabon.curr as curr from pengajuan_kb INNER JOIN kontrabon on kontrabon.no_kbon = pengajuan_kb.no_kbon where pengajuan_kb.status = '$status' and tgl_pengajuan between '$start_date' and '$end_date' group by id");
    }
    elseif ($nama_supp != 'ALL' and $status != 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
     $sql = mysqli_query($conn2,"select pengajuan_kb.id as id, pengajuan_kb.no_kbon as no_kbon,pengajuan_kb.no_bpb as no_bpb, pengajuan_kb.nama_supp as nama_supp, pengajuan_kb.tgl_pengajuan as tgl_Pengajuan, pengajuan_kb.nama_pengaju as nama_pengaju, pengajuan_kb.pesan as pesan, pengajuan_kb.status as status, pengajuan_kb.approved_user as approve, pengajuan_kb.cancel_user as cancel, pengajuan_kb.total as total, kontrabon.tgl_kbon as tanggal, kontrabon.curr as curr from pengajuan_kb INNER JOIN kontrabon on kontrabon.no_kbon = pengajuan_kb.no_kbon where pengajuan_kb.status = '$status' and nama_supp = '$nama_supp' group by id");
    }
    else{
    $sql = mysqli_query($conn2,"select pengajuan_kb.id as id, pengajuan_kb.no_kbon as no_kbon,pengajuan_kb.no_bpb as no_bpb, pengajuan_kb.nama_supp as nama_supp, pengajuan_kb.tgl_pengajuan as tgl_Pengajuan, pengajuan_kb.nama_pengaju as nama_pengaju, pengajuan_kb.pesan as pesan, pengajuan_kb.status as status, pengajuan_kb.approved_user as approve, pengajuan_kb.cancel_user as cancel, pengajuan_kb.total as total, kontrabon.tgl_kbon as tanggal, kontrabon.curr as curr from pengajuan_kb INNER JOIN kontrabon on kontrabon.no_kbon = pengajuan_kb.no_kbon where pengajuan_kb.status = '$status' and nama_supp = '$nama_supp' and tgl_pengajuan between '$start_date' and '$end_date' group by id ");
}
    while($row = mysqli_fetch_array($sql)){
    if (!empty($row)) {
...
<script type="text/javascript">
    $("table tbody tr").on("click", "#approve", function(){
        ...
        $.ajax({
            type:'POST',
            url:'approvepengajuan.php',
            data: {'id':id, 'no_kbon':no_kbon, 'no_bpb':no_bpb, 'approve_user':approve_user},
            // close: function(e){
            //     e.preventDefault();
            // },
...
<script type="text/javascript">
    ...
    location.href = "formpengajuankb.php";
};
</script>
<script type="text/javascript">
    document.getElementById('reset').onclick = function () {
    location.href = "pengajuankb.php";
};
</script>
