...
$pph = 0;
$total = 0; 
$noftrcbd = isset($_POST['noftrcbd']) ? $_POST['noftrcbd']: null;

$sql = mysqli_query($conn2,"select no_po, tgl_po, no_pi, supp, SUM(subtotal) as sub, SUM(tax) as tax, SUM(total) as total, biaya_tambahan from ftr_cbd where no_ftr_cbd = '$noftrcbd' group by no_po");	
