<?php include '../header.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h2 class="text-center">FORM MAINTAIN LIST PAYMENT CBD</h2>
<div class="box">
...
<form id="form-data" method="post">
          ...
          <div class="form-group">
            ...
            <label for="nama_supp"><b>Supplier</b></label>
              <select class="form-control selectpicker" name="nama_supp" id="nama_supp" data-dropup-auto="false" data-live-search="true">
                ...
                <label><b>List Payment CBD Date</b></label>
    ...
    <div class="box body">
        <div class="row">
            ...
            $sql = mysqli_query($conn2,"select id, no_payment, tgl_payment,no_kbon,tgl_kbon, nama_supp, SUM(total_kbon), SUM(outstanding), SUM(amount), curr, create_user, status, top, tgl_tempo, memo from list_payment_cbd where tgl_payment between '$start_date' and '$end_date' and nama_supp = '$nama_supp' and status = 'Approved' and status_int = '4' group by no_payment");
...
<div class="box footer"> 
        ...
        <!-- <form class="form-row col" method="POST" action="upload.php" enctype="multipart/form-data" style="margin-bottom: -15px;">
           ...
           <div class="form-row col">
            ...
            <button type="button" style="border-radius: 6px" class="btn-outline-danger btn-sm" name="batal" id="batal" onclick="location.href='pengajuanpaymentcbd.php'"><span class="fa fa-angle-double-left"></span> Back</button>           
            </div>
            </div>                                    
        </form>
        </div>
...
<script type="text/javascript">
    $("#form-simpan").on("click", "#simpan", function(){
        ...
        $.ajax({
            type:'POST',
            url:'insertpengajuan_paymentcbd.php',
            ...
            success: function(response){
                ...
                window.location = 'pengajuanpaymentcbd.php';
                },
            error: function (xhr, ajaxOptions, thrownError) {
                console.log(xhr);
                alert(xhr);
        ...
        if(document.querySelectorAll("input[name='select[]']:checked").length == 0){
            alert("Please check the Payment CBD number");            
        } else{
            alert("data submitted successfully");
        }           
    });
