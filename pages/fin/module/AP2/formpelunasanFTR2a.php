<?php include '../header.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h2 class="text-center">FORM PAYMENT</h2>
<div class="box">
    ...
    <div class="box body">
        <div class="row">
            ...
            <table id="mytable" class="table table-striped table-bordered" cellspacing="0" width="100%" style="font-size: 12px;text-align:center;">
                    <thead>
                        <tr>
                            ...
                            <th style="width:50px;">NO List Payment</th>
            ...
            $total = 0;            
             ...
             $sql = mysqli_query($conn2,"select list_payment.no_payment as no_pay, list_payment.tgl_payment as tgl_pay,list_payment.no_kbon as no_kbon, list_payment.tgl_kbon as tgl_kbon,list_payment.nama_supp as supplier, list_payment.total_kbon as total, list_payment.curr as valuta, SUM(list_payment.amount) as dibayar, list_payment.outstanding as outstanding, list_payment.pph_value as pph, ROUND(kontrabon_h.rate,2) as rate from list_payment left join kontrabon_h on kontrabon_h.no_kbon = list_payment.no_kbon where list_payment.nama_supp = '$nama_supp' and list_payment.status_int = '4' and total_kbon != 0 group by no_payment 
                union
                select no_pay, tgl_pay, no_kbon, IF(tgl_kbon is null,'-',tgl_kbon) as tgl_kbon, supplier, total, valuta, dibayar,outstanding, pph, rate from saldo_awal where supplier = '$nama_supp' and status_int = '4'");
...
<!-- 
            <div class="form-row col">
                <label for="subtotal" class="col-form-label" style="width: 150px;">No. List Payment</b></label> 
            <div class="col-md-3 mb-3">                              
            ...
            <div class="form-row col">
                <label for="subtotal" class="col-form-label" style="width: 150px;">List Payment Date</b></label>
            <div class="col-md-3 mb-3">                              
           ...
           <!-- <div class="form-row col">
            ...
            <div class="form-row col">
                <label for="total" class="col-form-label" style="width: 150px;">Total List Payment</b></label>
            <div class="col-md-3 mb-3">                              
           ...
           <div class="form-row col">
            ...
            <button type="button" style="border-radius: 6px" class="btn-outline-danger btn-sm" name="batal" id="batal" onclick="location.href='pelunasanftr.php'"><span class="fa fa-angle-double-left"></span> Back</button>           
            </div>
            </div>                                    
        </form>
        </div>
...
<script type="text/javascript">
    $("#form-simpan").on("click", "#simpan", function(){
        ...
        var ratebpb = parseFloat($(this).closest('tr').find('td:eq(10)').attr('data-rate'),10) || 0;
