...
.modal-dialog {
  ...
  vertical-align: middle;
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h2 class="text-center">REKAP PELUNASAN HUTANG & BIAYA</h2>
<div class="box">
    <div class="box header">

        <form id="form-data" action="rekap-pelunasan.php" method="post">        
        <div class="form-row">
...
<?php
        ...
        echo '<a style="padding-right: 10px;" target="_blank" href="ekspor_rekap_pelunasan.php?start_date='.$start_date.' && end_date='.$end_date.'"><button type="button" class="btn btn-success " style= "margin-top: 30px;"><i class="fa fa-file-excel-o" aria-hidden="true" style="padding-right: 10px; padding-left: 5px;font-size: 1rem;color: #fff;text-shadow: 1px 1px 1px #000"> Excel</i></button></a>
...
?> -->
   ...
   <table id="mytable" class="table table-striped table-bordered" role="grid" cellspacing="0" width="100%">
        <thead>
        <tr class="thead-dark">
            <th style="text-align: center;vertical-align: middle;width: 12%;">No Payment</th>
            <th style="text-align: center;vertical-align: middle;width: 12%;">Payment Date</th>
            <th style="text-align: center;vertical-align: middle;width: 16%;">Supplier</th>
            <th style="text-align: center;vertical-align: middle;width: 12%;">Total</th>
            <th style="text-align: center;vertical-align: middle;width: 12%;">Payment Method</th>
            <th style="text-align: center;vertical-align: middle;width: 12%;">Account</th>
            <th style="text-align: center;vertical-align: middle;width: 12%;">Bank</th>
            <th style="text-align: center;vertical-align: middle;width: 12%;">Nominal Payment</th>
        </tr>
    </thead>
        </tbody>
...
$limit = 0;
    while($row2 = mysqli_fetch_array($sql)){
        ...
        echo ' <tr style="font-size:12px;text-align:center;">
            ...
            <td style="text-align : left;" value = "'.$row2['Payment_date'].'">'.date("d-M-Y",strtotime($row2['Payment_date'])).'</td>
            <td style="text-align : left;" value = "'.$row2['Supplier'].'">'.$row2['Supplier'].'</td>
            <td style="text-align : right;" value = "'.$row2['Total_LP'].'">'.$row2['Curr_LP'].' '.number_format($row2['Total_LP'],2).'</td>
            ...
            <td style="text-align : right;" value = "'.$row2['nominal_payment'].'">'.$row2['valuta_bayar'].' '.number_format($row2['nominal_payment'],2).'</td>
            </tr>
            ';
}
?>  
