 ...
 <div class="form-row">
    ...
    <div class="box body">
        ...
        <tr><th class="text-center" style="width: 2%">-</th>
            <th class="text-center" style="width: 13%">COA</th>
            <th class="text-center" style="width: 13%">Cost Center</th>
            <th class="text-center" style="width: 12%">Reference</th>
            <th class="text-center" style="width: 12%">Reference Date</th>
            <th class="text-center" style="width: 13%">Buyer</th>
            <th class="text-center" style="width: 13%">Worksheet</th>
