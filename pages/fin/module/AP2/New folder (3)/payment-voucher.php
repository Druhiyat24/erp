...
<script type="text/javascript">     
    ...
    var pay_to = $(this).closest('tr').find('td:eq(11)').attr('value');
    var pay_date = $(this).closest('tr').find('td:eq(12)').attr('value');
    var pay_meth = $(this).closest('tr').find('td:eq(13)').attr('value');
    var f_akun = $(this).closest('tr').find('td:eq(14)').attr('value');
    var t_akun = $(this).closest('tr').find('td:eq(15)').attr('value');
    var cek_no = $(this).closest('tr').find('td:eq(9)').attr('value');
    var cek_date = $(this).closest('tr').find('td:eq(10)').attr('value');
    var pay_for = $(this).closest('tr').find('td:eq(16)').attr('value');
