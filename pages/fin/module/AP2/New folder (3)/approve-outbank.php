...
<form id="form-data" action="approve-pv.php" method="post">
    ...
    <div class="box body">
        <div class="row">
            ...
            // }else {
            $sql = mysqli_query($conn2,"select no_bankout,bankout_date,nama_supp,curr, amount, outstanding, status from b_bankout_h where status = 'Draft' group by no_bankout order by id asc");
            // }
