...
$sqlys = "select no_coa,nama_coa,nama_costcenter,reff_doc,reff_date,curr,debit,credit, keterangan from tbl_list_journal where debit > 0 and no_journal = '$no_bankout' || credit > 0 and no_journal = '$no_bankout'";
