<?php include '../header.php' ?>
    ...
    <!-- MAIN -->    
    <div class="col p-4">
        <h2 class="text-center">APPROVE CASH IN</h2>
<div class="box">
    <div class="box header">
<form id="form-data" action="approve-cashin.php" method="post">
        <div class="form-row">
            <!-- <div class="col-md-6">
    ...
    <div class="box body">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search no cashin..">
                </div>
            <table id="mytable" class="table table-striped table-bordered" cellspacing="0" width="100%" style="font-size: 12px;text-align:center;">
                    <thead>
                        <tr class="thead-dark">
                            ...
                            <th style="width:50px;">Reference Document</th>                                                                               
            ...
            // }else {
            $sql = mysqli_query($conn2,"select no_ci, tgl_ci,type_ci, IF(dokumen = '','-',dokumen) as dokumen, sum(amount) as amount from c_cash_in where status = 'draft' group by no_ci");
            // }
...
<div class="box footer">   
  ...
  <script language="JavaScript" src="../vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
...
<script type="text/javascript">
    $("#form-simpan").on("click", "#approve", function(){
        $("input[type=checkbox]:checked").each(function () {                
        var no_ci = $(this).closest('tr').find('td:eq(1)').attr('value');
        var approve_user = '<?php echo $user ?>';

        $.ajax({
            type:'POST',
            url:'approvecashin.php',
            data: {'no_ci':no_ci, 'approve_user':approve_user},
            close: function(e){
                e.preventDefault();
            },
            success: function(response){                
                console.log(response);
                window.location = 'approve-cashin.php';
        ...
        if(document.querySelectorAll("input[name='select[]']:checked").length >= 1){
            ...
            alert("Silahkan Ceklist No Cash In ");
        }        
    });
</script>
...
<script type="text/javascript">
    $("#form-simpan").on("click", "#cancel", function(){
        ...
        $.ajax({
            type:'POST',
            url:'cancelcashin.php',
            data: {'no_ci':no_ci, 'cancel_user':cancel_user},
            close: function(e){
                e.preventDefault();
            },
            success: function(response){                
