<?php include '../header.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h2 class="text-center">PURCHASE RETURN REPORT DETAIL</h2>
<div class="box">
    <div class="box header">
        ...
        <form id="form-data" action="laporan_retur_pembelian.php" method="post"> 
...
<script type="text/javascript">
    document.getElementById('ekspor').onclick = function () {
        ...
        ?>
    location.href = "ekspor_lap_retur_pembelian.php?status=<?= $nama_tipe;?>&nama_supp=<?= $nama_supp;?>&start_date=<?= $start_date;?>&end_date=<?= $end_date;?>";
};
</script>
