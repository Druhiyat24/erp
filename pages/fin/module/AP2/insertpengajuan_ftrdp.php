...
if ($no_cbd != '') {	
$query = "INSERT INTO pengajuan_ftrdp (no_cbd, tgl_cbd, no_po, nama_supp, total, dp, curr, tgl_pengajuan, nama_pengaju, pesan, status, approved_user, cancel_user) 
VALUES 
	('$no_cbd', '$tgl_cbd', '$no_po', '$nama_supp', '$total', '$dp', '$curr',  '$tgl_pengajuan', '$nama_pengaju', '$pesan', '$status', '$users', '$users')";
...
if(!$execute){	
   die('Error: ' . mysqli_error());	
	...
	$sql = "update ftr_dp set status = '$status' where no_ftr_dp= '$no_cbd'";
