...
$sql = "delete from kontrabon_h where no_kbon = '$no_kbon_h'";
$exec1 = mysqli_query($conn2,$sql);

if($exec1){	
$query = "INSERT INTO kontrabon_h (no_kbon, tgl_kbon, nama_supp, no_faktur, supp_inv, tgl_inv, tgl_tempo, subtotal, tax, pph, total, balance, curr, post_date, update_date, status, create_user, create_date) 
VALUES 
	('$no_kbon_h', '$tgl_kbon_h', '$nama_supp_h', '$no_faktur_h', '$supp_inv_h', '$tgl_inv_h', '$tgl_tempo_h', '$sub_h', '$tax_h', '$pph_h', '$total_h', '$balance', '$curr_h', '$post_date', '$update_date', '$status', '$create_user_h', '$create_date')";
