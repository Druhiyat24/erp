...
<div class="box">
    <div class="box header">
       ...
       <form id="form-data" action="reportbank.php" method="post">        
        <div class="form-row">
            <div class="col-md-5">
...
?>
    ...
    <div style="margin-left: 30px">
    	...
    	if ($curren == 'USD') {
    		echo '<a target="_blank" href="report_bank_usd.php?nama_bank='.$nama_bank.' && accountid='.$accountid.' && curren='.$curren.' && start_date='.$start_date.' && end_date='.$end_date.'"><button type="button" class="btn btn-success">
        <i class="fa fa-file-excel-o" aria-hidden="true" style="padding-right: 10px; padding-left: 5px;"> EXCEL</i></button></a>';
    	}else{
        echo '<a target="_blank" href="report_bank.php?nama_bank='.$nama_bank.' && accountid='.$accountid.' && curren='.$curren.' && start_date='.$start_date.' && end_date='.$end_date.'"><button type="button" class="btn btn-success">
        <i class="fa fa-file-excel-o" aria-hidden="true" style="padding-right: 10px; padding-left: 5px;"> EXCEL</i></button></a>';
    }
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $accountid = isset($_POST['accountid']) ? $_POST['accountid']: null;
    ...
    $saldoawal = 0;
    $saldo_awal = 1000000;
    $sqlxss1 = mysqli_query($conn1,"select max(id) as id from b_reportbank where akun = '$accountid' and transaksi_date < '$start_date'");
...
<table id="datatable" class="table table-striped table-bordered" role="grid" cellspacing="0" width="100%">
    ...
    <thead>
        <tr class="thead-dark">
            ...
            <th style="text-align: left;vertical-align: middle;width: 11%;">: ';?><?php echo $accountid; ?><?php echo'</th>
            ...
            <th style="text-align: left;vertical-align: middle;width: 11%;">: ';?><?php echo $curren; ?><?php echo'</th>                                                                            
        </tr>
        <tr class="thead-dark">
            ...
            <th colspan="2" style="text-align: center;vertical-align: middle;width: 22%;">Description</th>
            <th style="text-align: center;vertical-align: middle;width: 11%;">Category</th>
            <th style="text-align: center;vertical-align: middle;width: 13%;">Cash Flow Category</th>
    ...
    <thead>
        <tr class="thead-dark">
            ...
            <th colspan="2" style="text-align: left;vertical-align: middle;width: 20%;">: ';?><?php echo $curren; ?><?php echo'</th>                                                                            
        </tr>
        <tr class="thead-dark">
...
<?php
   ...
   if(empty($accountid) and empty($start_date) and empty($end_date)){
    echo '';
     ...
     $sql = mysqli_query($conn1,"select transaksi_date as date, no_doc as doc_num,deskripsi,debit,credit,curr, balance from b_reportbank where akun = '$accountid' and curr = '$curren' and transaksi_date between '$start_date' and '$end_date' order by date asc");
    }
