...
<body>
    ...
    <table style="width:100%;font-size:10px;" border="1" >
        ...
        <tr>
            ...
            <th style="text-align: right;vertical-align: middle;width: 11%;"><?php echo number_format($saldoawal,2); ?></th>                                                                            
        </tr>
        <?php
    $date_now = date("Y-m-d");                              
    $nama_bank=$_GET['nama_bank'];
    ...
    $sqlx = mysqli_query($conn1,"select if(max(id) is null,'0',max(id)) as id FROM b_reportbank where akun = '$accountid'");
