<?php include '../header.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h2 class="text-center">FORM PENGAJUAN CANCEL KONTRA BON</h2>
<div class="box">
...
<form id="form-data" method="post">
          ...
          <div class="form-group">
            ...
            <label for="nama_supp"><b>Supplier</b></label>
              <select class="form-control selectpicker" name="nama_supp" id="nama_supp" data-dropup-auto="false" data-live-search="true">
                ...
                <label><b>Pilih Tanggal Kontrabon</b></label>
    ...
    <div class="box body">
        <div class="row">
            ...
            $sql = mysqli_query($conn2,"select no_kbon, tgl_kbon, nama_supp, SUM(subtotal) , SUM(tax) as tax, SUM(total) , curr, create_user, status, status_int, tgl_tempo, no_faktur, supp_inv, tgl_inv, pph_code, SUM(pph_value) as pph_value, pph_code from kontrabon where tgl_kbon between '$start_date' and '$end_date' and nama_supp = '$nama_supp' and status = 'Post' group by no_kbon");
...
<div class="box footer">   
        <form id="form-simpan">
            ...
            <div class="form-row col">
                <label for="subtotal" class="col-sm-2 col-form-label" style="width: 100px;"><b>Nama Pengaju</b></label>
            ...
            <div class="form-row col">
                <label for="subtotal" class="col-sm-2 col-form-label" style="width: 100px;"><b>TGL Pengajuan</b></label>
            <div class="col-md-5 mb-3">                              
            ...
            <div class="form-row col">
                <label for="subtotal" class="col-sm-2 col-form-label" style="width: 100px;"><b>No Kontrabon</b></label>
            <div class="col-md-5 mb-3">                              
            ...
            <div class="form-row col">
                <label for="subtotal" class="col-sm-2 col-form-label" style="width: 100px;"><b>Pesan Pembatalan</b></label>
            <div class="col-md-5 mb-3">                              
                <textarea cols="30" rows="5" type="text" class="form-control " name="pesan" id="pesan" style="font-size: 14px; text-align: left;" placeholder="silahkan isikan pesan pengajuan" value=""
                 required> </textarea>
           ...
           <div class="form-row col">
            ...
            <button type="button" class="btn-danger" name="batal" id="batal" onclick="location.href='payment.php'"><span class="fa fa-times"></span> Batal</button>           
            </div>
            </div>                                    
        </form>
        </div>
...
<script type="text/javascript">
    $("#form-simpan").on("click", "#simpan", function(){
        ...
        $.ajax({
            type:'POST',
            url:'insertcancelkb.php',
            data: {'no_kbon':no_kbon, 'nama_supp':nama_supp, 'tgl_pengajuan':tgl_pengajuan, 'nama_pengaju':nama_pengaju, 'pesan':Pesan},
            cache: 'false',
            close: function(e){
                e.preventDefault();
            },
        ...
        if(document.querySelectorAll("input[name='select[]']:checked").length == 0){
            alert("Silahkan Ceklist No KB Dahulu");            
        }            
    });
</script>
