...
<form id="form-data" method="post">
        <div class="form-row">
            ...
            <?php
            $sql = mysqli_query($conn2,"select max(no_kbon) from kontrabon_cbd");
...
<!--            <div class="col-md-3 mb-3">            
    ...
    <div class="box body">
        <div class="row">
            ...
            $sql = mysqli_query($conn2,"select no_ftr_cbd, tgl_ftr_cbd, no_po, tgl_po, SUM(subtotal) as sub, SUM(tax) as tax, SUM(total) as total, supp as supplier, status, keterangan, create_user from ftr_cbd where supp = '$nama_supp' and tgl_ftr_cbd between '$start_date' and '$end_date' and is_invoiced != 'Invoiced' and status = 'Approved' group by no_ftr_cbd");                                                     
            while($row = mysqli_fetch_array($sql)){
            $cbd = $row['no_ftr_cbd'];
