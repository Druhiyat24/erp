<?php include '../header.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h2 class="text-center">LIST MAINTAIN KONTRA BON FTR CBD</h2>
<div class="box">
    <div class="box header">

        <form id="form-data" action="pengajuankb_cbd.php" method="post">        
        <div class="form-row">
            <div class="col-md-12">
...
<table id="datatable" class="table table-striped table-bordered" role="grid" cellspacing="0" width="100%">
    <thead>
        <tr class="thead-dark">
            ...
            <th style="text-align: center;vertical-align: middle;width: 80px">Total CBD</th>
...
$nama_supp ='';
    ...
    if(empty($nama_supp) and empty($status) and empty($start_date) and empty($end_date)){
     $sql = mysqli_query($conn2,"select pengajuan_kb_cbd.id as id, pengajuan_kb_cbd.no_kbon as no_kbon,pengajuan_kb_cbd.no_dp as no_dp, pengajuan_kb_cbd.nama_supp as nama_supp, pengajuan_kb_cbd.tgl_pengajuan as tgl_Pengajuan, pengajuan_kb_cbd.nama_pengaju as nama_pengaju, pengajuan_kb_cbd.pesan as pesan, pengajuan_kb_cbd.status as status, pengajuan_kb_cbd.approved_user as approve, pengajuan_kb_cbd.cancel_user as cancel, kontrabon_cbd.total as total, kontrabon_cbd.curr as curr, kontrabon_cbd.tgl_kbon as tanggal from pengajuan_kb_cbd INNER JOIN kontrabon_cbd on kontrabon_cbd.no_kbon = pengajuan_kb_cbd.no_kbon where tgl_pengajuan = '$date_now' group by id");
    }
    elseif ($nama_supp == 'ALL' and $status == 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {            
     $sql = mysqli_query($conn2,"select pengajuan_kb_cbd.id as id, pengajuan_kb_cbd.no_kbon as no_kbon,pengajuan_kb_cbd.no_dp as no_dp, pengajuan_kb_cbd.nama_supp as nama_supp, pengajuan_kb_cbd.tgl_pengajuan as tgl_Pengajuan, pengajuan_kb_cbd.nama_pengaju as nama_pengaju, pengajuan_kb_cbd.pesan as pesan, pengajuan_kb_cbd.status as status, pengajuan_kb_cbd.approved_user as approve, pengajuan_kb_cbd.cancel_user as cancel, kontrabon_cbd.total as total, kontrabon_cbd.curr as curr, kontrabon_cbd.tgl_kbon as tanggal from pengajuan_kb_cbd INNER JOIN kontrabon_cbd on kontrabon_cbd.no_kbon = pengajuan_kb_cbd.no_kbon group by id");
    }
    elseif ($nama_supp == 'ALL' and $status == 'ALL' and !empty($start_date) and !empty($end_date)) {
     $sql = mysqli_query($conn2,"select pengajuan_kb_cbd.id as id, pengajuan_kb_cbd.no_kbon as no_kbon,pengajuan_kb_cbd.no_dp as no_dp, pengajuan_kb_cbd.nama_supp as nama_supp, pengajuan_kb_cbd.tgl_pengajuan as tgl_Pengajuan, pengajuan_kb_cbd.nama_pengaju as nama_pengaju, pengajuan_kb_cbd.pesan as pesan, pengajuan_kb_cbd.status as status, pengajuan_kb_cbd.approved_user as approve, pengajuan_kb_cbd.cancel_user as cancel, kontrabon_cbd.total as total, kontrabon_cbd.curr as curr, kontrabon_cbd.tgl_kbon as tanggal from pengajuan_kb_cbd INNER JOIN kontrabon_cbd on kontrabon_cbd.no_kbon = pengajuan_kb_cbd.no_kbon where tgl_pengajuan between '$start_date' and '$end_date' group by id");
    }
    elseif ($nama_supp != 'ALL' and $status == 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
     $sql = mysqli_query($conn2,"select pengajuan_kb_cbd.id as id, pengajuan_kb_cbd.no_kbon as no_kbon,pengajuan_kb_cbd.no_dp as no_dp, pengajuan_kb_cbd.nama_supp as nama_supp, pengajuan_kb_cbd.tgl_pengajuan as tgl_Pengajuan, pengajuan_kb_cbd.nama_pengaju as nama_pengaju, pengajuan_kb_cbd.pesan as pesan, pengajuan_kb_cbd.status as status, pengajuan_kb_cbd.approved_user as approve, pengajuan_kb_cbd.cancel_user as cancel, kontrabon_cbd.total as total, kontrabon_cbd.curr as curr, kontrabon_cbd.tgl_pengajuan as tanggal from pengajuan_kb_cbd INNER JOIN kontrabon_cbd on kontrabon_cbd.no_kbon = pengajuan_kb_cbd.no_kbon where nama_supp = '$nama_supp' group by id");
    }
    elseif ($nama_supp != 'ALL' and $status == 'ALL' and !empty($start_date) and !empty($end_date)) {
     $sql = mysqli_query($conn2,"select pengajuan_kb_cbd.id as id, pengajuan_kb_cbd.no_kbon as no_kbon,pengajuan_kb_cbd.no_dp as no_dp, pengajuan_kb_cbd.nama_supp as nama_supp, pengajuan_kb_cbd.tgl_pengajuan as tgl_Pengajuan, pengajuan_kb_cbd.nama_pengaju as nama_pengaju, pengajuan_kb_cbd.pesan as pesan, pengajuan_kb_cbd.status as status, pengajuan_kb_cbd.approved_user as approve, pengajuan_kb_cbd.cancel_user as cancel, kontrabon_cbd.total as total, kontrabon_cbd.curr as curr, kontrabon_cbd.tgl_kbon as tanggal from pengajuan_kb_cbd INNER JOIN kontrabon_cbd on kontrabon_cbd.no_kbon = pengajuan_kb_cbd.no_kbon where nama_supp = '$nama_supp' and tgl_pengajuan between '$start_date' and '$end_date' group by id");
    }
    elseif ($nama_supp == 'ALL' and $status != 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
     $sql = mysqli_query($conn2,"select pengajuan_kb_cbd.id as id, pengajuan_kb_cbd.no_kbon as no_kbon,pengajuan_kb_cbd.no_dp as no_dp, pengajuan_kb_cbd.nama_supp as nama_supp, pengajuan_kb_cbd.tgl_pengajuan as tgl_Pengajuan, pengajuan_kb_cbd.nama_pengaju as nama_pengaju, pengajuan_kb_cbd.pesan as pesan, pengajuan_kb_cbd.status as status, pengajuan_kb_cbd.approved_user as approve, pengajuan_kb_cbd.cancel_user as cancel, kontrabon_cbd.total as total, kontrabon_cbd.curr as curr, kontrabon_cbd.tgl_kbon as tanggal from pengajuan_kb_cbd INNER JOIN kontrabon_cbd on kontrabon_cbd.no_kbon = pengajuan_kb_cbd.no_kbon where pengajuan_kb_cbd.status = '$status' group by id");
    }
    elseif ($nama_supp == 'ALL' and $status != 'ALL' and !empty($start_date) and !empty($end_date)) {
     $sql = mysqli_query($conn2,"select pengajuan_kb_cbd.id as id, pengajuan_kb_cbd.no_kbon as no_kbon,pengajuan_kb_cbd.no_dp as no_dp, pengajuan_kb_cbd.nama_supp as nama_supp, pengajuan_kb_cbd.tgl_pengajuan as tgl_Pengajuan, pengajuan_kb_cbd.nama_pengaju as nama_pengaju, pengajuan_kb_cbd.pesan as pesan, pengajuan_kb_cbd.status as status, pengajuan_kb_cbd.approved_user as approve, pengajuan_kb_cbd.cancel_user as cancel, kontrabon_cbd.total as total, kontrabon_cbd.curr as curr, kontrabon_cbd.tgl_kbon as tanggal from pengajuan_kb_cbd INNER JOIN kontrabon_cbd on kontrabon_cbd.no_kbon = pengajuan_kb_cbd.no_kbon where pengajuan_kb_cbd.status = '$status' and tgl_pengajuan between '$start_date' and '$end_date' group by id");
    }
    elseif ($nama_supp != 'ALL' and $status != 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
     $sql = mysqli_query($conn2,"select pengajuan_kb_cbd.id as id, pengajuan_kb_cbd.no_kbon as no_kbon,pengajuan_kb_cbd.no_dp as no_dp, pengajuan_kb_cbd.nama_supp as nama_supp, pengajuan_kb_cbd.tgl_pengajuan as tgl_Pengajuan, pengajuan_kb_cbd.nama_pengaju as nama_pengaju, pengajuan_kb_cbd.pesan as pesan, pengajuan_kb_cbd.status as status, pengajuan_kb_cbd.approved_user as approve, pengajuan_kb_cbd.cancel_user as cancel, kontrabon_cbd.total as total, kontrabon_cbd.curr as curr, kontrabon_cbd.tgl_kbon as tanggal from pengajuan_kb_cbd INNER JOIN kontrabon_cbd on kontrabon_cbd.no_kbon = pengajuan_kb_cbd.no_kbon where pengajuan_kb_cbd.status = '$status' and nama_supp = '$nama_supp' group by id");
    }
    else{
    $sql = mysqli_query($conn2,"select pengajuan_kb_cbd.id as id, pengajuan_kb_cbd.no_kbon as no_kbon,pengajuan_kb_cbd.no_dp as no_dp, pengajuan_kb_cbd.nama_supp as nama_supp, pengajuan_kb_cbd.tgl_pengajuan as tgl_Pengajuan, pengajuan_kb_cbd.nama_pengaju as nama_pengaju, pengajuan_kb_cbd.pesan as pesan, pengajuan_kb_cbd.status as status, pengajuan_kb_cbd.approved_user as approve, pengajuan_kb_cbd.cancel_user as cancel, kontrabon_cbd.total as total, kontrabon_cbd.curr as curr, kontrabon_cbd.tgl_kbon as tanggal from pengajuan_kb_cbd INNER JOIN kontrabon_cbd on kontrabon_cbd.no_kbon = pengajuan_kb_cbd.no_kbon where pengajuan_kb_cbd.status = '$status' and nama_supp = '$nama_supp' and tgl_pengajuan between '$start_date' and '$end_date' group by id ");
}
    while($row = mysqli_fetch_array($sql)){
    if (!empty($row)) {
...
<script>
    ...
    //     "processing": true,
    //     "ajax": {
    //         url: "fetch_data_kontrabon_cbd.php",
    //         type: "post"
    //     }
    // });
    $('#datatable').dataTable();
...
<script type="text/javascript">
    $("table tbody tr").on("click", "#approve", function(){
        ...
        var no_cbd = $(this).closest('tr').find('td:eq(2)').attr('value');
        var approve_user = '<?php echo $user ?>';


        $.ajax({
            type:'POST',
            url:'approvepengajuan_cbd.php',
            data: {'id':id, 'no_kbon':no_kbon, 'no_cbd':no_cbd, 'approve_user':approve_user},
            // close: function(e){
            //     e.preventDefault();
            // },
...
<script type="text/javascript">
    ...
    location.href = "formpengajuankb_cbd.php";
};
</script>
<script type="text/javascript">
    document.getElementById('reset').onclick = function () {
    location.href = "pengajuankb_cbd.php";
};
</script>
