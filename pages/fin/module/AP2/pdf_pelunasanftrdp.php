...
<?php
$sql= "select * from payment_ftrdp where payment_ftr_id = '$no_pay' ";
...
<tr>
    ...
    <td align="right"><h4>
      <?php
      $sql1 = mysqli_query($conn2,"select nama_supp from payment_ftrdp where payment_ftr_id = '$no_pay'");
...
<table style="font-size:12px;">
    ...
    <td style="text-align:center;padding-top: -15px;padding-bottom: -10px;">
      <?php
      $sql1 = mysqli_query($conn2,"select tgl_pelunasan from payment_ftrdp where payment_ftr_id = '$no_pay'");
      $rows = mysqli_fetch_array($sql1);
    ...
    <td style="text-align:center;padding-top: -15px;padding-bottom: -10px;">
      <?php
      $sql2 = mysqli_query($conn2,"select cara_bayar from payment_ftrdp where payment_ftr_id = '$no_pay'");
    ...
    <td style="text-align:center;padding-top: -15px;padding-bottom: -10px;">
      <?php
      $sql4 = mysqli_query($conn2,"select bank from payment_ftrdp where payment_ftr_id = '$no_pay'");
    ...
    <td style="text-align:center;padding-top: -15px;padding-bottom: -10px;">
      <?php
      $sql3 = mysqli_query($conn2,"select account from payment_ftrdp where payment_ftr_id = '$no_pay'");
