<?php include '../header.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h2 class="text-center">LIST CASH IN</h2>
<div class="box">
           ...
           <div class="col-md-3">
            <label for="nama_supp"><b>Reference</b></label>            
              <select class="form-control selectpicker" name="nama_supp" id="nama_supp" data-dropup-auto="false" data-live-search="true" onchange="this.form.submit()">
                ...
                $sql = mysql_query("select ref_doc from master_forpay where ket = '4' order by id ASC",$conn1);
...
<table id="datatable" class="table table-striped table-bordered" role="grid" cellspacing="0" width="100%">
    ...
    $sql = mysql_query("select no_ci, tgl_ci,type_ci, IF(dokumen = '','-',dokumen) as dokumen, sum(amount) as amount,status, create_by from c_cash_in $where group by no_ci",$conn1);
