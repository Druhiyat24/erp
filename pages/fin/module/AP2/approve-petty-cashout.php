<?php include '../header.php' ?>
    ...
    <!-- MAIN -->    
    <div class="col p-4">
        <h2 class="text-center">APPROVE PETTY CASH OUT</h2>
<div class="box">
    <div class="box header">
<form id="form-data" action="approve-petty-cashout.php" method="post">
        <div class="form-row">
            <!-- <div class="col-md-6">
    ...
    <div class="box body">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search no petty cashout..">
                </div>
            ...
            // }else {
            $sql = mysqli_query($conn2,"select a.no_pco,a.tgl_pco,a.reff,a.nama_supp,b.nama_coa,a.amount,a.deskripsi from c_petty_cashout_h a left join mastercoa_v2 b on b.no_coa = a.coa_akun where a.status = 'draft' group by a.no_pco");
            // }
            ...
            while($row = mysqli_fetch_array($sql)){
                ...
                // }                                     
                    echo'<tr>
                            ...
                            <td style="width: 150px;" value = "'.$row['no_pco'].'">'.$row['no_pco'].'</td>
                            <td style="width: 100px;" value = "'.$row['tgl_pco'].'">'.date("d-M-Y",strtotime($row['tgl_pco'])).'</td>
                            <td style="width: 150px;" value = "'.$row['reff'].'">'.$row['reff'].'</td>
                            <td style="width: 150px;" value = "'.$row['nama_supp'].'">'.$row['nama_supp'].'</td>
    ...
    $("#form-simpan").on("click", "#approve", function(){
        ...
        $.ajax({
            ...
            success: function(response){                
                ...
                window.location = 'approve-petty-cashout.php';
        ...
        if(document.querySelectorAll("input[name='select[]']:checked").length >= 1){
            ...
            alert("Silahkan Ceklist No Petty Cash Out ");
        }        
    });
</script>
