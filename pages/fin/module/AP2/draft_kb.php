<?php include '../header.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h2 class="text-center">LIST DRAFT KONTRA BON</h2>
<div class="box">
    <div class="box header">

        
        <form id="form-data" action="draft_kb.php" method="post">        
        <div class="form-row">
            <div class="col-md-6">
...
<?php
    ...
    echo '<button id="btncreate" type="button" class="btn-primary btn-xs"><span class="fa fa-arrow-circle-o-left"></span> Back</button>';
    }
?>
    </div>
    <div class="box body">
...
<table id="datatable" class="table table-striped table-bordered" role="grid" cellspacing="0" width="100%">
    <thead>
        <tr class="thead-dark">
            ...
            <th style="text-align: center;vertical-align: middle;width: 260px;">Action</th>
...
$nama_supp ='';
    ...
    $status = $row['status'];         
        echo '<tr style="font-size:12px;text-align:center;">
           ...
           echo '<td width="250px;">';
            if($status == 'Post' and $group != 'STAFF' and $fin == '1'){
                echo '<a id="approve" href=""><button type="button" class="btn btn-info"><i class="fa fa-paper-plane" aria-hidden="true" style="padding-right: 10px; padding-left: 5px;" onclick="alert_approve();"> Post</i></button></a>                
                <a id="delete" href=""><button type="button" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true" style="padding-right: 10px; padding-left: 5px;" onclick="alert_cancel();"> Delete</button></i></a>
                <a href="kontrabonedit.php?nokontrabon='.$row['no_kbon'].'" target="_blank"><button type="button" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true" style="padding-right: 10px; padding-left: 5px;"> Update</i></button></a>';               
            }elseif($status == 'Post' and $group == 'STAFF' and $fin == '1') {
