...
.modal-dialog {
  ...
  vertical-align: middle;
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h2 class="text-center">LIST CATEGORY COA 3</h2>
<div class="box">
        ...
        <div class="form-row" style="padding-top: 5px;"> 
            ...
            <label for="nama_group"><b>Category Name</b></label>            
              <select style="background-color: gray;" class="form-control select2bs4" name="id_ctg2" id="id_ctg2" required>
                ...
                $sql = mysqli_query($conn1,"select id_ctg3,Concat(id_ctg3,' - ',ind_name) as name from master_coa_ctg3");
...
<table id="datatable" class="table table-striped table-bordered" role="grid" cellspacing="0" width="100%">
    ...
    if($id_ctg2 == 'ALL'){
     $sql = mysql_query("select id_ctg3,ind_name,eng_name from master_coa_ctg3",$conn1);
    }else{
     $sql = mysql_query("select id_ctg3,ind_name,eng_name from master_coa_ctg3 where id_ctg3 = '$id_ctg2'",$conn1);
    }
    $no=0;
        ...
        <h4 class="modal-title" id="Heading">FORM CREATE CATEGORY COA 3</h4>
          ...
          <div class="form-group">
            <form id="modal-form3" method="post">
                ...
                $sql = mysql_query("select id_ctg1,Concat(id_ctg1,' - ',ind_name) as name from master_coa_ctg1",$conn1);
