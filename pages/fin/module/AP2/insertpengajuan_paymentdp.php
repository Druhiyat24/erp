...
if ($no_payment != '') {	
$query = "INSERT INTO pengajuan_paymentdp (no_payment, tgl_payment, no_kbon, nama_supp, total_kbon, total_amount, tgl_pengajuan, nama_pengaju, pesan, status, approved_user, cancel_user) 
VALUES 
...
if(!$execute){	
   die('Error: ' . mysqli_error());	
	...
	$sql = "update list_payment_dp set status_int = '$status_int', status = '$status' where no_payment= '$no_payment'";
