...
<table id="datatable" class="table table-striped table-bordered" role="grid" cellspacing="0" width="100%">
    <thead>
        <tr class="thead-dark">
            ...
            <th rowspan="2" style="text-align: center;vertical-align: middle;">Ending Balance IDR</th>                                                                            
        </tr>
        <tr class="thead-dark">
...
<div style="margin-left: 30px">
        ...
        $start_date = isset($_POST['start_date']) ? $_POST['start_date'] : null;
        $end_date = isset($_POST['end_date']) ? $_POST['end_date'] : null;
        echo '<a target="_blank" href="pcs_detail_summary.php?nama_supp='.$nama_supp.' && start_date='.$start_date.' && end_date='.$end_date.'"><button type="button" class="btn btn-success"><i class="fa fa-file-excel-o" aria-hidden="true" style="padding-right: 10px; padding-left: 5px;"> EXCEL SUMMARY </i></button></a>';
        ?>
    </div> 
</br>
...
<table id="datatable" class="table table-striped table-bordered" role="grid" cellspacing="0" width="100%">
    <thead>
        <tr class="thead-dark">
            <tr class="thead-dark">
            <th rowspan="2" style="text-align: center;vertical-align: middle;">Nama Supplier</th>
            <th colspan="7" style="text-align: center;vertical-align: middle;">Original Currency</th>
            <th rowspan="2" style="text-align: center;vertical-align: middle;">rate</th>
            <th rowspan="2" style="text-align: center;vertical-align: middle;">Ending Balance IDR</th>                                                                            
        </tr>
        <tr class="thead-dark">
