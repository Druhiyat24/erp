     ...
     <!--        <div class="form-row col">
       ...
       <!--     <div class="form-row col">
            ...
            <div class="col-md-1 mb-3">                              
                <button type="button" style="border-radius: 6px" class="btn-dark btn-sm" name="calculate" id="calculate"><span class="fa fa-calculator"></span> Calculate</button> 
...
<script type="text/javascript">
    $("#form-simpan").on("click", "#simpan", function(){
        ...
        $.ajax({
            ...
            'curr':curr, 'ceklist':ceklist, 'cash':cash, 'create_user':create_user, 'sum_sub':sum_sub, 'sum_tax':sum_tax, 'sum_dp':sum_dp, 'sum_pph':sum_pph, 'sum_total':sum_total, 'start_date':start_date, 'end_date':end_date, 'pph':pph, 'idtax':idtax, 'tgl_po':tgl_po, 'ttl_ro':ttl_ro, 'no_bppb':no_bppb},
            cache: 'false',
            close: function(e){
                e.preventDefault();
            },
