...
<?php
$sql= "select no_co,tgl_co,'KAS BESAR' akun,type_co,deskrip,curr,create_by,approve_by FROM c_cash_out where no_co = '$no_co'";
$rs=mysqli_fetch_array(mysqli_query($conn2,$sql));

$sqlys = "select no_coa,nama_coa,nama_costcenter,reff_doc,reff_date,curr,debit,credit, keterangan from tbl_list_journal where debit > 0 and no_journal = '$no_co' || credit > 0 and no_journal = '$no_co'";
