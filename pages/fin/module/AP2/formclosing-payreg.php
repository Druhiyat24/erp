<?php include '../header.php' ?>
    ...
    <!-- MAIN -->    
    <div class="col p-4">
        <h2 class="text-center">CLOSING PAYMENT REGULER</h2>
<div class="box">
    <div class="box header">
<form id="form-data" action="formclosing-payreg.php" method="post">
        <div class="form-row">
            <div class="col-md-6">
    ...
    $("#form-simpan").on("click", "#approve", function(){
        ...
        $.ajax({
            ...
            success: function(response){                
                ...
                window.location = 'formclosing-payreg.php';
