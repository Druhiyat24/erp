...
<div class="box footer">   
        <form id="form-data" action="create-bank-in.php" method="post">
            </br> 
            ...
            <label for="nama_supp"><b>Source</b></label>            
              <select class="form-control selectpicker" name="nama_supp" id="nama_supp" data-dropup-auto="false" data-live-search="true">
                ...
                <?php
            $sql = mysqli_query($conn2,"select max(doc_number) from ap_masterbank");
            ...
            <label for="nama_supp" class="col-form-label" style="width: 150px;"><b>COA</b></label>            
              <select class="form-control selectpicker" name="coa" id="coa" data-dropup-auto="false" data-live-search="true">
                ...
                $sql = mysqli_query($conn1,"select concat(id_coa,' ', coa_name) as coa from tbl_coa_detail");
                while ($row = mysqli_fetch_array($sql)) {
                    $data = $row['coa'];
            ...
            <label for="nama_supp" class="col-form-label" style="width: 150px;"><b>Cost Center</b></label>            
              <select class="form-control selectpicker" name="cost" id="cost" data-dropup-auto="false" data-live-search="true">
                ...
                $sql = mysqli_query($conn1,"select cost_name from tbl_cost_center");
                while ($row = mysqli_fetch_array($sql)) {
                    $data = $row['cost_name'];
            ...
            <div class="input-group">
            <label for="nama_supp" class="col-form-label" style="width: 150px;"><b>Reference Doc Number</b></label>            
...
<script type="text/javascript">
    $("#form-simpan").on("click", "#simpan", function(){
        ...
        $.ajax({
            ...
            data: {'tgl_active':tgl_active, 'no_doc':no_doc, 'sob':sob,'account':account, 'bank':bank, 'curr':curr,'pesan':pesan, 'create_user':create_user},
            cache: 'false',
            close: function(e){
                e.preventDefault();
            },
