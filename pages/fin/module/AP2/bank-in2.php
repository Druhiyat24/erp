<?php include '../header.php' ?>
    ...
    <!-- MAIN -->    
    <div class="col p-4">
        <h2 class="text-center">BANK IN</h2>
<div class="box">
    <div class="box header">
<form id="form-data" action="bank-in2.php" method="post">
        <div class="form-row">
            <div class="col-md-6">
    ...
    <thead>
        <tr class="thead-dark">
            ...
            $sql = mysql_query("select bpb.id ,bpb.bpbno_int, bpb.pono, bpb.bpbdate, mastersupplier.Supplier, po_header.jml_pterms, masterpterms.kode_pterms, bpb.curr, bpb.confirm_by, po_header.podate, po_header_draft.tipe_com
                ...
                where bpb.confirm='Y' and bpb.is_cancel='N' and bpb.bpbdate between '$start_date' and '$end_date' and po_header_draft.tipe_com is null || bpb.confirm='Y' and bpb.is_cancel='N' and bpb.bpbdate between '$start_date' and '$end_date' and po_header_draft.tipe_com = 'REGULAR' || bpb.confirm='Y' and bpb.is_cancel='N' and bpb.bpbdate between '$start_date' and '$end_date' and po_header_draft.tipe_com = 'BUYER' group by bpb.bpbno_int",$conn1);                
            }else {
            $sql = mysql_query("select bpb.id ,bpb.bpbno_int, bpb.pono, bpb.bpbdate, mastersupplier.Supplier, po_header.jml_pterms, masterpterms.kode_pterms, bpb.curr, bpb.confirm_by, po_header.podate, po_header_draft.tipe_com
                from bpb 
                INNER JOIN po_header on po_header.pono = bpb.pono 
        ...
        <form id="form-simpan">
           <div class="form-row col">
            ...
            <h4><i><u>Total</u></i></h4>              
                ...
                <div class="input-group" >
                    <label for="nama_supp" class="col-form-label" style="width: 150px;"><b>Outstanding </b></label>         
...
<!--         <table>
            <tr class="thead-dark">
            <th style="text-align: center;vertical-align: middle;">No Bank In</th>
            <th style="text-align: center;vertical-align: middle;"><input type="" name=""></th>                                                                                                                                                                       
                        </tr>
                        <tr class="thead-dark">
            <th style="text-align: center;vertical-align: middle;">Outstanding</th>
            <th style="text-align: center;vertical-align: middle;"><input type="" name=""></th>                                                                                                                                                                       
