...
.modal-dialog {
  ...
  vertical-align: middle;
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h2 class="text-center">LIST CASH FLOW</h2>
<div class="box">
...
<table id="datatable" class="table table-striped table-bordered" role="grid" cellspacing="0" width="100%">
    ...
    $sql = mysql_query("select a.id,b.type,b.eng_name as grup,a.eng_name as cf_name,a.status,a.ind_name as cf_name2 from tbl_master_cashflow a inner join tbl_master_group_cf b on b.id=a.id_group $where",$conn1);
