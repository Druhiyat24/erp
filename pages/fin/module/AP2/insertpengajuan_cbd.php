...
if ($no_kbon != '') {	
$query = "INSERT INTO pengajuan_kb_cbd (no_kbon, no_dp, nama_supp, tgl_pengajuan, nama_pengaju, pesan, status, approved_user, cancel_user) 
VALUES 
	('$no_kbon', '$no_cbd', '$nama_supp', '$tgl_pengajuan', '$nama_pengaju', '$pesan', '$status2', '$users', '$users')";
...
if(!$execute){	
   die('Error: ' . mysqli_error());	
	...
	$sql = "update kontrabon_cbd set status_int = '$status_int', status = '$status' where no_kbon= '$no_kbon'";
