...
where po_header.app = 'A' and po_header.pono = '$no_po' and po_item.cancel != 'Y' and po_header.jenis = 'N' and masterpterms.kode_pterms like '%DP%' and masterpterms.aktif = 'Y'");

}else{
$sql = mysqli_query($conn1,"select po_header.pono, jo.jo_no, po_header.id_terms, masterpterms.kode_pterms, 
...
where po_header.app = 'A' and po_header.pono = '$no_po' and po_item.cancel = 'N' and masterpterms.kode_pterms like '%DP%' and masterpterms.aktif = 'Y'");
}
