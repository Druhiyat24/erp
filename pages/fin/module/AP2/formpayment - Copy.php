...
<script type="text/javascript">
    $("#form-simpan").on("click", "#simpan", function(){
        ...
        $.ajax({
            ...
            data: {'no_payment':no_payment, 'tgl_payment':tgl_payment, 'keterangan':keterangan, 'no_kbon':no_kbon, 'tgl_kbon':tgl_kbon, 'nama_supp':nama_supp, 'curr':curr, 'create_user':create_user, 'total_kbon':total_kbon, 'top':top, 'outstanding':outstanding, 'amount':amount, 'tgl_tempo':tgl_tempo, 'balance':balance, 'no_bpb':no_bpb, 'tgl_bpb':tgl_bpb, 'no_po':no_po, 'tgl_po':tgl_po, 'pph_value':pph_value, 'duedate':duedate},
            cache: 'false',
            close: function(e){
                e.preventDefault();
            },
        ...
        }else if (document.getElementById('txt_amount').value == '' || document.getElementById('txt_amount').value == '0'){
