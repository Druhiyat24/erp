...
$sql = "update pengajuan_paymentdp set cancel_user='$cancel_user', tgl_cancel='$cancel_date', status='$status2' where id='$id'";
$query = mysqli_query($conn2,$sql);

$sql1 = "update list_payment_dp set status='$status1', status_int='$status_int' where no_payment = '$payment'";
