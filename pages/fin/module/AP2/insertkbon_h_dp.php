...
$query = "INSERT INTO kontrabon_h_dp (no_kbon, tgl_kbon, nama_supp, no_faktur, supp_inv, tgl_inv, tgl_tempo, subtotal, dp_value, total, balance, curr, post_date, update_date, status, create_user, create_date) 
VALUES 
	('$no_kbon_h', '$tgl_kbon_h', '$nama_supp_h', '$no_faktur_h', '$supp_inv_h', '$tgl_inv_h', '$tgl_tempo_h', '$sub_h', '$tax_h', '$total_h', '$balance', '$curr_h', '$post_date', '$update_date', '$status', '$create_user_h', '$create_date')";
