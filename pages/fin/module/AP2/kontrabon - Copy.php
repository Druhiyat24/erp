...
<table id="datatable" class="table table-striped table-bordered" role="grid" cellspacing="0" width="100%">
    ...
    if(empty($nama_supp) and empty($status) and empty($start_date) and empty($end_date)){
     $sql = mysqli_query($conn2,"select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, b.jml_return, b.jml_potong from kontrabon a INNER JOIN potongan b on b.no_kbon = a.no_kbon where a.tgl_kbon = '$date_now' and a.no_bpb != '' group by a.no_kbon");
    }
    elseif ($nama_supp == 'ALL' and $status == 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {            
     $sql = mysqli_query($conn2,"select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, b.jml_return, b.jml_potong from kontrabon a INNER JOIN potongan b on b.no_kbon = a.no_kbon where a.no_bpb != ''  group by a.no_kbon");
    }
    elseif ($nama_supp == 'ALL' and $status == 'ALL' and !empty($start_date) and !empty($end_date)) {
     $sql = mysqli_query($conn2,"select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, b.jml_return, b.jml_potong from kontrabon a INNER JOIN potongan b on b.no_kbon = a.no_kbon where a.tgl_kbon between '$start_date' and '$end_date' and a.no_bpb != '' group by a.no_kbon");
    }
    elseif ($nama_supp != 'ALL' and $status == 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
     $sql = mysqli_query($conn2,"select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, b.jml_return, b.jml_potong from kontrabon a INNER JOIN potongan b on b.no_kbon = a.no_kbon where a.nama_supp = '$nama_supp' and a.no_bpb != '' group by a.no_kbon");
    }
    elseif ($nama_supp != 'ALL' and $status == 'ALL' and !empty($start_date) and !empty($end_date)) {
     $sql = mysqli_query($conn2,"select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, b.jml_return, b.jml_potong from kontrabon a INNER JOIN potongan b on b.no_kbon = a.no_kbon where a.nama_supp = '$nama_supp' and a.tgl_kbon between '$start_date' and '$end_date' and a.no_bpb != '' group by a.no_kbon");
    }
    elseif ($nama_supp == 'ALL' and $status != 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
     $sql = mysqli_query($conn2,"select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, b.jml_return, b.jml_potong from kontrabon a INNER JOIN potongan b on b.no_kbon = a.no_kbon where a.status = '$status' and a.no_bpb != '' group by a.no_kbon");
    }
    elseif ($nama_supp == 'ALL' and $status != 'ALL' and !empty($start_date) and !empty($end_date)) {
     $sql = mysqli_query($conn2,"select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, b.jml_return, b.jml_potong from kontrabon a INNER JOIN potongan b on b.no_kbon = a.no_kbon where a.status = '$status' and a.tgl_kbon between '$start_date' and '$end_date' and a.no_bpb != '' group by a.no_kbon");
    }
    elseif ($nama_supp != 'ALL' and $status != 'ALL' and $start_date == '1970-01-01' and $end_date == '1970-01-01') {
     $sql = mysqli_query($conn2,"select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, b.jml_return, b.jml_potong from kontrabon a INNER JOIN potongan b on b.no_kbon = a.no_kbon where a.status = '$status' and a.nama_supp = '$nama_supp' and a.no_bpb != '' group by a.no_kbon");
    }
    else{
    $sql = mysqli_query($conn2,"select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, b.jml_return, b.jml_potong from kontrabon a INNER JOIN potongan b on b.no_kbon = a.no_kbon where a.status = '$status' and a.nama_supp = '$nama_supp' and a.tgl_kbon between '$start_date' and '$end_date' and a.no_bpb != '' group by a.no_kbon");
    }
    while($row = mysqli_fetch_array($sql)){
    if (!empty($row)) {
    $kbonno = $row['no_kbon'];
...
<script type="text/javascript">
    $("table tbody tr").on("click", "#approve", function(){                 
        ...
        var pph = $(this).closest('tr').find('td:eq(5)').attr('value');
        ...
        var tgl_po = $(this).closest('tr').find('td:eq(14)').attr('value');
        var total = $(this).closest('tr').find('td:eq(6)').attr('value');
