...
$sqlnkb = mysqli_query($conn2,"select max(no_pci) from c_petty_cashin_h where coa_akun = '$coa_akun' and YEAR(tgl_pci) = YEAR('$tgl_pci') AND MONTH(tgl_pci) = MONTH('$tgl_pci')");
