<?php include '../header.php' ?>
    ...
    <!-- MAIN -->
    <div class="col p-4">
        <h2 class="text-center">REPORT PETTY CASH</h2>
<div class="box">
       ...
       <form id="form-data" action="reportpettycash.php" method="post">        
        <div class="form-row">
            ...
            <label for="accountid" class="col-form-label" ><b>Account </b></label>  
                ...
                <?php 
                        $sqlacc = mysqli_query($conn1,"select no_coa as account, 'IDR' as curr,concat(no_coa,' ', nama_coa) as coa, SUBSTR(nama_coa,11,1) as kode from mastercoa_v2 where nama_coa like '%kas kecil%'");
...
<?php
   ...
   if(empty($accountid) and empty($start_date) and empty($end_date)){
    echo '';
     ...
     $sql = mysqli_query($conn1,"select transaksi_date as date, no_doc as doc_num,deskripsi,debit,credit,curr, balance from c_report_pettycash where akun = '$accountid' and transaksi_date between '$start_date' and '$end_date' order by date asc");
    }
