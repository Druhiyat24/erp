<?php include '../header.php' ?>
    ...
    <!-- MAIN -->    
    <div class="col p-4">
        <h2 class="text-center">CANCEL FAKTUR & INVOICE</h2>
<div class="box">
    <div class="box header">
<form id="form-data" action="form_cancel_faktur_inv.php" method="post">
        <div class="form-row">
            <div class="col-md-6">
    ...
    <div class="box body">
        <div class="row">
            ...
            $sql = mysqli_query($conn2,"SELECT no_dok, tgl_dok, no_inv, tgl_inv, no_faktur, tgl_faktur, no_bpb, tgl_bpb, nama_supp, status, created_by, created_date, jenis FROM bpb_faktur_inv WHERE status != 'CANCEL' group by no_dok");                
            }else {
            $sql = mysqli_query($conn2,"SELECT no_dok, tgl_dok, no_inv, tgl_inv, no_faktur, tgl_faktur, no_bpb, tgl_bpb, nama_supp, status, created_by, created_date, jenis FROM bpb_faktur_inv WHERE status != 'CANCEL' and nama_supp = '$nama_supp' group by no_dok");
            }
...
<script type="text/javascript">
    $("#form-simpan").on("click", "#cancel", function(){
        ...
        var jenis   = $(this).closest('tr').find('td:eq(10)').attr('value');
        ...
        $.ajax({
            ...
            success: function(response){                
                console.log(response);
                window.location = 'form_cancel_faktur_inv.php';                                               
            },
            error:  function (xhr, ajaxOptions, thrownError) {
               alert(xhr);
            }
        ...
        if(document.querySelectorAll("input[name='select[]']:checked").length >= 1){
            ...
            alert("Please check Document Number");
        }        
    });
</script>
