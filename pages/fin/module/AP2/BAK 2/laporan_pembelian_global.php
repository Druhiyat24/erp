...
<!-- <table id="datatable" class="table table-striped table-bordered" role="grid" cellspacing="0" width="100%"> -->
    ...
    $end_date ='';
     ...
     echo "<script>
   window.open('ekspor_lap_pembelian_global.php?status=$nama_tipe&nama_supp=$nama_supp&start_date=$start_date&end_date=$end_date');
    var redirect = function() {
        window.location = 'laporan_pembelian_global.php';
    };
