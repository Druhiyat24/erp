<?php include '../header.php' ?>
    ...
    <!-- MAIN -->    
    <div class="col p-4">
        <h2 class="text-center">APPROVE KONTRABON</h2>
<div class="box">
    <div class="box header">
<form id="form-data" action="formapprovekb.php" method="post">
        <div class="form-row">
            <div class="col-md-6">
    ...
    <div class="box body">
        <div class="row">
            ...
            $sql = mysqli_query($conn2,"select a.no_kbon, a.tgl_kbon, a.no_bpb,a.no_po,a.tgl_bpb,a.tgl_po, a.nama_supp, SUM(a.subtotal), SUM(a.tax) as tax, SUM(a.total), a.curr, a.create_user, a.status, a.tgl_tempo, a.no_faktur, a.supp_inv, a.tgl_inv, a.pph_code, SUM(a.pph_value) as pph_value, a.dp_value, a.pph_code, b.jml_return, b.jml_potong from kontrabon a INNER JOIN potongan b on b.no_kbon = a.no_kbon where a.nama_supp = '$nama_supp' and a.no_bpb != '' and a.status = 'draft' group by a.no_kbon");
            }
...
<script type="text/javascript">     
    ...
    var tgl_tempo = $(this).closest('tr').find('td:eq(19)').text();
    ...
    var no_faktur = $(this).closest('tr').find('td:eq(20)').attr('value');
    var supp_inv = $(this).closest('tr').find('td:eq(21)').attr('value');
    var tgl_inv = $(this).closest('tr').find('td:eq(22)').text();                
...
<script type="text/javascript">
    $("#form-simpan").on("click", "#approve", function(){
       ...
       var no_kbon = $(this).closest('tr').find('td:eq(1 )').attr('value');
        ...
        var no_bpb = $(this).closest('tr').find('td:eq(16)').attr('value');
        var tgl_po = $(this).closest('tr').find('td:eq(17)').attr('value');
        var total = $(this).closest('tr').find('td:eq(10)').attr('value');
        ...
        $.ajax({
           type:'POST',
            ...
            success: function(response){                
                ...
                window.location = 'formapprovekb.php';
        ...
        if(document.querySelectorAll("input[name='select[]']:checked").length >= 1){
            ...
            alert("Silahkan Ceklist No kontrabon Dahulu");
        }        
    });
</script>
