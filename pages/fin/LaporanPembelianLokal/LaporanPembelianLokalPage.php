					...
					<table style="width:100%;font-size:11px; border-collapse: collapse; outline: none; border: none;">
						...
						<thead>
							...
							<tr>
								...
								<th style="font-size: 16px; border-collapse: collapse; border: none;" colspan="14"><strong>Laporan Pembelian Lokal</strong></th>
    ...
    <div id="formBs" class='box'>
            ...
            <thead style="text-align: center;">
              <tr>
                ...
                <th style="background-color:#ffffff; min-width: 150px" rowspan="2" style="text-align: center;">NAMA BARANG</th>
