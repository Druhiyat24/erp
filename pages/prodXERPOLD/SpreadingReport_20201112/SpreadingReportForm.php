    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-8">
						<input type="text" id="bagian" class="form-control form" placeholder="Masukkan Bagian">
                </div>	
        ...
        <div class="row">
            <div class='col-md-3'>
                ...
                <a type='submit' name='cancel' onclick="my_back('../prod/?mod=SpreadingReport')" class='btn btn-primary'>Kembali</a>
            </div>
        </div>
		<br/>
</div>
...
<div class="box">
	...
	<br/>
        <div class="row">
            <div class="col-md-12">
                <table id="inv_scrap_detail" class="table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th style="background-color:#FFFFFF">Sticker yards</th>
							<th style="background-color:#FFFFFF">Lembar Gelaran</th>
							<th style="background-color:#FFFFFF">Sisa Gelar</th>
                            <th style="background-color:#FFFFFF">Sambung Duluan Bisa</th>
                            <th style="background-color:#FFFFFF">Sisa tidak bisa</th>
							<th style="background-color:#FFFFFF">Qty Reject(YDS)</th>
							<th style="background-color:#FFFFFF">Total(YDS)</th>
							<th style="background-color:#FFFFFF">Short Roll(+/- YDS)</th>
							<th style="background-color:#FFFFFF">Percent(%)</th>
							<th style="background-color:#FFFFFF">REMARK</th>
                        </tr>
                    </thead>
                </table>
            </div>
