            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type='text' onchange="handlekeyup(this)" class='form-control' id='tanggalt' 
                    ...
                    <div class="form-group">
                        ...
                        name='txtdateout' placeholder='Masukkan Jam Output' value='<?php echo date('H : i') ?>' disabled>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        <label>WS *</label>
                        <select class='form-control select2' id="ws" style='width: 100%;' name='txtJOItem' id='ws' onchange="getList(this.value);getDetail(this.value);handlekeyup(this);">
