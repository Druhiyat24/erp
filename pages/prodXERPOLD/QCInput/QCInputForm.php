        ...
        <form action="" name="form" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Line *</label>
                        <select class='form-control select2' id="line" style='width: 100%;' name='line' onchange="handlekeyup(this)">
                            <!-- <option selected disabled>--Choose WS--</option> -->
                        </select>
                    </div>
                    <div class="form-group">
                        <label>WS *</label>
                        <select class='form-control select2' id="ws" style='width: 100%;' name='ws' multiple="multiple" onchange="getDetail(this.value);handlekeyup(this)">
                            <!-- <option selected disabled>--Choose WS--</option> -->
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Notes</label>
                        <input type='text' class='form-control' onkeyup ="handlekeyup(this)" name='notes' id="notes"
