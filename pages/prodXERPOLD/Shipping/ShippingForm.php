    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-8">
                    <input type="text" disabled id="no_finishing_shp" class="form-control form" placeholder="(Auto)">
                </div>			
                ...
                <table id="table_detail" class="table-bordered" style="width:100%">
                    <thead>
                        <tr>
							...
							<th style="background-color:#FFFFFF">Qty Fg</th>
							<th style="background-color:#FFFFFF">Tot. Qty Shp</th>
