...
$sql = "select a.*, ms.supplier supplier, mb.supplier buyer,IF(ditagihkan = 'Y','YA','TIDAK') ditagihkan_fix,b.inv_vendor 
from memo_h a
...
<table width="100%" style="border:none; font-size:9pt">
  <tr>
    <td width="20%">List Invoice Vendor </td>
    <td width="80%">: <?php echo $inv_vendor; ?></td>
  </tr>
</table>
<br>
<table width="100%" style="border:none; font-size:9pt">
...
<th align='center' colspan = "5">test</th>
    ...
    <tr class="head">
      ...
      <td align='center'>Invoice Vendor</td>
  ...
  <tbody>
    ...
    $querylain = mysql_query("select nm_ctg,nm_sub_ctg,concat(IF(curr = 'IDR', 'Rp. ', '$ '),format(round(biaya,2),2)) biaya, inv_vendor from memo_det det 
inner join memo_h h on det.id_h = h.id_h
where det.id_h = '$id_h'
and det.cancel = 'N'");
    $no = 1;
