  ...
  <title>
    ...
    if ($excel=="N")
      {?>
        ...
        <style>
          /* Samakan tampilan input dan select2 */
          .form-control,
          ...
          /* Select2 container agar full width */
          .select2-container {
            width: 100% !important;
          }

          /* Select2 selection agar isi tengah vertikal */
          .select2-container--default .select2-selection--single {
            display: flex !important;
            align-items: center;
            padding: 0 12px; /* kiri-kanan seperti input biasa */
          }
...
<script type="text/javascript">
  $('table tbody tr').on('click', 'td:eq(1)', function(){                
    ...
    var jns_inv = $(this).closest('tr').find('td:eq(4)').attr('value');
    var kepada = $(this).closest('tr').find('td:eq(5)').attr('value');
    var supplier = $(this).closest('tr').find('td:eq(6)').attr('value');
    var jns_trans = $(this).closest('tr').find('td:eq(7)').attr('value');
    var buyer = $(this).closest('tr').find('td:eq(9)').attr('value');
    var id_h = $(this).closest('tr').find('td:eq(14)').attr('value');
    $.ajax({
      type: 'post',
