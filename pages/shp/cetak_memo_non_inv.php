...
$sql = "select a.*, ms.supplier supplier, mb.supplier buyer,IF(ditagihkan = 'Y','YA','TIDAK') ditagihkan_fix,b.inv_vendor,IF(jatuh_tempo is null,jatuh_tempo_new,jatuh_tempo) jatuh_tempo_new, mp.nama_pc from memo_h a
...
try {
  ...
  $mpdf = new mPDF('utf-8', $ukuran_kertas, 9, 'Arial', 5, 5, 68, 5, 5, 1, $orientasi_kertas);
