...
<?php if ($mod == "lap_memo_summary") {
  ...
  if (isset($_POST['submit'])) //KLIK SUBMIT
  {
    ...
    echo "<script>
  window.open ('?mod=lap_data_exc_memo_sum&from=$from&to=$to&tipe_inv=$tipe_inv&nama_supp=$nama_supp&nama_buyer=$nama_buyer&dest=xls', '_blank');
    </script>";
  } else {
  }
