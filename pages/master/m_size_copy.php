  ...
  <div class="box-body">
    <table id="examplefix" class="display responsive" style="width:100%">
      ...
      <tbody>
        <?php
        # QUERY TABLE
		    $query = mysql_query("SELECT * FROM mastersize ORDER BY urut asc limit 500");
			  $no = 1; 
          ...
          echo "<td><a $cl_ubah href='../master/?mod=$mod&mode=$mode&id=$data[size]' $tt_ubah </a>";
				  echo " <a $cl_hapus href='d_size.php?mod=$mod&mode=$mode&id=$data[size]' $tt_hapus";?> 
