      ...
      echo "<form method='post' name='form' action='s_width.php?mod=$mod&id=$id_type' onsubmit='return validasi()'>";
        ...
        <div class='col-md-3'>
          <div class='form-group'>
            ...
            IsiCombo("select e.id isi,concat(nama_group,' ',nama_sub_group,' ',nama_type,' ',nama_contents) 
    ...
    <table id="examplefix" class="display responsive" style="width:100%">
      ...
      <tbody>
        ...
        # QUERY TABLE
          ...
          echo "<td>$data[kode_width]</td>";
          echo "<td>$data[nama_width]</td>";
          echo "<td><a $cl_ubah href='../master/?mod=$mod&mode=$mode&id=$data[id]' $tt_ubah </a>";
				  echo " <a $cl_hapus href='d_width.php?mod=$mod&mode=$mode&id=$data[id]' $tt_hapus";?> 
