...
<div class="box">
  ...
  <div class="box-body">
    <table id="mpanel" class="display responsive" style="width:100%">
      <thead>
      <tr>
				<!-- <th>No</th> -->
				<th># ID</th>
      ...
      <tbody>
        <?php
        # QUERY TABLE
		    $query = mysql_query("SELECT * FROM masterpanel ORDER BY id DESC limit 500");
			  $no = 1; 
			  ...
			  { echo "<tr>";
				  echo "
					...
					<td><a $cl_ubah href='../master/?mod=$mod&mode=$mode&id=$data[id]' $tt_ubah </a>";
				 echo " <a $cl_hapus href='d_panel.php?mod=$mod&mode=$mode&id=$data[id]' $tt_hapus";?> 
