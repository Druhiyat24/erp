    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<label >Currency : </label>
			<input onkeyup="handleKeyUp('MANUAL',this)" class="form-control" type="text" readonly value="USD" id="currency">
		</div>
		<div class="form-group">
		<label >Dari Tanggal: </label>
			<input onchange="handleKeyUp('MANUAL',this)" class="form-control" type="text" value=" " id="tanggal">
		</div>		
		<div class="form-group" id="labelTo">
		<label >Sampai Tanggal: </label>
			<!--<input onchange="handleKeyUp('MANUAL',this)" class="form-control" type="text" value=" " id="tanggalto"> -->
			<input readonly class="form-control" type="text" value=" " id="tanggalto">
		</div>		
		<div class="form-group formHarian" >
		<label >Rate Jual : </label>
			<input onkeyup="handleKeyUp('MANUAL',this);getRateTengah()"  class="form-control" type="text" value="0" id="ratejual">
		</div>		
		<div class="form-group" >
		<label >Rate  : </label>
			<input onkeyup="handleKeyUp('MANUAL',this)"   class="form-control" type="text" value=" " id="rate">
		</div>
		<div class="form-group formHarian" >
		<label >Rate Beli : </label> 
			<input onkeyup="handleKeyUp('MANUAL',this);getRateTengah()"  class="form-control" type="text" value="0" id="ratebeli">
		</div>
