...
{ $query = mysql_query("SELECT * FROM masterweight where id='$id_type'");
  $data = mysql_fetch_array($query);
  $type = $data['kode_weight'];
  $type_desc = $data['nama_weight'];
  $id_prev = $data['id_length'];
}
# END COPAS EDIT
...
echo "
  <script type='text/javascript'>
    ...
    { var id_group = document.form.cboid.value;
      ...
      else if (type == '') { alert('Kode weight Tidak Boleh Kosong'); document.form.txttype.focus();valid = false;}
...
echo "<div class='box'>";
  echo "<div class='box-body'>";
    echo "<div class='row'>";
      echo "<form method='post' name='form' action='s_weight.php?mod=$mod&id=$id_type' onsubmit='return validasi()'>";
        echo "
        <div class='col-md-3'>
          <div class='form-group'>
            <label>Id *</label>
            <select class='form-control select2' style='weight: 100%;' id='cboid' name='cboid'>";
            IsiCombo("select g.id isi,concat(nama_group,' ',
          ...
          <div class='form-group'>
            ...
            placeholder='Masukkan Kode WeigHt' value='$type'>
          </div>
          <div class='form-group'>
...
<div class="box">
  ...
  <div class="box-body">
    <table id="examplefix" class="display responsive" style="weight:100%">
      <thead>
      <tr>
		      <th>No</th>
      ...
      <tbody>
        ...
        # QUERY TABLE
          ...
          echo "<td>$data[kode_weight]</td>";
          echo "<td>$data[nama_weight]</td>";
          echo "<td><a $cl_ubah href='../master/?mod=$mod&mode=$mode&id=$data[id]' $tt_ubah </a>";
				  echo " <a $cl_hapus href='d_weight.php?mod=$mod&mode=$mode&id=$data[id]' $tt_hapus";?> 
