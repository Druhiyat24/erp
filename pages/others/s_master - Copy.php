...
if ($cek=="0" and $id=="")
{	$sql = "insert into masteritem (matclass,tipe_item,tipe_mut,mattype,goods_code,itemdesc,color,size,file_gambar)
		values ('-','$txtjenisitem','$txtjenismut','$txtmattype','$txtgoods_code','$txtitemdesc','$txtcolor','$txtsize','$nama_file')";
	insert_log($sql,$user);
...
{	$sql = "update masteritem set tipe_item='$txtjenisitem',tipe_mut='$txtjenismut',goods_code='$txtgoods_code',
