...
$mod=1;
$id=$_GET['id'];
$kode_mkt=flookup("kode_mkt","userpassword","username='$id'");
$Groupp=flookup("groupp","userpassword","username='$id'");
?>
<?php 
# END COPAS ADD
?>
  ...
  <div class="box">
    ...
    <div class='col-md-3'>
      <div class='form-group'>
        ...
        <input type='text' class='form-control' name='txtkode_mkt' placeholder='Masukkan Group Marketing' value='<?php echo $kode_mkt;?>' >
      </div>
    </div>
    <div class="box-body">
