      ...
      <form method='post' name='form' action='s_po.php?mod=<?php echo $mod; ?>' onsubmit='return validasi()'>
        ...
        <div class='col-md-3'>          
          ...
          <div class='form-group'>
            ...
            <select class='form-control select2' disabled style='width: 100%;' name='txtcurr'>
 ...
 <div class='row'>
            ...
            <div class='col-md-12'>
              ...
              <div class='form-group'>
                ...
                <select onchange="check_payment_terms(this)" class='form-control select2' disabled style='width: 100%;' name='txtid_terms'>
          ...
          <div class='row'>
            ...
            <div class='col-md-6'>
              ...
              <div class='form-group'>
                ...
                <input type='number' disabled class='form-control' name='txtpph' placeholder='Masukkan PPh' value='<?php echo $pph;?>' >
            ...
            <div class='col-md-6'>
              ...
              <div class='form-group'>
                ...
                <input type='number' disabled readonly id='ppn_nya' class='form-control' name='txtppn' 
        ...
        <input class="form-control" type="text" disabled id="n_kurs" name="n_kurs" placeholder="Masukkan Nilai Kurs" value="<?php echo $n_kurs;?> ">
          ...
          <div class='form-group'>
            ...
            <textarea row='5' class='form-control' disabled name='txtnotes' id='txtnotes' placeholder='Masukkan Notes'><?php echo $notes;?></textarea>
		...
		<input type="checkbox"  disabled <?=$checked ?>  onclick="checkpkp()" name="pkp" id="pkp" value="<?=$pkp ?>" />PKP	
              ...
              <div class='form-group'>
                ...
                <select disabled class='form-control select2' <?=$disabled ?> id='triger_ppn' style='width: 100%;' onchange="$('#ppn_nya').val(this.value)" name='tax_nya'>
		...
		<input type="checkbox"  disabled <?=$checked_installment ?>  onclick="return false;" value="<?=$fg_installment ?>" id="fg_installment" name="fg_installment" id="fg_installment" value="<?=$fg_installment ?>" />Installment	

              <div class='form-group'>

                <label >Jumlah Cicilan</label>

				<input class="form-control" disabled type="text" <?=$disabled_installment ?> id="n_installment" name="n_installment" value="<?=$n_installment?> ">
              ...
              <div class='form-group'>
				...
				<input class="form-control" disabled type="text" <?=$disabled_installment ?> id="datepicker_installment" name="d_installment" value="<?=$d_installment?> ">
...
<?php } else if (($mod=="9" or $mod=="9z") and $id_po!="") { ?>
