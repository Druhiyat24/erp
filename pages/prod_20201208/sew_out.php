...
<script type="text/javascript">
  ...
  { var id_jo = document.form.txtJOItem.value;
    var html = $.ajax
    ({  type: "POST",
        url: 'ajax_sew.php?modeajax=view_list_jo',
        data: {id_jo: id_jo},
        async: false
    }).responseText;
    if(html)
...
<div class='box'>
  <div class='box-body'>
    <div class='row'>
      <form method='post' name='form' action='s_sew.php?mod=<?php echo $mod; ?>' onsubmit='return validasi()'>
        <div class='col-md-3'>
...
<div class="box">
  <div class="box-header">
    <h3 class="box-title">List Sewing Output</h3>
    <a href='../prod/?mod=4' class='btn btn-primary btn-s'>
    ...
    <table id="examplefix" class="display responsive" style="width:100%">
      ...
      <tbody>
        ...
        $query = mysql_query("select ac.styleno,ms.supplier,ac.kpno,co.dateinput,co.jam,co.dateoutput,co.qty qtyout,sod.id,so.so_no,so.buyerno,sod.dest,sod.color,sod.size,sod.qty,so.unit
          ...
          inner join sew_out co on sod.id=co.id_so_det
