...
<div class='box'>
  <div class='box-body'>
    <div class='row'>
        <div class='col-md-3'>
          <div class='form-group'>
            ...
            <input type='text' class='form-control' id='datepicker4' 
              name='txtdateout' id="tanggalinput" onchange="handlekeyup(this)" placeholder='Masukkan Tanggal Output' >
          </div>
          <div class='form-group'>
            <label>Notes</label>
        ...
        <div class='col-md-3'>
          <a type='submit' name='submit' onClick="save(Add)" class='btn btn-primary'>Simpan</a>
        </div>
    </div>
  </div>
</div>
