...
/* if($populasi_id_url.G_kondisi == '1'){
	...
	// GenerateTableDetail("webservices/getListSecInDetail.php?id_cost=" + $id_cost + "&id_url=" + $id_url + "&id_proses="+$str_id_proses+"&id_panel="+$str_id_panel)
...
function get_panel_proses(my_value){
	...
	Option("webservices/getListSecInPanel.php?id_cost="+my_value) //getListSecInProcess
		.then(data 					=> generate_option(data, '--Choose Panek--'))//OPTION LINE 
