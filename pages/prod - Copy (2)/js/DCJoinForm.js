...
function Save() {
	...
	// 	if (isNaN($qty)) {
	// 		alert("Qty DC Input baris ke-" + Detail[i].no + " Salah Format");
	// 		$("#qty_" + i).val("0");
	// 		return false;
	// 	}

	// 	// alert(parseInt(Detail[i].qty_cut_val))
	// 	if (parseInt(Detail[i].qty_val) > parseInt(Detail[i].qty_cut_val)) {
	// 		alert('Baris ke-' + Detail[i].no + ' Qty DC Input ' + '(' + Detail[i].qty_val + ')' + ' Lebih Besar Dari Qty Cutting ' + '(' + Detail[i].qty_cut_val + ')')
	// 		return false
	// 	}
	// }
