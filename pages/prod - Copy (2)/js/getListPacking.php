...
$columnName       = 'X.no_finishing_packing'; // Column name
...
/* 		$_str = "<input type='checkbox' onclick='check_uncheck(this)' checked class='{$_attr}[]' data-bppbno='{$bppbno_req}' data-id='".$_attr."__".$id_reff."' >"; */
			...
			$_str = "<a href='?mod=Pack_Form&id_finishing_packing_header={$__data["id_finishing_packing_header"]}' ><i class='fa fa-pencil'> </i></a>";
		}
		return $_str;
	}
