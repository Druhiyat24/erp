...
$columnName       = 'X.no_finishing_metal_detector'; // Column name
...
/* 		$_str = "<input type='checkbox' onclick='check_uncheck(this)' checked class='{$_attr}[]' data-bppbno='{$bppbno_req}' data-id='".$_attr."__".$id_reff."' >"; */
			...
			$_str = "<a href='?mod=Met_Dec_Form&id_finishing_metal_detector_header={$__data["id_finishing_metal_detector_header"]}' ><i class='fa fa-pencil'> </i></a>";
		}
		return $_str;
	}
