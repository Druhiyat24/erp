			...
			.DataTable({
				...
				"url": "webservices/getDataLaporanSummary.php?from="+from+"&to="+to+"&id_buyer="+id_buyer+"&status="+status,
					...
					//is_lembar_gelar
					{
						"data": null,
						"render": function (data) {
							return decodeURIComponent(data.tot_qty_cutt_out);
						},
						"className": "right"
					},
				
					{
						"data": null,
						"render": function (data) {
							return decodeURIComponent(data.balance_cutt_out);
						},
						"className": "right"
						//"className": "center"
					},
					//is_sambung_duluan_bisa 10
					{
						"data": null,
						"render": function (data) {
							return decodeURIComponent(data.tot_qty_numbering);
						},
						"className": "right"
						//"className": "center"
					},
					//is_sisa_tidak_bisa 11
					{
						...
						"data": null,
						"render": function (data) {
							return decodeURIComponent(data.balance_numbering);
						},
						"className": "right"
					},
					{
						"data": null,
						"render": function (data) {
							return decodeURIComponent(data.tot_qty_cutt_out_qc);
						},
						"className": "right"
					},						
					{"data": null,
						"render": function (data) {
							return decodeURIComponent(data.balance_cutt_out_qc);
						},
						"className": "right"
					},
...

					{
						"data": null,
						"render": function (data) {
							return decodeURIComponent(data.tot_dc_join);
						},
						"className": "right"
					},	

					{
						"data": null,
						"render": function (data) {
							return decodeURIComponent(data.balance_dc_join);
						},
						"className": "right"
					},	

					{
						"data": null,
						"render": function (data) {
							return decodeURIComponent(data.tot_dc_set);
						},
						"className": "right"
					},	

					{
						"data": null,
						"render": function (data) {
							return decodeURIComponent(data.balance_dc_set);
						},
						"className": "right"
					},	
