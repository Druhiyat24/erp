...
$_json 						= $Proses->generate_json_with_attribut($username,$data_datatable,$populasi_kolom,$populasi_attribut,$key_det); // bermain disini
...
/* 		$_str = "<input type='checkbox' onclick='check_uncheck(this)' checked class='{$_attr}[]' data-bppbno='{$bppbno_req}' data-id='".$_attr."__".$id_reff."' >"; */
	...
	public function generate_json_with_attribut($username,$_data,$_populasi_kolom,$_populasi_attribut,$_key_det){
		$j_data = array();
		$outp = "";/* 
