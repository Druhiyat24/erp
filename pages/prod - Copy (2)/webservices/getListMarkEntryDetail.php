...
class getListData {
	...
	public function get($id_cost,$color,$id_url,$id_item,$id_panel,$sequence){
		...
		// Table 1
		$table .="<table id='marker' class='table-bordered table-striped' style='width: 100%'>";
		$table .="<thead>";
		$table .="<tr>";
		...
		while($rowG = mysql_fetch_array($stmt_group)){
			...
			while($row3 = mysql_fetch_array($stmt_3)){
				...
				$table .="<td  style='text-align: center;'>
							<input type='text' onkeyup='handleKeyUp(this);' name='ratio' id='ratio_".$_id_md."_".$sequence."' class='form-control' value=".$_ratio." style='
							width: 30%;
							text-align: center;
							margin-left: auto;
							margin-right: auto;
			...
			$table .="<td  style='text-align: center;'>
					<input type='text' name='spread' id='spread_".$rowG['id_group']."_".$sequence."' onkeyup='handleKeyUp(this);' class='form-control' value=".$rowG['spread']." 
					style='
					width: 40%;
					text-align: center;
					float: right;
