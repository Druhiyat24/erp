...
//echo $row['n_post'];
	...
	$button = '';		
	$button .="<a href='../prod/?mod=cutQCForm&id=$row[id_cut_out]&cost=$row[id_cost]&color=$row[color]' style='color: #3c8dbc;' title='Edit' class='btn btn-sm' onclick='edit(".'"'.$row['id_cut_out'].'"'.")' ><i class='fa fa-pencil'> </i></a>";
