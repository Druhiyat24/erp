      ...
      echo "<form method='post' name='form' enctype='multipart/form-data' action='s_color.php?mod=$mod&id=$id_type' onsubmit='return validasi()'>";
        ...
        <div class='col-md-3'>
          <div class='form-group'>
            ...
            IsiCombo("select h.id isi,concat(nama_group,' ',
...
<div class="box">
  ...
  <div class="box-body">
    <table id="examplefix" class="display responsive" style="color:100%">
      <thead>
      <tr>
		      <th>No</th>
      ...
      <tbody>
        ...
        # QUERY TABLE
          ...
          echo "<td>$data[kode_color]</td>";
          echo "<td>$data[nama_color]</td>";
          echo "<td>$data[phantom]</td>";
          echo "<td><a $cl_ubah href='../master/?mod=$mod&mode=$mode&id=$data[id]' $tt_ubah </a>";
				  echo " <a $cl_hapus href='d_col.php?mod=$mod&mode=$mode&id=$data[id]' $tt_hapus";?> 
