...
$stmt = mysqli_query($conn_li,$q);	
	...
	public function get($data){
		...
		$q = "SELECT v_idgroup
			...
			$q = "SELECT v_idgroup,id,curr,max(tanggal)tos,min(tanggal)froms, rate,rate_jual,rate_beli,v_codecurr FROM 		masterrate GROUP BY v_idgroup having v_codecurr = '$codeCurr'";		
