  ...
  <div class="box-body">
    <table id="examplefix" class="display responsive" style="width:100%">
      ...
      <tbody>
        <?php
        # QUERY TABLE
		    $query = mysql_query("SELECT * FROM masterseason ORDER BY id_season DESC limit 500");
			  $no = 1; 
          ...
          echo "<td><a $cl_ubah href='../master/?mod=2&mode=$mode&id=$data[id_season]' $tt_ubah </a>";
				  echo " <a $cl_hapus href='d_seas.php?mod=2&mode=$mode&id=$data[id_season]' $tt_hapus";?> 
