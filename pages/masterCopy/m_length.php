      ...
      echo "<form method='post' name='form' action='s_length.php?mod=$mod&id=$id_type' onsubmit='return validasi()'>";
        ...
        <div class='col-md-3'>
          <div class='form-group'>
            ...
            IsiCombo("select f.id isi,concat(nama_group,' ',
...
<div class="box">
  ...
  <div class="box-body">
    <table id="examplefix" class="display responsive" style="length:100%">
      <thead>
      <tr>
		      <th>No</th>
      ...
      <tbody>
        ...
        # QUERY TABLE
          ...
          echo "<td>$data[kode_length]</td>";
          echo "<td>$data[nama_length]</td>";
          echo "<td><a $cl_ubah href='../master/?mod=$mod&mode=$mode&id=$data[id]' $tt_ubah </a>";
				  echo " <a $cl_hapus href='d_len.php?mod=$mod&mode=$mode&id=$data[id]' $tt_hapus";?> 
