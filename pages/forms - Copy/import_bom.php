...
$akses = flookup("bom","userpassword","username='$user'");
if ($akses=="0") 
...
echo "<div class='box'>";
  echo "<div class='box-body'>";
    echo "<div class='row'>";
      echo "<form method='post' name='form' enctype='multipart/form-data' action='import_proses_bom.php?mode=$mode' onsubmit='return validasi()'>";
