...
/* 				echo $cek;
				...
				{	$cek="0";
					if ($cek=="0")
					{	$sql = "insert into $nm_tbl (id_bpb,id_item_bb,id_item,id_item_fg,qty,unit,curr,price,remark,berat_bersih,berat_kotor,nomor_mobil,id_supplier,invno,bcno,bcdate,
							bppbno,bppbno_int,bppbno_req,bppbdate,jenis_dok,username,use_kite,nomor_aju,tanggal_aju,kpno,
							nomor_rak,status_retur,tujuan,subtujuan,id_jo) values ('$id_bpb','$txtid_item_bb','$txtid_item','$txtid_item_fg',
