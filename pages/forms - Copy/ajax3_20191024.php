...
if ($modenya=="view_list_stock" or $modenya=="view_list_stock2")
{	echo "
	<head>
	...
	{	$ponya=$crinya;
		echo "<table id='examplefix2' style='width: 100%;font-size:12px;'>";
			echo "
				...
				{	$sql="select s.id line_item,d.id_item,ac.kpno,d.goods_code,concat(d.itemdesc,' ',d.add_info) itemdesc,s.qty,s.unit, 
				...
				{	$id=$data['id_item'].":".$data['line_item'];
					...
					echo "
						<tr>";
							...
							<td>$data[itemdesc]</td>
							<td>
								<input type ='text' size='4' name ='qtypo[$id]' value='$data[qty]' id='qtypo$i' readonly>
							...
							<td>
								<input type ='text' size='4' name ='qtybpb[$id]' class='qtyclass' id='qtybpb$i' onchange='calc_total()'>
...
{	if($modenya=="view_list_stock")
	...
	if ($crinya!="")
	{	$ponya=$crinya;
		echo "<table id='examplefix' style='width: 100%;'>";
			echo "
				<thead>
					<tr>";
						...
						{	echo "<th>Qty BOM</th>"; }
						if ($jenis_company=="VENDOR LG" and $modenya!="view_list_stock2")
						{	echo "<th>Cons</th>"; }
						echo "
						<th>Unit</th>";
						if ($modenya=="view_list_stock2")
				...
				{	$id=$data['id_item'].":".$data['id_jo'];
					...
					echo "
						<tr>";
							...
							<td>
								$data[jo_no]
								<input type ='hidden' size='4' name ='jo[$id]' value='$data[id_jo]' id='jo$i' readonly>
							</td>";
							if($modenya=="view_list_stock")
