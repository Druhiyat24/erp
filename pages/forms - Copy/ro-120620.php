    ...
    <div class="box-body">
      ...
      <table id="examplefix3" class="display responsive" style="width:100%">
        ...
        <tbody>
          ...
          $query = mysql_query("SELECT jo_no,ac.kpno wsno,ac.styleno stylenya,a.*,s.goods_code,$fld_desc itemdesc,supplier , a.last_date_bppb
          ...
          { echo "<tr>";
			...
			if($akses_date=="1") {  
              ...
              echo "<td>$data[last_date_bppb]</td>";
			}
             echo "<td>$data[stylenya]</td>";
			...
			<td>
            	...
            	<a href='?mod=2&mode=$mode&noid=$data[bppbno]'
