		    ...
		    $txtid_item=$cri[0];
		  	...
		  	$cbomat = flookup("mattype","masteritem","id_item='$txtid_item'");
				...
				{	if ($txtbpbno=="") 
					...
					if ($cek=="0")
					{	$sql = "insert into bpb_dev (id_item,id_item_fg,qty,unit,curr,price,remark,jam_masuk,berat_bersih,berat_kotor,nomor_mobil,pono,id_supplier,
...
echo "<script>window.location.href='../forms/?mod=26v_dev&mode=$mode&noid=$bpbno';</script>";
?>