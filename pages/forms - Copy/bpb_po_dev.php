...
{ $id_item = "";
  ...
  $query = mysql_query("SELECT * from bpb_dev where bpbno='$bpbno' ORDER BY id_item ASC");
...
{ $query = mysql_query("SELECT * from bpb_dev where bpbno='$bpbno' and id_item='$id_item' and kpno='$kp' ORDER BY id_item ASC");
  $data = mysql_fetch_array($query);
...
<script type="text/javascript">
  ...
  { var nama_sup = document.form.cbosupfil.value;
    ...
    ({  type: "POST",
        <?php 
        if($mode=="General")
        { echo "url: 'ajax2.php?modeajax=cari_list_po_gen_dev',"; }
        else
        { echo "url: 'ajax2.php?modeajax=cari_list_po_dev',"; }
        ?>
  ...
  { jQuery.ajax
    ({  url: 'ajax3.php?modeajax=copy_po_dev',
        method: 'POST',
        data: {cri_item: cri_item}, 
    ...
    var html = $.ajax
    ({  type: "POST",
        url: 'ajax3.php?modeajax=view_list_po',
        data: "cri_item=" +cri_item,
        async: false
    }).responseText;
    if(html)
...
{ echo "<div class='box'>";
    echo "<div class='box-body'>";
      echo "<div class='row'>";
        echo "<form method='post' name='form' action='save_data_bpb_po_dev.php?mod=$mod&mode=$mode&noid=$bpbno&id=$id_item&kp=$kp' onsubmit='return validasi()'>";
          ?>
          <div class='col-md-12'>
                ...
                <div class='col-md-3'>
                  ...
                  <div class='form-group'>
                    ...
                    $sql = "select a.id_supplier isi,supplier tampil from mastersupplier a  
                      inner join po_header_dev s on a.id_supplier=s.id_supplier  
                      where tipe_sup='S' group by a.id_supplier";
                  ...
                  { echo "
                    <div class='row'>
                      ...
                      <div class='col-md-6'>
                        <div class='form-group'>
                          <label>$c47</label>
                          <select class='form-control select2' style='width: 100%;' id='cbotujuan' name='txttujuan'>";
                          if ($bpbno!="")
      ...
      <table id="examplefix3" class="display responsive" style="width:100%;font-size:11px;">
        ...
        <tbody>
          ...
          $query = mysql_query("SELECT a.*,s.goods_code,$fld_desc itemdesc,supplier 
            from bpb_dev a inner join $tbl_mst s on a.id_item=s.id_item 
