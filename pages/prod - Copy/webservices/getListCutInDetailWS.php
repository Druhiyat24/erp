...
//echo $row['n_post'];
	...
	$input = '';
	$input .="<input type='number' id='qtyyard_".$no."' class='form-control yard' value='{$qty_yard}' onkeyup='handleKeyUp(this);yardKeyUp()'>";

	$input2 = '';
$input2 .="<input type='number' id='qtyroll_".$no."' class='form-control roll' value='{$qty_roll}' onkeyup='handleKeyUp(this)'>";
	$no++;
