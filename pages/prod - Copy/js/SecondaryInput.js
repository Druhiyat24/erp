...
function getListInHouseSubcon(){
        ...
        type:"POST",
        cache:false,
        url:"webservices/getListInhouseSubcon.php", 
...
function getListDeptSubcon(){
	alert("123");
        ...
        type:"POST",
        cache:false,
        url:"webservices/getListDeptSubcon.php", 
        data : { code : '1',id_inhouse_subcon:Ddata.inhousesubcon},     // multiple data sent using ajax
        success: function (response) {
			data = response;
				d = JSON.parse(data);
				//d = response;
...
function handlekeyup(myValue){
	...
	function getListProses(){
        ...
        type:"POST",
        cache:false,
        url:"webservices/getListProsesSecondary.php", 
        data : { code : '1'},     // multiple data sent using ajax
        success: function (response) {
			data = response;
				d = JSON.parse(data);
