  ...
  echo "<div class='box-body'>";
    echo "<div class='row'>";
      ...
      echo "<div class='col-md-3'>";
          ...
          <label>Pilih Filter Tanggal</label>
          <select class='form-control select2' style='width: 100%;' 
            name='txtpilih'>
           <?php 
            $sql = "select nama_pilihan isi,nama_pilihan tampil from 
            	masterpilihan where kode_pilihan='PILIH_TGL'";
            IsiCombo($sql,'Tgl. Delivery','Pilih Filter Tanggal');
           ?>
          </select>
        </div>
      	<?php
      	echo "
    		<div class='form-group'>
    			...
    			<input type='text' class='form-control' id='datepicker1' name='txtfrom' placeholder='Masukkan Dari Tanggal' value='$from'>
    		</div>
    		<div class='form-group'>
    			<label>Sampai Tanggal *</label>
    			<input type='text' class='form-control' id='datepicker2' name='txtto' placeholder='Masukkan Sampai Tanggal' value='$to'>
    		</div>";
